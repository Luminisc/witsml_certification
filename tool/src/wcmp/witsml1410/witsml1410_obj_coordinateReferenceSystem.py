# .\witsml1410_obj_coordinateReferenceSystem.py
# -*- coding: utf-8 -*-
...
# Complex type {http://www.witsml.org/schemas/1series}cs_standardGeodeticCRS with content type ELEMENT_ONLY
class cs_standardGeodeticCRS (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_standardGeodeticCRS')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardGeodeticCRS.xsd', 28, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.opengis.net/gml/3.2}GeodeticCRS uses Python identifier GeodeticCRS
    __GeodeticCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'GeodeticCRS'), 'GeodeticCRS', '__httpwww_witsml_orgschemas1series_cs_standardGeodeticCRS_httpwww_opengis_netgml3_2GeodeticCRS', False, pyxb.utils.utility.Location(u'http://schemas.opengis.net/gml/3.2.1/coordinateReferenceSystems.xsd', 80, 1), )

    
    GeodeticCRS = property(__GeodeticCRS.value, __GeodeticCRS.set, None, None)

    
    # Element {http://www.witsml.org/schemas/1series}nameCRS uses Python identifier nameCRS
    __nameCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameCRS'), 'nameCRS', '__httpwww_witsml_orgschemas1series_cs_standardGeodeticCRS_httpwww_witsml_orgschemas1seriesnameCRS', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardGeodeticCRS.xsd', 35, 4), )

    
    nameCRS = property(__nameCRS.value, __nameCRS.set, None, u"The name of the coordinate reference system in a particular naming system. An optional short name (code) can also be specified. Specifying a well known system is highly desired. An example would be to specify a name of 'ED50' with a code of '4230' in the 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting that the parameters in the EPSG database are appropriate for this CRS. This is also true for any other naming system. If in doubt, contact your local geodesist.")


    _ElementMap = {
        __GeodeticCRS.name() : __GeodeticCRS,
        __nameCRS.name() : __nameCRS
    }
    _AttributeMap = {
        
    }
Namespace.addCategoryObject('typeBinding', u'cs_standardGeodeticCRS', cs_standardGeodeticCRS)


# Complex type {http://www.witsml.org/schemas/1series}cs_standardProjectedCRS with content type ELEMENT_ONLY
class cs_standardProjectedCRS (pyxb.binding.basis.complexTypeDefinition):
    """The sender may choose to send a nameCRS, with a well known name structure, or the sequence of information that fully defines the CRS. It is recommended that, for the standard CRSs in the EPSG database, the nameCRS be sent."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_standardProjectedCRS')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardProjectedCRS.xsd', 29, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.opengis.net/gml/3.2}ProjectedCRS uses Python identifier ProjectedCRS
    __ProjectedCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'ProjectedCRS'), 'ProjectedCRS', '__httpwww_witsml_orgschemas1series_cs_standardProjectedCRS_httpwww_opengis_netgml3_2ProjectedCRS', False, pyxb.utils.utility.Location(u'http://schemas.opengis.net/gml/3.2.1/coordinateReferenceSystems.xsd', 162, 1), )
    ...
    # Element {http://www.witsml.org/schemas/1series}nameCRS uses Python identifier nameCRS
    __nameCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameCRS'), 'nameCRS', '__httpwww_witsml_orgschemas1series_cs_standardProjectedCRS_httpwww_witsml_orgschemas1seriesnameCRS', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardProjectedCRS.xsd', 36, 4), )
...
Namespace.addCategoryObject('typeBinding', u'cs_standardProjectedCRS', cs_standardProjectedCRS)


# Complex type {http://www.witsml.org/schemas/1series}cs_standardVerticalCRS with content type ELEMENT_ONLY
class cs_standardVerticalCRS (pyxb.binding.basis.complexTypeDefinition):
    """The sender may choose to send a nameCRS, with a well known name structure, or the sequence of information that fully defines the CRS. It is recommended that, for the standard CRSs in the EPSG database, the nameCRS be sent."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_standardVerticalCRS')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 29, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.opengis.net/gml/3.2}VerticalCRS uses Python identifier VerticalCRS
    __VerticalCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'VerticalCRS'), 'VerticalCRS', '__httpwww_witsml_orgschemas1series_cs_standardVerticalCRS_httpwww_opengis_netgml3_2VerticalCRS', False, pyxb.utils.utility.Location(u'http://schemas.opengis.net/gml/3.2.1/coordinateReferenceSystems.xsd', 128, 1), )
    ...
    # Element {http://www.witsml.org/schemas/1series}nameCRS uses Python identifier nameCRS
    __nameCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameCRS'), 'nameCRS', '__httpwww_witsml_orgschemas1series_cs_standardVerticalCRS_httpwww_witsml_orgschemas1seriesnameCRS', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 36, 4), )
    ...
    # Element {http://www.witsml.org/schemas/1series}ellipsoidalDatum uses Python identifier ellipsoidalDatum
    __ellipsoidalDatum = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'ellipsoidalDatum'), 'ellipsoidalDatum', '__httpwww_witsml_orgschemas1series_cs_standardVerticalCRS_httpwww_witsml_orgschemas1seriesellipsoidalDatum', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 48, 3), )

    
    ellipsoidalDatum = property(__ellipsoidalDatum.value, __ellipsoidalDatum.set, None, u'In the case that the vertical datum is the ellipsoid, and that the vertical coordinate values are heights above the ellipsoid, this element should be instantiated to indicate this. This element should point to the geodetic CRS that defines this ellipsoid system. The ellipsoidal height is only valid if the horizontal CRS using the same ellipsoid is defined.')


    _ElementMap = {
        __VerticalCRS.name() : __VerticalCRS,
        __nameCRS.name() : __nameCRS,
        __ellipsoidalDatum.name() : __ellipsoidalDatum
    }
    _AttributeMap = {
        
    }
Namespace.addCategoryObject('typeBinding', u'cs_standardVerticalCRS', cs_standardVerticalCRS)
...
# Complex type {http://www.witsml.org/schemas/1series}obj_coordinateReferenceSystems with content type ELEMENT_ONLY
class obj_coordinateReferenceSystems (_abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_coordinateReferenceSystems')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystems_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 48, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}coordinateReferenceSystem uses Python identifier coordinateReferenceSystem
    __coordinateReferenceSystem = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'coordinateReferenceSystem'), 'coordinateReferenceSystem', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystems_httpwww_witsml_orgschemas1seriescoordinateReferenceSystem', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 53, 5), )

    
    coordinateReferenceSystem = property(__coordinateReferenceSystem.value, __coordinateReferenceSystem.set, None, u'A single  CRS.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystems_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 59, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 59, 4)
...
Namespace.addCategoryObject('typeBinding', u'obj_coordinateReferenceSystems', obj_coordinateReferenceSystems)
...
# Complex type {http://www.witsml.org/schemas/1series}obj_coordinateReferenceSystem with content type ELEMENT_ONLY
class obj_coordinateReferenceSystem (pyxb.binding.basis.complexTypeDefinition):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_coordinateReferenceSystem')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 70, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}geodeticCRS uses Python identifier geodeticCRS
    __geodeticCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'geodeticCRS'), 'geodeticCRS', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_httpwww_witsml_orgschemas1seriesgeodeticCRS', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 37, 4), )

    
    geodeticCRS = property(__geodeticCRS.value, __geodeticCRS.set, None, u'Use this for a geodetic CRS.')

    
    # Element {http://www.witsml.org/schemas/1series}projectedCRS uses Python identifier projectedCRS
    __projectedCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'projectedCRS'), 'projectedCRS', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_httpwww_witsml_orgschemas1seriesprojectedCRS', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 42, 4), )

    
    projectedCRS = property(__projectedCRS.value, __projectedCRS.set, None, u'Use this for a projected CRS.')

    
    # Element {http://www.witsml.org/schemas/1series}verticalCRS uses Python identifier verticalCRS
    __verticalCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'verticalCRS'), 'verticalCRS', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_httpwww_witsml_orgschemas1seriesverticalCRS', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 47, 4), )

    
    verticalCRS = property(__verticalCRS.value, __verticalCRS.set, None, u'Use this for a vertical CRS.')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 75, 3), )

    
    name = property(__name.value, __name.set, None, u'A standard, human recognizable name by which this CRS is known.')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 85, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 91, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_coordinateReferenceSystem_uid', uidString)
...
Namespace.addCategoryObject('typeBinding', u'obj_coordinateReferenceSystem', obj_coordinateReferenceSystem)
...
coordinateReferenceSystems = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coordinateReferenceSystems'), obj_coordinateReferenceSystems, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 32, 1))
Namespace.addCategoryObject('elementBinding', coordinateReferenceSystems.name().localName(), coordinateReferenceSystems)
...
cs_standardGeodeticCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'GeodeticCRS'), _nsgroup.GeodeticCRSType, scope=cs_standardGeodeticCRS, location=pyxb.utils.utility.Location(u'http://schemas.opengis.net/gml/3.2.1/coordinateReferenceSystems.xsd', 80, 1)))

cs_standardGeodeticCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameCRS'), wellKnownNameStruct, scope=cs_standardGeodeticCRS, documentation=u"The name of the coordinate reference system in a particular naming system. An optional short name (code) can also be specified. Specifying a well known system is highly desired. An example would be to specify a name of 'ED50' with a code of '4230' in the 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting that the parameters in the EPSG database are appropriate for this CRS. This is also true for any other naming system. If in doubt, contact your local geodesist.", location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardGeodeticCRS.xsd', 35, 4)))
...
def _BuildAutomaton_6 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_standardGeodeticCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardGeodeticCRS.xsd', 35, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_standardGeodeticCRS._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'GeodeticCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardGeodeticCRS.xsd', 40, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    st_0._set_transitionSet(transitions)
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_standardGeodeticCRS._Automaton = _BuildAutomaton_6()




cs_standardProjectedCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'ProjectedCRS'), _nsgroup.ProjectedCRSType, scope=cs_standardProjectedCRS, documentation=u'gml:ProjectedCRS is a 2D coordinate reference system used to approximate the shape of the earth on a planar surface, but in such a way that the distortion that is inherent to the approximation is carefully controlled and known. Distortion correction is commonly applied to calculated bearings and distances to produce values that are a close match to actual field values.', location=pyxb.utils.utility.Location(u'http://schemas.opengis.net/gml/3.2.1/coordinateReferenceSystems.xsd', 162, 1)))

cs_standardProjectedCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameCRS'), wellKnownNameStruct, scope=cs_standardProjectedCRS, documentation=u"The name of the coordinate reference system in a particular naming system. An optional short name (code) can also be specified. Specifying a well known system is highly desired. An example would be to specify a name of 'Accra / Ghana National Grid' with a code of '2136' in the 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting that the parameters in the EPSG database are appropriate for this CRS. This is also true for any other naming system. If in doubt, contact your local geodesist.", location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardProjectedCRS.xsd', 36, 4)))
...
def _BuildAutomaton_7 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_standardProjectedCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardProjectedCRS.xsd', 36, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_standardProjectedCRS._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'ProjectedCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardProjectedCRS.xsd', 41, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    st_0._set_transitionSet(transitions)
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_standardProjectedCRS._Automaton = _BuildAutomaton_7()




cs_standardVerticalCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'VerticalCRS'), _nsgroup.VerticalCRSType, scope=cs_standardVerticalCRS, documentation=u'gml:VerticalCRS is a 1D coordinate reference system used for recording heights or depths. Vertical CRSs make use of the direction of gravity to define the concept of height or depth, but the relationship with gravity may not be straightforward. By implication, ellipsoidal heights (h) cannot be captured in a vertical coordinate reference system. Ellipsoidal heights cannot exist independently, but only as an inseparable part of a 3D coordinate tuple defined in a geographic 3D coordinate reference system.', location=pyxb.utils.utility.Location(u'http://schemas.opengis.net/gml/3.2.1/coordinateReferenceSystems.xsd', 128, 1)))

cs_standardVerticalCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameCRS'), wellKnownNameStruct, scope=cs_standardVerticalCRS, documentation=u"The name of the coordinate reference system in a particular naming system. An optional short name (code) can also be specified. Specifying a well known system is highly desired. An example would be to specify a name of 'RH70' with a code of '5718' in the 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting that the parameters in the EPSG database are appropriate for this CRS. This is also true for any other naming system. If in doubt, contact your local geodesist.", location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 36, 4)))

cs_standardVerticalCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ellipsoidalDatum'), refNameString, scope=cs_standardVerticalCRS, documentation=u'In the case that the vertical datum is the ellipsoid, and that the vertical coordinate values are heights above the ellipsoid, this element should be instantiated to indicate this. This element should point to the geodetic CRS that defines this ellipsoid system. The ellipsoidal height is only valid if the horizontal CRS using the same ellipsoid is defined.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 48, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 48, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_standardVerticalCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 36, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_standardVerticalCRS._UseForTag(pyxb.namespace.ExpandedName(pyxb.namespace.NamespaceForURI(u'http://www.opengis.net/gml/3.2'), u'VerticalCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 42, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_standardVerticalCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ellipsoidalDatum')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_standardVerticalCRS.xsd', 48, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_2, [
    ...
    st_2._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_standardVerticalCRS._Automaton = _BuildAutomaton_8()




obj_coordinateReferenceSystems._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_coordinateReferenceSystems, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 48, 5)))

obj_coordinateReferenceSystems._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'coordinateReferenceSystem'), obj_coordinateReferenceSystem, scope=obj_coordinateReferenceSystems, documentation=u'A single  CRS.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 53, 5)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystems._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystems._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'coordinateReferenceSystem')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_coordinateReferenceSystems._Automaton = _BuildAutomaton_9()
...
def _BuildAutomaton_10 ():
    ...
    st_4._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_documentEvent._Automaton = _BuildAutomaton_10()
...
def _BuildAutomaton_11 ():
    ...
    st_4._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_documentSecurityInfo._Automaton = _BuildAutomaton_11()
...
def _BuildAutomaton_12 ():
    ...
    st_7._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_extensionNameValue._Automaton = _BuildAutomaton_12()




obj_coordinateReferenceSystem._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'geodeticCRS'), cs_standardGeodeticCRS, scope=obj_coordinateReferenceSystem, documentation=u'Use this for a geodetic CRS.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 37, 4)))

obj_coordinateReferenceSystem._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'projectedCRS'), cs_standardProjectedCRS, scope=obj_coordinateReferenceSystem, documentation=u'Use this for a projected CRS.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 42, 4)))

obj_coordinateReferenceSystem._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'verticalCRS'), cs_standardVerticalCRS, scope=obj_coordinateReferenceSystem, documentation=u'Use this for a vertical CRS.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 47, 4)))

obj_coordinateReferenceSystem._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_coordinateReferenceSystem, documentation=u'A standard, human recognizable name by which this CRS is known.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 75, 3)))

obj_coordinateReferenceSystem._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_coordinateReferenceSystem, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 85, 3)))

obj_coordinateReferenceSystem._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_coordinateReferenceSystem, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 91, 3)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 80, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 85, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 91, 3))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystem._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'geodeticCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 37, 4))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystem._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'projectedCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 42, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystem._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'verticalCRS')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_coordinateReferenceSystem.xsd', 47, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystem._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 75, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    ...
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_coordinateReferenceSystem._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_coordinateReferenceSystem.xsd', 91, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_5._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_coordinateReferenceSystem._Automaton = _BuildAutomaton_13()


coordinateReferenceSystems._setSubstitutionGroup(_abs.abstractDataObject)
