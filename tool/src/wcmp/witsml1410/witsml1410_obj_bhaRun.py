# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1410/witsml1410_obj_bhaRun.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:07:47.696553 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:a42c5ce7-84dd-4dcd-80bf-3f34dc6cb3cb')
...
class cs_drillingParams (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element {http://www.witsml.org/schemas/1series}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comments'), 'comments', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescomments', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_drillingParams.xsd', 301, 3), )
...
cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comments'), commentString, scope=cs_drillingParams, documentation='Comments and remarks.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_drillingParams, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 301, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters.add(cc_52)
    cc_53 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 301, 3))
    counters.add(cc_53)
    states = []
    final_update = None
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comments')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 301, 3))
