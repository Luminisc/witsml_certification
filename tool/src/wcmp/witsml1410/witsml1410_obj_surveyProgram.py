...
class obj_surveyPrograms (_abs.abstractObject):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_surveyPrograms')
    ...
    __surveyProgram = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'surveyProgram'), 'surveyProgram', '__httpwww_witsml_orgschemas1series_obj_surveyPrograms_httpwww_witsml_orgschemas1seriessurveyProgram', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 53, 5), )

    
    surveyProgram = property(__surveyProgram.value, __surveyProgram.set, None, 'A single survey program .  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_surveyPrograms_version', schemaVersionString, required=True)
...
Namespace.addCategoryObject('typeBinding', 'obj_surveyPrograms', obj_surveyPrograms)
...
class cs_surveySection (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_surveySection')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 21, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}sequence uses Python identifier sequence
    __sequence = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sequence'), 'sequence', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriessequence', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 26, 3), )

    
    sequence = property(__sequence.value, __sequence.set, None, 'Order in which program sections will be executed / were executed.  ')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 31, 3), )

    
    name = property(__name.value, __name.set, None, 'Name of survey program section.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdStart uses Python identifier mdStart
    __mdStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdStart'), 'mdStart', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesmdStart', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 36, 3), )

    
    mdStart = property(__mdStart.value, __mdStart.set, None, 'Hole measured depth at which the survey run will begin/began.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdEnd uses Python identifier mdEnd
    __mdEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdEnd'), 'mdEnd', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesmdEnd', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 41, 3), )

    
    mdEnd = property(__mdEnd.value, __mdEnd.set, None, 'Hole measured depth at which the survey run will end/ended.  ')

    
    # Element {http://www.witsml.org/schemas/1series}nameSurveyCompany uses Python identifier nameSurveyCompany
    __nameSurveyCompany = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameSurveyCompany'), 'nameSurveyCompany', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesnameSurveyCompany', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 46, 3), )

    
    nameSurveyCompany = property(__nameSurveyCompany.value, __nameSurveyCompany.set, None, 'Company who will run / has run sruvey tool.  ')

    
    # Element {http://www.witsml.org/schemas/1series}nameTool uses Python identifier nameTool
    __nameTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameTool'), 'nameTool', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesnameTool', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 51, 3), )

    
    nameTool = property(__nameTool.value, __nameTool.set, None, 'Name of survey tool to be used / used for this section.  ')

    
    # Element {http://www.witsml.org/schemas/1series}typeTool uses Python identifier typeTool
    __typeTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeTool'), 'typeTool', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriestypeTool', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 56, 3), )

    
    typeTool = property(__typeTool.value, __typeTool.set, None, 'Type of tool used.  ')

    
    # Element {http://www.witsml.org/schemas/1series}modelError uses Python identifier modelError
    __modelError = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'modelError'), 'modelError', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesmodelError', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 61, 3), )

    
    modelError = property(__modelError.value, __modelError.set, None, 'Error model used to calculate ellipses of uncertainty.  ')

    
    # Element {http://www.witsml.org/schemas/1series}overwrite uses Python identifier overwrite
    __overwrite = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'overwrite'), 'overwrite', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesoverwrite', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 66, 3), )

    
    overwrite = property(__overwrite.value, __overwrite.set, None, 'Normally true, higher index trajectory takes precedence over overlapping \n\t\t\t\t\tsection of previous trajectory.  Values are "true" (or "1") and "false" (or "0").')

    
    # Element {http://www.witsml.org/schemas/1series}frequencyMx uses Python identifier frequencyMx
    __frequencyMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'frequencyMx'), 'frequencyMx', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesfrequencyMx', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 72, 3), )

    
    frequencyMx = property(__frequencyMx.value, __frequencyMx.set, None, 'Maximum allowable depth frequency for survey stations for this survey run.\n\t\t\t\t\t')

    
    # Element {http://www.witsml.org/schemas/1series}itemState uses Python identifier itemState
    __itemState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'itemState'), 'itemState', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesitemState', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 78, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comments'), 'comments', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriescomments', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 83, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_surveySection_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 88, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_surveySection_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
...
Namespace.addCategoryObject('typeBinding', 'cs_surveySection', cs_surveySection)
...
class obj_surveyProgram (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_surveyProgram')
    ...
    __surveyVer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'surveyVer'), 'surveyVer', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_httpwww_witsml_orgschemas1seriessurveyVer', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 25, 3), )

    
    surveyVer = property(__surveyVer.value, __surveyVer.set, None, 'Survey version number, incremented every time the program is modified.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dTimTrajProg uses Python identifier dTimTrajProg
    __dTimTrajProg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimTrajProg'), 'dTimTrajProg', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_httpwww_witsml_orgschemas1seriesdTimTrajProg', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 30, 3), )

    
    dTimTrajProg = property(__dTimTrajProg.value, __dTimTrajProg.set, None, 'Date and time trajectory program was created or edited.  ')

    
    # Element {http://www.witsml.org/schemas/1series}engineer uses Python identifier engineer
    __engineer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'engineer'), 'engineer', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_httpwww_witsml_orgschemas1seriesengineer', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 35, 3), )

    
    engineer = property(__engineer.value, __engineer.set, None, 'Name of engineer.  ')

    
    # Element {http://www.witsml.org/schemas/1series}final uses Python identifier final
    __final = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'final'), 'final', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_httpwww_witsml_orgschemas1seriesfinal', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 40, 3), )

    
    final = property(__final.value, __final.set, None, 'Is program a final or intermediate/preliminary?  ')

    
    # Element {http://www.witsml.org/schemas/1series}surveySection uses Python identifier surveySection
    __surveySection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'surveySection'), 'surveySection', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_httpwww_witsml_orgschemas1seriessurveySection', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 45, 3), )

    
    surveySection = property(__surveySection.value, __surveySection.set, None, 'Survey section object.  ')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 72, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_uidWell', uidParentString)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_surveyProgram_uidWellbore', uidParentString)
...
Namespace.addCategoryObject('typeBinding', 'obj_surveyProgram', obj_surveyProgram)
...
obj_surveyPrograms._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_surveyPrograms, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 48, 5)))

obj_surveyPrograms._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'surveyProgram'), obj_surveyProgram, scope=obj_surveyPrograms, documentation='A single survey program .  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_surveyPrograms._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_surveyPrograms._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'surveyProgram')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sequence'), positiveCount, scope=cs_surveySection, documentation='Order in which program sections will be executed / were executed.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 26, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_surveySection, documentation='Name of survey program section.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 31, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdStart'), measuredDepthCoord, scope=cs_surveySection, documentation='Hole measured depth at which the survey run will begin/began.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 36, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdEnd'), measuredDepthCoord, scope=cs_surveySection, documentation='Hole measured depth at which the survey run will end/ended.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 41, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameSurveyCompany'), nameString, scope=cs_surveySection, documentation='Company who will run / has run sruvey tool.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 46, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameTool'), nameString, scope=cs_surveySection, documentation='Name of survey tool to be used / used for this section.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 51, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeTool'), nameString, scope=cs_surveySection, documentation='Type of tool used.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 56, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'modelError'), nameString, scope=cs_surveySection, documentation='Error model used to calculate ellipses of uncertainty.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 61, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'overwrite'), logicalBoolean, scope=cs_surveySection, documentation='Normally true, higher index trajectory takes precedence over overlapping \n\t\t\t\t\tsection of previous trajectory.  Values are "true" (or "1") and "false" (or "0").', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 66, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'frequencyMx'), lengthMeasure, scope=cs_surveySection, documentation='Maximum allowable depth frequency for survey stations for this survey run.\n\t\t\t\t\t', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 72, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'itemState'), ItemState, scope=cs_surveySection, documentation='The item state for the data object.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 78, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comments'), commentString, scope=cs_surveySection, documentation='Comments and remarks.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 83, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_surveySection, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 88, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 31, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 61, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 66, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 72, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 78, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 83, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 88, 3))
    counters.add(cc_6)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sequence')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdStart')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdEnd')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameSurveyCompany')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameTool')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 51, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeTool')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 56, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'modelError')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 61, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'overwrite')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 66, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'frequencyMx')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 72, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'itemState')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 78, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comments')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 83, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_surveySection.xsd', 88, 3))
...
obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'surveyVer'), positiveCount, scope=obj_surveyProgram, documentation='Survey version number, incremented every time the program is modified.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 25, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimTrajProg'), timestamp, scope=obj_surveyProgram, documentation='Date and time trajectory program was created or edited.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 30, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'engineer'), str32, scope=obj_surveyProgram, documentation='Name of engineer.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 35, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'final'), str16, scope=obj_surveyProgram, documentation='Is program a final or intermediate/preliminary?  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 40, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'surveySection'), cs_surveySection, scope=obj_surveyProgram, documentation='Survey section object.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 45, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_surveyProgram, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 72, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_surveyProgram, documentation='Human recognizable context for the wellbore that contains the survey program.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 77, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_surveyProgram, documentation='Human recognizable context for the survey program.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 82, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_surveyProgram, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 92, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_surveyProgram, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 98, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 30, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 35, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 40, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 45, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 87, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 92, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 98, 3))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'surveyVer')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimTrajProg')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 30, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'engineer')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'final')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 40, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'surveySection')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_surveyProgram.xsd', 45, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 72, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 77, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 82, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 92, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_surveyProgram.xsd', 98, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
