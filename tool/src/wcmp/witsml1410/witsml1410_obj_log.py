# .\witsml1410_obj_log.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2013-06-21 14:42:24.995000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b1641d40-daaa-11e2-acea-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/1series}cs_logData with content type ELEMENT_ONLY
class cs_logData (pyxb.binding.basis.complexTypeDefinition):
    """WITSML Log - Curve Information
			The order of the data should correspond to the 'direction'."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_logData')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 20, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mnemonicList uses Python identifier mnemonicList
    __mnemonicList = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mnemonicList'), 'mnemonicList', '__httpwww_witsml_orgschemas1series_cs_logData_httpwww_witsml_orgschemas1seriesmnemonicList', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 26, 3), )

    
    mnemonicList = property(__mnemonicList.value, __mnemonicList.set, None, u'A comma delimited list of curve mnemonics.\n\t\t\t\t\tEach mnemonic should only occur once in the list.\n\t\t\t\t\tThe order of the mnemonics defines the order of the  delimited values in elements "unitList" and "data". \n\t\t\t\t\tIf the index curve is specified then it must be first in the list.\n\t\t\t\t\tThis is an API "column-identifier" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}unitList uses Python identifier unitList
    __unitList = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'unitList'), 'unitList', '__httpwww_witsml_orgschemas1series_cs_logData_httpwww_witsml_orgschemas1seriesunitList', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 37, 3), )

    
    unitList = property(__unitList.value, __unitList.set, None, u'A comma delimited list of unit of measure acronyms that represent the values in "data".\n\t\t\t\t\tThe units are in the same order as the mnemonics in element mnemonicList.\n\t\t\t\t\tEach unit value must match the value in the logCurveInfo structure for that curve.\n\t\t\t\t\tA null value (i.e., unitless as opposed to dimensionless) will be defined by adjacent commas.')

    
    # Element {http://www.witsml.org/schemas/1series}data uses Python identifier data
    __data = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'data'), 'data', '__httpwww_witsml_orgschemas1series_cs_logData_httpwww_witsml_orgschemas1seriesdata', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 46, 3), )

    
    data = property(__data.value, __data.set, None, u'The actual data corresponding to the curves defined in \n\t\t\t\t\tthe "mnemonicList" element. Normally a comma delimited list of data values (see dataDelimiter) with one \n\t\t\t\t\tvalue for each curve on the log (e.g., "xxx,yyy, zzz"). For array curves,\n\t\t\t\t\tthe value of the array curve will be a space delimited list of values that\n\t\t\t\t\tare contained within the commas that delimit the value for that curve\n\t\t\t\t\t(e.g., "xxx,aa bb cc,zzz").\n\t\t\t\t\tThis essentially represents one row of a table where the curve \n\t\t\t\t\tmnemonics represent the column headings.\n\t\t\t\t\tThis is an API "data-node" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')


    _ElementMap = {
        __mnemonicList.name() : __mnemonicList,
...
Namespace.addCategoryObject('typeBinding', u'cs_logData', cs_logData)
...
# Complex type {http://www.witsml.org/schemas/1series}obj_logs with content type ELEMENT_ONLY
class obj_logs (_abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_logs')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 42, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_logs_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 49, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}log uses Python identifier log
    __log = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'log'), 'log', '__httpwww_witsml_orgschemas1series_obj_logs_httpwww_witsml_orgschemas1serieslog', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 54, 5), )

    
    log = property(__log.value, __log.set, None, u'A single log.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_logs_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 60, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 60, 4)
...
Namespace.addCategoryObject('typeBinding', u'obj_logs', obj_logs)
...
# Complex type {http://www.witsml.org/schemas/1series}cs_axisDefinition with content type ELEMENT_ONLY
class cs_axisDefinition (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_axisDefinition')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 21, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}order uses Python identifier order
    __order = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'order'), 'order', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesorder', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 28, 3), )

    
    order = property(__order.value, __order.set, None, u'The order of this axis. The order should  \n\t\t\t\t\tbegin with one and increment by one for each additional axis. \n\t\t\t\t\tThe order indicates how fast the index of the axis varies \n\t\t\t\t\tin the serialized list of values. \n\t\t\t\t\tThe index of an axis with an order of one varies the slowest.\n\t\t\t\t\tThe index of an axis with an order of two varies the next slowest. \n\t\t\t\t\tAnd so on. This is the same ordering that is used in the C programming language.\n\t\t\t\t\tFor example, the following array:\n\t\t\t\t\t\t         [   x axis  ]\n\t\t\t\t\t\t   |     z11  z12  z13\n\t\t\t\t\t\ty axis:  z21  z22  z23\n\t\t\t\t\t\t   |     z31  z32  z33\n\t\t\t\t\t\t   |     z41  z42  z43\n\t\t\t\t\tmay be encoded as follows:\n\t\t\t\t\t\taxisDefinition[order=1].name=\'x\'\n\t\t\t\t\t\taxisDefinition[order=1].count=\'3\'\n\t\t\t\t\t\taxisDefinition[order=2].name=\'y\'\n\t\t\t\t\t\taxisDefinition[order=2].count=\'4\'\n\t\t\t\t\t\t{ z11 z21 z31 z41 z12 z22 z32 z42 z13 z23 z33 z43 }\n\t\t\t\t\tor alternatively:\n\t\t\t\t\t\taxisDefinition[order=1].name=\'y\'\n\t\t\t\t\t\taxisDefinition[order=1].count=\'4\'\n\t\t\t\t\t\taxisDefinition[order=2].name=\'x\'\n\t\t\t\t\t\taxisDefinition[order=2].count=\'3\'\n\t\t\t\t\t\t{ z11 z12 z13 z21 z22 z23 z31 z32 z33 z41 z42 z43 }\n\t\t\t\t\tSTORE UNIQUE KEY: When accessed via the Store Interface, the "order" must be unique.\n\t\t\t\t\t')

    
    # Element {http://www.witsml.org/schemas/1series}count uses Python identifier count
    __count = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'count'), 'count', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriescount', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 60, 3), )

    
    count = property(__count.value, __count.set, None, u'The count of elements along this axis of the array.')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 65, 3), )

    
    name = property(__name.value, __name.set, None, u'The name of the array axis.')

    
    # Element {http://www.witsml.org/schemas/1series}propertyType uses Python identifier propertyType
    __propertyType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'propertyType'), 'propertyType', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriespropertyType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 70, 3), )

    
    propertyType = property(__propertyType.value, __propertyType.set, None, u'The property type by which the array axis is classified.')

    
    # Element {http://www.witsml.org/schemas/1series}uom uses Python identifier uom
    __uom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'uom'), 'uom', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesuom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 75, 3), )

    
    uom = property(__uom.value, __uom.set, None, u'A string representing the units of measure of the axis values.')

    
    # Element {http://www.witsml.org/schemas/1series}doubleValues uses Python identifier doubleValues
    __doubleValues = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'doubleValues'), 'doubleValues', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesdoubleValues', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 84, 4), )

    
    doubleValues = property(__doubleValues.value, __doubleValues.set, None, u'The serialziation of the axis positions of an array as a \n\t\t\t\t\t\twhitespace-delimited list values of type xsd:double.  If the length of this list\n\t\t\t\t\t\tis less than \'count\' then the difference in the last two values represents the increment\n\t\t\t\t\t\tto be used to fill out the list. For example, the list \'2 4\' with count=4 \n\t\t\t\t\t\trepresents the  list \'2 4 6 8\'.\n\t\t\t\t\t\tNote: This has an underlying string type because .NET will not properly handle\n\t\t\t\t\t\ta "list of double".')

    
    # Element {http://www.witsml.org/schemas/1series}stringValues uses Python identifier stringValues
    __stringValues = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'stringValues'), 'stringValues', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesstringValues', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 97, 4), )

    
    stringValues = property(__stringValues.value, __stringValues.set, None, u'The serialziation of the axis positions of an array as \n\t\t\t\t\t\ta whitespace-delimited list values of type xsd:String.\n\t\t\t\t\t\tNote: the serialization of string elements with embedded whitespace cannot \n\t\t\t\t\t\tbe properly decoded.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 107, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_uid', uidString)
    ...
    _ElementMap = {
        ...
        __uom.name() : __uom,
        __doubleValues.name() : __doubleValues,
        __stringValues.name() : __stringValues,
        __extensionNameValue.name() : __extensionNameValue
    }
    _AttributeMap = {
        __uid.name() : __uid
    }
Namespace.addCategoryObject('typeBinding', u'cs_axisDefinition', cs_axisDefinition)
...
# Complex type {http://www.witsml.org/schemas/1series}cs_logCurveInfo with content type ELEMENT_ONLY
class cs_logCurveInfo (pyxb.binding.basis.complexTypeDefinition):
    """WITSML Log - Curve Information"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_logCurveInfo')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 22, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mnemonic uses Python identifier mnemonic
    __mnemonic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mnemonic'), 'mnemonic', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmnemonic', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 28, 3), )

    
    mnemonic = property(__mnemonic.value, __mnemonic.set, None, u'The curve name.  \n\t\t\t\t\tThis must be unique for all curves in a log.\n\t\t\t\t\tThe naming authority for the mnemonic can be catptured in the namingSystem attribute.\n\t\t\t\t\tSince both the mnemonic and uid have similar requirements within the context \n\t\t\t\t\tof a WITSML server, the uid can be derived from the mnemonic (e.g., by converting blank to underscore).')

    
    # Element {http://www.witsml.org/schemas/1series}classWitsml uses Python identifier classWitsml
    __classWitsml = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'classWitsml'), 'classWitsml', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesclassWitsml', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 40, 3), )

    
    classWitsml = property(__classWitsml.value, __classWitsml.set, None, u'The curve classification obtained from a lookup in the vendors \n\t\t\t\t\tmnemonic catalog.')

    
    # Element {http://www.witsml.org/schemas/1series}classIndex uses Python identifier classIndex
    __classIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'classIndex'), 'classIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesclassIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 47, 3), )

    
    classIndex = property(__classIndex.value, __classIndex.set, None, u'The count relative to (possibly) repeating values of classWitsml.\n\t\t\t\t\tThis is used to indicate something like the first pump, second pump, etc.')

    
    # Element {http://www.witsml.org/schemas/1series}unit uses Python identifier unit
    __unit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'unit'), 'unit', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesunit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 54, 3), )

    
    unit = property(__unit.value, __unit.set, None, u'Unit of measurement of the data values. ')

    
    # Element {http://www.witsml.org/schemas/1series}mnemAlias uses Python identifier mnemAlias
    __mnemAlias = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mnemAlias'), 'mnemAlias', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmnemAlias', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 59, 3), )

    
    mnemAlias = property(__mnemAlias.value, __mnemAlias.set, None, u'Name alias for this trace.\n\t\t\t\t\tThe naming authority for the mnemonic can be catptured in the namingSystem attribute.')

    
    # Element {http://www.witsml.org/schemas/1series}nullValue uses Python identifier nullValue
    __nullValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nullValue'), 'nullValue', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesnullValue', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 67, 3), )

    
    nullValue = property(__nullValue.value, __nullValue.set, None, u'An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e., when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value is defined in the logCurveInfo, it overrides any null value specified at the \n\t\t\t\t\tlogHeader level. An empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. ')

    
    # Element {http://www.witsml.org/schemas/1series}alternateIndex uses Python identifier alternateIndex
    __alternateIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'alternateIndex'), 'alternateIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesalternateIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 80, 3), )

    
    alternateIndex = property(__alternateIndex.value, __alternateIndex.set, None, u'True (true or 1) if this curve is a candidate to be a primary index.\n\t\t\t\t\tFalse (false or 0) or not given, indicates otherwise.\n\t\t\t\t\tAn index curve should monotonically change when sorted on its own values (i.e., no duplicates). ')

    
    # Element {http://www.witsml.org/schemas/1series}wellDatum uses Python identifier wellDatum
    __wellDatum = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wellDatum'), 'wellDatum', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1serieswellDatum', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 87, 3), )

    
    wellDatum = property(__wellDatum.value, __wellDatum.set, None, u'A pointer to the wellDatum that represents the values of this trace.\n\t\t\t\t\tThis is only relevant for measured depths, vertical depths or elevations.')

    
    # Element {http://www.witsml.org/schemas/1series}minIndex uses Python identifier minIndex
    __minIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'minIndex'), 'minIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesminIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 93, 3), )

    
    minIndex = property(__minIndex.value, __minIndex.set, None, u'The minimum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve. \n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}maxIndex uses Python identifier maxIndex
    __maxIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'maxIndex'), 'maxIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmaxIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 104, 3), )

    
    maxIndex = property(__maxIndex.value, __maxIndex.set, None, u'The maximum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}minDateTimeIndex uses Python identifier minDateTimeIndex
    __minDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'minDateTimeIndex'), 'minDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesminDateTimeIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 115, 3), )

    
    minDateTimeIndex = property(__minDateTimeIndex.value, __minDateTimeIndex.set, None, u'The minimum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}maxDateTimeIndex uses Python identifier maxDateTimeIndex
    __maxDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'maxDateTimeIndex'), 'maxDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmaxDateTimeIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 126, 3), )

    
    maxDateTimeIndex = property(__maxDateTimeIndex.value, __maxDateTimeIndex.set, None, u'The maximum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}curveDescription uses Python identifier curveDescription
    __curveDescription = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'curveDescription'), 'curveDescription', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriescurveDescription', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 137, 3), )

    
    curveDescription = property(__curveDescription.value, __curveDescription.set, None, u'Description of the curve.  ')

    
    # Element {http://www.witsml.org/schemas/1series}sensorOffset uses Python identifier sensorOffset
    __sensorOffset = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sensorOffset'), 'sensorOffset', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriessensorOffset', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 142, 3), )

    
    sensorOffset = property(__sensorOffset.value, __sensorOffset.set, None, u'Offset of sensor from a downhole equipment vertical reference (the\n\t\t\t\t\tdrill bit, for MWD logs;  the tool zero reference for wireline\n\t\t\t\t\tlogs).  This element is only informative (log values are presented\n\t\t\t\t\tat actual depth, not requiring subtraction of an offset).')

    
    # Element {http://www.witsml.org/schemas/1series}dataSource uses Python identifier dataSource
    __dataSource = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dataSource'), 'dataSource', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesdataSource', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 151, 3), )

    
    dataSource = property(__dataSource.value, __dataSource.set, None, u'Data source, could be tool name/id.  ')

    
    # Element {http://www.witsml.org/schemas/1series}densData uses Python identifier densData
    __densData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'densData'), 'densData', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesdensData', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 156, 3), )

    
    densData = property(__densData.value, __densData.set, None, u'Data density of sample in samples per length unit.  ')

    
    # Element {http://www.witsml.org/schemas/1series}traceState uses Python identifier traceState
    __traceState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'traceState'), 'traceState', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriestraceState', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 161, 3), )

    
    traceState = property(__traceState.value, __traceState.set, None, u'State of trace data.  ')

    
    # Element {http://www.witsml.org/schemas/1series}traceOrigin uses Python identifier traceOrigin
    __traceOrigin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'traceOrigin'), 'traceOrigin', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriestraceOrigin', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 166, 3), )

    
    traceOrigin = property(__traceOrigin.value, __traceOrigin.set, None, u'Origin of trace data.  ')

    
    # Element {http://www.witsml.org/schemas/1series}typeLogData uses Python identifier typeLogData
    __typeLogData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'typeLogData'), 'typeLogData', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriestypeLogData', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 171, 3), )

    
    typeLogData = property(__typeLogData.value, __typeLogData.set, None, u'Log data type.')

    
    # Element {http://www.witsml.org/schemas/1series}axisDefinition uses Python identifier axisDefinition
    __axisDefinition = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'axisDefinition'), 'axisDefinition', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesaxisDefinition', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 177, 3), )

    
    axisDefinition = property(__axisDefinition.value, __axisDefinition.set, None, u'Indicates that the curve is an array curve (i.e., multi-valued samples), \n\t\t\t\t\tand provides meta data by which an axis of the array can be understood.\n\t\t\t\t\tA separate definition is required for each axis of an N-dimensional array.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 185, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    ...
    _ElementMap = {
        __mnemonic.name() : __mnemonic,
        __classWitsml.name() : __classWitsml,
        __classIndex.name() : __classIndex,
        __unit.name() : __unit,
        __mnemAlias.name() : __mnemAlias,
        __nullValue.name() : __nullValue,
        __alternateIndex.name() : __alternateIndex,
        __wellDatum.name() : __wellDatum,
        __minIndex.name() : __minIndex,
        __maxIndex.name() : __maxIndex,
        __minDateTimeIndex.name() : __minDateTimeIndex,
        __maxDateTimeIndex.name() : __maxDateTimeIndex,
        __curveDescription.name() : __curveDescription,
        __sensorOffset.name() : __sensorOffset,
        __dataSource.name() : __dataSource,
        __densData.name() : __densData,
        __traceState.name() : __traceState,
        __traceOrigin.name() : __traceOrigin,
        __typeLogData.name() : __typeLogData,
        __axisDefinition.name() : __axisDefinition,
        __extensionNameValue.name() : __extensionNameValue
    }
    _AttributeMap = {
        __uid.name() : __uid
    }
Namespace.addCategoryObject('typeBinding', u'cs_logCurveInfo', cs_logCurveInfo)


# Complex type {http://www.witsml.org/schemas/1series}obj_log with content type ELEMENT_ONLY
class obj_log (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/1series}obj_log with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_log')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 71, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}objectGrowing uses Python identifier objectGrowing
    __objectGrowing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectGrowing'), 'objectGrowing', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesobjectGrowing', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 27, 3), )

    
    objectGrowing = property(__objectGrowing.value, __objectGrowing.set, None, u'The growing state of the object.\n\t\t\t\t\tThis value is only relevant within the context of a server.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling of Change Information" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}dataUpateRate uses Python identifier dataUpateRate
    __dataUpateRate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dataUpateRate'), 'dataUpateRate', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdataUpateRate', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 39, 3), )

    
    dataUpateRate = property(__dataUpateRate.value, __dataUpateRate.set, None, u'The data append rate (in seconds) of this growing object.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling Systematically Growing Objects" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}requestLatestValue uses Python identifier requestLatestValue
    __requestLatestValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'requestLatestValue'), 'requestLatestValue', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesrequestLatestValue', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 47, 3), )

    
    requestLatestValue = property(__requestLatestValue.value, __requestLatestValue.set, None, u'Requests that only the latest N values be returned from the end of each curve.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling Systematically Growing Objects" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}curveSensorsAligned uses Python identifier curveSensorsAligned
    __curveSensorsAligned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'curveSensorsAligned'), 'curveSensorsAligned', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescurveSensorsAligned', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 55, 3), )

    
    curveSensorsAligned = property(__curveSensorsAligned.value, __curveSensorsAligned.set, None, u'This value is only relevant within the context of a server.\n\t\t\t\t\tTrue ("true" or "1") indicates that all curves have\n\t\t\t\t\tthe same sensor offset from the downhole equipment vertical reference. \n\t\t\t\t\tFalse ("false" or 0") or not given indicates otherwise.\n\t\t\t\t\tFor a growing log, a value of true will allow a query \n\t\t\t\t\tto use the the endIndex from the previous query as the startIndex of the next query.')

    
    # Element {http://www.witsml.org/schemas/1series}dataGroup uses Python identifier dataGroup
    __dataGroup = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dataGroup'), 'dataGroup', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdataGroup', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 66, 3), )

    
    dataGroup = property(__dataGroup.value, __dataGroup.set, None, u'The name of the grouping represented by curves in this log.\n\t\t\t\t\tA group represents a named combination of curves and the curves in a particular\n\t\t\t\t\tlog should be represented in that list.')

    
    # Element {http://www.witsml.org/schemas/1series}serviceCompany uses Python identifier serviceCompany
    __serviceCompany = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'serviceCompany'), 'serviceCompany', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesserviceCompany', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 74, 3), )

    
    serviceCompany = property(__serviceCompany.value, __serviceCompany.set, None, u'Name of contractor who provided the service.  ')

    
    # Element {http://www.witsml.org/schemas/1series}runNumber uses Python identifier runNumber
    __runNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'runNumber'), 'runNumber', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesrunNumber', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 79, 3), )

    
    runNumber = property(__runNumber.value, __runNumber.set, None, u'Log run number. This should normally be a number; however \n\t\t\t\t\tsome legacy systems encode other information in this value.')

    
    # Element {http://www.witsml.org/schemas/1series}bhaRunNumber uses Python identifier bhaRunNumber
    __bhaRunNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'bhaRunNumber'), 'bhaRunNumber', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesbhaRunNumber', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 85, 3), )

    
    bhaRunNumber = property(__bhaRunNumber.value, __bhaRunNumber.set, None, u'The bottom hole assembly run number associated with this log.\n\t\t\t\t\tThis should match the run number on the BHA run object.')

    
    # Element {http://www.witsml.org/schemas/1series}pass uses Python identifier pass_
    __pass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'pass'), 'pass_', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriespass', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 92, 3), )

    
    pass_ = property(__pass.value, __pass.set, None, u'Identifies the pass within the run.')

    
    # Element {http://www.witsml.org/schemas/1series}creationDate uses Python identifier creationDate
    __creationDate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'creationDate'), 'creationDate', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescreationDate', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 97, 3), )

    
    creationDate = property(__creationDate.value, __creationDate.set, None, u'Date and time that the log was created.  ')

    
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 102, 3), )

    
    description = property(__description.value, __description.set, None, u'Description of item and details.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dataDelimiter uses Python identifier dataDelimiter
    __dataDelimiter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dataDelimiter'), 'dataDelimiter', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdataDelimiter', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 107, 3), )

    
    dataDelimiter = property(__dataDelimiter.value, __dataDelimiter.set, None, u'The value delimiter in the data string. Defaults to a comma.\n\t\t\t\t\tNote that this does not affect any space delimited array data.')

    
    # Element {http://www.witsml.org/schemas/1series}indexType uses Python identifier indexType
    __indexType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'indexType'), 'indexType', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesindexType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 114, 3), )

    
    indexType = property(__indexType.value, __indexType.set, None, u'Primary index type.  ')

    
    # Element {http://www.witsml.org/schemas/1series}startIndex uses Python identifier startIndex
    __startIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'startIndex'), 'startIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesstartIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 120, 4), )

    
    startIndex = property(__startIndex.value, __startIndex.set, None, u'When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first non-null data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first non-null data point is located.\n\t\t\t\t\t\tEither a quantity index set (start and end) or a date time index set must be given.\n\t\t\t\t\t\tIf both sets are given then "indexType" and \n\t\t\t\t\t\t"indexCurve" must represent an elapsed time from "startDateTimeIndex".\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}endIndex uses Python identifier endIndex
    __endIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'endIndex'), 'endIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesendIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 135, 4), )

    
    endIndex = property(__endIndex.value, __endIndex.set, None, u'When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\t\tis the ending (maximum) index value at which the last non-null data point is located.  \n\t\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t\t(minimum) index value at which the last non-null data point is located.\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}stepIncrement uses Python identifier stepIncrement
    __stepIncrement = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'stepIncrement'), 'stepIncrement', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesstepIncrement', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 147, 4), )

    
    stepIncrement = property(__stepIncrement.value, __stepIncrement.set, None, u'The sampling increment. Set to zero for unequal sampling.\n\t\t\t\t\t\tA non-zero value indicates that the data is regularly sampled even if it has an explicit index curve.\n\t\t\t\t\t\tIf it is zero or not given then assume that it is non-regular even though it may be regular.\n\t\t\t\t\t\tThe problem is that writers generally cannot guarantee the regularity of the log until after they have finished processing it\n\t\t\t\t\t\tFor curves that are originally sampled at a constant increment, this value should\n\t\t\t\t\t\tbe retained because calculated values may have cumulative errors.')

    
    # Element {http://www.witsml.org/schemas/1series}startDateTimeIndex uses Python identifier startDateTimeIndex
    __startDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'startDateTimeIndex'), 'startDateTimeIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesstartDateTimeIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 158, 4), )

    
    startDateTimeIndex = property(__startDateTimeIndex.value, __startDateTimeIndex.set, None, u'When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first non-null data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first non-null data point is located.\n\t\t\t\t\t\tEither a quantity index set (start and end) or a date time index set must be given.\n\t\t\t\t\t\tIf both sets are given then "indexType" and \n\t\t\t\t\t\t"indexCurve" must represent an elapsed time from "startDateTimeIndex".\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}endDateTimeIndex uses Python identifier endDateTimeIndex
    __endDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'endDateTimeIndex'), 'endDateTimeIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesendDateTimeIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 173, 4), )

    
    endDateTimeIndex = property(__endDateTimeIndex.value, __endDateTimeIndex.set, None, u'When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\t\tis the ending (maximum) index value at which the last non-null data point is located.  \n\t\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t\t(minimum) index value at which the last non-null data point is located. \n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}direction uses Python identifier direction
    __direction = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'direction'), 'direction', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdirection', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 186, 3), )

    
    direction = property(__direction.value, __direction.set, None, u'The sort order of the data row index values in the XML instance.\n\t\t\t\t\tFor an "Increasing" direction the index value of consecutive data nodes are ascending.\n\t\t\t\t\tFor a "Decreasing" direction the index value of consecutive data nodes are descending.\n\t\t\t\t\tThe default direction is "Increasing".  The direction of a log cannot be changed \n\t\t\t\t\tonce it has been created. That is, this value cannot be updated in a server.')

    
    # Element {http://www.witsml.org/schemas/1series}indexCurve uses Python identifier indexCurve
    __indexCurve = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'indexCurve'), 'indexCurve', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesindexCurve', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 195, 3), )

    
    indexCurve = property(__indexCurve.value, __indexCurve.set, None, u'The mnemonic of the index curve.\n\t\t\t\t\tDuplicate index values can exist in a log but a change of direction is not allowed.\n\t\t\t\t\tIf a change of direction is required then a new log must be created.\n\t\t\t\t\tSome servers may eliminate (i.e., overwrite) duplicate indexes.\n\t\t\t\t\tThe data values associated with this curve represent an API "node-index" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}nullValue uses Python identifier nullValue
    __nullValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nullValue'), 'nullValue', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesnullValue', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 209, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}logParam uses Python identifier logParam
    __logParam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'logParam'), 'logParam', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1serieslogParam', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 223, 3), )

    
    logParam = property(__logParam.value, __logParam.set, None, u'Log parameters.  \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.\n\t\t\t\t\tA parameter name of "multipass" represents a boolean values ("true" or "false").\n\t\t\t\t\tA "multipass" parameter value of "true" asserts that the object contains values for \n\t\t\t\t\tbhaRunNumber (or runNumber), passNumber and direction.')

    
    # Element {http://www.witsml.org/schemas/1series}logCurveInfo uses Python identifier logCurveInfo
    __logCurveInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'logCurveInfo'), 'logCurveInfo', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1serieslogCurveInfo', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 235, 3), )

    
    logCurveInfo = property(__logCurveInfo.value, __logCurveInfo.set, None, u'Container element for the log curve information. \n\t\t\t\t\tThis is an API "column-definition" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.')

    
    # Element {http://www.witsml.org/schemas/1series}logData uses Python identifier logData
    __logData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'logData'), 'logData', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1serieslogData', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 243, 3), )

    
    logData = property(__logData.value, __logData.set, None, u'Container for one or more "rows" of log data.\n\t\t\t\t\tThe use of more than one logData node represents a sparse view of the actual data and \n\t\t\t\t\tis contrained for use in the WITSML API for adding and updating sparse data. \n\t\t\t\t\tAny other usage should utilize only one instance of logData.')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 73, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 78, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, u'Human recognizable context for the wellbore that contains the log.  ')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 83, 3), )

    
    name = property(__name.value, __name.set, None, u'Human recognizable context for the log.  ')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 93, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 99, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_log_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_log_uidWell', uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 106, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 106, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_log_uidWellbore', uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 113, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 113, 2)
    ...
    _ElementMap = {
        ...
        __dataUpateRate.name() : __dataUpateRate,
        __requestLatestValue.name() : __requestLatestValue,
        __curveSensorsAligned.name() : __curveSensorsAligned,
        __dataGroup.name() : __dataGroup,
        __serviceCompany.name() : __serviceCompany,
        __runNumber.name() : __runNumber,
        __bhaRunNumber.name() : __bhaRunNumber,
        __pass.name() : __pass,
        __creationDate.name() : __creationDate,
        __description.name() : __description,
        __dataDelimiter.name() : __dataDelimiter,
        __indexType.name() : __indexType,
        __startIndex.name() : __startIndex,
        __endIndex.name() : __endIndex,
        __stepIncrement.name() : __stepIncrement,
        __startDateTimeIndex.name() : __startDateTimeIndex,
        __endDateTimeIndex.name() : __endDateTimeIndex,
        __direction.name() : __direction,
        __indexCurve.name() : __indexCurve,
        __nullValue.name() : __nullValue,
        __logParam.name() : __logParam,
        __logCurveInfo.name() : __logCurveInfo,
...
Namespace.addCategoryObject('typeBinding', u'obj_log', obj_log)
...
logs = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'logs'), obj_logs, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 33, 1))
Namespace.addCategoryObject('elementBinding', logs.name().localName(), logs)
...
cs_logData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mnemonicList'), pyxb.binding.datatypes.string, scope=cs_logData, documentation=u'A comma delimited list of curve mnemonics.\n\t\t\t\t\tEach mnemonic should only occur once in the list.\n\t\t\t\t\tThe order of the mnemonics defines the order of the  delimited values in elements "unitList" and "data". \n\t\t\t\t\tIf the index curve is specified then it must be first in the list.\n\t\t\t\t\tThis is an API "column-identifier" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 26, 3)))

cs_logData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'unitList'), pyxb.binding.datatypes.string, scope=cs_logData, documentation=u'A comma delimited list of unit of measure acronyms that represent the values in "data".\n\t\t\t\t\tThe units are in the same order as the mnemonics in element mnemonicList.\n\t\t\t\t\tEach unit value must match the value in the logCurveInfo structure for that curve.\n\t\t\t\t\tA null value (i.e., unitless as opposed to dimensionless) will be defined by adjacent commas.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 37, 3)))

cs_logData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'data'), pyxb.binding.datatypes.string, scope=cs_logData, documentation=u'The actual data corresponding to the curves defined in \n\t\t\t\t\tthe "mnemonicList" element. Normally a comma delimited list of data values (see dataDelimiter) with one \n\t\t\t\t\tvalue for each curve on the log (e.g., "xxx,yyy, zzz"). For array curves,\n\t\t\t\t\tthe value of the array curve will be a space delimited list of values that\n\t\t\t\t\tare contained within the commas that delimit the value for that curve\n\t\t\t\t\t(e.g., "xxx,aa bb cc,zzz").\n\t\t\t\t\tThis essentially represents one row of a table where the curve \n\t\t\t\t\tmnemonics represent the column headings.\n\t\t\t\t\tThis is an API "data-node" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 46, 3)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 46, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mnemonicList')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'unitList')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 37, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'data')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logData.xsd', 46, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_2._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_logData._Automaton = _BuildAutomaton_6()




obj_logs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_logs, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 49, 5)))

obj_logs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'log'), obj_log, scope=obj_logs, documentation=u'A single log.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 54, 5)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 49, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_logs._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 49, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_logs._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'log')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 54, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_logs._Automaton = _BuildAutomaton_7()




cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'order'), positiveCount, scope=cs_axisDefinition, documentation=u'The order of this axis. The order should  \n\t\t\t\t\tbegin with one and increment by one for each additional axis. \n\t\t\t\t\tThe order indicates how fast the index of the axis varies \n\t\t\t\t\tin the serialized list of values. \n\t\t\t\t\tThe index of an axis with an order of one varies the slowest.\n\t\t\t\t\tThe index of an axis with an order of two varies the next slowest. \n\t\t\t\t\tAnd so on. This is the same ordering that is used in the C programming language.\n\t\t\t\t\tFor example, the following array:\n\t\t\t\t\t\t         [   x axis  ]\n\t\t\t\t\t\t   |     z11  z12  z13\n\t\t\t\t\t\ty axis:  z21  z22  z23\n\t\t\t\t\t\t   |     z31  z32  z33\n\t\t\t\t\t\t   |     z41  z42  z43\n\t\t\t\t\tmay be encoded as follows:\n\t\t\t\t\t\taxisDefinition[order=1].name=\'x\'\n\t\t\t\t\t\taxisDefinition[order=1].count=\'3\'\n\t\t\t\t\t\taxisDefinition[order=2].name=\'y\'\n\t\t\t\t\t\taxisDefinition[order=2].count=\'4\'\n\t\t\t\t\t\t{ z11 z21 z31 z41 z12 z22 z32 z42 z13 z23 z33 z43 }\n\t\t\t\t\tor alternatively:\n\t\t\t\t\t\taxisDefinition[order=1].name=\'y\'\n\t\t\t\t\t\taxisDefinition[order=1].count=\'4\'\n\t\t\t\t\t\taxisDefinition[order=2].name=\'x\'\n\t\t\t\t\t\taxisDefinition[order=2].count=\'3\'\n\t\t\t\t\t\t{ z11 z12 z13 z21 z22 z23 z31 z32 z33 z41 z42 z43 }\n\t\t\t\t\tSTORE UNIQUE KEY: When accessed via the Store Interface, the "order" must be unique.\n\t\t\t\t\t', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 28, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'count'), positiveCount, scope=cs_axisDefinition, documentation=u'The count of elements along this axis of the array.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 60, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=cs_axisDefinition, documentation=u'The name of the array axis.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 65, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'propertyType'), nameString, scope=cs_axisDefinition, documentation=u'The property type by which the array axis is classified.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 70, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'uom'), uomString, scope=cs_axisDefinition, documentation=u'A string representing the units of measure of the axis values.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 75, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'doubleValues'), listOfString, scope=cs_axisDefinition, documentation=u'The serialziation of the axis positions of an array as a \n\t\t\t\t\t\twhitespace-delimited list values of type xsd:double.  If the length of this list\n\t\t\t\t\t\tis less than \'count\' then the difference in the last two values represents the increment\n\t\t\t\t\t\tto be used to fill out the list. For example, the list \'2 4\' with count=4 \n\t\t\t\t\t\trepresents the  list \'2 4 6 8\'.\n\t\t\t\t\t\tNote: This has an underlying string type because .NET will not properly handle\n\t\t\t\t\t\ta "list of double".', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 84, 4)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'stringValues'), listOfString, scope=cs_axisDefinition, documentation=u'The serialziation of the axis positions of an array as \n\t\t\t\t\t\ta whitespace-delimited list values of type xsd:String.\n\t\t\t\t\t\tNote: the serialization of string elements with embedded whitespace cannot \n\t\t\t\t\t\tbe properly decoded.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 97, 4)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), cs_extensionNameValue, scope=cs_axisDefinition, documentation=u'Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 107, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 65, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 70, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 75, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 107, 3))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'order')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'count')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 60, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 65, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'propertyType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 70, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'uom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 75, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'doubleValues')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 84, 4))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'stringValues')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 97, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_axisDefinition.xsd', 107, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_7._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_axisDefinition._Automaton = _BuildAutomaton_8()
...
cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mnemonic'), shortNameStruct, scope=cs_logCurveInfo, documentation=u'The curve name.  \n\t\t\t\t\tThis must be unique for all curves in a log.\n\t\t\t\t\tThe naming authority for the mnemonic can be catptured in the namingSystem attribute.\n\t\t\t\t\tSince both the mnemonic and uid have similar requirements within the context \n\t\t\t\t\tof a WITSML server, the uid can be derived from the mnemonic (e.g., by converting blank to underscore).', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 28, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'classWitsml'), descriptionString, scope=cs_logCurveInfo, documentation=u'The curve classification obtained from a lookup in the vendors \n\t\t\t\t\tmnemonic catalog.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 40, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'classIndex'), positiveCount, scope=cs_logCurveInfo, documentation=u'The count relative to (possibly) repeating values of classWitsml.\n\t\t\t\t\tThis is used to indicate something like the first pump, second pump, etc.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 47, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'unit'), uomString, scope=cs_logCurveInfo, documentation=u'Unit of measurement of the data values. ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 54, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mnemAlias'), shortNameStruct, scope=cs_logCurveInfo, documentation=u'Name alias for this trace.\n\t\t\t\t\tThe naming authority for the mnemonic can be catptured in the namingSystem attribute.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 59, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nullValue'), encodedValueString, scope=cs_logCurveInfo, documentation=u'An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e., when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value is defined in the logCurveInfo, it overrides any null value specified at the \n\t\t\t\t\tlogHeader level. An empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 67, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'alternateIndex'), logicalBoolean, scope=cs_logCurveInfo, documentation=u'True (true or 1) if this curve is a candidate to be a primary index.\n\t\t\t\t\tFalse (false or 0) or not given, indicates otherwise.\n\t\t\t\t\tAn index curve should monotonically change when sorted on its own values (i.e., no duplicates). ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 80, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wellDatum'), refNameString, scope=cs_logCurveInfo, documentation=u'A pointer to the wellDatum that represents the values of this trace.\n\t\t\t\t\tThis is only relevant for measured depths, vertical depths or elevations.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 87, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'minIndex'), genericMeasure, scope=cs_logCurveInfo, documentation=u'The minimum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve. \n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 93, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'maxIndex'), genericMeasure, scope=cs_logCurveInfo, documentation=u'The maximum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 104, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'minDateTimeIndex'), timestamp, scope=cs_logCurveInfo, documentation=u'The minimum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 115, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'maxDateTimeIndex'), timestamp, scope=cs_logCurveInfo, documentation=u'The maximum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 126, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'curveDescription'), descriptionString, scope=cs_logCurveInfo, documentation=u'Description of the curve.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 137, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sensorOffset'), lengthMeasure, scope=cs_logCurveInfo, documentation=u'Offset of sensor from a downhole equipment vertical reference (the\n\t\t\t\t\tdrill bit, for MWD logs;  the tool zero reference for wireline\n\t\t\t\t\tlogs).  This element is only informative (log values are presented\n\t\t\t\t\tat actual depth, not requiring subtraction of an offset).', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 142, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dataSource'), str32, scope=cs_logCurveInfo, documentation=u'Data source, could be tool name/id.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 151, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'densData'), perLengthMeasure, scope=cs_logCurveInfo, documentation=u'Data density of sample in samples per length unit.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 156, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'traceState'), LogTraceState, scope=cs_logCurveInfo, documentation=u'State of trace data.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 161, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'traceOrigin'), LogTraceOrigin, scope=cs_logCurveInfo, documentation=u'Origin of trace data.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 166, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'typeLogData'), LogDataType, scope=cs_logCurveInfo, documentation=u'Log data type.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 171, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'axisDefinition'), cs_axisDefinition, scope=cs_logCurveInfo, documentation=u'Indicates that the curve is an array curve (i.e., multi-valued samples), \n\t\t\t\t\tand provides meta data by which an axis of the array can be understood.\n\t\t\t\t\tA separate definition is required for each axis of an N-dimensional array.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 177, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), cs_extensionNameValue, scope=cs_logCurveInfo, documentation=u'Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 185, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 40, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 47, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 54, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 59, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 67, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 80, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 87, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 93, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 104, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 115, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 126, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 137, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 142, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 151, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 156, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 161, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 166, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 177, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 185, 3))
    counters.add(cc_18)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mnemonic')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'classWitsml')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'classIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 47, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'unit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 54, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mnemAlias')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 59, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nullValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 67, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'alternateIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 80, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wellDatum')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 87, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'minIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 93, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'maxIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 104, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'minDateTimeIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 115, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'maxDateTimeIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 126, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'curveDescription')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 137, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sensorOffset')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 142, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dataSource')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 151, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'densData')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 156, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'traceState')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 161, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'traceOrigin')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 166, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'typeLogData')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 171, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'axisDefinition')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 177, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_logCurveInfo.xsd', 185, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
cs_logCurveInfo._Automaton = _BuildAutomaton_12()




obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectGrowing'), logicalBoolean, scope=obj_log, documentation=u'The growing state of the object.\n\t\t\t\t\tThis value is only relevant within the context of a server.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling of Change Information" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 27, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dataUpateRate'), positiveBigCount, scope=obj_log, documentation=u'The data append rate (in seconds) of this growing object.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling Systematically Growing Objects" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 39, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'requestLatestValue'), positiveBigCount, scope=obj_log, documentation=u'Requests that only the latest N values be returned from the end of each curve.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling Systematically Growing Objects" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 47, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'curveSensorsAligned'), logicalBoolean, scope=obj_log, documentation=u'This value is only relevant within the context of a server.\n\t\t\t\t\tTrue ("true" or "1") indicates that all curves have\n\t\t\t\t\tthe same sensor offset from the downhole equipment vertical reference. \n\t\t\t\t\tFalse ("false" or 0") or not given indicates otherwise.\n\t\t\t\t\tFor a growing log, a value of true will allow a query \n\t\t\t\t\tto use the the endIndex from the previous query as the startIndex of the next query.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 55, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dataGroup'), kindString, scope=obj_log, documentation=u'The name of the grouping represented by curves in this log.\n\t\t\t\t\tA group represents a named combination of curves and the curves in a particular\n\t\t\t\t\tlog should be represented in that list.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 66, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'serviceCompany'), nameString, scope=obj_log, documentation=u'Name of contractor who provided the service.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 74, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'runNumber'), str16, scope=obj_log, documentation=u'Log run number. This should normally be a number; however \n\t\t\t\t\tsome legacy systems encode other information in this value.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 79, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'bhaRunNumber'), positiveCount, scope=obj_log, documentation=u'The bottom hole assembly run number associated with this log.\n\t\t\t\t\tThis should match the run number on the BHA run object.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 85, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pass'), str16, scope=obj_log, documentation=u'Identifies the pass within the run.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 92, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'creationDate'), timestamp, scope=obj_log, documentation=u'Date and time that the log was created.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 97, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'description'), commentString, scope=obj_log, documentation=u'Description of item and details.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 102, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dataDelimiter'), str2, scope=obj_log, documentation=u'The value delimiter in the data string. Defaults to a comma.\n\t\t\t\t\tNote that this does not affect any space delimited array data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 107, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'indexType'), LogIndexType, scope=obj_log, documentation=u'Primary index type.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 114, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'startIndex'), genericMeasure, scope=obj_log, documentation=u'When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first non-null data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first non-null data point is located.\n\t\t\t\t\t\tEither a quantity index set (start and end) or a date time index set must be given.\n\t\t\t\t\t\tIf both sets are given then "indexType" and \n\t\t\t\t\t\t"indexCurve" must represent an elapsed time from "startDateTimeIndex".\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 120, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'endIndex'), genericMeasure, scope=obj_log, documentation=u'When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\t\tis the ending (maximum) index value at which the last non-null data point is located.  \n\t\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t\t(minimum) index value at which the last non-null data point is located.\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 135, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'stepIncrement'), ratioGenericMeasure, scope=obj_log, documentation=u'The sampling increment. Set to zero for unequal sampling.\n\t\t\t\t\t\tA non-zero value indicates that the data is regularly sampled even if it has an explicit index curve.\n\t\t\t\t\t\tIf it is zero or not given then assume that it is non-regular even though it may be regular.\n\t\t\t\t\t\tThe problem is that writers generally cannot guarantee the regularity of the log until after they have finished processing it\n\t\t\t\t\t\tFor curves that are originally sampled at a constant increment, this value should\n\t\t\t\t\t\tbe retained because calculated values may have cumulative errors.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 147, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'startDateTimeIndex'), timestamp, scope=obj_log, documentation=u'When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first non-null data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first non-null data point is located.\n\t\t\t\t\t\tEither a quantity index set (start and end) or a date time index set must be given.\n\t\t\t\t\t\tIf both sets are given then "indexType" and \n\t\t\t\t\t\t"indexCurve" must represent an elapsed time from "startDateTimeIndex".\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 158, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'endDateTimeIndex'), timestamp, scope=obj_log, documentation=u'When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\t\tis the ending (maximum) index value at which the last non-null data point is located.  \n\t\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t\t(minimum) index value at which the last non-null data point is located. \n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 173, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'direction'), LogIndexDirection, scope=obj_log, documentation=u'The sort order of the data row index values in the XML instance.\n\t\t\t\t\tFor an "Increasing" direction the index value of consecutive data nodes are ascending.\n\t\t\t\t\tFor a "Decreasing" direction the index value of consecutive data nodes are descending.\n\t\t\t\t\tThe default direction is "Increasing".  The direction of a log cannot be changed \n\t\t\t\t\tonce it has been created. That is, this value cannot be updated in a server.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 186, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'indexCurve'), str32, scope=obj_log, documentation=u'The mnemonic of the index curve.\n\t\t\t\t\tDuplicate index values can exist in a log but a change of direction is not allowed.\n\t\t\t\t\tIf a change of direction is required then a new log must be created.\n\t\t\t\t\tSome servers may eliminate (i.e., overwrite) duplicate indexes.\n\t\t\t\t\tThe data values associated with this curve represent an API "node-index" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 195, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nullValue'), encodedValueString, scope=obj_log, documentation=u'An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e. when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value representation is defined for a log, this becomes the default for all curves\n\t\t\t\t\tin that log (but can be overridden at the curve level).  \n\t\t\t\t\tAn empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. \n\t\t\t\t\t', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 209, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'logParam'), indexedObject, scope=obj_log, documentation=u'Log parameters.  \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.\n\t\t\t\t\tA parameter name of "multipass" represents a boolean values ("true" or "false").\n\t\t\t\t\tA "multipass" parameter value of "true" asserts that the object contains values for \n\t\t\t\t\tbhaRunNumber (or runNumber), passNumber and direction.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 223, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'logCurveInfo'), cs_logCurveInfo, scope=obj_log, documentation=u'Container element for the log curve information. \n\t\t\t\t\tThis is an API "column-definition" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 235, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'logData'), cs_logData, scope=obj_log, documentation=u'Container for one or more "rows" of log data.\n\t\t\t\t\tThe use of more than one logData node represents a sparse view of the actual data and \n\t\t\t\t\tis contrained for use in the WITSML API for adding and updating sparse data. \n\t\t\t\t\tAny other usage should utilize only one instance of logData.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 243, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_log, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 73, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_log, documentation=u'Human recognizable context for the wellbore that contains the log.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 78, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_log, documentation=u'Human recognizable context for the log.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 83, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_log, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 93, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_log, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 99, 3)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 27, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 39, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 47, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 55, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 66, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 74, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 79, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 85, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 92, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 97, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 102, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 107, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 120, 4))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 135, 4))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 147, 4))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 158, 4))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 173, 4))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 186, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 209, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 223, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 235, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 243, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 88, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 93, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 99, 3))
    counters.add(cc_24)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectGrowing')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dataUpateRate')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 39, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'requestLatestValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 47, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'curveSensorsAligned')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 55, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dataGroup')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 66, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'serviceCompany')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 74, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'runNumber')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 79, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'bhaRunNumber')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 85, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'pass')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 92, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'creationDate')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 97, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'description')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 102, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dataDelimiter')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 107, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'indexType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 114, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'startIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 120, 4))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'endIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 135, 4))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'stepIncrement')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 147, 4))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'startDateTimeIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 158, 4))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'endDateTimeIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 173, 4))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'direction')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 186, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'indexCurve')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 195, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nullValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 209, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'logParam')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 223, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'logCurveInfo')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 235, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'logData')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_log.xsd', 243, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 73, 3))
    st_24 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 78, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 83, 3))
    st_26 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_26)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 93, 3))
    st_27 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_27)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_log.xsd', 99, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
obj_log._Automaton = _BuildAutomaton_13()


logs._setSubstitutionGroup(_abs.abstractDataObject)
