# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1410/witsml1410_obj_log.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:08:43.105890 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:4ec89415-fb26-4176-9ec7-6b874af47531')
...
class cs_logData (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_logData.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mnemonicList uses Python identifier mnemonicList
    __mnemonicList = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mnemonicList'), 'mnemonicList', '__httpwww_witsml_orgschemas1series_cs_logData_httpwww_witsml_orgschemas1seriesmnemonicList', False, pyxb.utils.utility.Location('cs_logData.xsd', 26, 3), )
    ...
    __unitList = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'unitList'), 'unitList', '__httpwww_witsml_orgschemas1series_cs_logData_httpwww_witsml_orgschemas1seriesunitList', False, pyxb.utils.utility.Location('cs_logData.xsd', 37, 3), )
    ...
    __data = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'data'), 'data', '__httpwww_witsml_orgschemas1series_cs_logData_httpwww_witsml_orgschemas1seriesdata', True, pyxb.utils.utility.Location('cs_logData.xsd', 46, 3), )
...
_module_typeBindings.cs_logData = cs_logData
...
class obj_logs (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_logs')
    _XSDLocation = pyxb.utils.utility.Location('obj_log.xsd', 42, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_logs_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_log.xsd', 49, 5), )
    ...
    __log = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'log'), 'log', '__httpwww_witsml_orgschemas1series_obj_logs_httpwww_witsml_orgschemas1serieslog', True, pyxb.utils.utility.Location('obj_log.xsd', 54, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_logs_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_log.xsd', 60, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_log.xsd', 60, 4)
...
_module_typeBindings.obj_logs = obj_logs
...
class cs_axisDefinition (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_axisDefinition.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}order uses Python identifier order
    __order = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'order'), 'order', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesorder', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 28, 3), )
    ...
    __count = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'count'), 'count', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriescount', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 60, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 65, 3), )
    ...
    __propertyType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'propertyType'), 'propertyType', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriespropertyType', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 70, 3), )
    ...
    __uom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'uom'), 'uom', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesuom', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 75, 3), )
    ...
    __doubleValues = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'doubleValues'), 'doubleValues', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesdoubleValues', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 84, 4), )
    ...
    __stringValues = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stringValues'), 'stringValues', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_httpwww_witsml_orgschemas1seriesstringValues', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 97, 4), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_axisDefinition_uid', _module_typeBindings.uidString)
...
_module_typeBindings.cs_axisDefinition = cs_axisDefinition
...
class cs_logCurveInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 22, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mnemonic uses Python identifier mnemonic
    __mnemonic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mnemonic'), 'mnemonic', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmnemonic', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 28, 3), )
    ...
    __classWitsml = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'classWitsml'), 'classWitsml', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesclassWitsml', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 40, 3), )
    ...
    __classIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'classIndex'), 'classIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesclassIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3), )
    ...
    __unit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'unit'), 'unit', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesunit', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 54, 3), )
    ...
    __mnemAlias = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mnemAlias'), 'mnemAlias', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmnemAlias', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3), )
    ...
    __nullValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), 'nullValue', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesnullValue', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 67, 3), )
    ...
    __alternateIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'alternateIndex'), 'alternateIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesalternateIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 80, 3), )
    ...
    __wellDatum = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellDatum'), 'wellDatum', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1serieswellDatum', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 87, 3), )
    ...
    __minIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'minIndex'), 'minIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesminIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 93, 3), )
    ...
    __maxIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'maxIndex'), 'maxIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmaxIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3), )
    ...
    __minDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'minDateTimeIndex'), 'minDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesminDateTimeIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 115, 3), )
    ...
    __maxDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'maxDateTimeIndex'), 'maxDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesmaxDateTimeIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 126, 3), )
    ...
    __curveDescription = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'curveDescription'), 'curveDescription', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriescurveDescription', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3), )
    ...
    __sensorOffset = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sensorOffset'), 'sensorOffset', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriessensorOffset', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3), )
    ...
    __dataSource = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dataSource'), 'dataSource', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesdataSource', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 151, 3), )
    ...
    __densData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'densData'), 'densData', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesdensData', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 156, 3), )
    ...
    __traceState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'traceState'), 'traceState', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriestraceState', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 161, 3), )
    ...
    __traceOrigin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'traceOrigin'), 'traceOrigin', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriestraceOrigin', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 166, 3), )
    ...
    __typeLogData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeLogData'), 'typeLogData', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriestypeLogData', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 171, 3), )
    ...
    __axisDefinition = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'axisDefinition'), 'axisDefinition', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesaxisDefinition', True, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 177, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 185, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_logCurveInfo_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_logCurveInfo = cs_logCurveInfo
...
class obj_log (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_log.xsd', 71, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}objectGrowing uses Python identifier objectGrowing
    __objectGrowing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectGrowing'), 'objectGrowing', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesobjectGrowing', False, pyxb.utils.utility.Location('grp_log.xsd', 27, 3), )
    ...
    __dataUpateRate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dataUpateRate'), 'dataUpateRate', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdataUpateRate', False, pyxb.utils.utility.Location('grp_log.xsd', 39, 3), )
    ...
    __requestLatestValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'requestLatestValue'), 'requestLatestValue', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesrequestLatestValue', False, pyxb.utils.utility.Location('grp_log.xsd', 47, 3), )
    ...
    __curveSensorsAligned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'curveSensorsAligned'), 'curveSensorsAligned', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescurveSensorsAligned', False, pyxb.utils.utility.Location('grp_log.xsd', 55, 3), )
    ...
    __dataGroup = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dataGroup'), 'dataGroup', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdataGroup', False, pyxb.utils.utility.Location('grp_log.xsd', 66, 3), )
    ...
    __serviceCompany = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany'), 'serviceCompany', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesserviceCompany', False, pyxb.utils.utility.Location('grp_log.xsd', 74, 3), )
    ...
    __runNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'runNumber'), 'runNumber', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesrunNumber', False, pyxb.utils.utility.Location('grp_log.xsd', 79, 3), )
    ...
    __bhaRunNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'bhaRunNumber'), 'bhaRunNumber', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesbhaRunNumber', False, pyxb.utils.utility.Location('grp_log.xsd', 85, 3), )
    ...
    __pass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'pass'), 'pass_', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriespass', False, pyxb.utils.utility.Location('grp_log.xsd', 92, 3), )
    ...
    __creationDate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'creationDate'), 'creationDate', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescreationDate', False, pyxb.utils.utility.Location('grp_log.xsd', 97, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('grp_log.xsd', 102, 3), )
    ...
    __dataDelimiter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dataDelimiter'), 'dataDelimiter', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdataDelimiter', False, pyxb.utils.utility.Location('grp_log.xsd', 107, 3), )
    ...
    __indexType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'indexType'), 'indexType', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesindexType', False, pyxb.utils.utility.Location('grp_log.xsd', 114, 3), )
    ...
    __startIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'startIndex'), 'startIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesstartIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 120, 4), )
    ...
    __endIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'endIndex'), 'endIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesendIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 135, 4), )
    ...
    __stepIncrement = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stepIncrement'), 'stepIncrement', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesstepIncrement', False, pyxb.utils.utility.Location('grp_log.xsd', 147, 4), )
    ...
    __startDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex'), 'startDateTimeIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesstartDateTimeIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 158, 4), )
    ...
    __endDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex'), 'endDateTimeIndex', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesendDateTimeIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 173, 4), )
    ...
    __direction = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'direction'), 'direction', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesdirection', False, pyxb.utils.utility.Location('grp_log.xsd', 186, 3), )
    ...
    __indexCurve = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'indexCurve'), 'indexCurve', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesindexCurve', False, pyxb.utils.utility.Location('grp_log.xsd', 195, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}nullValue uses Python identifier nullValue
    __nullValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), 'nullValue', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesnullValue', False, pyxb.utils.utility.Location('grp_log.xsd', 209, 3), )
    ...
    __logParam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'logParam'), 'logParam', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1serieslogParam', True, pyxb.utils.utility.Location('grp_log.xsd', 223, 3), )
    ...
    __logCurveInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'logCurveInfo'), 'logCurveInfo', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1serieslogCurveInfo', True, pyxb.utils.utility.Location('grp_log.xsd', 235, 3), )
    ...
    __logData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'logData'), 'logData', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1serieslogData', True, pyxb.utils.utility.Location('grp_log.xsd', 243, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_log.xsd', 73, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_log.xsd', 78, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_log.xsd', 83, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_log.xsd', 93, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_log_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_log.xsd', 99, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_log_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_log_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_log.xsd', 106, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_log.xsd', 106, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_log_uidWellbore', _module_typeBindings.uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_log.xsd', 113, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_log.xsd', 113, 2)
...
_module_typeBindings.obj_log = obj_log
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_logData.xsd', 46, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mnemonicList')), pyxb.utils.utility.Location('cs_logData.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'unitList')), pyxb.utils.utility.Location('cs_logData.xsd', 37, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'data')), pyxb.utils.utility.Location('cs_logData.xsd', 46, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_logs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_logs, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 49, 5)))

obj_logs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'log'), obj_log, scope=obj_logs, documentation='A single log.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 54, 5)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 49, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_logs._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_log.xsd', 49, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_logs._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'log')), pyxb.utils.utility.Location('obj_log.xsd', 54, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'order'), positiveCount, scope=cs_axisDefinition, documentation='The order of this axis. The order should  \n\t\t\t\t\tbegin with one and increment by one for each additional axis. \n\t\t\t\t\tThe order indicates how fast the index of the axis varies \n\t\t\t\t\tin the serialized list of values. \n\t\t\t\t\tThe index of an axis with an order of one varies the slowest.\n\t\t\t\t\tThe index of an axis with an order of two varies the next slowest. \n\t\t\t\t\tAnd so on. This is the same ordering that is used in the C programming language.\n\t\t\t\t\tFor example, the following array:\n\t\t\t\t\t\t         [   x axis  ]\n\t\t\t\t\t\t   |     z11  z12  z13\n\t\t\t\t\t\ty axis:  z21  z22  z23\n\t\t\t\t\t\t   |     z31  z32  z33\n\t\t\t\t\t\t   |     z41  z42  z43\n\t\t\t\t\tmay be encoded as follows:\n\t\t\t\t\t\taxisDefinition[order=1].name=\'x\'\n\t\t\t\t\t\taxisDefinition[order=1].count=\'3\'\n\t\t\t\t\t\taxisDefinition[order=2].name=\'y\'\n\t\t\t\t\t\taxisDefinition[order=2].count=\'4\'\n\t\t\t\t\t\t{ z11 z21 z31 z41 z12 z22 z32 z42 z13 z23 z33 z43 }\n\t\t\t\t\tor alternatively:\n\t\t\t\t\t\taxisDefinition[order=1].name=\'y\'\n\t\t\t\t\t\taxisDefinition[order=1].count=\'4\'\n\t\t\t\t\t\taxisDefinition[order=2].name=\'x\'\n\t\t\t\t\t\taxisDefinition[order=2].count=\'3\'\n\t\t\t\t\t\t{ z11 z12 z13 z21 z22 z23 z31 z32 z33 z41 z42 z43 }\n\t\t\t\t\tSTORE UNIQUE KEY: When accessed via the Store Interface, the "order" must be unique.\n\t\t\t\t\t', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 28, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'count'), positiveCount, scope=cs_axisDefinition, documentation='The count of elements along this axis of the array.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 60, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_axisDefinition, documentation='The name of the array axis.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 65, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'propertyType'), nameString, scope=cs_axisDefinition, documentation='The property type by which the array axis is classified.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 70, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'uom'), uomString, scope=cs_axisDefinition, documentation='A string representing the units of measure of the axis values.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 75, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'doubleValues'), listOfString, scope=cs_axisDefinition, documentation='The serialziation of the axis positions of an array as a \n\t\t\t\t\t\twhitespace-delimited list values of type xsd:double.  If the length of this list\n\t\t\t\t\t\tis less than \'count\' then the difference in the last two values represents the increment\n\t\t\t\t\t\tto be used to fill out the list. For example, the list \'2 4\' with count=4 \n\t\t\t\t\t\trepresents the  list \'2 4 6 8\'.\n\t\t\t\t\t\tNote: This has an underlying string type because .NET will not properly handle\n\t\t\t\t\t\ta "list of double".', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 84, 4)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stringValues'), listOfString, scope=cs_axisDefinition, documentation='The serialziation of the axis positions of an array as \n\t\t\t\t\t\ta whitespace-delimited list values of type xsd:String.\n\t\t\t\t\t\tNote: the serialization of string elements with embedded whitespace cannot \n\t\t\t\t\t\tbe properly decoded.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 97, 4)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_axisDefinition, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 107, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 65, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 70, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 75, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 107, 3))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'order')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'count')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 60, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 65, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'propertyType')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 70, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'uom')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 75, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'doubleValues')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 84, 4))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stringValues')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 97, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 107, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mnemonic'), shortNameStruct, scope=cs_logCurveInfo, documentation='The curve name.  \n\t\t\t\t\tThis must be unique for all curves in a log.\n\t\t\t\t\tThe naming authority for the mnemonic can be catptured in the namingSystem attribute.\n\t\t\t\t\tSince both the mnemonic and uid have similar requirements within the context \n\t\t\t\t\tof a WITSML server, the uid can be derived from the mnemonic (e.g., by converting blank to underscore).', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 28, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'classWitsml'), descriptionString, scope=cs_logCurveInfo, documentation='The curve classification obtained from a lookup in the vendors \n\t\t\t\t\tmnemonic catalog.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 40, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'classIndex'), positiveCount, scope=cs_logCurveInfo, documentation='The count relative to (possibly) repeating values of classWitsml.\n\t\t\t\t\tThis is used to indicate something like the first pump, second pump, etc.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'unit'), uomString, scope=cs_logCurveInfo, documentation='Unit of measurement of the data values. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 54, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mnemAlias'), shortNameStruct, scope=cs_logCurveInfo, documentation='Name alias for this trace.\n\t\t\t\t\tThe naming authority for the mnemonic can be catptured in the namingSystem attribute.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), encodedValueString, scope=cs_logCurveInfo, documentation='An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e., when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value is defined in the logCurveInfo, it overrides any null value specified at the \n\t\t\t\t\tlogHeader level. An empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 67, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'alternateIndex'), logicalBoolean, scope=cs_logCurveInfo, documentation='True (true or 1) if this curve is a candidate to be a primary index.\n\t\t\t\t\tFalse (false or 0) or not given, indicates otherwise.\n\t\t\t\t\tAn index curve should monotonically change when sorted on its own values (i.e., no duplicates). ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 80, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellDatum'), refNameString, scope=cs_logCurveInfo, documentation='A pointer to the wellDatum that represents the values of this trace.\n\t\t\t\t\tThis is only relevant for measured depths, vertical depths or elevations.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 87, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'minIndex'), genericMeasure, scope=cs_logCurveInfo, documentation='The minimum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve. \n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 93, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'maxIndex'), genericMeasure, scope=cs_logCurveInfo, documentation='The maximum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'minDateTimeIndex'), timestamp, scope=cs_logCurveInfo, documentation='The minimum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 115, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'maxDateTimeIndex'), timestamp, scope=cs_logCurveInfo, documentation='The maximum index value of any valid data point in the curve. \n\t\t\t\t\tNull values are excluded from this determination.\n\t\t\t\t\tThe value is the same regardless of the direction of the curve.\n\t\t\t\t\tThis is an API "column-range" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 126, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'curveDescription'), descriptionString, scope=cs_logCurveInfo, documentation='Description of the curve.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sensorOffset'), lengthMeasure, scope=cs_logCurveInfo, documentation='Offset of sensor from a downhole equipment vertical reference (the\n\t\t\t\t\tdrill bit, for MWD logs;  the tool zero reference for wireline\n\t\t\t\t\tlogs).  This element is only informative (log values are presented\n\t\t\t\t\tat actual depth, not requiring subtraction of an offset).', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dataSource'), str32, scope=cs_logCurveInfo, documentation='Data source, could be tool name/id.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 151, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'densData'), perLengthMeasure, scope=cs_logCurveInfo, documentation='Data density of sample in samples per length unit.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 156, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'traceState'), LogTraceState, scope=cs_logCurveInfo, documentation='State of trace data.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 161, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'traceOrigin'), LogTraceOrigin, scope=cs_logCurveInfo, documentation='Origin of trace data.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 166, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeLogData'), LogDataType, scope=cs_logCurveInfo, documentation='Log data type.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 171, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'axisDefinition'), cs_axisDefinition, scope=cs_logCurveInfo, documentation='Indicates that the curve is an array curve (i.e., multi-valued samples), \n\t\t\t\t\tand provides meta data by which an axis of the array can be understood.\n\t\t\t\t\tA separate definition is required for each axis of an N-dimensional array.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 177, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_logCurveInfo, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 185, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 40, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 54, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 67, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 80, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 87, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 93, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 115, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 126, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 151, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 156, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 161, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 166, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 177, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 185, 3))
    counters.add(cc_18)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mnemonic')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'classWitsml')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'classIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'unit')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 54, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mnemAlias')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nullValue')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 67, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'alternateIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 80, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellDatum')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 87, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'minIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 93, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'maxIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'minDateTimeIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 115, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'maxDateTimeIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 126, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'curveDescription')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sensorOffset')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dataSource')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 151, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'densData')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 156, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'traceState')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 161, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'traceOrigin')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 166, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeLogData')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 171, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'axisDefinition')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 177, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 185, 3))
...
obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectGrowing'), logicalBoolean, scope=obj_log, documentation='The growing state of the object.\n\t\t\t\t\tThis value is only relevant within the context of a server.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling of Change Information" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 27, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dataUpateRate'), positiveBigCount, scope=obj_log, documentation='The data append rate (in seconds) of this growing object.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling Systematically Growing Objects" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 39, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'requestLatestValue'), positiveBigCount, scope=obj_log, documentation='Requests that only the latest N values be returned from the end of each curve.\n\t\t\t\t\tThis is an API server parameter releted to the "Special Handling Systematically Growing Objects" within a server. \n\t\t\t\t\tSee the relevant API specification for the  behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 47, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'curveSensorsAligned'), logicalBoolean, scope=obj_log, documentation='This value is only relevant within the context of a server.\n\t\t\t\t\tTrue ("true" or "1") indicates that all curves have\n\t\t\t\t\tthe same sensor offset from the downhole equipment vertical reference. \n\t\t\t\t\tFalse ("false" or 0") or not given indicates otherwise.\n\t\t\t\t\tFor a growing log, a value of true will allow a query \n\t\t\t\t\tto use the the endIndex from the previous query as the startIndex of the next query.', location=pyxb.utils.utility.Location('grp_log.xsd', 55, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dataGroup'), kindString, scope=obj_log, documentation='The name of the grouping represented by curves in this log.\n\t\t\t\t\tA group represents a named combination of curves and the curves in a particular\n\t\t\t\t\tlog should be represented in that list.', location=pyxb.utils.utility.Location('grp_log.xsd', 66, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany'), nameString, scope=obj_log, documentation='Name of contractor who provided the service.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 74, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'runNumber'), str16, scope=obj_log, documentation='Log run number. This should normally be a number; however \n\t\t\t\t\tsome legacy systems encode other information in this value.', location=pyxb.utils.utility.Location('grp_log.xsd', 79, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bhaRunNumber'), positiveCount, scope=obj_log, documentation='The bottom hole assembly run number associated with this log.\n\t\t\t\t\tThis should match the run number on the BHA run object.', location=pyxb.utils.utility.Location('grp_log.xsd', 85, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pass'), str16, scope=obj_log, documentation='Identifies the pass within the run.', location=pyxb.utils.utility.Location('grp_log.xsd', 92, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'creationDate'), timestamp, scope=obj_log, documentation='Date and time that the log was created.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 97, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=obj_log, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 102, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dataDelimiter'), str2, scope=obj_log, documentation='The value delimiter in the data string. Defaults to a comma.\n\t\t\t\t\tNote that this does not affect any space delimited array data.', location=pyxb.utils.utility.Location('grp_log.xsd', 107, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'indexType'), LogIndexType, scope=obj_log, documentation='Primary index type.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 114, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'startIndex'), genericMeasure, scope=obj_log, documentation='When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first non-null data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first non-null data point is located.\n\t\t\t\t\t\tEither a quantity index set (start and end) or a date time index set must be given.\n\t\t\t\t\t\tIf both sets are given then "indexType" and \n\t\t\t\t\t\t"indexCurve" must represent an elapsed time from "startDateTimeIndex".\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 120, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'endIndex'), genericMeasure, scope=obj_log, documentation='When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\t\tis the ending (maximum) index value at which the last non-null data point is located.  \n\t\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t\t(minimum) index value at which the last non-null data point is located.\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 135, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stepIncrement'), ratioGenericMeasure, scope=obj_log, documentation='The sampling increment. Set to zero for unequal sampling.\n\t\t\t\t\t\tA non-zero value indicates that the data is regularly sampled even if it has an explicit index curve.\n\t\t\t\t\t\tIf it is zero or not given then assume that it is non-regular even though it may be regular.\n\t\t\t\t\t\tThe problem is that writers generally cannot guarantee the regularity of the log until after they have finished processing it\n\t\t\t\t\t\tFor curves that are originally sampled at a constant increment, this value should\n\t\t\t\t\t\tbe retained because calculated values may have cumulative errors.', location=pyxb.utils.utility.Location('grp_log.xsd', 147, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex'), timestamp, scope=obj_log, documentation='When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first non-null data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first non-null data point is located.\n\t\t\t\t\t\tEither a quantity index set (start and end) or a date time index set must be given.\n\t\t\t\t\t\tIf both sets are given then "indexType" and \n\t\t\t\t\t\t"indexCurve" must represent an elapsed time from "startDateTimeIndex".\n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 158, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex'), timestamp, scope=obj_log, documentation='When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\t\tis the ending (maximum) index value at which the last non-null data point is located.  \n\t\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t\t(minimum) index value at which the last non-null data point is located. \n\t\t\t\t\t\tThis is an API "structural-range" query parameter for growing objects. \n\t\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 173, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'direction'), LogIndexDirection, scope=obj_log, documentation='The sort order of the data row index values in the XML instance.\n\t\t\t\t\tFor an "Increasing" direction the index value of consecutive data nodes are ascending.\n\t\t\t\t\tFor a "Decreasing" direction the index value of consecutive data nodes are descending.\n\t\t\t\t\tThe default direction is "Increasing".  The direction of a log cannot be changed \n\t\t\t\t\tonce it has been created. That is, this value cannot be updated in a server.', location=pyxb.utils.utility.Location('grp_log.xsd', 186, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'indexCurve'), str32, scope=obj_log, documentation='The mnemonic of the index curve.\n\t\t\t\t\tDuplicate index values can exist in a log but a change of direction is not allowed.\n\t\t\t\t\tIf a change of direction is required then a new log must be created.\n\t\t\t\t\tSome servers may eliminate (i.e., overwrite) duplicate indexes.\n\t\t\t\t\tThe data values associated with this curve represent an API "node-index" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 195, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), encodedValueString, scope=obj_log, documentation='An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e. when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value representation is defined for a log, this becomes the default for all curves\n\t\t\t\t\tin that log (but can be overridden at the curve level).  \n\t\t\t\t\tAn empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. \n\t\t\t\t\t', location=pyxb.utils.utility.Location('grp_log.xsd', 209, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'logParam'), indexedObject, scope=obj_log, documentation='Log parameters.  \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.\n\t\t\t\t\tA parameter name of "multipass" represents a boolean values ("true" or "false").\n\t\t\t\t\tA "multipass" parameter value of "true" asserts that the object contains values for \n\t\t\t\t\tbhaRunNumber (or runNumber), passNumber and direction.', location=pyxb.utils.utility.Location('grp_log.xsd', 223, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'logCurveInfo'), cs_logCurveInfo, scope=obj_log, documentation='Container element for the log curve information. \n\t\t\t\t\tThis is an API "column-definition" query parameter for growing objects. \n\t\t\t\t\tSee the relevant API specification for the query behavior related to this element.', location=pyxb.utils.utility.Location('grp_log.xsd', 235, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'logData'), cs_logData, scope=obj_log, documentation='Container for one or more "rows" of log data.\n\t\t\t\t\tThe use of more than one logData node represents a sparse view of the actual data and \n\t\t\t\t\tis contrained for use in the WITSML API for adding and updating sparse data. \n\t\t\t\t\tAny other usage should utilize only one instance of logData.', location=pyxb.utils.utility.Location('grp_log.xsd', 243, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_log, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 73, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_log, documentation='Human recognizable context for the wellbore that contains the log.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 78, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_log, documentation='Human recognizable context for the log.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 83, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_log, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 93, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_log, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_log.xsd', 99, 3)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 27, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 39, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 47, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 55, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 66, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 74, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 79, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 85, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 92, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 97, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 102, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 107, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 120, 4))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 135, 4))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 147, 4))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 158, 4))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 173, 4))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 186, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 209, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_log.xsd', 223, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_log.xsd', 235, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_log.xsd', 243, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 93, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 99, 3))
    counters.add(cc_24)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_log.xsd', 73, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_log.xsd', 78, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_log.xsd', 83, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectGrowing')), pyxb.utils.utility.Location('grp_log.xsd', 27, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dataUpateRate')), pyxb.utils.utility.Location('grp_log.xsd', 39, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'requestLatestValue')), pyxb.utils.utility.Location('grp_log.xsd', 47, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'curveSensorsAligned')), pyxb.utils.utility.Location('grp_log.xsd', 55, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dataGroup')), pyxb.utils.utility.Location('grp_log.xsd', 66, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany')), pyxb.utils.utility.Location('grp_log.xsd', 74, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'runNumber')), pyxb.utils.utility.Location('grp_log.xsd', 79, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bhaRunNumber')), pyxb.utils.utility.Location('grp_log.xsd', 85, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pass')), pyxb.utils.utility.Location('grp_log.xsd', 92, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'creationDate')), pyxb.utils.utility.Location('grp_log.xsd', 97, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('grp_log.xsd', 102, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dataDelimiter')), pyxb.utils.utility.Location('grp_log.xsd', 107, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'indexType')), pyxb.utils.utility.Location('grp_log.xsd', 114, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'startIndex')), pyxb.utils.utility.Location('grp_log.xsd', 120, 4))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'endIndex')), pyxb.utils.utility.Location('grp_log.xsd', 135, 4))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stepIncrement')), pyxb.utils.utility.Location('grp_log.xsd', 147, 4))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex')), pyxb.utils.utility.Location('grp_log.xsd', 158, 4))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex')), pyxb.utils.utility.Location('grp_log.xsd', 173, 4))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'direction')), pyxb.utils.utility.Location('grp_log.xsd', 186, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'indexCurve')), pyxb.utils.utility.Location('grp_log.xsd', 195, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nullValue')), pyxb.utils.utility.Location('grp_log.xsd', 209, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'logParam')), pyxb.utils.utility.Location('grp_log.xsd', 223, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'logCurveInfo')), pyxb.utils.utility.Location('grp_log.xsd', 235, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'logData')), pyxb.utils.utility.Location('grp_log.xsd', 243, 3))
    st_26 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_26)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_log.xsd', 93, 3))
    st_27 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_27)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_log.xsd', 99, 3))
...
logs._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
