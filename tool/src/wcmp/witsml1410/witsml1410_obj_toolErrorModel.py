...
class cs_iscwsaAuthorizationData (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 20, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}author uses Python identifier author
    __author = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'author'), 'author', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriesauthor', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 26, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}comment uses Python identifier comment
    __comment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comment'), 'comment', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriescomment', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 51, 3), )
...
class cs_iscwsaModelParameters (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_iscwsaModelParameters')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 20, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}misalignmentMode uses Python identifier misalignmentMode
    __misalignmentMode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'misalignmentMode'), 'misalignmentMode', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesmisalignmentMode', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 26, 3), )

    
    misalignmentMode = property(__misalignmentMode.value, __misalignmentMode.set, None, 'Choice of mathmatical modelling of misalignment.')

    
    # Element {http://www.witsml.org/schemas/1series}gyroInitialization uses Python identifier gyroInitialization
    __gyroInitialization = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'gyroInitialization'), 'gyroInitialization', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesgyroInitialization', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 31, 3), )

    
    gyroInitialization = property(__gyroInitialization.value, __gyroInitialization.set, None, 'Inclination at which gyro initialization occurs.')
    ...
    __gyroReinitializationDistance = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'gyroReinitializationDistance'), 'gyroReinitializationDistance', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesgyroReinitializationDistance', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 36, 3), )

    
    gyroReinitializationDistance = property(__gyroReinitializationDistance.value, __gyroReinitializationDistance.set, None, 'Maximum length of continuous survey before re-initialisation.')

    
    # Element {http://www.witsml.org/schemas/1series}switching uses Python identifier switching
    __switching = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'switching'), 'switching', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesswitching', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 41, 3), )

    
    switching = property(__switching.value, __switching.set, None, 'True if the survey tool is rotated at inclinations greater than 90 degrees.')

    
    # Element {http://www.witsml.org/schemas/1series}noiseReductionFactor uses Python identifier noiseReductionFactor
    __noiseReductionFactor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'noiseReductionFactor'), 'noiseReductionFactor', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesnoiseReductionFactor', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 46, 3), )

    
    noiseReductionFactor = property(__noiseReductionFactor.value, __noiseReductionFactor.set, None, 'Factor applied to Random Noise error terms depending on mode of gyro initialisation.\n\t\t\t\t\tValues must be greater than zero and less than or equal to 1.')

    
    # Element {http://www.witsml.org/schemas/1series}gyroRunningSpeed uses Python identifier gyroRunningSpeed
    __gyroRunningSpeed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'gyroRunningSpeed'), 'gyroRunningSpeed', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesgyroRunningSpeed', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 52, 3), )

    
    gyroRunningSpeed = property(__gyroRunningSpeed.value, __gyroRunningSpeed.set, None, 'Speed at which the tool traverses the wellbore during continuous survey.')
...
Namespace.addCategoryObject('typeBinding', 'cs_iscwsaModelParameters', cs_iscwsaModelParameters)
...
class obj_toolErrorModels (_abs.abstractObject):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_toolErrorModels')
...
Namespace.addCategoryObject('typeBinding', 'obj_toolErrorModels', obj_toolErrorModels)
...
class cs_iscwsaErrorTermValue (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_iscwsaErrorTermValue')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 22, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}term uses Python identifier term
    __term = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'term'), 'term', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesterm', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 30, 3), )

    
    term = property(__term.value, __term.set, None, 'A pointer to the errorTerm represented by this value.\n\t\t\t\t\tThis term must exist in the toolErrorTermSet referenced by the parent of this node.\n\t\t\t\t\tThe same term may only be referenced once in the model.')

    
    # Element {http://www.witsml.org/schemas/1series}prop uses Python identifier prop
    __prop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'prop'), 'prop', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesprop', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 37, 3), )

    
    prop = property(__prop.value, __prop.set, None, 'This is the propagation mode for this term in this model.')

    
    # Element {http://www.witsml.org/schemas/1series}bias uses Python identifier bias
    __bias = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'bias'), 'bias', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesbias', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 42, 3), )

    
    bias = property(__bias.value, __bias.set, None, 'The mean or expected value of the variance.')

    
    # Element {http://www.witsml.org/schemas/1series}value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'value'), 'value_', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesvalue', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 47, 3), )

    
    value_ = property(__value.value, __value.set, None, 'The value of the error term in this model.\n\t\t\t\t\tThe unit of measure must be in the set allowed by the \n\t\t\t\t\tmeasure class of the referenced error term.')

    
    # Element {http://www.witsml.org/schemas/1series}comment uses Python identifier comment
    __comment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comment'), 'comment', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriescomment', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 54, 3), )

    
    comment = property(__comment.value, __comment.set, None, 'A textual comment about this error term value.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 59, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
...
Namespace.addCategoryObject('typeBinding', 'cs_iscwsaErrorTermValue', cs_iscwsaErrorTermValue)
...
class cs_iscwsaSurveyToolOperatingCondition (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_iscwsaSurveyToolOperatingCondition')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 22, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}parameter uses Python identifier parameter
    __parameter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'parameter'), 'parameter', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesparameter', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3), )

    
    parameter = property(__parameter.value, __parameter.set, None, 'A particular constraint.')

    
    # Element {http://www.witsml.org/schemas/1series}min uses Python identifier min
    __min = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'min'), 'min', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesmin', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3), )

    
    min = property(__min.value, __min.set, None, 'The least value the constraint may take.')
    ...
    max = property(__max.value, __max.set, None, 'The greatest value the constraint may take.')

    
    # Element {http://www.witsml.org/schemas/1series}value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'value'), 'value_', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesvalue', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3), )

    
    value_ = property(__value.value, __value.set, None, 'A fixed value that the constraint must take.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
...
Namespace.addCategoryObject('typeBinding', 'cs_iscwsaSurveyToolOperatingCondition', cs_iscwsaSurveyToolOperatingCondition)
...
class cs_iscwsaSurveyToolOperatingInterval (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_iscwsaSurveyToolOperatingInterval')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 21, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mode uses Python identifier mode
    __mode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mode'), 'mode', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesmode', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 30, 3), )

    
    mode = property(__mode.value, __mode.set, None, 'Tool operating mode over this interval.')

    
    # Element {http://www.witsml.org/schemas/1series}start uses Python identifier start
    __start = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'start'), 'start', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesstart', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 35, 3), )

    
    start = property(__start.value, __start.set, None, 'Inclination at which mode commences.')

    
    # Element {http://www.witsml.org/schemas/1series}end uses Python identifier end
    __end = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'end'), 'end', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesend', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 40, 3), )

    
    end = property(__end.value, __end.set, None, 'Inclination at which mode terminates.')

    
    # Element {http://www.witsml.org/schemas/1series}speed uses Python identifier speed
    __speed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'speed'), 'speed', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesspeed', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3), )

    
    speed = property(__speed.value, __speed.set, None, 'Running speed for continuous surveys.')

    
    # Element {http://www.witsml.org/schemas/1series}sampleRate uses Python identifier sampleRate
    __sampleRate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sampleRate'), 'sampleRate', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriessampleRate', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3), )

    
    sampleRate = property(__sampleRate.value, __sampleRate.set, None, 'Time between survey samples for continuous surveys.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
...
Namespace.addCategoryObject('typeBinding', 'cs_iscwsaSurveyToolOperatingInterval', cs_iscwsaSurveyToolOperatingInterval)
...
class obj_toolErrorModel (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_toolErrorModel')
    ...
    __authorization = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'authorization'), 'authorization', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesauthorization', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 30, 3), )

    
    authorization = property(__authorization.value, __authorization.set, None, 'The definitive source, authority, status and version of this model.')

    
    # Element {http://www.witsml.org/schemas/1series}typeSurveyTool uses Python identifier typeSurveyTool
    __typeSurveyTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeSurveyTool'), 'typeSurveyTool', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriestypeSurveyTool', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 35, 3), )

    
    typeSurveyTool = property(__typeSurveyTool.value, __typeSurveyTool.set, None, 'The type of tool used for the measurements.  \n\t\t\t\t\tThis is the same list as defined for a trajectoryStation.')

    
    # Element {http://www.witsml.org/schemas/1series}operatingCondition uses Python identifier operatingCondition
    __operatingCondition = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'operatingCondition'), 'operatingCondition', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesoperatingCondition', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 41, 3), )

    
    operatingCondition = property(__operatingCondition.value, __operatingCondition.set, None, 'The operating condition for this tool. \n\t\t\t\t\tIf not specified then stationary should be assumed.')

    
    # Element {http://www.witsml.org/schemas/1series}operatingInterval uses Python identifier operatingInterval
    __operatingInterval = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'operatingInterval'), 'operatingInterval', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesoperatingInterval', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 47, 3), )

    
    operatingInterval = property(__operatingInterval.value, __operatingInterval.set, None, 'The operating interval for this tool. \n\t\t\t\t\tIf not specified then stationary should be assumed.')

    
    # Element {http://www.witsml.org/schemas/1series}modelParameters uses Python identifier modelParameters
    __modelParameters = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'modelParameters'), 'modelParameters', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesmodelParameters', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 53, 3), )

    
    modelParameters = property(__modelParameters.value, __modelParameters.set, None, 'Values related to the tool running conditions that influence \n\t\t\t\t\tthe variance generation.')

    
    # Element {http://www.witsml.org/schemas/1series}useErrorTermSet uses Python identifier useErrorTermSet
    __useErrorTermSet = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'useErrorTermSet'), 'useErrorTermSet', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesuseErrorTermSet', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 59, 3), )

    
    useErrorTermSet = property(__useErrorTermSet.value, __useErrorTermSet.set, None, 'Reference to the toolErrorTermSet object that \n\t\t\t\t\tcontains the error terms used in this model.')

    
    # Element {http://www.witsml.org/schemas/1series}errorTermValue uses Python identifier errorTermValue
    __errorTermValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'errorTermValue'), 'errorTermValue', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1serieserrorTermValue', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 65, 3), )

    
    errorTermValue = property(__errorTermValue.value, __errorTermValue.set, None, 'Value for an error term that is part of the model.')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 73, 3), )

    
    name = property(__name.value, __name.set, None, 'Human-readable name for the model.')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 83, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_uid', uidString)
...
Namespace.addCategoryObject('typeBinding', 'obj_toolErrorModel', obj_toolErrorModel)
...
cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'author'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Person responsible for the information.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 26, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'source'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Source from which the information is derived.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 31, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'authority'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Person or collective body responsible for authorizing the information.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 36, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'status'), AuthorizationStatus, scope=cs_iscwsaAuthorizationData, documentation='Authorization state of the information.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 41, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'version'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Version name or number.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 46, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comment'), commentString, scope=cs_iscwsaAuthorizationData, documentation='A comment about the object. \n\t\t\t\t\tThis should include information regarding the derivation of the information.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 51, 3)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 26, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 31, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 46, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 51, 3))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'author')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'source')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'authority')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'status')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'version')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comment')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaAuthorizationData.xsd', 51, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'misalignmentMode'), ErrorModelMisalignmentMode, scope=cs_iscwsaModelParameters, documentation='Choice of mathmatical modelling of misalignment.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 26, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gyroInitialization'), planeAngleMeasure, scope=cs_iscwsaModelParameters, documentation='Inclination at which gyro initialization occurs.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 31, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gyroReinitializationDistance'), lengthMeasure, scope=cs_iscwsaModelParameters, documentation='Maximum length of continuous survey before re-initialisation.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 36, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'switching'), logicalBoolean, scope=cs_iscwsaModelParameters, documentation='True if the survey tool is rotated at inclinations greater than 90 degrees.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 41, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'noiseReductionFactor'), gtZeroAndLeOne, scope=cs_iscwsaModelParameters, documentation='Factor applied to Random Noise error terms depending on mode of gyro initialisation.\n\t\t\t\t\tValues must be greater than zero and less than or equal to 1.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 46, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gyroRunningSpeed'), velocityMeasure, scope=cs_iscwsaModelParameters, documentation='Speed at which the tool traverses the wellbore during continuous survey.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 52, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 31, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 36, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 41, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 46, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 52, 3))
    counters.add(cc_4)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'misalignmentMode')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gyroInitialization')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gyroReinitializationDistance')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'switching')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'noiseReductionFactor')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gyroRunningSpeed')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaModelParameters.xsd', 52, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_toolErrorModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_toolErrorModels, documentation='Information about the XML message instance.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 45, 5)))

obj_toolErrorModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'toolErrorModel'), obj_toolErrorModel, scope=obj_toolErrorModels, documentation='A single error Term Source.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 50, 5)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 45, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModels._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 45, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModels._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'toolErrorModel')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 50, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'term'), refNameString, scope=cs_iscwsaErrorTermValue, documentation='A pointer to the errorTerm represented by this value.\n\t\t\t\t\tThis term must exist in the toolErrorTermSet referenced by the parent of this node.\n\t\t\t\t\tThe same term may only be referenced once in the model.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 30, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'prop'), ErrorPropagationMode, scope=cs_iscwsaErrorTermValue, documentation='This is the propagation mode for this term in this model.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 37, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bias'), pyxb.binding.datatypes.double, scope=cs_iscwsaErrorTermValue, documentation='The mean or expected value of the variance.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 42, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'value'), measureOrQuantity, scope=cs_iscwsaErrorTermValue, documentation='The value of the error term in this model.\n\t\t\t\t\tThe unit of measure must be in the set allowed by the \n\t\t\t\t\tmeasure class of the referenced error term.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 47, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comment'), commentString, scope=cs_iscwsaErrorTermValue, documentation='A textual comment about this error term value.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 54, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaErrorTermValue, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 59, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 42, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 54, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 59, 3))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'term')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 30, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'prop')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 37, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bias')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 42, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'value')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 47, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comment')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 54, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaErrorTermValue.xsd', 59, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'parameter'), nameString, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='A particular constraint.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'min'), genericMeasure, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='The least value the constraint may take.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'max'), genericMeasure, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='The greatest value the constraint may take.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'value'), str32, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='A fixed value that the constraint must take.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parameter')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'min')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'max')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'value')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mode'), SurveyToolOperatingMode, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Tool operating mode over this interval.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 30, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'start'), planeAngleMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Inclination at which mode commences.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 35, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'end'), planeAngleMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Inclination at which mode terminates.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 40, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'speed'), velocityMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Running speed for continuous surveys.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sampleRate'), timeMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Time between survey samples for continuous surveys.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3)))
...
def _BuildAutomaton_14 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mode')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 30, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'start')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 35, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'end')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 40, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'speed')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sampleRate')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'authorization'), cs_iscwsaAuthorizationData, scope=obj_toolErrorModel, documentation='The definitive source, authority, status and version of this model.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 30, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeSurveyTool'), TypeSurveyTool, scope=obj_toolErrorModel, documentation='The type of tool used for the measurements.  \n\t\t\t\t\tThis is the same list as defined for a trajectoryStation.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 35, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operatingCondition'), cs_iscwsaSurveyToolOperatingCondition, scope=obj_toolErrorModel, documentation='The operating condition for this tool. \n\t\t\t\t\tIf not specified then stationary should be assumed.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 41, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operatingInterval'), cs_iscwsaSurveyToolOperatingInterval, scope=obj_toolErrorModel, documentation='The operating interval for this tool. \n\t\t\t\t\tIf not specified then stationary should be assumed.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 47, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'modelParameters'), cs_iscwsaModelParameters, scope=obj_toolErrorModel, documentation='Values related to the tool running conditions that influence \n\t\t\t\t\tthe variance generation.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 53, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'useErrorTermSet'), refNameString, scope=obj_toolErrorModel, documentation='Reference to the toolErrorTermSet object that \n\t\t\t\t\tcontains the error terms used in this model.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 59, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'errorTermValue'), cs_iscwsaErrorTermValue, scope=obj_toolErrorModel, documentation='Value for an error term that is part of the model.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 65, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_toolErrorModel, documentation='Human-readable name for the model.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 73, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_toolErrorModel, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects. ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 83, 3)))

obj_toolErrorModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_toolErrorModel, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 89, 3)))
...
def _BuildAutomaton_15 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 30, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 35, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 41, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 47, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 53, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 59, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 78, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 83, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 89, 3))
    counters.add(cc_8)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'authorization')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 30, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeSurveyTool')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 35, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operatingCondition')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 41, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operatingInterval')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 47, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'modelParameters')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 53, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'useErrorTermSet')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 59, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'errorTermValue')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_toolErrorModel.xsd', 65, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 73, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 83, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_toolErrorModel.xsd', 89, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
