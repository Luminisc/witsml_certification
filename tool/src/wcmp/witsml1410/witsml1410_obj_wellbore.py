# .\witsml1410_obj_wellbore.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2013-06-21 14:43:43.216000 by PyXB version 1.2.1
...
# Complex type {http://www.witsml.org/schemas/1series}obj_wellbores with content type ELEMENT_ONLY
class obj_wellbores (_abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_wellbores')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_wellbores_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 48, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wellbore uses Python identifier wellbore
    __wellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wellbore'), 'wellbore', '__httpwww_witsml_orgschemas1series_obj_wellbores_httpwww_witsml_orgschemas1serieswellbore', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 53, 5), )

    
    wellbore = property(__wellbore.value, __wellbore.set, None, u'Information about a single wellbore.\n\t\t\t\t\t\t\tA wellbore is a unique, oriented path from the bottom of a drilled \n\t\t\t\t\t\t\tborehole to the surface of the Earth. The path must not overlap or cross itself.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_wellbores_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 61, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 61, 4)
    ...
    _ElementMap.update({
        ...
        __wellbore.name() : __wellbore
    })
    _AttributeMap = _abs.abstractObject._AttributeMap.copy()
    _AttributeMap.update({
        __version.name() : __version
    })
Namespace.addCategoryObject('typeBinding', u'obj_wellbores', obj_wellbores)
...
# Complex type {http://www.witsml.org/schemas/1series}obj_wellbore with content type ELEMENT_ONLY
class obj_wellbore (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/1series}obj_wellbore with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_wellbore')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 72, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}parentWellbore uses Python identifier parentWellbore
    __parentWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'parentWellbore'), 'parentWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesparentWellbore', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 25, 3), )

    
    parentWellbore = property(__parentWellbore.value, __parentWellbore.set, None, u'This is a pointer to the parent wellbore. No parent = starts from top.   ')

    
    # Element {http://www.witsml.org/schemas/1series}number uses Python identifier number
    __number = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'number'), 'number', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesnumber', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 30, 3), )

    
    number = property(__number.value, __number.set, None, u'Operator borehole number.  ')

    
    # Element {http://www.witsml.org/schemas/1series}suffixAPI uses Python identifier suffixAPI
    __suffixAPI = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'suffixAPI'), 'suffixAPI', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriessuffixAPI', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 35, 3), )

    
    suffixAPI = property(__suffixAPI.value, __suffixAPI.set, None, u'API suffix.  ')

    
    # Element {http://www.witsml.org/schemas/1series}numGovt uses Python identifier numGovt
    __numGovt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'numGovt'), 'numGovt', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesnumGovt', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 40, 3), )

    
    numGovt = property(__numGovt.value, __numGovt.set, None, u'Government assigned number.  ')

    
    # Element {http://www.witsml.org/schemas/1series}statusWellbore uses Python identifier statusWellbore
    __statusWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'statusWellbore'), 'statusWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesstatusWellbore', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 45, 3), )

    
    statusWellbore = property(__statusWellbore.value, __statusWellbore.set, None, u'POSC wellbore status.  ')

    
    # Element {http://www.witsml.org/schemas/1series}isActive uses Python identifier isActive
    __isActive = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'isActive'), 'isActive', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesisActive', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 50, 3), )

    
    isActive = property(__isActive.value, __isActive.set, None, u'True (="1" or "true") indicates that the wellbore is active.\n\t\t\t\t\tFalse (="0" or "false") indicates otherwise. It is the servers responsibility to \n\t\t\t\t\tset this value based on its available internal data (e.g., what objects are changing).')

    
    # Element {http://www.witsml.org/schemas/1series}purposeWellbore uses Python identifier purposeWellbore
    __purposeWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'purposeWellbore'), 'purposeWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriespurposeWellbore', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 58, 3), )

    
    purposeWellbore = property(__purposeWellbore.value, __purposeWellbore.set, None, u'POSC wellbore purpose.  ')

    
    # Element {http://www.witsml.org/schemas/1series}typeWellbore uses Python identifier typeWellbore
    __typeWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'typeWellbore'), 'typeWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestypeWellbore', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 63, 3), )

    
    typeWellbore = property(__typeWellbore.value, __typeWellbore.set, None, u'Type of wellbore.  ')

    
    # Element {http://www.witsml.org/schemas/1series}shape uses Python identifier shape
    __shape = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'shape'), 'shape', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesshape', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 68, 3), )

    
    shape = property(__shape.value, __shape.set, None, u'POSC wellbore trajectory shape.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dTimKickoff uses Python identifier dTimKickoff
    __dTimKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimKickoff'), 'dTimKickoff', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesdTimKickoff', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 73, 3), )

    
    dTimKickoff = property(__dTimKickoff.value, __dTimKickoff.set, None, u'Date and time of wellbore kickoff.  ')

    
    # Element {http://www.witsml.org/schemas/1series}achievedTD uses Python identifier achievedTD
    __achievedTD = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'achievedTD'), 'achievedTD', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesachievedTD', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 78, 3), )

    
    achievedTD = property(__achievedTD.value, __achievedTD.set, None, u'True ("true" of "1") indicates that the wellbore has \n\t\t\t\t\tacheieved total depth. That is, drilling has completed. False ("false" or "0") indicates otherwise. \n\t\t\t\t\tNot given indicates that it is not known whether total depth has been reached.')

    
    # Element {http://www.witsml.org/schemas/1series}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'md'), 'md', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmd', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 85, 3), )

    
    md = property(__md.value, __md.set, None, u'The measured depth of the borehole. \n\t\t\t\t\tIf status is plugged, indicates the maximum depth reached before plugging.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.')

    
    # Element {http://www.witsml.org/schemas/1series}tvd uses Python identifier tvd
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvd'), 'tvd', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvd', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 96, 3), )

    
    tvd = property(__tvd.value, __tvd.set, None, u'The  true vertical depth of the borehole.  \n\t\t\t\t\tIf status is plugged, indicates the maximum depth reached before plugging. \n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.')

    
    # Element {http://www.witsml.org/schemas/1series}mdBit uses Python identifier mdBit
    __mdBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdBit'), 'mdBit', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdBit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 107, 3), )

    
    mdBit = property(__mdBit.value, __mdBit.set, None, u'The measured depth of the bit. \n\t\t\t\t\tIf isActive=false then this value is not relevant.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.')

    
    # Element {http://www.witsml.org/schemas/1series}tvdBit uses Python identifier tvdBit
    __tvdBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdBit'), 'tvdBit', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdBit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 118, 3), )

    
    tvdBit = property(__tvdBit.value, __tvdBit.set, None, u'The true vertical depth of the bit.\n\t\t\t\t\tIf isActive=false then this value is not relevant.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.')

    
    # Element {http://www.witsml.org/schemas/1series}mdKickoff uses Python identifier mdKickoff
    __mdKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdKickoff'), 'mdKickoff', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdKickoff', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 129, 3), )

    
    mdKickoff = property(__mdKickoff.value, __mdKickoff.set, None, u'Kickoff measured depth of the wellbore. ')

    
    # Element {http://www.witsml.org/schemas/1series}tvdKickoff uses Python identifier tvdKickoff
    __tvdKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdKickoff'), 'tvdKickoff', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdKickoff', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 134, 3), )

    
    tvdKickoff = property(__tvdKickoff.value, __tvdKickoff.set, None, u'Kickoff true vertical depth of the wellbore.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdPlanned uses Python identifier mdPlanned
    __mdPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdPlanned'), 'mdPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdPlanned', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 139, 3), )

    
    mdPlanned = property(__mdPlanned.value, __mdPlanned.set, None, u'Planned measured depth for the wellbore total depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tvdPlanned uses Python identifier tvdPlanned
    __tvdPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdPlanned'), 'tvdPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdPlanned', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 144, 3), )

    
    tvdPlanned = property(__tvdPlanned.value, __tvdPlanned.set, None, u'Planned true vertical depth for the wellbore total depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdSubSeaPlanned uses Python identifier mdSubSeaPlanned
    __mdSubSeaPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdSubSeaPlanned'), 'mdSubSeaPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdSubSeaPlanned', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 149, 3), )

    
    mdSubSeaPlanned = property(__mdSubSeaPlanned.value, __mdSubSeaPlanned.set, None, u'Planned measured for the wellbore total depth - with respect to seabed.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tvdSubSeaPlanned uses Python identifier tvdSubSeaPlanned
    __tvdSubSeaPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdSubSeaPlanned'), 'tvdSubSeaPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdSubSeaPlanned', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 154, 3), )

    
    tvdSubSeaPlanned = property(__tvdSubSeaPlanned.value, __tvdSubSeaPlanned.set, None, u'Planned true vertical depth for the wellbore total depth - with respect to seabed.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dayTarget uses Python identifier dayTarget
    __dayTarget = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dayTarget'), 'dayTarget', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesdayTarget', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 159, 3), )

    
    dayTarget = property(__dayTarget.value, __dayTarget.set, None, u'Target days for drilling wellbore.  ')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 74, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 79, 3), )

    
    name = property(__name.value, __name.set, None, u'Human recognizable context for the wellbore.  ')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 89, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 95, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_wellbore_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_wellbore_uidWell', uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 102, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 102, 2)
    ...
    _ElementMap = {
        __parentWellbore.name() : __parentWellbore,
        __number.name() : __number,
        __suffixAPI.name() : __suffixAPI,
        __numGovt.name() : __numGovt,
        __statusWellbore.name() : __statusWellbore,
        __isActive.name() : __isActive,
        __purposeWellbore.name() : __purposeWellbore,
        __typeWellbore.name() : __typeWellbore,
        __shape.name() : __shape,
        __dTimKickoff.name() : __dTimKickoff,
        __achievedTD.name() : __achievedTD,
        __md.name() : __md,
        __tvd.name() : __tvd,
        __mdBit.name() : __mdBit,
        __tvdBit.name() : __tvdBit,
        __mdKickoff.name() : __mdKickoff,
        __tvdKickoff.name() : __tvdKickoff,
        __mdPlanned.name() : __mdPlanned,
        __tvdPlanned.name() : __tvdPlanned,
        __mdSubSeaPlanned.name() : __mdSubSeaPlanned,
        __tvdSubSeaPlanned.name() : __tvdSubSeaPlanned,
        __dayTarget.name() : __dayTarget,
...
Namespace.addCategoryObject('typeBinding', u'obj_wellbore', obj_wellbore)
...
wellbores = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wellbores'), obj_wellbores, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 32, 1))
Namespace.addCategoryObject('elementBinding', wellbores.name().localName(), wellbores)
...
obj_wellbores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_wellbores, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 48, 5)))

obj_wellbores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wellbore'), obj_wellbore, scope=obj_wellbores, documentation=u'Information about a single wellbore.\n\t\t\t\t\t\t\tA wellbore is a unique, oriented path from the bottom of a drilled \n\t\t\t\t\t\t\tborehole to the surface of the Earth. The path must not overlap or cross itself.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wellbores._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wellbores._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_wellbores._Automaton = _BuildAutomaton_6()
...
obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'parentWellbore'), refNameString, scope=obj_wellbore, documentation=u'This is a pointer to the parent wellbore. No parent = starts from top.   ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 25, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'number'), str32, scope=obj_wellbore, documentation=u'Operator borehole number.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 30, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'suffixAPI'), nameString, scope=obj_wellbore, documentation=u'API suffix.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 35, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'numGovt'), nameString, scope=obj_wellbore, documentation=u'Government assigned number.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 40, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'statusWellbore'), WellStatus, scope=obj_wellbore, documentation=u'POSC wellbore status.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 45, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'isActive'), logicalBoolean, scope=obj_wellbore, documentation=u'True (="1" or "true") indicates that the wellbore is active.\n\t\t\t\t\tFalse (="0" or "false") indicates otherwise. It is the servers responsibility to \n\t\t\t\t\tset this value based on its available internal data (e.g., what objects are changing).', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 50, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'purposeWellbore'), WellPurpose, scope=obj_wellbore, documentation=u'POSC wellbore purpose.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 58, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'typeWellbore'), WellboreType, scope=obj_wellbore, documentation=u'Type of wellbore.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 63, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'shape'), WellboreShape, scope=obj_wellbore, documentation=u'POSC wellbore trajectory shape.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 68, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimKickoff'), timestamp, scope=obj_wellbore, documentation=u'Date and time of wellbore kickoff.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 73, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'achievedTD'), logicalBoolean, scope=obj_wellbore, documentation=u'True ("true" of "1") indicates that the wellbore has \n\t\t\t\t\tacheieved total depth. That is, drilling has completed. False ("false" or "0") indicates otherwise. \n\t\t\t\t\tNot given indicates that it is not known whether total depth has been reached.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 78, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'md'), measuredDepthCoord, scope=obj_wellbore, documentation=u'The measured depth of the borehole. \n\t\t\t\t\tIf status is plugged, indicates the maximum depth reached before plugging.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 85, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvd'), wellVerticalDepthCoord, scope=obj_wellbore, documentation=u'The  true vertical depth of the borehole.  \n\t\t\t\t\tIf status is plugged, indicates the maximum depth reached before plugging. \n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 96, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdBit'), measuredDepthCoord, scope=obj_wellbore, documentation=u'The measured depth of the bit. \n\t\t\t\t\tIf isActive=false then this value is not relevant.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 107, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdBit'), wellVerticalDepthCoord, scope=obj_wellbore, documentation=u'The true vertical depth of the bit.\n\t\t\t\t\tIf isActive=false then this value is not relevant.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 118, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdKickoff'), measuredDepthCoord, scope=obj_wellbore, documentation=u'Kickoff measured depth of the wellbore. ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 129, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdKickoff'), wellVerticalDepthCoord, scope=obj_wellbore, documentation=u'Kickoff true vertical depth of the wellbore.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 134, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdPlanned'), measuredDepthCoord, scope=obj_wellbore, documentation=u'Planned measured depth for the wellbore total depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 139, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdPlanned'), wellVerticalDepthCoord, scope=obj_wellbore, documentation=u'Planned true vertical depth for the wellbore total depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 144, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdSubSeaPlanned'), measuredDepthCoord, scope=obj_wellbore, documentation=u'Planned measured for the wellbore total depth - with respect to seabed.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 149, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdSubSeaPlanned'), wellVerticalDepthCoord, scope=obj_wellbore, documentation=u'Planned true vertical depth for the wellbore total depth - with respect to seabed.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 154, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dayTarget'), timeMeasure, scope=obj_wellbore, documentation=u'Target days for drilling wellbore.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 159, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_wellbore, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 74, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_wellbore, documentation=u'Human recognizable context for the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 79, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_wellbore, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 89, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_wellbore, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 95, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 25, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 30, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 35, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 40, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 45, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 50, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 58, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 63, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 68, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 73, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 78, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 85, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 96, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 107, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 118, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 129, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 134, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 139, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 144, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 149, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 154, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 159, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 84, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 89, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 95, 3))
    counters.add(cc_24)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'parentWellbore')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'number')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 30, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'suffixAPI')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'numGovt')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 40, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'statusWellbore')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 45, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'isActive')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 50, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'purposeWellbore')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 58, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'typeWellbore')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 63, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'shape')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 68, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimKickoff')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 73, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'achievedTD')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 78, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'md')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 85, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvd')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 96, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdBit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 107, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdBit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 118, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdKickoff')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 129, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdKickoff')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 134, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdPlanned')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 139, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdPlanned')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 144, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdSubSeaPlanned')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 149, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdSubSeaPlanned')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 154, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dayTarget')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_wellbore.xsd', 159, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 74, 3))
    st_22 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 79, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 89, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_wellbore.xsd', 95, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
obj_wellbore._Automaton = _BuildAutomaton_10()


wellbores._setSubstitutionGroup(_abs.abstractDataObject)
