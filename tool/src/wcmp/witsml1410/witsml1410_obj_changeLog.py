# .\witsml1410_obj_changeLog.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2013-06-21 14:41:50.373000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:9d399bb0-daaa-11e2-af69-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/1series}obj_changeLogs with content type ELEMENT_ONLY
class obj_changeLogs (_abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_changeLogs')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 44, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_changeLogs_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 51, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}changeLog uses Python identifier changeLog
    __changeLog = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'changeLog'), 'changeLog', '__httpwww_witsml_orgschemas1series_obj_changeLogs_httpwww_witsml_orgschemas1serieschangeLog', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 56, 5), )

    
    changeLog = property(__changeLog.value, __changeLog.set, None, u'Defines a singular changeLog object.')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_changeLogs_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 62, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 62, 4)
    ...
    _ElementMap.update({
        ...
        __changeLog.name() : __changeLog
    })
    _AttributeMap = _abs.abstractObject._AttributeMap.copy()
    _AttributeMap.update({
        __version.name() : __version
    })
Namespace.addCategoryObject('typeBinding', u'obj_changeLogs', obj_changeLogs)
...
# Complex type {http://www.witsml.org/schemas/1series}cs_changeHistory with content type ELEMENT_ONLY
class cs_changeHistory (pyxb.binding.basis.complexTypeDefinition):
    """Defines detail changes of an object."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_changeHistory')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 21, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}dTimChange uses Python identifier dTimChange
    __dTimChange = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimChange'), 'dTimChange', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesdTimChange', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 27, 3), )

    
    dTimChange = property(__dTimChange.value, __dTimChange.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}changeType uses Python identifier changeType
    __changeType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'changeType'), 'changeType', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1serieschangeType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 32, 3), )

    
    changeType = property(__changeType.value, __changeType.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}objectGrowingState uses Python identifier objectGrowingState
    __objectGrowingState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectGrowingState'), 'objectGrowingState', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesobjectGrowingState', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 37, 3), )

    
    objectGrowingState = property(__objectGrowingState.value, __objectGrowingState.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}updatedHeader uses Python identifier updatedHeader
    __updatedHeader = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'updatedHeader'), 'updatedHeader', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesupdatedHeader', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 42, 3), )

    
    updatedHeader = property(__updatedHeader.value, __updatedHeader.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}changeInfo uses Python identifier changeInfo
    __changeInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'changeInfo'), 'changeInfo', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1serieschangeInfo', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 47, 3), )

    
    changeInfo = property(__changeInfo.value, __changeInfo.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}startIndex uses Python identifier startIndex
    __startIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'startIndex'), 'startIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesstartIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 52, 3), )

    
    startIndex = property(__startIndex.value, __startIndex.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}endIndex uses Python identifier endIndex
    __endIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'endIndex'), 'endIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesendIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 57, 3), )

    
    endIndex = property(__endIndex.value, __endIndex.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}startDateTimeIndex uses Python identifier startDateTimeIndex
    __startDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'startDateTimeIndex'), 'startDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesstartDateTimeIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 62, 3), )

    
    startDateTimeIndex = property(__startDateTimeIndex.value, __startDateTimeIndex.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}endDateTimeIndex uses Python identifier endDateTimeIndex
    __endDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'endDateTimeIndex'), 'endDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesendDateTimeIndex', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 67, 3), )

    
    endDateTimeIndex = property(__endDateTimeIndex.value, __endDateTimeIndex.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}mnemonics uses Python identifier mnemonics
    __mnemonics = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mnemonics'), 'mnemonics', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesmnemonics', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 72, 3), )

    
    mnemonics = property(__mnemonics.value, __mnemonics.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 77, 3), )

    
    extensionNameValue = property(__extensionNameValue.value, __extensionNameValue.set, None, u'See the API specification for a description of the use of this data.')

    
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_changeHistory_uid', uidString)
    ...
    _ElementMap = {
        __dTimChange.name() : __dTimChange,
        __changeType.name() : __changeType,
        __objectGrowingState.name() : __objectGrowingState,
        __updatedHeader.name() : __updatedHeader,
        __changeInfo.name() : __changeInfo,
        ...
        __mnemonics.name() : __mnemonics,
        __extensionNameValue.name() : __extensionNameValue
    }
    _AttributeMap = {
        __uid.name() : __uid
    }
Namespace.addCategoryObject('typeBinding', u'cs_changeHistory', cs_changeHistory)
...
# Complex type {http://www.witsml.org/schemas/1series}obj_changeLog with content type ELEMENT_ONLY
class obj_changeLog (pyxb.binding.basis.complexTypeDefinition):
    """Defines the singular change log data type."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_changeLog')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 73, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}sourceName uses Python identifier sourceName
    __sourceName = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sourceName'), 'sourceName', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriessourceName', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 26, 3), )

    
    sourceName = property(__sourceName.value, __sourceName.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}lastChangeType uses Python identifier lastChangeType
    __lastChangeType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'lastChangeType'), 'lastChangeType', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1serieslastChangeType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 31, 3), )

    
    lastChangeType = property(__lastChangeType.value, __lastChangeType.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}lastChangeInfo uses Python identifier lastChangeInfo
    __lastChangeInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'lastChangeInfo'), 'lastChangeInfo', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1serieslastChangeInfo', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 37, 3), )

    
    lastChangeInfo = property(__lastChangeInfo.value, __lastChangeInfo.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}changeHistory uses Python identifier changeHistory
    __changeHistory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'changeHistory'), 'changeHistory', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1serieschangeHistory', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 42, 3), )

    
    changeHistory = property(__changeHistory.value, __changeHistory.set, None, u'See the API specification for a description of the use of this data.')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 79, 3), )

    
    nameWell = property(__nameWell.value, __nameWell.set, None, u'Human recognizable contextual name for a Well.\n\t\t\t\t\tThis should match the value of element nameWell in the changed object.\n\t\t\t\t\tIf the changed object is well then this value will not be defined.\n\t\t\t\t\tThis is required for objects which are a direct or indirect child of a well.')

    
    # Element {http://www.witsml.org/schemas/1series}nameWellbore uses Python identifier nameWellbore
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 87, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, u'Human recognizable contextual name for the Wellbore.\n\t\t\t\t\tThis should match the value of element nameWellbore in the changed object.\n\t\t\t\t\tIf the changed object is well or wellbore then this value will not be defined.\n\t\t\t\t\tThis is required for objects which are a direct or indirect child of a wellbore.')

    
    # Element {http://www.witsml.org/schemas/1series}nameObject uses Python identifier nameObject
    __nameObject = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameObject'), 'nameObject', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesnameObject', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 95, 3), )

    
    nameObject = property(__nameObject.value, __nameObject.set, None, u'Human recognizable contextual name for the object.\n\t\t\t\t\tThis should match the value of the name element in the changed object.')

    
    # Element {http://www.witsml.org/schemas/1series}objectType uses Python identifier objectType
    __objectType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectType'), 'objectType', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesobjectType', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 101, 3), )

    
    objectType = property(__objectType.value, __objectType.set, None, u'The schema name of the (singular) object that changed. For example, "trajectory".')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 111, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 117, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_changeLog_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_changeLog_uidWell', uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 124, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 124, 2)
    
    uidWell = property(__uidWell.value, __uidWell.set, None, u'Unique identifier for the well.\n\t\t\t\tThis should match the value of the uidWell attribute in the changed object.\n\t\t\t\tIf the changed object is well then this value will not be defined.\n\t\t\t\tThis is required for objects which are a direct or indirect child of a well.')

    
    # Attribute uidWellbore uses Python identifier uidWellbore
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_changeLog_uidWellbore', uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 132, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 132, 2)
    
    uidWellbore = property(__uidWellbore.value, __uidWellbore.set, None, u'Unique identifier for the wellbore.\n\t\t\t\tThis should match the value of the uidWellbore attribute in the changed object.\n\t\t\t\tIf the changed object is well or wellbore then this value will not be defined.\n\t\t\t\tThis is required for objects which are a direct or indirect child of a well or wellbore.')

    
    # Attribute uidObject uses Python identifier uidObject
    __uidObject = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidObject'), 'uidObject', '__httpwww_witsml_orgschemas1series_obj_changeLog_uidObject', uidString, required=True)
    __uidObject._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 140, 2)
    __uidObject._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 140, 2)
    
    uidObject = property(__uidObject.value, __uidObject.set, None, u'Unique identifier for the changed object.\n\t\t\t\tThis should match the value of the uid attribute in the changed object.')


    _ElementMap = {
        __sourceName.name() : __sourceName,
        __lastChangeType.name() : __lastChangeType,
        __lastChangeInfo.name() : __lastChangeInfo,
        __changeHistory.name() : __changeHistory,
        __nameWell.name() : __nameWell,
        __nameWellbore.name() : __nameWellbore,
        __nameObject.name() : __nameObject,
    ...
    _AttributeMap = {
        ...
        __uidObject.name() : __uidObject
    }
Namespace.addCategoryObject('typeBinding', u'obj_changeLog', obj_changeLog)
...
changeLogs = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'changeLogs'), obj_changeLogs, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 35, 1))
Namespace.addCategoryObject('elementBinding', changeLogs.name().localName(), changeLogs)
...
obj_changeLogs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_changeLogs, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 51, 5)))

obj_changeLogs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'changeLog'), obj_changeLog, scope=obj_changeLogs, documentation=u'Defines a singular changeLog object.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 56, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 51, 5))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 56, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLogs._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 51, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLogs._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'changeLog')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 56, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
obj_changeLogs._Automaton = _BuildAutomaton_6()




cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimChange'), timestamp, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 27, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'changeType'), ChangeInfoType, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 32, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectGrowingState'), logicalBoolean, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 37, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'updatedHeader'), logicalBoolean, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 42, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'changeInfo'), commentString, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 47, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'startIndex'), genericMeasure, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 52, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'endIndex'), genericMeasure, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 57, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'startDateTimeIndex'), timestamp, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 62, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'endDateTimeIndex'), timestamp, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 67, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mnemonics'), commentString, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 72, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), cs_extensionNameValue, scope=cs_changeHistory, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 77, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 37, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 42, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 47, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 52, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 57, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 62, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 67, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 72, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 77, 3))
    counters.add(cc_8)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimChange')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'changeType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectGrowingState')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'updatedHeader')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'changeInfo')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 47, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'startIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 52, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'endIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 57, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'startDateTimeIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 62, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'endDateTimeIndex')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 67, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mnemonics')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 72, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_changeHistory.xsd', 77, 3))
    ...
    st_10._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_changeHistory._Automaton = _BuildAutomaton_7()
...
obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sourceName'), nameString, scope=obj_changeLog, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 26, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lastChangeType'), ChangeInfoType, scope=obj_changeLog, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 31, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lastChangeInfo'), commentString, scope=obj_changeLog, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 37, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'changeHistory'), cs_changeHistory, scope=obj_changeLog, documentation=u'See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 42, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_changeLog, documentation=u'Human recognizable contextual name for a Well.\n\t\t\t\t\tThis should match the value of element nameWell in the changed object.\n\t\t\t\t\tIf the changed object is well then this value will not be defined.\n\t\t\t\t\tThis is required for objects which are a direct or indirect child of a well.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 79, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_changeLog, documentation=u'Human recognizable contextual name for the Wellbore.\n\t\t\t\t\tThis should match the value of element nameWellbore in the changed object.\n\t\t\t\t\tIf the changed object is well or wellbore then this value will not be defined.\n\t\t\t\t\tThis is required for objects which are a direct or indirect child of a wellbore.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 87, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameObject'), nameString, scope=obj_changeLog, documentation=u'Human recognizable contextual name for the object.\n\t\t\t\t\tThis should match the value of the name element in the changed object.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 95, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectType'), nameString, scope=obj_changeLog, documentation=u'The schema name of the (singular) object that changed. For example, "trajectory".', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 101, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_changeLog, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 111, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_changeLog, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 117, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 26, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 37, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 42, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 79, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 87, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 106, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 111, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 117, 3))
    counters.add(cc_7)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sourceName')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lastChangeType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lastChangeInfo')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'changeHistory')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_changeLog.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 79, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 87, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameObject')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 95, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectType')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 101, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 111, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_changeLog.xsd', 117, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_changeLog._Automaton = _BuildAutomaton_11()


changeLogs._setSubstitutionGroup(_abs.abstractDataObject)
