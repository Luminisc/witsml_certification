# .\witsml1410_obj_message.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2013-06-21 14:42:28.082000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b35df170-daaa-11e2-8c92-08002718187b')
...
class obj_messages (_abs.abstractObject):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_messages')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_messages_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 48, 5), )
    ...
    __message = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'message'), 'message', '__httpwww_witsml_orgschemas1series_obj_messages_httpwww_witsml_orgschemas1seriesmessage', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 53, 5), )

    
    message = property(__message.value, __message.set, None, 'A single message.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_messages_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 59, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 59, 4)
...
Namespace.addCategoryObject('typeBinding', 'obj_messages', obj_messages)
...
class obj_message (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_message')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 70, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}objectReference uses Python identifier objectReference
    __objectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), 'objectReference', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesobjectReference', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 25, 3), )
    ...
    __subObjectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'subObjectReference'), 'subObjectReference', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriessubObjectReference', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 31, 3), )

    
    subObjectReference = property(__subObjectReference.value, __subObjectReference.set, None, 'A reference to an sub-object that is defined within the \n\t\t\t\t\tcontext of the object referenced by objectReference.\n\t\t\t\t\tThis should only refer to recurring components of a growing object.')

    
    # Element {http://www.witsml.org/schemas/1series}dTim uses Python identifier dTim
    __dTim = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTim'), 'dTim', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesdTim', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 38, 3), )
    ...
    __activityCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'activityCode'), 'activityCode', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesactivityCode', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 43, 3), )

    
    activityCode = property(__activityCode.value, __activityCode.set, None, 'A code used to define rig activity.')

    
    # Element {http://www.witsml.org/schemas/1series}detailActivity uses Python identifier detailActivity
    __detailActivity = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'detailActivity'), 'detailActivity', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesdetailActivity', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 48, 3), )

    
    detailActivity = property(__detailActivity.value, __detailActivity.set, None, 'Custom string to further define an activity.  ')

    
    # Element {http://www.witsml.org/schemas/1series}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'md'), 'md', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesmd', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 53, 3), )
    ...
    __mdBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBit'), 'mdBit', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesmdBit', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 58, 3), )

    
    mdBit = property(__mdBit.value, __mdBit.set, None, 'Along hole measured depth of measurement from the drill datum.  ')

    
    # Element {http://www.witsml.org/schemas/1series}typeMessage uses Python identifier typeMessage
    __typeMessage = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeMessage'), 'typeMessage', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriestypeMessage', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 63, 3), )

    
    typeMessage = property(__typeMessage.value, __typeMessage.set, None, 'Message type.  ')

    
    # Element {http://www.witsml.org/schemas/1series}messageText uses Python identifier messageText
    __messageText = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'messageText'), 'messageText', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesmessageText', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 68, 3), )

    
    messageText = property(__messageText.value, __messageText.set, None, 'Message text. ')

    
    # Element {http://www.witsml.org/schemas/1series}param uses Python identifier param
    __param = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'param'), 'param', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesparam', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 73, 3), )

    
    param = property(__param.value, __param.set, None, 'Any extra numeric data.\n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.')

    
    # Element {http://www.witsml.org/schemas/1series}severity uses Python identifier severity
    __severity = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'severity'), 'severity', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesseverity', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 81, 3), )

    
    severity = property(__severity.value, __severity.set, None, 'Severity of incident.  ')

    
    # Element {http://www.witsml.org/schemas/1series}warnProbability uses Python identifier warnProbability
    __warnProbability = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'warnProbability'), 'warnProbability', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1serieswarnProbability', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 86, 3), )

    
    warnProbability = property(__warnProbability.value, __warnProbability.set, None, 'A warning probability (applies to warning).')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 72, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 77, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, 'Human recognizable context for the wellbore that contains the message.  ')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 82, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 92, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_message_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 98, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_message_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_message_uidWell', uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 105, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 105, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_message_uidWellbore', uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 112, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 112, 2)
...
Namespace.addCategoryObject('typeBinding', 'obj_message', obj_message)
...
messages = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'messages'), obj_messages, documentation='The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 32, 1))
...
obj_messages._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_messages, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 48, 5)))

obj_messages._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'message'), obj_message, scope=obj_messages, documentation='A single message.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_messages._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_messages._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'message')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), refObjectString, scope=obj_message, documentation='A reference to an object that is defined within the \n\t\t\t\t\tcontext of a wellbore.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 25, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'subObjectReference'), refObjectString, scope=obj_message, documentation='A reference to an sub-object that is defined within the \n\t\t\t\t\tcontext of the object referenced by objectReference.\n\t\t\t\t\tThis should only refer to recurring components of a growing object.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 31, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTim'), timestamp, scope=obj_message, documentation='Date and time the information is related to.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 38, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'activityCode'), ActivityCode, scope=obj_message, documentation='A code used to define rig activity.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 43, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'detailActivity'), str32, scope=obj_message, documentation='Custom string to further define an activity.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 48, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'md'), measuredDepthCoord, scope=obj_message, documentation='Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 53, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBit'), measuredDepthCoord, scope=obj_message, documentation='Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 58, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeMessage'), MessageType, scope=obj_message, documentation='Message type.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 63, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'messageText'), commentString, scope=obj_message, documentation='Message text. ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 68, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'param'), indexedObject, scope=obj_message, documentation='Any extra numeric data.\n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 73, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'severity'), MessageSeverity, scope=obj_message, documentation='Severity of incident.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 81, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'warnProbability'), MessageProbability, scope=obj_message, documentation='A warning probability (applies to warning).', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 86, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_message, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 72, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_message, documentation='Human recognizable context for the wellbore that contains the message.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 77, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_message, documentation='Human recognizable context for the risk.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 82, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_message, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 92, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_message, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 98, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 25, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 31, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 43, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 48, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 53, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 58, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 68, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 73, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 81, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 86, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 87, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 92, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 98, 3))
    counters.add(cc_12)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectReference')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'subObjectReference')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTim')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 38, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'activityCode')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 43, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'detailActivity')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 48, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'md')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 53, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBit')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 58, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeMessage')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 63, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'messageText')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 68, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'param')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 73, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'severity')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 81, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'warnProbability')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_message.xsd', 86, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 72, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 77, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 82, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 92, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_message.xsd', 98, 3))
