# .\witsml1410_obj_objectGroup.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2013-06-21 14:42:35.587000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b790778f-daaa-11e2-9405-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/1series}obj_objectGroups with content type ELEMENT_ONLY
class obj_objectGroups (_abs.abstractObject):
    """Complex type {http://www.witsml.org/schemas/1series}obj_objectGroups with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_objectGroups')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_objectGroups_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 45, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.')

    
    # Element {http://www.witsml.org/schemas/1series}objectGroup uses Python identifier objectGroup
    __objectGroup = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectGroup'), 'objectGroup', '__httpwww_witsml_orgschemas1series_obj_objectGroups_httpwww_witsml_orgschemas1seriesobjectGroup', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 50, 5), )

    
    objectGroup = property(__objectGroup.value, __objectGroup.set, None, u'A single objectGroup Object')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_objectGroups_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 56, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 56, 4)
    ...
    _ElementMap.update({
        ...
        __objectGroup.name() : __objectGroup
    })
    _AttributeMap = _abs.abstractObject._AttributeMap.copy()
    _AttributeMap.update({
        __version.name() : __version
    })
Namespace.addCategoryObject('typeBinding', u'obj_objectGroups', obj_objectGroups)
...
# Complex type {http://www.witsml.org/schemas/1series}cs_memberObject with content type ELEMENT_ONLY
class cs_memberObject (pyxb.binding.basis.complexTypeDefinition):
    """Defines a member of an objectGroup."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_memberObject')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 22, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}objectReference uses Python identifier objectReference
    __objectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectReference'), 'objectReference', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesobjectReference', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 28, 3), )

    
    objectReference = property(__objectReference.value, __objectReference.set, None, u'A reference to an object that is defined within the \n\t\t\t\t\tcontext of the specified wellbore.')

    
    # Element {http://www.witsml.org/schemas/1series}indexType uses Python identifier indexType
    __indexType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'indexType'), 'indexType', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesindexType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 34, 3), )

    
    indexType = property(__indexType.value, __indexType.set, None, u'For a log object, this specifies the kind of the index curve for the log.\n\t\t\t\t\tThis is only relevant for a systematically growing object.')

    
    # Element {http://www.witsml.org/schemas/1series}sequence1 uses Python identifier sequence1
    __sequence1 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sequence1'), 'sequence1', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriessequence1', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 41, 4), )

    
    sequence1 = property(__sequence1.value, __sequence1.set, None, u'Defines primary numeric ordering of this object within the group.\n\t\t\t\t\t\tThe meaning of this order will be defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}sequence2 uses Python identifier sequence2
    __sequence2 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sequence2'), 'sequence2', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriessequence2', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 48, 5), )

    
    sequence2 = property(__sequence2.value, __sequence2.set, None, u'Defines secondary numeric ordering of this object within the group.\n\t\t\t\t\t\t\tThe meaning of this order will be defined by the groupType.\n\t\t\t\t\t\t\tA value for sequence2 can only be given if a value is given for sequence1.')

    
    # Element {http://www.witsml.org/schemas/1series}sequence3 uses Python identifier sequence3
    __sequence3 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sequence3'), 'sequence3', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriessequence3', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 56, 6), )

    
    sequence3 = property(__sequence3.value, __sequence3.set, None, u'Defines tertiary numeric ordering of this object within the group.\n\t\t\t\t\t\t\t\tThe meaning of this order will be defined by the groupType.\n\t\t\t\t\t\t\t\tA value for sequence3 can only be given if a value is given for sequence2.')

    
    # Element {http://www.witsml.org/schemas/1series}rangeMin uses Python identifier rangeMin
    __rangeMin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rangeMin'), 'rangeMin', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesrangeMin', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 66, 3), )

    
    rangeMin = property(__rangeMin.value, __rangeMin.set, None, u'The minimum growing-object index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}rangeMax uses Python identifier rangeMax
    __rangeMax = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rangeMax'), 'rangeMax', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesrangeMax', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 72, 3), )

    
    rangeMax = property(__rangeMax.value, __rangeMax.set, None, u'The maximum growing-object index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}rangeDateTimeMin uses Python identifier rangeDateTimeMin
    __rangeDateTimeMin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rangeDateTimeMin'), 'rangeDateTimeMin', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesrangeDateTimeMin', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 78, 3), )

    
    rangeDateTimeMin = property(__rangeDateTimeMin.value, __rangeDateTimeMin.set, None, u'The minimum log date-time index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}rangeDateTimeMax uses Python identifier rangeDateTimeMax
    __rangeDateTimeMax = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rangeDateTimeMax'), 'rangeDateTimeMax', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesrangeDateTimeMax', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 84, 3), )

    
    rangeDateTimeMax = property(__rangeDateTimeMax.value, __rangeDateTimeMax.set, None, u'The maximum log date-time index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}mnemonicList uses Python identifier mnemonicList
    __mnemonicList = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mnemonicList'), 'mnemonicList', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesmnemonicList', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 90, 3), )

    
    mnemonicList = property(__mnemonicList.value, __mnemonicList.set, None, u'A comma delimited list of log curve mnemonics.\n\t\t\t\t\tEach mnemonic should only occur once in the list.\n\t\t\t\t\tIf not specified then the group applies to all curves in the log.')

    
    # Element {http://www.witsml.org/schemas/1series}referenceDepth uses Python identifier referenceDepth
    __referenceDepth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'referenceDepth'), 'referenceDepth', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesreferenceDepth', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 97, 3), )

    
    referenceDepth = property(__referenceDepth.value, __referenceDepth.set, None, u'A measured depth related to this group. \n\t\t\t\t\tThis does not necessarily represent an actual depth within a growing-object.\n\t\t\t\t\tThe significance of this depth is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}referenceDateTime uses Python identifier referenceDateTime
    __referenceDateTime = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'referenceDateTime'), 'referenceDateTime', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesreferenceDateTime', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 104, 3), )

    
    referenceDateTime = property(__referenceDateTime.value, __referenceDateTime.set, None, u'A date and time related to this group. \n\t\t\t\t\tThis does not necessarily represent an actual index within a growing-object.\n\t\t\t\t\tThe significance of this time is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}param uses Python identifier param
    __param = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'param'), 'param', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesparam', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 111, 3), )

    
    param = property(__param.value, __param.set, None, u'Any extra parameter data related to the group. \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_memberObject_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 118, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_memberObject_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\attgrp_uid.xsd', 22, 2)
    ...
    _ElementMap = {
        ...
        __sequence3.name() : __sequence3,
        __rangeMin.name() : __rangeMin,
        __rangeMax.name() : __rangeMax,
        __rangeDateTimeMin.name() : __rangeDateTimeMin,
        __rangeDateTimeMax.name() : __rangeDateTimeMax,
        __mnemonicList.name() : __mnemonicList,
        __referenceDepth.name() : __referenceDepth,
        __referenceDateTime.name() : __referenceDateTime,
...
Namespace.addCategoryObject('typeBinding', u'cs_memberObject', cs_memberObject)


# Complex type {http://www.witsml.org/schemas/1series}obj_objectGroup with content type ELEMENT_ONLY
class obj_objectGroup (pyxb.binding.basis.complexTypeDefinition):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_objectGroup')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 67, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}groupType uses Python identifier groupType
    __groupType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'groupType'), 'groupType', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesgroupType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 27, 3), )

    
    groupType = property(__groupType.value, __groupType.set, None, u'Defines the type of group.')

    
    # Element {http://www.witsml.org/schemas/1series}sequence uses Python identifier sequence
    __sequence = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sequence'), 'sequence', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriessequence', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 32, 3), )

    
    sequence = property(__sequence.value, __sequence.set, None, u'The sequence number related to the group. \n\t\t\t\t\tThe meaning of the sequence is defined by the groupType.')

    
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 38, 3), )

    
    description = property(__description.value, __description.set, None, u'A description of attachment')

    
    # Element {http://www.witsml.org/schemas/1series}param uses Python identifier param
    __param = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'param'), 'param', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesparam', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 43, 3), )

    
    param = property(__param.value, __param.set, None, u'Any extra parameter data. \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.')

    
    # Element {http://www.witsml.org/schemas/1series}memberObject uses Python identifier memberObject
    __memberObject = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'memberObject'), 'memberObject', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesmemberObject', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 50, 3), )

    
    memberObject = property(__memberObject.value, __memberObject.set, None, u'References a specific data-object that is a member of this group.')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 72, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 77, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, u'Human recognizable context for the wellbore that contains the (sub) object\n\t\t\t\t\tthat is represented by the objectGroup. If no wellbore is specified then the objectGroup\n\t\t\t\t\trepresents the well. If a wellbore is specified but no other object is specified then the \n\t\t\t\t\tobjectGroup represents the wellbore.')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 85, 3), )

    
    name = property(__name.value, __name.set, None, u'Human recognizable context for the objectGroup.')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 95, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 101, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_objectGroup_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_objectGroup_uidWell', uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 108, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 108, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_objectGroup_uidWellbore', uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 114, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 114, 2)
    ...
    _ElementMap = {
        __groupType.name() : __groupType,
        __sequence.name() : __sequence,
        __description.name() : __description,
        __param.name() : __param,
        __memberObject.name() : __memberObject,
...
Namespace.addCategoryObject('typeBinding', u'obj_objectGroup', obj_objectGroup)
...
objectGroups = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectGroups'), obj_objectGroups, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 32, 1))
Namespace.addCategoryObject('elementBinding', objectGroups.name().localName(), objectGroups)
...
obj_objectGroups._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_objectGroups, documentation=u'Information about the XML message instance.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 45, 5)))

obj_objectGroups._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectGroup'), obj_objectGroup, scope=obj_objectGroups, documentation=u'A single objectGroup Object', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 50, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 45, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroups._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 45, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_objectGroups._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectGroup')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 50, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_objectGroups._Automaton = _BuildAutomaton_6()
...
cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectReference'), refObjectString, scope=cs_memberObject, documentation=u'A reference to an object that is defined within the \n\t\t\t\t\tcontext of the specified wellbore.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 28, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'indexType'), LogIndexType, scope=cs_memberObject, documentation=u'For a log object, this specifies the kind of the index curve for the log.\n\t\t\t\t\tThis is only relevant for a systematically growing object.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 34, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sequence1'), objectSequence, scope=cs_memberObject, documentation=u'Defines primary numeric ordering of this object within the group.\n\t\t\t\t\t\tThe meaning of this order will be defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 41, 4)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sequence2'), objectSequence, scope=cs_memberObject, documentation=u'Defines secondary numeric ordering of this object within the group.\n\t\t\t\t\t\t\tThe meaning of this order will be defined by the groupType.\n\t\t\t\t\t\t\tA value for sequence2 can only be given if a value is given for sequence1.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 48, 5)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sequence3'), objectSequence, scope=cs_memberObject, documentation=u'Defines tertiary numeric ordering of this object within the group.\n\t\t\t\t\t\t\t\tThe meaning of this order will be defined by the groupType.\n\t\t\t\t\t\t\t\tA value for sequence3 can only be given if a value is given for sequence2.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 56, 6)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rangeMin'), genericMeasure, scope=cs_memberObject, documentation=u'The minimum growing-object index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 66, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rangeMax'), genericMeasure, scope=cs_memberObject, documentation=u'The maximum growing-object index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 72, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rangeDateTimeMin'), timestamp, scope=cs_memberObject, documentation=u'The minimum log date-time index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 78, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rangeDateTimeMax'), timestamp, scope=cs_memberObject, documentation=u'The maximum log date-time index value that applies to this group.\n\t\t\t\t\tThe significance of this range is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 84, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mnemonicList'), pyxb.binding.datatypes.string, scope=cs_memberObject, documentation=u'A comma delimited list of log curve mnemonics.\n\t\t\t\t\tEach mnemonic should only occur once in the list.\n\t\t\t\t\tIf not specified then the group applies to all curves in the log.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 90, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'referenceDepth'), measuredDepthCoord, scope=cs_memberObject, documentation=u'A measured depth related to this group. \n\t\t\t\t\tThis does not necessarily represent an actual depth within a growing-object.\n\t\t\t\t\tThe significance of this depth is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 97, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'referenceDateTime'), timestamp, scope=cs_memberObject, documentation=u'A date and time related to this group. \n\t\t\t\t\tThis does not necessarily represent an actual index within a growing-object.\n\t\t\t\t\tThe significance of this time is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 104, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'param'), indexedObject, scope=cs_memberObject, documentation=u'Any extra parameter data related to the group. \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 111, 3)))

cs_memberObject._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue'), cs_extensionNameValue, scope=cs_memberObject, documentation=u'Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 118, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 34, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 40, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 47, 4))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 55, 5))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 66, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 72, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 78, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 84, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 90, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 97, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 104, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 111, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 118, 3))
    counters.add(cc_12)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectReference')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'indexType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 34, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sequence1')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 41, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sequence2')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 48, 5))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sequence3')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 56, 6))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rangeMin')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 66, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rangeMax')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 72, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rangeDateTimeMin')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 78, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rangeDateTimeMax')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 84, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mnemonicList')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 90, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'referenceDepth')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 97, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'referenceDateTime')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 104, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'param')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 111, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_memberObject._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'extensionNameValue')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\cs_memberObject.xsd', 118, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
cs_memberObject._Automaton = _BuildAutomaton_10()




obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'groupType'), ObjectGroupKind, scope=obj_objectGroup, documentation=u'Defines the type of group.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 27, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sequence'), positiveCount, scope=obj_objectGroup, documentation=u'The sequence number related to the group. \n\t\t\t\t\tThe meaning of the sequence is defined by the groupType.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 32, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'description'), commentString, scope=obj_objectGroup, documentation=u'A description of attachment', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 38, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'param'), indexedObject, scope=obj_objectGroup, documentation=u'Any extra parameter data. \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 43, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'memberObject'), cs_memberObject, scope=obj_objectGroup, documentation=u'References a specific data-object that is a member of this group.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 50, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_objectGroup, documentation=u'Human recognizable context for the well that contains the wellbore.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 72, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_objectGroup, documentation=u'Human recognizable context for the wellbore that contains the (sub) object\n\t\t\t\t\tthat is represented by the objectGroup. If no wellbore is specified then the objectGroup\n\t\t\t\t\trepresents the well. If a wellbore is specified but no other object is specified then the \n\t\t\t\t\tobjectGroup represents the wellbore.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 77, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_objectGroup, documentation=u'Human recognizable context for the objectGroup.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 85, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_objectGroup, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 95, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_objectGroup, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 101, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 32, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 38, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 43, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 90, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 95, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 101, 3))
    counters.add(cc_5)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'groupType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sequence')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'description')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 38, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'param')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 43, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'memberObject')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_objectGroup.xsd', 50, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 72, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 77, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 85, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 95, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_objectGroup.xsd', 101, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_objectGroup._Automaton = _BuildAutomaton_11()


objectGroups._setSubstitutionGroup(_abs.abstractDataObject)
