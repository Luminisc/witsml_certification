# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1410/witsml1410_obj_objectGroup.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:08:58.622697 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:2facd8bf-fd5b-40c4-b606-2f742bb543f4')
...
class obj_objectGroup (pyxb.binding.basis.complexTypeDefinition):
    ...
    __sequence = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sequence'), 'sequence', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriessequence', False, pyxb.utils.utility.Location('grp_objectGroup.xsd', 32, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('grp_objectGroup.xsd', 38, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}param uses Python identifier param
    __param = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'param'), 'param', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesparam', True, pyxb.utils.utility.Location('grp_objectGroup.xsd', 43, 3), )
    ...
    __memberObject = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'memberObject'), 'memberObject', '__httpwww_witsml_orgschemas1series_obj_objectGroup_httpwww_witsml_orgschemas1seriesmemberObject', True, pyxb.utils.utility.Location('grp_objectGroup.xsd', 50, 3), )
...
obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'groupType'), ObjectGroupKind, scope=obj_objectGroup, documentation='Defines the type of group.', location=pyxb.utils.utility.Location('grp_objectGroup.xsd', 27, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sequence'), positiveCount, scope=obj_objectGroup, documentation='The sequence number related to the group. \n\t\t\t\t\tThe meaning of the sequence is defined by the groupType.', location=pyxb.utils.utility.Location('grp_objectGroup.xsd', 32, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=obj_objectGroup, documentation='A description of attachment', location=pyxb.utils.utility.Location('grp_objectGroup.xsd', 38, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'param'), indexedObject, scope=obj_objectGroup, documentation='Any extra parameter data. \n\t\t\t\t\tFor this usage the name attribute MUST be specified because it represents the meaning of the data.\n\t\t\t\t\tWhile the index attribute is mandatory, it is only significant if the same name repeats.', location=pyxb.utils.utility.Location('grp_objectGroup.xsd', 43, 3)))

obj_objectGroup._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'memberObject'), cs_memberObject, scope=obj_objectGroup, documentation='References a specific data-object that is a member of this group.', location=pyxb.utils.utility.Location('grp_objectGroup.xsd', 50, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_objectGroup.xsd', 43, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_objectGroup.xsd', 95, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_objectGroup.xsd', 101, 3))
    counters.add(cc_5)
    states = []
    final_update = None
    ...
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sequence')), pyxb.utils.utility.Location('grp_objectGroup.xsd', 32, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('grp_objectGroup.xsd', 38, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'param')), pyxb.utils.utility.Location('grp_objectGroup.xsd', 43, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_objectGroup._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'memberObject')), pyxb.utils.utility.Location('grp_objectGroup.xsd', 50, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
