# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1410/witsml1410_obj_formationMarker.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:08:37.810727 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:a52f49f9-e0a1-4230-991f-3e71c4c98818')
...
class obj_formationMarker (pyxb.binding.basis.complexTypeDefinition):
    ...
    __nameFormation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), 'nameFormation', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameFormation', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 85, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 90, 3), )
...
obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed'), lengthMeasure, scope=obj_formationMarker, documentation='Bed Thickness.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 45, 3)))
...
obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen'), lengthMeasure, scope=obj_formationMarker, documentation='Perpendicular thickness.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 55, 3)))
...
obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic'), str32, scope=obj_formationMarker, documentation='Chronostratigraphic classification.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 80, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), str32, scope=obj_formationMarker, documentation='Formation name.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 85, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=obj_formationMarker, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 90, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 85, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 90, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 92, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 98, 3))
    counters.add(cc_15)
    states = []
    final_update = None
    ...
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 80, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameFormation')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 85, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 90, 3))
