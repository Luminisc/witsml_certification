# .\witsml1410_obj_formationMarker.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2013-06-21 14:42:21.696000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:af91f54f-daaa-11e2-8f8b-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/1series}obj_formationMarkers with content type ELEMENT_ONLY
class obj_formationMarkers (_abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_formationMarkers')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_formationMarkers_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 48, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}formationMarker uses Python identifier formationMarker
    __formationMarker = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'formationMarker'), 'formationMarker', '__httpwww_witsml_orgschemas1series_obj_formationMarkers_httpwww_witsml_orgschemas1seriesformationMarker', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 53, 5), )

    
    formationMarker = property(__formationMarker.value, __formationMarker.set, None, u'A single formation marker.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_formationMarkers_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 59, 4)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 59, 4)
    ...
    _ElementMap.update({
        ...
        __formationMarker.name() : __formationMarker
    })
    _AttributeMap = _abs.abstractObject._AttributeMap.copy()
    _AttributeMap.update({
        __version.name() : __version
    })
Namespace.addCategoryObject('typeBinding', u'obj_formationMarkers', obj_formationMarkers)
...
# Complex type {http://www.witsml.org/schemas/1series}obj_formationMarker with content type ELEMENT_ONLY
class obj_formationMarker (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/1series}obj_formationMarker with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_formationMarker')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 70, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mdPrognosed uses Python identifier mdPrognosed
    __mdPrognosed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdPrognosed'), 'mdPrognosed', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesmdPrognosed', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 25, 3), )

    
    mdPrognosed = property(__mdPrognosed.value, __mdPrognosed.set, None, u'Prognosed measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tvdPrognosed uses Python identifier tvdPrognosed
    __tvdPrognosed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdPrognosed'), 'tvdPrognosed', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriestvdPrognosed', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 30, 3), )

    
    tvdPrognosed = property(__tvdPrognosed.value, __tvdPrognosed.set, None, u'Prognosed true vertical depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdTopSample uses Python identifier mdTopSample
    __mdTopSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdTopSample'), 'mdTopSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesmdTopSample', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 35, 3), )

    
    mdTopSample = property(__mdTopSample.value, __mdTopSample.set, None, u'Sampled measured depth at top of marker.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tvdTopSample uses Python identifier tvdTopSample
    __tvdTopSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdTopSample'), 'tvdTopSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriestvdTopSample', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 40, 3), )

    
    tvdTopSample = property(__tvdTopSample.value, __tvdTopSample.set, None, u'Sampled true vertical depth at top of marker.  ')

    
    # Element {http://www.witsml.org/schemas/1series}thicknessBed uses Python identifier thicknessBed
    __thicknessBed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'thicknessBed'), 'thicknessBed', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesthicknessBed', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 45, 3), )

    
    thicknessBed = property(__thicknessBed.value, __thicknessBed.set, None, u'Bed Thickness.  ')

    
    # Element {http://www.witsml.org/schemas/1series}thicknessApparent uses Python identifier thicknessApparent
    __thicknessApparent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'thicknessApparent'), 'thicknessApparent', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesthicknessApparent', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 50, 3), )

    
    thicknessApparent = property(__thicknessApparent.value, __thicknessApparent.set, None, u'Formation exposed along the wellbore.  ')

    
    # Element {http://www.witsml.org/schemas/1series}thicknessPerpen uses Python identifier thicknessPerpen
    __thicknessPerpen = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'thicknessPerpen'), 'thicknessPerpen', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesthicknessPerpen', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 55, 3), )

    
    thicknessPerpen = property(__thicknessPerpen.value, __thicknessPerpen.set, None, u'Perpendicular thickness.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdLogSample uses Python identifier mdLogSample
    __mdLogSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdLogSample'), 'mdLogSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesmdLogSample', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 60, 3), )

    
    mdLogSample = property(__mdLogSample.value, __mdLogSample.set, None, u'Logged measured depth at top of marker.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tvdLogSample uses Python identifier tvdLogSample
    __tvdLogSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdLogSample'), 'tvdLogSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriestvdLogSample', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 65, 3), )

    
    tvdLogSample = property(__tvdLogSample.value, __tvdLogSample.set, None, u'Logged true vertical depth at top of marker.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dip uses Python identifier dip
    __dip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dip'), 'dip', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdip', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 70, 3), )

    
    dip = property(__dip.value, __dip.set, None, u'Angle of dip with respect to horizontal.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dipDirection uses Python identifier dipDirection
    __dipDirection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dipDirection'), 'dipDirection', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdipDirection', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 75, 3), )

    
    dipDirection = property(__dipDirection.value, __dipDirection.set, None, u'Interpreted downdip direction.  ')

    
    # Element {http://www.witsml.org/schemas/1series}chronostratigraphic uses Python identifier chronostratigraphic
    __chronostratigraphic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'chronostratigraphic'), 'chronostratigraphic', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1serieschronostratigraphic', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 80, 3), )

    
    chronostratigraphic = property(__chronostratigraphic.value, __chronostratigraphic.set, None, u'Chronostratigraphic classification.  ')

    
    # Element {http://www.witsml.org/schemas/1series}nameFormation uses Python identifier nameFormation
    __nameFormation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameFormation'), 'nameFormation', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameFormation', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 85, 3), )

    
    nameFormation = property(__nameFormation.value, __nameFormation.set, None, u'Formation name.  ')

    
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 90, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 72, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 77, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, u'Human recognizable context for the wellbore that contains the formation marker.  ')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 82, 3), )

    
    name = property(__name.value, __name.set, None, u'Human recognizable context for the formation marker.  ')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 92, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 98, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_formationMarker_uid', uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_formationMarker_uidWell', uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 105, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 105, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_formationMarker_uidWellbore', uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 112, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 112, 2)
    ...
    _ElementMap = {
        __mdPrognosed.name() : __mdPrognosed,
        __tvdPrognosed.name() : __tvdPrognosed,
        __mdTopSample.name() : __mdTopSample,
        __tvdTopSample.name() : __tvdTopSample,
        __thicknessBed.name() : __thicknessBed,
        __thicknessApparent.name() : __thicknessApparent,
        __thicknessPerpen.name() : __thicknessPerpen,
        __mdLogSample.name() : __mdLogSample,
        __tvdLogSample.name() : __tvdLogSample,
        __dip.name() : __dip,
        __dipDirection.name() : __dipDirection,
        __chronostratigraphic.name() : __chronostratigraphic,
...
Namespace.addCategoryObject('typeBinding', u'obj_formationMarker', obj_formationMarker)
...
formationMarkers = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'formationMarkers'), obj_formationMarkers, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 32, 1))
Namespace.addCategoryObject('elementBinding', formationMarkers.name().localName(), formationMarkers)
...
obj_formationMarkers._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_formationMarkers, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 48, 5)))

obj_formationMarkers._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'formationMarker'), obj_formationMarker, scope=obj_formationMarkers, documentation=u'A single formation marker.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarkers._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_formationMarkers._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'formationMarker')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_formationMarkers._Automaton = _BuildAutomaton_6()
...
obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdPrognosed'), measuredDepthCoord, scope=obj_formationMarker, documentation=u'Prognosed measured depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 25, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdPrognosed'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation=u'Prognosed true vertical depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 30, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdTopSample'), measuredDepthCoord, scope=obj_formationMarker, documentation=u'Sampled measured depth at top of marker.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 35, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdTopSample'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation=u'Sampled true vertical depth at top of marker.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 40, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'thicknessBed'), lengthMeasure, scope=obj_formationMarker, documentation=u'Bed Thickness.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 45, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'thicknessApparent'), lengthMeasure, scope=obj_formationMarker, documentation=u'Formation exposed along the wellbore.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 50, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'thicknessPerpen'), lengthMeasure, scope=obj_formationMarker, documentation=u'Perpendicular thickness.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 55, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdLogSample'), measuredDepthCoord, scope=obj_formationMarker, documentation=u'Logged measured depth at top of marker.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 60, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdLogSample'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation=u'Logged true vertical depth at top of marker.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 65, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dip'), planeAngleMeasure, scope=obj_formationMarker, documentation=u'Angle of dip with respect to horizontal.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 70, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dipDirection'), planeAngleMeasure, scope=obj_formationMarker, documentation=u'Interpreted downdip direction.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 75, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'chronostratigraphic'), str32, scope=obj_formationMarker, documentation=u'Chronostratigraphic classification.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 80, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameFormation'), str32, scope=obj_formationMarker, documentation=u'Formation name.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 85, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'description'), commentString, scope=obj_formationMarker, documentation=u'Description of item and details.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 90, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_formationMarker, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 72, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_formationMarker, documentation=u'Human recognizable context for the wellbore that contains the formation marker.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 77, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_formationMarker, documentation=u'Human recognizable context for the formation marker.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 82, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_formationMarker, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 92, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_formationMarker, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 98, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 25, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 30, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 40, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 45, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 50, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 55, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 60, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 65, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 70, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 75, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 80, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 85, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 90, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 87, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 92, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 98, 3))
    counters.add(cc_15)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdPrognosed')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdPrognosed')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 30, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdTopSample')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdTopSample')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 40, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'thicknessBed')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 45, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'thicknessApparent')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 50, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'thicknessPerpen')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 55, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdLogSample')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 60, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdLogSample')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 65, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dip')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 70, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dipDirection')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 75, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'chronostratigraphic')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 80, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameFormation')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 85, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'description')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\grp_formationMarker.xsd', 90, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 72, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 77, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 82, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 92, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.4.1.0_Data_Schema\\witsml_v1.4.1_data\\xsd_schemas\\obj_formationMarker.xsd', 98, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
obj_formationMarker._Automaton = _BuildAutomaton_10()


formationMarkers._setSubstitutionGroup(_abs.abstractDataObject)
