# .\witsml1311_obj_wbGeometry.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2013-06-21 14:47:18.765000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:60d830e1-daab-11e2-9984-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/131}obj_wbGeometrys with content type ELEMENT_ONLY
class obj_wbGeometrys (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_wbGeometrys with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_wbGeometrys')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 33, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_wbGeometrys_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 35, 3), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/131}wbGeometry uses Python identifier wbGeometry
    __wbGeometry = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wbGeometry'), 'wbGeometry', '__httpwww_witsml_orgschemas131_obj_wbGeometrys_httpwww_witsml_orgschemas131wbGeometry', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 40, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas131_obj_wbGeometrys_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 46, 2)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 46, 2)
...
# Complex type {http://www.witsml.org/schemas/131}cs_wbGeometrySection with content type ELEMENT_ONLY
class cs_wbGeometrySection (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 19, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}typeHoleCasing uses Python identifier typeHoleCasing
    __typeHoleCasing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'typeHoleCasing'), 'typeHoleCasing', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131typeHoleCasing', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 27, 3), )
    ...
    __mdTop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdTop'), 'mdTop', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131mdTop', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 32, 3), )
    ...
    __mdBottom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdBottom'), 'mdBottom', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131mdBottom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 37, 3), )

    
    mdBottom = property(__mdBottom.value, __mdBottom.set, None, u'Measured depth at bottom of the section.  ')

    
    # Element {http://www.witsml.org/schemas/131}tvdTop uses Python identifier tvdTop
    __tvdTop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdTop'), 'tvdTop', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131tvdTop', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 42, 3), )

    
    tvdTop = property(__tvdTop.value, __tvdTop.set, None, u'True vertical depth at top of the section.  ')

    
    # Element {http://www.witsml.org/schemas/131}tvdBottom uses Python identifier tvdBottom
    __tvdBottom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvdBottom'), 'tvdBottom', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131tvdBottom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 47, 3), )

    
    tvdBottom = property(__tvdBottom.value, __tvdBottom.set, None, u'True vertical depth at bottom of the section.  ')

    
    # Element {http://www.witsml.org/schemas/131}idSection uses Python identifier idSection
    __idSection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'idSection'), 'idSection', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131idSection', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 52, 3), )

    
    idSection = property(__idSection.value, __idSection.set, None, u'Inner diameter.  ')

    
    # Element {http://www.witsml.org/schemas/131}odSection uses Python identifier odSection
    __odSection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'odSection'), 'odSection', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131odSection', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 57, 3), )
    ...
    __wtPerLen = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wtPerLen'), 'wtPerLen', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131wtPerLen', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 62, 3), )
    ...
    __grade = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'grade'), 'grade', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131grade', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 67, 3), )

    
    grade = property(__grade.value, __grade.set, None, u'Material grade for the tubular section.  ')

    
    # Element {http://www.witsml.org/schemas/131}curveConductor uses Python identifier curveConductor
    __curveConductor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'curveConductor'), 'curveConductor', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131curveConductor', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 72, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}diaDrift uses Python identifier diaDrift
    __diaDrift = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'diaDrift'), 'diaDrift', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131diaDrift', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 77, 3), )
    ...
    __factFric = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'factFric'), 'factFric', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_httpwww_witsml_orgschemas131factFric', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 82, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_wbGeometrySection_uid', uidString)
...
# Complex type {http://www.witsml.org/schemas/131}obj_wbGeometry with content type ELEMENT_ONLY
class obj_wbGeometry (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 55, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}dTimReport uses Python identifier dTimReport
    __dTimReport = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimReport'), 'dTimReport', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131dTimReport', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 23, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}mdBottom uses Python identifier mdBottom
    __mdBottom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdBottom'), 'mdBottom', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131mdBottom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 28, 3), )

    
    mdBottom = property(__mdBottom.value, __mdBottom.set, None, u'Measured depth at bottom.  ')

    
    # Element {http://www.witsml.org/schemas/131}gapAir uses Python identifier gapAir
    __gapAir = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'gapAir'), 'gapAir', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131gapAir', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 33, 3), )

    
    gapAir = property(__gapAir.value, __gapAir.set, None, u'Air gap.  ')

    
    # Element {http://www.witsml.org/schemas/131}depthWaterMean uses Python identifier depthWaterMean
    __depthWaterMean = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'depthWaterMean'), 'depthWaterMean', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131depthWaterMean', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 38, 3), )

    
    depthWaterMean = property(__depthWaterMean.value, __depthWaterMean.set, None, u'Water depth.  ')

    
    # Element {http://www.witsml.org/schemas/131}wbGeometrySection uses Python identifier wbGeometrySection
    __wbGeometrySection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wbGeometrySection'), 'wbGeometrySection', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131wbGeometrySection', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 43, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 62, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 67, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 77, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_wbGeometry_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 83, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_wbGeometry_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_wbGeometry_uidWell', uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 90, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 90, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_wbGeometry_uidWellbore', uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 96, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 96, 2)
...
obj_wbGeometrys._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_wbGeometrys, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 35, 3)))

obj_wbGeometrys._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wbGeometry'), obj_wbGeometry, scope=obj_wbGeometrys, documentation=u'A single wellbore geometry.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometrys._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometrys._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wbGeometry')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_wbGeometrys._Automaton = _BuildAutomaton_7()




cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'typeHoleCasing'), HoleCasingType, scope=cs_wbGeometrySection, documentation=u'Type of fixed component.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 27, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdTop'), measuredDepthCoord, scope=cs_wbGeometrySection, documentation=u'Measured depth at Top of Interval.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 32, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdBottom'), measuredDepthCoord, scope=cs_wbGeometrySection, documentation=u'Measured depth at bottom of the section.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 37, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdTop'), wellVerticalDepthCoord, scope=cs_wbGeometrySection, documentation=u'True vertical depth at top of the section.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 42, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvdBottom'), wellVerticalDepthCoord, scope=cs_wbGeometrySection, documentation=u'True vertical depth at bottom of the section.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 47, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'idSection'), lengthMeasure, scope=cs_wbGeometrySection, documentation=u'Inner diameter.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 52, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'odSection'), lengthMeasure, scope=cs_wbGeometrySection, documentation=u'Outer diameter - Only for casings and risers.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 57, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wtPerLen'), massPerLengthMeasure, scope=cs_wbGeometrySection, documentation=u'Weight per unit length for casing sections.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 62, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'grade'), str32, scope=cs_wbGeometrySection, documentation=u'Material grade for the tubular section.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 67, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'curveConductor'), logicalBoolean, scope=cs_wbGeometrySection, documentation=u'Curved conductor? Values are "true" (or "1") and "false" (or "0").  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 72, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'diaDrift'), lengthMeasure, scope=cs_wbGeometrySection, documentation=u'Maximum diameter that can pass through.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 77, 3)))

cs_wbGeometrySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'factFric'), unitlessQuantity, scope=cs_wbGeometrySection, documentation=u'Friction factor.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 82, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 27, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 32, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 37, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 42, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 47, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 52, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 57, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 62, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 67, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 72, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 77, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 82, 3))
    counters.add(cc_11)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'typeHoleCasing')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdTop')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdBottom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdTop')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvdBottom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 47, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'idSection')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 52, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'odSection')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 57, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wtPerLen')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 62, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'grade')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 67, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'curveConductor')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 72, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'diaDrift')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 77, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_wbGeometrySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'factFric')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_wbGeometrySection.xsd', 82, 3))
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
cs_wbGeometrySection._Automaton = _BuildAutomaton_8()




obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimReport'), timestamp, scope=obj_wbGeometry, documentation=u'Time report generated.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 23, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdBottom'), measuredDepthCoord, scope=obj_wbGeometry, documentation=u'Measured depth at bottom.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 28, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'gapAir'), lengthMeasure, scope=obj_wbGeometry, documentation=u'Air gap.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 33, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'depthWaterMean'), lengthMeasure, scope=obj_wbGeometry, documentation=u'Water depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 38, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wbGeometrySection'), cs_wbGeometrySection, scope=obj_wbGeometry, documentation=u'Wellbore geometry section object.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 43, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_wbGeometry, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 57, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_wbGeometry, documentation=u'Human recognizable context for the wellbore that contains the wellbore geometry.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 62, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_wbGeometry, documentation=u'Human recognizable context for the wellbore geometry.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 67, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_wbGeometry, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 77, 3)))

obj_wbGeometry._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_wbGeometry, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 83, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 28, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 38, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 43, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 72, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 77, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 83, 3))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimReport')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdBottom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 28, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'gapAir')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 33, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'depthWaterMean')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 38, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wbGeometrySection')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_wbGeometry.xsd', 43, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 57, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 62, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 67, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 77, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_wbGeometry._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_wbGeometry.xsd', 83, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_wbGeometry._Automaton = _BuildAutomaton_9()
