# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_well.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:53:08.114646 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:042c6593-0888-43aa-9be0-dd6ab52a655f')
...
# Complex type {http://www.witsml.org/schemas/131}cs_geodeticModel with content type ELEMENT_ONLY
class cs_geodeticModel (pyxb.binding.basis.complexTypeDefinition):
    """WITSML - Geodetic Model Component Schema"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_geodeticModel')
    _XSDLocation = pyxb.utils.utility.Location('cs_geodeticModel.xsd', 18, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}nameCRS uses Python identifier nameCRS
    __nameCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameCRS'), 'nameCRS', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131nameCRS', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 23, 3), )

    
    nameCRS = property(__nameCRS.value, __nameCRS.set, None, "The name of the coordinate reference system in a particular naming system.\n\t\t\t\t\tAn optional short name (code) can also be specified. Specifying a well known system is highly desired.\n\t\t\t\t\tAn example would be to specify a name of 'ED50' with a code of '4230' in\n\t\t\t\t\tthe 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting\n\t\t\t\t\tthat the parameters in the EPSG database are appropriate for this CRS. This is \n\t\t\t\t\talso true for any other naming system. If in doubt, contact your local geodesist.")

    
    # Element {http://www.witsml.org/schemas/131}geodeticDatumCode uses Python identifier geodeticDatumCode
    __geodeticDatumCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'geodeticDatumCode'), 'geodeticDatumCode', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131geodeticDatumCode', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 33, 3), )

    
    geodeticDatumCode = property(__geodeticDatumCode.value, __geodeticDatumCode.set, None, 'Geodetic datum code. This defines a system in the Geoshare naming system\n\t\t\t\t\tand should probably not be used with CRSName.  ')

    
    # Element {http://www.witsml.org/schemas/131}xTranslation uses Python identifier xTranslation
    __xTranslation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'xTranslation'), 'xTranslation', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131xTranslation', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 39, 3), )

    
    xTranslation = property(__xTranslation.value, __xTranslation.set, None, 'Ellipsoid translation (3). Units are meters by convention.  ')

    
    # Element {http://www.witsml.org/schemas/131}yTranslation uses Python identifier yTranslation
    __yTranslation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'yTranslation'), 'yTranslation', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131yTranslation', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 44, 3), )

    
    yTranslation = property(__yTranslation.value, __yTranslation.set, None, 'Ellipsoid translation (3). Units are meters by convention.  ')

    
    # Element {http://www.witsml.org/schemas/131}zTranslation uses Python identifier zTranslation
    __zTranslation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'zTranslation'), 'zTranslation', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131zTranslation', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 49, 3), )

    
    zTranslation = property(__zTranslation.value, __zTranslation.set, None, 'Ellipsoid translation (3). Units are meters by convention.  ')

    
    # Element {http://www.witsml.org/schemas/131}xRotation uses Python identifier xRotation
    __xRotation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'xRotation'), 'xRotation', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131xRotation', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 54, 3), )

    
    xRotation = property(__xRotation.value, __xRotation.set, None, 'Ellipsoid rotation (3). Seconds of arc by convention.  ')

    
    # Element {http://www.witsml.org/schemas/131}yRotation uses Python identifier yRotation
    __yRotation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'yRotation'), 'yRotation', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131yRotation', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 59, 3), )

    
    yRotation = property(__yRotation.value, __yRotation.set, None, 'Ellipsoid rotation (3). Seconds of arc by convention.  ')

    
    # Element {http://www.witsml.org/schemas/131}zRotation uses Python identifier zRotation
    __zRotation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'zRotation'), 'zRotation', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131zRotation', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 64, 3), )

    
    zRotation = property(__zRotation.value, __zRotation.set, None, 'Ellipsoid rotation (3). Seconds of arc by convention.  ')

    
    # Element {http://www.witsml.org/schemas/131}scaleFactor uses Python identifier scaleFactor
    __scaleFactor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'scaleFactor'), 'scaleFactor', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131scaleFactor', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 69, 3), )

    
    scaleFactor = property(__scaleFactor.value, __scaleFactor.set, None, 'Ellipsoid scale factor.  ')

    
    # Element {http://www.witsml.org/schemas/131}ellipsoidCode uses Python identifier ellipsoidCode
    __ellipsoidCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidCode'), 'ellipsoidCode', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131ellipsoidCode', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 74, 3), )

    
    ellipsoidCode = property(__ellipsoidCode.value, __ellipsoidCode.set, None, 'Ellipsoid code (spheroid) defining geographic or planar coordinates. \n\t\t\t\t\tImplied if geodeticDatumCode is specified (and is not user defined). ')

    
    # Element {http://www.witsml.org/schemas/131}ellipsoidSemiMajorAxis uses Python identifier ellipsoidSemiMajorAxis
    __ellipsoidSemiMajorAxis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidSemiMajorAxis'), 'ellipsoidSemiMajorAxis', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131ellipsoidSemiMajorAxis', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 80, 3), )

    
    ellipsoidSemiMajorAxis = property(__ellipsoidSemiMajorAxis.value, __ellipsoidSemiMajorAxis.set, None, 'Ellipsoid semi-major axis size. Implied if geodeticDatumCode or ellipsoidCode \n\t\t\t\t\tspecified.  ')

    
    # Element {http://www.witsml.org/schemas/131}ellipsoidInverseFlattening uses Python identifier ellipsoidInverseFlattening
    __ellipsoidInverseFlattening = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidInverseFlattening'), 'ellipsoidInverseFlattening', '__httpwww_witsml_orgschemas131_cs_geodeticModel_httpwww_witsml_orgschemas131ellipsoidInverseFlattening', False, pyxb.utils.utility.Location('cs_geodeticModel.xsd', 86, 3), )

    
    ellipsoidInverseFlattening = property(__ellipsoidInverseFlattening.value, __ellipsoidInverseFlattening.set, None, 'Ellipsoid inverse flattening value (ie. 1/x). Implied if geodeticDatumCode \n\t\t\t\t\tor ellipsoidCode specified.  ')

    _ElementMap.update({
        __nameCRS.name() : __nameCRS,
        __geodeticDatumCode.name() : __geodeticDatumCode,
        __xTranslation.name() : __xTranslation,
        __yTranslation.name() : __yTranslation,
        __zTranslation.name() : __zTranslation,
        __xRotation.name() : __xRotation,
        __yRotation.name() : __yRotation,
        __zRotation.name() : __zRotation,
        __scaleFactor.name() : __scaleFactor,
        __ellipsoidCode.name() : __ellipsoidCode,
        __ellipsoidSemiMajorAxis.name() : __ellipsoidSemiMajorAxis,
        __ellipsoidInverseFlattening.name() : __ellipsoidInverseFlattening
    })
    _AttributeMap.update({
        
    })
_module_typeBindings.cs_geodeticModel = cs_geodeticModel
Namespace.addCategoryObject('typeBinding', 'cs_geodeticModel', cs_geodeticModel)


# Complex type {http://www.witsml.org/schemas/131}cs_localCRS with content type ELEMENT_ONLY
class cs_localCRS (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}cs_localCRS with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_localCRS')
    _XSDLocation = pyxb.utils.utility.Location('cs_localCRS.xsd', 18, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}usesWellAsOrigin uses Python identifier usesWellAsOrigin
    __usesWellAsOrigin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'usesWellAsOrigin'), 'usesWellAsOrigin', '__httpwww_witsml_orgschemas131_cs_localCRS_httpwww_witsml_orgschemas131usesWellAsOrigin', False, pyxb.utils.utility.Location('cs_localCRS.xsd', 21, 4), )

    
    usesWellAsOrigin = property(__usesWellAsOrigin.value, __usesWellAsOrigin.set, None, 'True ("true" or "1") indicates that the well surface\n\t\t\t\t\t\tpoint is the origin of this CRS.  \n\t\t\t\t\t\tFalse ("false" or "0") or not given indicates otherwise.')

    
    # Element {http://www.witsml.org/schemas/131}origin uses Python identifier origin
    __origin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'origin'), 'origin', '__httpwww_witsml_orgschemas131_cs_localCRS_httpwww_witsml_orgschemas131origin', False, pyxb.utils.utility.Location('cs_localCRS.xsd', 28, 4), )

    
    origin = property(__origin.value, __origin.set, None, 'A pointer to the reference point that is the origin\n\t\t\t\t\t\tof this CRS.')

    
    # Element {http://www.witsml.org/schemas/131}originDescription uses Python identifier originDescription
    __originDescription = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'originDescription'), 'originDescription', '__httpwww_witsml_orgschemas131_cs_localCRS_httpwww_witsml_orgschemas131originDescription', False, pyxb.utils.utility.Location('cs_localCRS.xsd', 34, 4), )

    
    originDescription = property(__originDescription.value, __originDescription.set, None, 'A textual description of the origin.')

    
    # Element {http://www.witsml.org/schemas/131}yAxisAzimuth uses Python identifier yAxisAzimuth
    __yAxisAzimuth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'yAxisAzimuth'), 'yAxisAzimuth', '__httpwww_witsml_orgschemas131_cs_localCRS_httpwww_witsml_orgschemas131yAxisAzimuth', False, pyxb.utils.utility.Location('cs_localCRS.xsd', 40, 3), )

    
    yAxisAzimuth = property(__yAxisAzimuth.value, __yAxisAzimuth.set, None, 'The angle of the Y axis from North (as described \n\t\t\t\t\tin attribute northDirection). Defaults to zero. Positive clockwise.')

    
    # Element {http://www.witsml.org/schemas/131}yAxisDescription uses Python identifier yAxisDescription
    __yAxisDescription = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'yAxisDescription'), 'yAxisDescription', '__httpwww_witsml_orgschemas131_cs_localCRS_httpwww_witsml_orgschemas131yAxisDescription', False, pyxb.utils.utility.Location('cs_localCRS.xsd', 46, 3), )

    
    yAxisDescription = property(__yAxisDescription.value, __yAxisDescription.set, None, "A free-form description of the Y axis. \n\t\t\t\t\tExamples would be 'parallel to the west side of the platform', or \n\t\t\t\t\t'along the main entry road'.")

    
    # Element {http://www.witsml.org/schemas/131}xRotationCounterClockwise uses Python identifier xRotationCounterClockwise
    __xRotationCounterClockwise = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'xRotationCounterClockwise'), 'xRotationCounterClockwise', '__httpwww_witsml_orgschemas131_cs_localCRS_httpwww_witsml_orgschemas131xRotationCounterClockwise', False, pyxb.utils.utility.Location('cs_localCRS.xsd', 53, 3), )

    
    xRotationCounterClockwise = property(__xRotationCounterClockwise.value, __xRotationCounterClockwise.set, None, 'True ("true" or "1") indicates that the X axis is rotated \n\t\t\t\t\tcounter-clockwise from the Y axis when viewed from above the earth looking down.\n\t\t\t\t\tFalse ("false" or "0") or not given indicates a clockwise rotation. \n\t\t\t\t\tGenerally the X axis is rotated clockwise.')

    _ElementMap.update({
        __usesWellAsOrigin.name() : __usesWellAsOrigin,
        __origin.name() : __origin,
        __originDescription.name() : __originDescription,
        __yAxisAzimuth.name() : __yAxisAzimuth,
        __yAxisDescription.name() : __yAxisDescription,
        __xRotationCounterClockwise.name() : __xRotationCounterClockwise
    })
    _AttributeMap.update({
        
    })
_module_typeBindings.cs_localCRS = cs_localCRS
Namespace.addCategoryObject('typeBinding', 'cs_localCRS', cs_localCRS)


# Complex type {http://www.witsml.org/schemas/131}cs_projectionx with content type ELEMENT_ONLY
class cs_projectionx (pyxb.binding.basis.complexTypeDefinition):
    """WITSML Element Types"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_projectionx')
    _XSDLocation = pyxb.utils.utility.Location('cs_projectionx.xsd', 18, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}nameCRS uses Python identifier nameCRS
    __nameCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameCRS'), 'nameCRS', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131nameCRS', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 23, 3), )

    
    nameCRS = property(__nameCRS.value, __nameCRS.set, None, "The name of the coordinate reference system in a particular naming system.\n\t\t\t\t\tAn optional short name (code) can also be specified. Specifying a well known system is highly desired.\n\t\t\t\t\tAn example would be to specify a name of 'WGS 84 / UTM zone 10N' with a code of '32610' in\n\t\t\t\t\tthe 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting\n\t\t\t\t\tthat the parameters in the EPSG database are appropriate for this CRS. This is \n\t\t\t\t\talso true for any other naming system. If in doubt, contact your local geodesist.")

    
    # Element {http://www.witsml.org/schemas/131}projectionCode uses Python identifier projectionCode
    __projectionCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'projectionCode'), 'projectionCode', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131projectionCode', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 33, 3), )

    
    projectionCode = property(__projectionCode.value, __projectionCode.set, None, 'A code to identify the type of projection.  ')

    
    # Element {http://www.witsml.org/schemas/131}projectedFrom uses Python identifier projectedFrom
    __projectedFrom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'projectedFrom'), 'projectedFrom', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131projectedFrom', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 38, 3), )

    
    projectedFrom = property(__projectedFrom.value, __projectedFrom.set, None, 'A pointer to the wellCRS that represents the geographic\n\t\t\t\t\tsystem from which this system was projected.')

    
    # Element {http://www.witsml.org/schemas/131}stdParallel1 uses Python identifier stdParallel1
    __stdParallel1 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stdParallel1'), 'stdParallel1', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131stdParallel1', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 44, 3), )

    
    stdParallel1 = property(__stdParallel1.value, __stdParallel1.set, None, 'Latitude of first standard parallel.  ')

    
    # Element {http://www.witsml.org/schemas/131}stdParallel2 uses Python identifier stdParallel2
    __stdParallel2 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stdParallel2'), 'stdParallel2', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131stdParallel2', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 49, 3), )

    
    stdParallel2 = property(__stdParallel2.value, __stdParallel2.set, None, 'Latitude of second standard parallel, if used.  ')

    
    # Element {http://www.witsml.org/schemas/131}centralMeridian uses Python identifier centralMeridian
    __centralMeridian = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'centralMeridian'), 'centralMeridian', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131centralMeridian', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 54, 3), )

    
    centralMeridian = property(__centralMeridian.value, __centralMeridian.set, None, 'Longitude of the Y axis of the resulting map.  ')

    
    # Element {http://www.witsml.org/schemas/131}originLatitude uses Python identifier originLatitude
    __originLatitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'originLatitude'), 'originLatitude', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131originLatitude', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 59, 3), )

    
    originLatitude = property(__originLatitude.value, __originLatitude.set, None, 'Latitude at which the X axis intersects the central meridian.  ')

    
    # Element {http://www.witsml.org/schemas/131}originLongitude uses Python identifier originLongitude
    __originLongitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'originLongitude'), 'originLongitude', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131originLongitude', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 64, 3), )

    
    originLongitude = property(__originLongitude.value, __originLongitude.set, None, 'Longitude of the central meridian.  ')

    
    # Element {http://www.witsml.org/schemas/131}latitude1 uses Python identifier latitude1
    __latitude1 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'latitude1'), 'latitude1', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131latitude1', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 69, 3), )

    
    latitude1 = property(__latitude1.value, __latitude1.set, None, 'Latitude of the first point if the two-point specification \n\t\t\t\t\tof the central line is used.  ')

    
    # Element {http://www.witsml.org/schemas/131}longitude1 uses Python identifier longitude1
    __longitude1 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'longitude1'), 'longitude1', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131longitude1', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 75, 3), )

    
    longitude1 = property(__longitude1.value, __longitude1.set, None, 'Longitude of the first point if the two-point specification \n\t\t\t\t\tof the central line is used.  ')

    
    # Element {http://www.witsml.org/schemas/131}latitude2 uses Python identifier latitude2
    __latitude2 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'latitude2'), 'latitude2', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131latitude2', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 81, 3), )

    
    latitude2 = property(__latitude2.value, __latitude2.set, None, 'Latitude of the second point if the two-point specification \n\t\t\t\t\tof the central line is used.  ')

    
    # Element {http://www.witsml.org/schemas/131}longitude2 uses Python identifier longitude2
    __longitude2 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'longitude2'), 'longitude2', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131longitude2', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 87, 3), )

    
    longitude2 = property(__longitude2.value, __longitude2.set, None, 'Longitude of the second point if the two-point specification \n\t\t\t\t\tof the central line is used.  ')

    
    # Element {http://www.witsml.org/schemas/131}latitudeForScale uses Python identifier latitudeForScale
    __latitudeForScale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'latitudeForScale'), 'latitudeForScale', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131latitudeForScale', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 93, 3), )

    
    latitudeForScale = property(__latitudeForScale.value, __latitudeForScale.set, None, 'Latitude of a point for which the scale factor is specified exactly. \n\t\t\t\t\tDefault to origin.  ')

    
    # Element {http://www.witsml.org/schemas/131}longitudeForScale uses Python identifier longitudeForScale
    __longitudeForScale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'longitudeForScale'), 'longitudeForScale', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131longitudeForScale', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 99, 3), )

    
    longitudeForScale = property(__longitudeForScale.value, __longitudeForScale.set, None, 'Longitude of a point for which the scale factor is specified exactly. \n\t\t\t\t\tDefault to origin.  ')

    
    # Element {http://www.witsml.org/schemas/131}trueScaleLatitude uses Python identifier trueScaleLatitude
    __trueScaleLatitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'trueScaleLatitude'), 'trueScaleLatitude', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131trueScaleLatitude', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 105, 3), )

    
    trueScaleLatitude = property(__trueScaleLatitude.value, __trueScaleLatitude.set, None, 'Latitude at which the scale on the map is exact. If none is provided, \n\t\t\t\t\tscale is assumed to be exact at the equator.  ')

    
    # Element {http://www.witsml.org/schemas/131}spheroidRadius uses Python identifier spheroidRadius
    __spheroidRadius = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'spheroidRadius'), 'spheroidRadius', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131spheroidRadius', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 111, 3), )

    
    spheroidRadius = property(__spheroidRadius.value, __spheroidRadius.set, None, 'Spheroid radius.  ')

    
    # Element {http://www.witsml.org/schemas/131}scaleFactor uses Python identifier scaleFactor
    __scaleFactor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'scaleFactor'), 'scaleFactor', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131scaleFactor', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 116, 3), )

    
    scaleFactor = property(__scaleFactor.value, __scaleFactor.set, None, 'Ellipsoid scale factor.  ')

    
    # Element {http://www.witsml.org/schemas/131}methodVariant uses Python identifier methodVariant
    __methodVariant = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'methodVariant'), 'methodVariant', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131methodVariant', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 121, 3), )

    
    methodVariant = property(__methodVariant.value, __methodVariant.set, None, 'Projection method variant - establishes minor variations of the projection. \n\t\t\t\t\tGeoshare proposal.  ')

    
    # Element {http://www.witsml.org/schemas/131}perspectiveHeight uses Python identifier perspectiveHeight
    __perspectiveHeight = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'perspectiveHeight'), 'perspectiveHeight', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131perspectiveHeight', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 127, 3), )

    
    perspectiveHeight = property(__perspectiveHeight.value, __perspectiveHeight.set, None, 'Height above the surface origin location from which the perspective is taken.  ')

    
    # Element {http://www.witsml.org/schemas/131}zone uses Python identifier zone
    __zone = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'zone'), 'zone', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131zone', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 132, 3), )

    
    zone = property(__zone.value, __zone.set, None, 'Zone for the type of projection. Zones have values from 1 to 60\n\t\t\t\t\twith a required direction of "N" (North) or "S" (South). For example, "21N". ')

    
    # Element {http://www.witsml.org/schemas/131}NADType uses Python identifier NADType
    __NADType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'NADType'), 'NADType', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131NADType', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 138, 3), )

    
    NADType = property(__NADType.value, __NADType.set, None, 'North American Datum type.  ')

    
    # Element {http://www.witsml.org/schemas/131}falseEasting uses Python identifier falseEasting
    __falseEasting = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'falseEasting'), 'falseEasting', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131falseEasting', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 143, 3), )

    
    falseEasting = property(__falseEasting.value, __falseEasting.set, None, 'Artificial value added to the X axis.  ')

    
    # Element {http://www.witsml.org/schemas/131}falseNorthing uses Python identifier falseNorthing
    __falseNorthing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'falseNorthing'), 'falseNorthing', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131falseNorthing', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 148, 3), )

    
    falseNorthing = property(__falseNorthing.value, __falseNorthing.set, None, 'Artificial value added to the Y axis.  ')

    
    # Element {http://www.witsml.org/schemas/131}bearing uses Python identifier bearing
    __bearing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'bearing'), 'bearing', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131bearing', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 153, 3), )

    
    bearing = property(__bearing.value, __bearing.set, None, 'Bearing angle of the great circle with respect to north at the central \n\t\t\t\t\tpoint.  ')

    
    # Element {http://www.witsml.org/schemas/131}hemisphere uses Python identifier hemisphere
    __hemisphere = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'hemisphere'), 'hemisphere', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131hemisphere', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 159, 3), )

    
    hemisphere = property(__hemisphere.value, __hemisphere.set, None, 'Is the projection in the northern hemisphere or the southern hemisphere.  ')

    
    # Element {http://www.witsml.org/schemas/131}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('cs_projectionx.xsd', 164, 3), )

    
    description = property(__description.value, __description.set, None, 'Description of item and details.  ')

    
    # Element {http://www.witsml.org/schemas/131}parameter uses Python identifier parameter
    __parameter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'parameter'), 'parameter', '__httpwww_witsml_orgschemas131_cs_projectionx_httpwww_witsml_orgschemas131parameter', True, pyxb.utils.utility.Location('cs_projectionx.xsd', 169, 3), )

    
    parameter = property(__parameter.value, __parameter.set, None, 'Parameter describing the user-defined projection.  ')

    _ElementMap.update({
        __nameCRS.name() : __nameCRS,
        __projectionCode.name() : __projectionCode,
        __projectedFrom.name() : __projectedFrom,
        __stdParallel1.name() : __stdParallel1,
        __stdParallel2.name() : __stdParallel2,
        __centralMeridian.name() : __centralMeridian,
        __originLatitude.name() : __originLatitude,
        __originLongitude.name() : __originLongitude,
        __latitude1.name() : __latitude1,
        __longitude1.name() : __longitude1,
        __latitude2.name() : __latitude2,
        __longitude2.name() : __longitude2,
        __latitudeForScale.name() : __latitudeForScale,
        __longitudeForScale.name() : __longitudeForScale,
        __trueScaleLatitude.name() : __trueScaleLatitude,
        __spheroidRadius.name() : __spheroidRadius,
        __scaleFactor.name() : __scaleFactor,
        __methodVariant.name() : __methodVariant,
        __perspectiveHeight.name() : __perspectiveHeight,
        __zone.name() : __zone,
        __NADType.name() : __NADType,
        __falseEasting.name() : __falseEasting,
        __falseNorthing.name() : __falseNorthing,
        __bearing.name() : __bearing,
        __hemisphere.name() : __hemisphere,
...
_module_typeBindings.cs_projectionx = cs_projectionx
Namespace.addCategoryObject('typeBinding', 'cs_projectionx', cs_projectionx)


# Complex type {http://www.witsml.org/schemas/131}cs_refWellWellbore with content type ELEMENT_ONLY
class cs_refWellWellbore (pyxb.binding.basis.complexTypeDefinition):
    """Data that represents a foreign key to a wellbore.
			The wellbore may be defined within the context of another well."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_refWellWellbore')
    _XSDLocation = pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}wellboreReference uses Python identifier wellboreReference
    __wellboreReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellboreReference'), 'wellboreReference', '__httpwww_witsml_orgschemas131_cs_refWellWellbore_httpwww_witsml_orgschemas131wellboreReference', False, pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 26, 3), )

    
    wellboreReference = property(__wellboreReference.value, __wellboreReference.set, None, 'A pointer the wellbore with which there is a relationship.')

    
    # Element {http://www.witsml.org/schemas/131}wellParent uses Python identifier wellParent
    __wellParent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellParent'), 'wellParent', '__httpwww_witsml_orgschemas131_cs_refWellWellbore_httpwww_witsml_orgschemas131wellParent', False, pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 31, 3), )

    
    wellParent = property(__wellParent.value, __wellParent.set, None, 'A pointer to the well that contains the wellboreReference.\n\t\t\t\t\tThis is not needed unless the referenced wellbore is outside the \n\t\t\t\t\tcontext of a common parent well.')

    _ElementMap.update({
        __wellboreReference.name() : __wellboreReference,
        __wellParent.name() : __wellParent
    })
    _AttributeMap.update({
        
    })
_module_typeBindings.cs_refWellWellbore = cs_refWellWellbore
Namespace.addCategoryObject('typeBinding', 'cs_refWellWellbore', cs_refWellWellbore)


# Complex type {http://www.witsml.org/schemas/131}cs_refWellWellboreRig with content type ELEMENT_ONLY
class cs_refWellWellboreRig (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_refWellWellboreRig')
    _XSDLocation = pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 19, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}rigReference uses Python identifier rigReference
    __rigReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rigReference'), 'rigReference', '__httpwww_witsml_orgschemas131_cs_refWellWellboreRig_httpwww_witsml_orgschemas131rigReference', False, pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 26, 3), )

    
    rigReference = property(__rigReference.value, __rigReference.set, None, 'A pointer to the rig with which there is a relationship.')

    
    # Element {http://www.witsml.org/schemas/131}wellboreParent uses Python identifier wellboreParent
    __wellboreParent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellboreParent'), 'wellboreParent', '__httpwww_witsml_orgschemas131_cs_refWellWellboreRig_httpwww_witsml_orgschemas131wellboreParent', False, pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 31, 3), )

    
    wellboreParent = property(__wellboreParent.value, __wellboreParent.set, None, 'A pointer to the wellbore that contains the rigReference.\n\t\t\t\t\tThis is not needed unless the referenced rig is outside the \n\t\t\t\t\tcontext of a common parent wellbore.')

    
    # Element {http://www.witsml.org/schemas/131}wellParent uses Python identifier wellParent
    __wellParent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellParent'), 'wellParent', '__httpwww_witsml_orgschemas131_cs_refWellWellboreRig_httpwww_witsml_orgschemas131wellParent', False, pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 38, 3), )

    
    wellParent = property(__wellParent.value, __wellParent.set, None, 'A pointer to the well that contains the wellboreParent.\n\t\t\t\t\tThis is not needed unless the referenced wellbore is outside the \n\t\t\t\t\tcontext of a common parent well.')

    _ElementMap.update({
        __rigReference.name() : __rigReference,
...
_module_typeBindings.cs_refWellWellboreRig = cs_refWellWellboreRig
Namespace.addCategoryObject('typeBinding', 'cs_refWellWellboreRig', cs_refWellWellboreRig)
...
# Complex type {http://www.witsml.org/schemas/131}obj_wells with content type ELEMENT_ONLY
class obj_wells (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_wells with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_wells')
    _XSDLocation = pyxb.utils.utility.Location('obj_well.xsd', 33, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_wells_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_well.xsd', 35, 3), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, 'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/131}well uses Python identifier well
    __well = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'well'), 'well', '__httpwww_witsml_orgschemas131_obj_wells_httpwww_witsml_orgschemas131well', True, pyxb.utils.utility.Location('obj_well.xsd', 40, 3), )

    
    well = property(__well.value, __well.set, None, 'Information about a single well.\n\t\t\t\t\tA well is a unique surface location from which wellbores are drilled \n\t\t\t\t\tinto the Earth for the purpose of either (1) finding or producing \n\t\t\t\t\tunderground resources; or (2) providing services related to the \n\t\t\t\t\tproduction of underground resources.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_wells_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_well.xsd', 50, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_well.xsd', 50, 2)
...
_module_typeBindings.obj_wells = obj_wells
Namespace.addCategoryObject('typeBinding', 'obj_wells', obj_wells)
...
class cs_location (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_location.xsd', 19, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}wellCRS uses Python identifier wellCRS
    __wellCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellCRS'), 'wellCRS', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131wellCRS', False, pyxb.utils.utility.Location('cs_location.xsd', 27, 3), )
    ...
    __latitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'latitude'), 'latitude', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131latitude', False, pyxb.utils.utility.Location('cs_location.xsd', 45, 5), )
    ...
    __longitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'longitude'), 'longitude', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131longitude', False, pyxb.utils.utility.Location('cs_location.xsd', 50, 5), )
    ...
    __easting = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'easting'), 'easting', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131easting', False, pyxb.utils.utility.Location('cs_location.xsd', 57, 5), )
    ...
    __northing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'northing'), 'northing', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131northing', False, pyxb.utils.utility.Location('cs_location.xsd', 64, 5), )
    ...
    __westing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'westing'), 'westing', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131westing', False, pyxb.utils.utility.Location('cs_location.xsd', 73, 5), )
    ...
    __southing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'southing'), 'southing', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131southing', False, pyxb.utils.utility.Location('cs_location.xsd', 81, 5), )
    ...
    __projectedX = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'projectedX'), 'projectedX', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131projectedX', False, pyxb.utils.utility.Location('cs_location.xsd', 91, 5), )
    ...
    __projectedY = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'projectedY'), 'projectedY', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131projectedY', False, pyxb.utils.utility.Location('cs_location.xsd', 100, 5), )
    ...
    __localX = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'localX'), 'localX', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131localX', False, pyxb.utils.utility.Location('cs_location.xsd', 111, 5), )
    ...
    __localY = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'localY'), 'localY', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131localY', False, pyxb.utils.utility.Location('cs_location.xsd', 117, 5), )
    ...
    __original = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'original'), 'original', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131original', False, pyxb.utils.utility.Location('cs_location.xsd', 125, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_cs_location_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('cs_location.xsd', 133, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_location_uid', _module_typeBindings.uidString)
...
# Complex type {http://www.witsml.org/schemas/131}cs_referencePoint with content type ELEMENT_ONLY
class cs_referencePoint (pyxb.binding.basis.complexTypeDefinition):
    """WITSML - Reference Point Component Schema."""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_referencePoint')
    _XSDLocation = pyxb.utils.utility.Location('cs_referencePoint.xsd', 19, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_cs_referencePoint_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('cs_referencePoint.xsd', 24, 3), )

    
    name = property(__name.value, __name.set, None, 'Human recognizable context for the point.  ')

    
    # Element {http://www.witsml.org/schemas/131}type uses Python identifier type
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas131_cs_referencePoint_httpwww_witsml_orgschemas131type', False, pyxb.utils.utility.Location('cs_referencePoint.xsd', 29, 3), )

    
    type = property(__type.value, __type.set, None, "The kind of point. For example, \n\t\t\t\t\t'well reference point', 'platform reference point', 'sea surface',\n\t\t\t\t\t'sea bottom'.  ")

    
    # Element {http://www.witsml.org/schemas/131}elevation uses Python identifier elevation
    __elevation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'elevation'), 'elevation', '__httpwww_witsml_orgschemas131_cs_referencePoint_httpwww_witsml_orgschemas131elevation', False, pyxb.utils.utility.Location('cs_referencePoint.xsd', 36, 3), )

    
    elevation = property(__elevation.value, __elevation.set, None, 'The gravity based elevation coordinate of this point \n\t\t\t\t\tas measured from a datum. Positive moving upward from the elevation datum. ')

    
    # Element {http://www.witsml.org/schemas/131}measuredDepth uses Python identifier measuredDepth
    __measuredDepth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'measuredDepth'), 'measuredDepth', '__httpwww_witsml_orgschemas131_cs_referencePoint_httpwww_witsml_orgschemas131measuredDepth', False, pyxb.utils.utility.Location('cs_referencePoint.xsd', 42, 3), )

    
    measuredDepth = property(__measuredDepth.value, __measuredDepth.set, None, 'The measured depth coordinate of this reference point.\n\t\t\t\t\tPositive moving toward the bottomhole from the measured depth datum.\n\t\t\t\t\tThis should be given when the reference is "downhole", such as an ocean \n\t\t\t\t\tbottom template, or when the reference point is also used as a vertical well datum.\n\t\t\t\t\tThe measured depth value can be used to determine if the reference point\n\t\t\t\t\tand a vertical well datum are at the same point.')

    
    # Element {http://www.witsml.org/schemas/131}location uses Python identifier location
    __location = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'location'), 'location', '__httpwww_witsml_orgschemas131_cs_referencePoint_httpwww_witsml_orgschemas131location', True, pyxb.utils.utility.Location('cs_referencePoint.xsd', 52, 3), )

    
    location = property(__location.value, __location.set, None, 'Two dimensional coordinates that locate the point.  ')

    
    # Element {http://www.witsml.org/schemas/131}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_cs_referencePoint_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('cs_referencePoint.xsd', 57, 3), )

    
    description = property(__description.value, __description.set, None, 'A textual description of the point.  ')

    
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_referencePoint_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    ...
    _ElementMap.update({
        ...
        __measuredDepth.name() : __measuredDepth,
...
_module_typeBindings.cs_referencePoint = cs_referencePoint
Namespace.addCategoryObject('typeBinding', 'cs_referencePoint', cs_referencePoint)


# Complex type {http://www.witsml.org/schemas/131}cs_wellCRS with content type ELEMENT_ONLY
class cs_wellCRS (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_wellCRS')
    _XSDLocation = pyxb.utils.utility.Location('cs_wellCRS.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_cs_wellCRS_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('cs_wellCRS.xsd', 31, 3), )

    
    name = property(__name.value, __name.set, None, 'Human recognizable context for the system. \n\t\t\t\t\tFor a geographic system this is commonly the name of the datum. ')

    
    # Element {http://www.witsml.org/schemas/131}mapProjection uses Python identifier mapProjection
    __mapProjection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mapProjection'), 'mapProjection', '__httpwww_witsml_orgschemas131_cs_wellCRS_httpwww_witsml_orgschemas131mapProjection', False, pyxb.utils.utility.Location('cs_wellCRS.xsd', 43, 4), )

    
    mapProjection = property(__mapProjection.value, __mapProjection.set, None, 'Map projection system.  ')

    
    # Element {http://www.witsml.org/schemas/131}geographic uses Python identifier geographic
    __geographic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'geographic'), 'geographic', '__httpwww_witsml_orgschemas131_cs_wellCRS_httpwww_witsml_orgschemas131geographic', False, pyxb.utils.utility.Location('cs_wellCRS.xsd', 48, 4), )

    
    geographic = property(__geographic.value, __geographic.set, None, 'Geographic system.  ')

    
    # Element {http://www.witsml.org/schemas/131}localCRS uses Python identifier localCRS
    __localCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'localCRS'), 'localCRS', '__httpwww_witsml_orgschemas131_cs_wellCRS_httpwww_witsml_orgschemas131localCRS', False, pyxb.utils.utility.Location('cs_wellCRS.xsd', 53, 4), )

    
    localCRS = property(__localCRS.value, __localCRS.set, None, 'Local (engineering) system.  ')

    
    # Element {http://www.witsml.org/schemas/131}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_cs_wellCRS_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('cs_wellCRS.xsd', 59, 3), )

    
    description = property(__description.value, __description.set, None, 'A textual description of the system.  ')

    
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_wellCRS_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    ...
    _ElementMap.update({
        __name.name() : __name,
        __mapProjection.name() : __mapProjection,
        __geographic.name() : __geographic,
        __localCRS.name() : __localCRS,
        __description.name() : __description
    })
    _AttributeMap.update({
        __uid.name() : __uid
    })
_module_typeBindings.cs_wellCRS = cs_wellCRS
Namespace.addCategoryObject('typeBinding', 'cs_wellCRS', cs_wellCRS)


# Complex type {http://www.witsml.org/schemas/131}cs_wellDatum with content type ELEMENT_ONLY
class cs_wellDatum (pyxb.binding.basis.complexTypeDefinition):
    """Defines the datums associated with elevation, vertical depth 
			and measured depth coordinates within the context of a well. """
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_wellDatum')
    _XSDLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 27, 3), )

    
    name = property(__name.value, __name.set, None, 'The human understandable contextual name of the reference datum.')

    
    # Element {http://www.witsml.org/schemas/131}code uses Python identifier code
    __code = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'code'), 'code', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131code', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 32, 3), )

    
    code = property(__code.value, __code.set, None, 'The code value that represents the type of reference datum. \n\t\t\t\t\tThis may represent a point on a device (e.g., kelly bushing) or it may represent \n\t\t\t\t\ta vertical reference datum (e.g., mean sea level).')

    
    # Element {http://www.witsml.org/schemas/131}datumName uses Python identifier datumName
    __datumName = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'datumName'), 'datumName', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131datumName', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 39, 3), )

    
    datumName = property(__datumName.value, __datumName.set, None, "The name of the vertical reference datum in a particular naming system.\n\t\t\t\t\tThis should only be specified if the above 'code' represents some variation of sea level.\n\t\t\t\t\tAn optional short name (code) can also be specified. Specifying a well known datum is highly desired \n\t\t\t\t\tif the above code is a variant of sea level because sea level varies over time and space.\n\t\t\t\t\tAn example would be to specify a name of 'Caspian Sea' with a code of '5106' in\n\t\t\t\t\tthe 'EPSG' naming system.")

    
    # Element {http://www.witsml.org/schemas/131}kind uses Python identifier kind
    __kind = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'kind'), 'kind', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131kind', True, pyxb.utils.utility.Location('cs_wellDatum.xsd', 49, 3), )

    
    kind = property(__kind.value, __kind.set, None, "Since various activities may use different points as \n\t\t\t\t\tmeasurement datums, it is useful to characterize the point based on its usage. \n\t\t\t\t\tA well reference datum may have more than one such characterization. \n\t\t\t\t\tFor example, it may be the datum used by the driller and logger for measuring \n\t\t\t\t\ttheir depths. Example usage values would be 'permanent','driller', 'logger'\n\t\t\t\t\t'WRP' (well reference point) and 'SRP' (site reference point).")

    
    # Element {http://www.witsml.org/schemas/131}wellbore uses Python identifier wellbore
    __wellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellbore'), 'wellbore', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131wellbore', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 59, 3), )

    
    wellbore = property(__wellbore.value, __wellbore.set, None, 'A pointer to the wellbore that contains the reference datum.\n\t\t\t\t\tThis should be specified if a measured depth is given.')

    
    # Element {http://www.witsml.org/schemas/131}rig uses Python identifier rig
    __rig = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rig'), 'rig', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131rig', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 65, 3), )

    
    rig = property(__rig.value, __rig.set, None, 'A pointer to the rig that contains the device used \n\t\t\t\t\tas a reference datum. The rig may be associated with a wellbore in another well\n\t\t\t\t\t(e.g., pattern drilling using a rig on a track).')

    
    # Element {http://www.witsml.org/schemas/131}elevation uses Python identifier elevation
    __elevation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'elevation'), 'elevation', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131elevation', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 72, 3), )

    
    elevation = property(__elevation.value, __elevation.set, None, 'The gravity based elevation coordinate of this reference datum \n\t\t\t\t\tas measured from another datum. Positive moving upward from the elevation datum.\n\t\t\t\t\tAn elevation should be given unless this is a vertical reference datum (e.g., sea level). ')

    
    # Element {http://www.witsml.org/schemas/131}measuredDepth uses Python identifier measuredDepth
    __measuredDepth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'measuredDepth'), 'measuredDepth', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131measuredDepth', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 79, 3), )

    
    measuredDepth = property(__measuredDepth.value, __measuredDepth.set, None, 'The measured depth coordinate of this reference datum\n\t\t\t\t\tas measured from another datum. The measured depth datum should either be the same as\n\t\t\t\t\tthe elevation datum or it should be relatable to the elevation datum through other datums.\n\t\t\t\t\tPositive moving toward the bottomhole from the measured depth datum.\n\t\t\t\t\tThis should be given when a local reference is "downhole", \n\t\t\t\t\tsuch as a kickoff point or ocean bottom template, and the borehole may not be vertical.\n\t\t\t\t\tIf a Depth is given then an Elevation should also be given.')

    
    # Element {http://www.witsml.org/schemas/131}comment uses Python identifier comment
    __comment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comment'), 'comment', '__httpwww_witsml_orgschemas131_cs_wellDatum_httpwww_witsml_orgschemas131comment', False, pyxb.utils.utility.Location('cs_wellDatum.xsd', 90, 3), )

    
    comment = property(__comment.value, __comment.set, None, 'A contextual description of the well reference datum.')

    
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_wellDatum_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    ...
    # Attribute defaultMeasuredDepth uses Python identifier defaultMeasuredDepth
    __defaultMeasuredDepth = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'defaultMeasuredDepth'), 'defaultMeasuredDepth', '__httpwww_witsml_orgschemas131_cs_wellDatum_defaultMeasuredDepth', _module_typeBindings.logicalBoolean)
    __defaultMeasuredDepth._DeclarationLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 96, 2)
    __defaultMeasuredDepth._UseLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 96, 2)
    
    defaultMeasuredDepth = property(__defaultMeasuredDepth.value, __defaultMeasuredDepth.set, None, 'True indicates that this is the default reference datum\n\t\t\t\tfor measured depth coordinates. \n\t\t\t\tFalse or not given indicates that this is not the default reference datum.\n\t\t\t\tMeasured depth coordinates that do not specify a datum reference should be \n\t\t\t\tassumed to be measured relative to this default reference datum.\n\t\t\t\tOnly one reference datum may be designated as the default measured depth datum for each well.\n\t\t\t\tValues are "true" (or "1") and "false" ( or "0").')

    
    # Attribute defaultVerticalDepth uses Python identifier defaultVerticalDepth
    __defaultVerticalDepth = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'defaultVerticalDepth'), 'defaultVerticalDepth', '__httpwww_witsml_orgschemas131_cs_wellDatum_defaultVerticalDepth', _module_typeBindings.logicalBoolean)
    __defaultVerticalDepth._DeclarationLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 107, 2)
    __defaultVerticalDepth._UseLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 107, 2)
    
    defaultVerticalDepth = property(__defaultVerticalDepth.value, __defaultVerticalDepth.set, None, 'True indicates that this is the default reference datum\n\t\t\t\tfor vertical depth coordinates. \n\t\t\t\tFalse or not given indicates that this is not the default reference datum.\n\t\t\t\tVertical depth coordinates that do not specify a datum reference should be \n\t\t\t\tassumed to be measured relative to the default reference datum.\n\t\t\t\tOnly one reference datum may be designated as the default vertical depth datum for each well.\n\t\t\t\tValues are "true" (or "1") and "false" ( or "0").')

    
    # Attribute defaultElevation uses Python identifier defaultElevation
    __defaultElevation = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'defaultElevation'), 'defaultElevation', '__httpwww_witsml_orgschemas131_cs_wellDatum_defaultElevation', _module_typeBindings.logicalBoolean)
    __defaultElevation._DeclarationLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 118, 2)
    __defaultElevation._UseLocation = pyxb.utils.utility.Location('cs_wellDatum.xsd', 118, 2)
    
    defaultElevation = property(__defaultElevation.value, __defaultElevation.set, None, 'True indicates that this is the default reference datum\n\t\t\t\tfor elevation coordinates.  \n\t\t\t\tFalse or not given indicates that this is not the default reference datum.\n\t\t\t\tElevation coordinates that do not specify a datum reference should be assumed to be\n\t\t\t\tmeasured relative to the default reference datum.\n\t\t\t\tOnly one reference datum may be designated as the default elevation datum for each well.\n\t\t\t\tValues are "true" (or "1") and "false" ( or "0").')
    ...
    _AttributeMap.update({
        __uid.name() : __uid,
        __defaultMeasuredDepth.name() : __defaultMeasuredDepth,
        __defaultVerticalDepth.name() : __defaultVerticalDepth,
        __defaultElevation.name() : __defaultElevation
    })
_module_typeBindings.cs_wellDatum = cs_wellDatum
Namespace.addCategoryObject('typeBinding', 'cs_wellDatum', cs_wellDatum)


# Complex type {http://www.witsml.org/schemas/131}obj_well with content type ELEMENT_ONLY
class obj_well (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_well with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_well')
    _XSDLocation = pyxb.utils.utility.Location('obj_well.xsd', 59, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}nameLegal uses Python identifier nameLegal
    __nameLegal = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameLegal'), 'nameLegal', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131nameLegal', False, pyxb.utils.utility.Location('grp_well.xsd', 26, 3), )

    
    nameLegal = property(__nameLegal.value, __nameLegal.set, None, 'Legal name of the well.  ')

    
    # Element {http://www.witsml.org/schemas/131}numLicense uses Python identifier numLicense
    __numLicense = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numLicense'), 'numLicense', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131numLicense', False, pyxb.utils.utility.Location('grp_well.xsd', 31, 3), )

    
    numLicense = property(__numLicense.value, __numLicense.set, None, 'License number of the well.  ')

    
    # Element {http://www.witsml.org/schemas/131}numGovt uses Python identifier numGovt
    __numGovt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numGovt'), 'numGovt', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131numGovt', False, pyxb.utils.utility.Location('grp_well.xsd', 36, 3), )

    
    numGovt = property(__numGovt.value, __numGovt.set, None, 'Government assigned well number.  ')

    
    # Element {http://www.witsml.org/schemas/131}dTimLicense uses Python identifier dTimLicense
    __dTimLicense = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimLicense'), 'dTimLicense', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131dTimLicense', False, pyxb.utils.utility.Location('grp_well.xsd', 41, 3), )

    
    dTimLicense = property(__dTimLicense.value, __dTimLicense.set, None, 'Date and time license  was issued.  ')

    
    # Element {http://www.witsml.org/schemas/131}field uses Python identifier field
    __field = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'field'), 'field', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131field', False, pyxb.utils.utility.Location('grp_well.xsd', 46, 3), )

    
    field = property(__field.value, __field.set, None, 'Name of the field in which the well is located.  ')

    
    # Element {http://www.witsml.org/schemas/131}country uses Python identifier country
    __country = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'country'), 'country', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131country', False, pyxb.utils.utility.Location('grp_well.xsd', 51, 3), )

    
    country = property(__country.value, __country.set, None, 'Country in which well is located.  ')

    
    # Element {http://www.witsml.org/schemas/131}state uses Python identifier state
    __state = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'state'), 'state', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131state', False, pyxb.utils.utility.Location('grp_well.xsd', 56, 3), )

    
    state = property(__state.value, __state.set, None, 'State or province in which well is located.  ')

    
    # Element {http://www.witsml.org/schemas/131}county uses Python identifier county
    __county = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'county'), 'county', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131county', False, pyxb.utils.utility.Location('grp_well.xsd', 61, 3), )

    
    county = property(__county.value, __county.set, None, 'County in which the well is located.  ')

    
    # Element {http://www.witsml.org/schemas/131}region uses Python identifier region
    __region = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'region'), 'region', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131region', False, pyxb.utils.utility.Location('grp_well.xsd', 66, 3), )

    
    region = property(__region.value, __region.set, None, 'Geo-political region.  ')

    
    # Element {http://www.witsml.org/schemas/131}district uses Python identifier district
    __district = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'district'), 'district', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131district', False, pyxb.utils.utility.Location('grp_well.xsd', 71, 3), )

    
    district = property(__district.value, __district.set, None, 'Geo-political district name.  ')

    
    # Element {http://www.witsml.org/schemas/131}block uses Python identifier block
    __block = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'block'), 'block', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131block', False, pyxb.utils.utility.Location('grp_well.xsd', 76, 3), )

    
    block = property(__block.value, __block.set, None, 'Block name in which well is located.  ')

    
    # Element {http://www.witsml.org/schemas/131}timeZone uses Python identifier timeZone
    __timeZone = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'timeZone'), 'timeZone', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131timeZone', False, pyxb.utils.utility.Location('grp_well.xsd', 81, 3), )

    
    timeZone = property(__timeZone.value, __timeZone.set, None, 'The time zone in which well is located.  \n\t\t\t\t\tIt is the deviation in hours and minutes from UTC.\n\t\t\t\t\tThis should be the normal time zone at the well and not a seasonally \n\t\t\t\t\tadjusted value such as daylight savings time.\n\t\t\t\t\tWhile the time zone is optional in a date time value, it is strongly\n\t\t\t\t\tadvised that the zone always be specified in each date time value.\n\t\t\t\t\tThe time zone in a date time value may use seasonally adjusted values.')

    
    # Element {http://www.witsml.org/schemas/131}operator uses Python identifier operator
    __operator = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'operator'), 'operator', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131operator', False, pyxb.utils.utility.Location('grp_well.xsd', 92, 3), )

    
    operator = property(__operator.value, __operator.set, None, 'Operator company name.  ')

    
    # Element {http://www.witsml.org/schemas/131}operatorDiv uses Python identifier operatorDiv
    __operatorDiv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'operatorDiv'), 'operatorDiv', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131operatorDiv', False, pyxb.utils.utility.Location('grp_well.xsd', 97, 3), )

    
    operatorDiv = property(__operatorDiv.value, __operatorDiv.set, None, 'Division of operator company.  ')

    
    # Element {http://www.witsml.org/schemas/131}pcInterest uses Python identifier pcInterest
    __pcInterest = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'pcInterest'), 'pcInterest', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131pcInterest', False, pyxb.utils.utility.Location('grp_well.xsd', 102, 3), )

    
    pcInterest = property(__pcInterest.value, __pcInterest.set, None, 'Interest for Operator. Commonly in percent.  ')

    
    # Element {http://www.witsml.org/schemas/131}numAPI uses Python identifier numAPI
    __numAPI = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numAPI'), 'numAPI', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131numAPI', False, pyxb.utils.utility.Location('grp_well.xsd', 107, 3), )

    
    numAPI = property(__numAPI.value, __numAPI.set, None, 'American Petroleum Institute well number.  ')

    
    # Element {http://www.witsml.org/schemas/131}statusWell uses Python identifier statusWell
    __statusWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'statusWell'), 'statusWell', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131statusWell', False, pyxb.utils.utility.Location('grp_well.xsd', 112, 3), )

    
    statusWell = property(__statusWell.value, __statusWell.set, None, 'POSC Well status.  ')

    
    # Element {http://www.witsml.org/schemas/131}purposeWell uses Python identifier purposeWell
    __purposeWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'purposeWell'), 'purposeWell', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131purposeWell', False, pyxb.utils.utility.Location('grp_well.xsd', 117, 3), )

    
    purposeWell = property(__purposeWell.value, __purposeWell.set, None, 'POSC well purpose.  ')

    
    # Element {http://www.witsml.org/schemas/131}fluidWell uses Python identifier fluidWell
    __fluidWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'fluidWell'), 'fluidWell', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131fluidWell', False, pyxb.utils.utility.Location('grp_well.xsd', 122, 3), )

    
    fluidWell = property(__fluidWell.value, __fluidWell.set, None, 'POSC well fluid. The type of fluid being produced from or injected \n\t\t\t\t\tinto a well facility. ')

    
    # Element {http://www.witsml.org/schemas/131}directionWell uses Python identifier directionWell
    __directionWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'directionWell'), 'directionWell', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131directionWell', False, pyxb.utils.utility.Location('grp_well.xsd', 128, 3), )

    
    directionWell = property(__directionWell.value, __directionWell.set, None, 'POSC well direction. The direction of flow of the fluids in a well facility\n\t\t\t\t\t(generally, injected or produced, or some combination). ')

    
    # Element {http://www.witsml.org/schemas/131}dTimSpud uses Python identifier dTimSpud
    __dTimSpud = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimSpud'), 'dTimSpud', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131dTimSpud', False, pyxb.utils.utility.Location('grp_well.xsd', 134, 3), )

    
    dTimSpud = property(__dTimSpud.value, __dTimSpud.set, None, 'Date and time at which well was spudded.  ')

    
    # Element {http://www.witsml.org/schemas/131}dTimPa uses Python identifier dTimPa
    __dTimPa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimPa'), 'dTimPa', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131dTimPa', False, pyxb.utils.utility.Location('grp_well.xsd', 139, 3), )

    
    dTimPa = property(__dTimPa.value, __dTimPa.set, None, 'Date and time at which well was plugged and abandoned.  ')

    
    # Element {http://www.witsml.org/schemas/131}wellheadElevation uses Python identifier wellheadElevation
    __wellheadElevation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellheadElevation'), 'wellheadElevation', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131wellheadElevation', False, pyxb.utils.utility.Location('grp_well.xsd', 144, 3), )

    
    wellheadElevation = property(__wellheadElevation.value, __wellheadElevation.set, None, 'Elevation of wellhead relative to a wellDatum.  ')

    
    # Element {http://www.witsml.org/schemas/131}wellDatum uses Python identifier wellDatum
    __wellDatum = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellDatum'), 'wellDatum', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131wellDatum', True, pyxb.utils.utility.Location('grp_well.xsd', 149, 3), )

    
    wellDatum = property(__wellDatum.value, __wellDatum.set, None, 'A datum to which elevations and depths are referenced. ')

    
    # Element {http://www.witsml.org/schemas/131}groundElevation uses Python identifier groundElevation
    __groundElevation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'groundElevation'), 'groundElevation', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131groundElevation', False, pyxb.utils.utility.Location('grp_well.xsd', 154, 3), )

    
    groundElevation = property(__groundElevation.value, __groundElevation.set, None, 'Elevation of ground level (land rigs).  ')

    
    # Element {http://www.witsml.org/schemas/131}waterDepth uses Python identifier waterDepth
    __waterDepth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'waterDepth'), 'waterDepth', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131waterDepth', False, pyxb.utils.utility.Location('grp_well.xsd', 159, 3), )

    
    waterDepth = property(__waterDepth.value, __waterDepth.set, None, 'Depth of water (not land rigs).  ')

    
    # Element {http://www.witsml.org/schemas/131}wellLocation uses Python identifier wellLocation
    __wellLocation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellLocation'), 'wellLocation', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131wellLocation', True, pyxb.utils.utility.Location('grp_well.xsd', 164, 3), )

    
    wellLocation = property(__wellLocation.value, __wellLocation.set, None, 'the 2D coordinates of the well surface point in one coordinate reference system. \n\t\t\t\t\tThis is where the well crosses ground level on land and crosses the platform offshore.  ')

    
    # Element {http://www.witsml.org/schemas/131}referencePoint uses Python identifier referencePoint
    __referencePoint = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'referencePoint'), 'referencePoint', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131referencePoint', True, pyxb.utils.utility.Location('grp_well.xsd', 170, 3), )

    
    referencePoint = property(__referencePoint.value, __referencePoint.set, None, 'Defines a reference point within the context of the well.  ')

    
    # Element {http://www.witsml.org/schemas/131}wellCRS uses Python identifier wellCRS
    __wellCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellCRS'), 'wellCRS', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131wellCRS', True, pyxb.utils.utility.Location('grp_well.xsd', 175, 3), )

    
    wellCRS = property(__wellCRS.value, __wellCRS.set, None, 'A coordinate reference system that was used within \n\t\t\t\t\tthe context of this well.  ')

    
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_well.xsd', 61, 3), )

    
    name = property(__name.value, __name.set, None, 'Human recognizable context for the well.  ')

    
    # Element {http://www.witsml.org/schemas/131}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_well.xsd', 71, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_well_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_well.xsd', 77, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_well_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    ...
    _ElementMap.update({
        __nameLegal.name() : __nameLegal,
        __numLicense.name() : __numLicense,
        __numGovt.name() : __numGovt,
        __dTimLicense.name() : __dTimLicense,
        __field.name() : __field,
        __country.name() : __country,
        __state.name() : __state,
        __county.name() : __county,
        __region.name() : __region,
        __district.name() : __district,
        __block.name() : __block,
        __timeZone.name() : __timeZone,
        __operator.name() : __operator,
        __operatorDiv.name() : __operatorDiv,
        __pcInterest.name() : __pcInterest,
        __numAPI.name() : __numAPI,
        __statusWell.name() : __statusWell,
        __purposeWell.name() : __purposeWell,
        __fluidWell.name() : __fluidWell,
        __directionWell.name() : __directionWell,
        __dTimSpud.name() : __dTimSpud,
        __dTimPa.name() : __dTimPa,
        __wellheadElevation.name() : __wellheadElevation,
        __wellDatum.name() : __wellDatum,
        __groundElevation.name() : __groundElevation,
        __waterDepth.name() : __waterDepth,
        __wellLocation.name() : __wellLocation,
...
_module_typeBindings.obj_well = obj_well
Namespace.addCategoryObject('typeBinding', 'obj_well', obj_well)
...
wells = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wells'), obj_wells, documentation='The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('obj_well.xsd', 25, 1))
Namespace.addCategoryObject('elementBinding', wells.name().localName(), wells)
...
cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameCRS'), wellKnownNameStruct, scope=cs_geodeticModel, documentation="The name of the coordinate reference system in a particular naming system.\n\t\t\t\t\tAn optional short name (code) can also be specified. Specifying a well known system is highly desired.\n\t\t\t\t\tAn example would be to specify a name of 'ED50' with a code of '4230' in\n\t\t\t\t\tthe 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting\n\t\t\t\t\tthat the parameters in the EPSG database are appropriate for this CRS. This is \n\t\t\t\t\talso true for any other naming system. If in doubt, contact your local geodesist.", location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 23, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'geodeticDatumCode'), GeodeticDatum, scope=cs_geodeticModel, documentation='Geodetic datum code. This defines a system in the Geoshare naming system\n\t\t\t\t\tand should probably not be used with CRSName.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 33, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'xTranslation'), lengthMeasure, scope=cs_geodeticModel, documentation='Ellipsoid translation (3). Units are meters by convention.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 39, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'yTranslation'), lengthMeasure, scope=cs_geodeticModel, documentation='Ellipsoid translation (3). Units are meters by convention.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 44, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'zTranslation'), lengthMeasure, scope=cs_geodeticModel, documentation='Ellipsoid translation (3). Units are meters by convention.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 49, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'xRotation'), planeAngleMeasure, scope=cs_geodeticModel, documentation='Ellipsoid rotation (3). Seconds of arc by convention.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 54, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'yRotation'), planeAngleMeasure, scope=cs_geodeticModel, documentation='Ellipsoid rotation (3). Seconds of arc by convention.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 59, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'zRotation'), planeAngleMeasure, scope=cs_geodeticModel, documentation='Ellipsoid rotation (3). Seconds of arc by convention.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 64, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'scaleFactor'), unitlessQuantity, scope=cs_geodeticModel, documentation='Ellipsoid scale factor.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 69, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidCode'), Ellipsoid, scope=cs_geodeticModel, documentation='Ellipsoid code (spheroid) defining geographic or planar coordinates. \n\t\t\t\t\tImplied if geodeticDatumCode is specified (and is not user defined). ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 74, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidSemiMajorAxis'), lengthMeasure, scope=cs_geodeticModel, documentation='Ellipsoid semi-major axis size. Implied if geodeticDatumCode or ellipsoidCode \n\t\t\t\t\tspecified.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 80, 3)))

cs_geodeticModel._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidInverseFlattening'), unitlessQuantity, scope=cs_geodeticModel, documentation='Ellipsoid inverse flattening value (ie. 1/x). Implied if geodeticDatumCode \n\t\t\t\t\tor ellipsoidCode specified.  ', location=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 86, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 23, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 39, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 44, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 49, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 54, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 59, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 64, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 69, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 74, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 80, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_geodeticModel.xsd', 86, 3))
    counters.add(cc_11)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameCRS')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'geodeticDatumCode')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 33, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'xTranslation')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 39, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'yTranslation')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 44, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'zTranslation')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 49, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'xRotation')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 54, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'yRotation')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 59, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'zRotation')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 64, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'scaleFactor')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 69, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidCode')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 74, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidSemiMajorAxis')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 80, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_geodeticModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ellipsoidInverseFlattening')), pyxb.utils.utility.Location('cs_geodeticModel.xsd', 86, 3))
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
cs_geodeticModel._Automaton = _BuildAutomaton_7()




cs_localCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'usesWellAsOrigin'), logicalBoolean, scope=cs_localCRS, documentation='True ("true" or "1") indicates that the well surface\n\t\t\t\t\t\tpoint is the origin of this CRS.  \n\t\t\t\t\t\tFalse ("false" or "0") or not given indicates otherwise.', location=pyxb.utils.utility.Location('cs_localCRS.xsd', 21, 4)))

cs_localCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'origin'), refNameString, scope=cs_localCRS, documentation='A pointer to the reference point that is the origin\n\t\t\t\t\t\tof this CRS.', location=pyxb.utils.utility.Location('cs_localCRS.xsd', 28, 4)))

cs_localCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'originDescription'), commentString, scope=cs_localCRS, documentation='A textual description of the origin.', location=pyxb.utils.utility.Location('cs_localCRS.xsd', 34, 4)))

cs_localCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'yAxisAzimuth'), yAxisAzimuth, scope=cs_localCRS, documentation='The angle of the Y axis from North (as described \n\t\t\t\t\tin attribute northDirection). Defaults to zero. Positive clockwise.', location=pyxb.utils.utility.Location('cs_localCRS.xsd', 40, 3)))

cs_localCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'yAxisDescription'), commentString, scope=cs_localCRS, documentation="A free-form description of the Y axis. \n\t\t\t\t\tExamples would be 'parallel to the west side of the platform', or \n\t\t\t\t\t'along the main entry road'.", location=pyxb.utils.utility.Location('cs_localCRS.xsd', 46, 3)))

cs_localCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'xRotationCounterClockwise'), logicalBoolean, scope=cs_localCRS, documentation='True ("true" or "1") indicates that the X axis is rotated \n\t\t\t\t\tcounter-clockwise from the Y axis when viewed from above the earth looking down.\n\t\t\t\t\tFalse ("false" or "0") or not given indicates a clockwise rotation. \n\t\t\t\t\tGenerally the X axis is rotated clockwise.', location=pyxb.utils.utility.Location('cs_localCRS.xsd', 53, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 20, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 21, 4))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 28, 4))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 34, 4))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 40, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 46, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_localCRS.xsd', 53, 3))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_localCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'usesWellAsOrigin')), pyxb.utils.utility.Location('cs_localCRS.xsd', 21, 4))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_localCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'origin')), pyxb.utils.utility.Location('cs_localCRS.xsd', 28, 4))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_localCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'originDescription')), pyxb.utils.utility.Location('cs_localCRS.xsd', 34, 4))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_localCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'yAxisAzimuth')), pyxb.utils.utility.Location('cs_localCRS.xsd', 40, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_localCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'yAxisDescription')), pyxb.utils.utility.Location('cs_localCRS.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_localCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'xRotationCounterClockwise')), pyxb.utils.utility.Location('cs_localCRS.xsd', 53, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_5._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_localCRS._Automaton = _BuildAutomaton_8()




cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameCRS'), wellKnownNameStruct, scope=cs_projectionx, documentation="The name of the coordinate reference system in a particular naming system.\n\t\t\t\t\tAn optional short name (code) can also be specified. Specifying a well known system is highly desired.\n\t\t\t\t\tAn example would be to specify a name of 'WGS 84 / UTM zone 10N' with a code of '32610' in\n\t\t\t\t\tthe 'EPSG' naming system. Note that specifying a name in the EPSG naming system is asserting\n\t\t\t\t\tthat the parameters in the EPSG database are appropriate for this CRS. This is \n\t\t\t\t\talso true for any other naming system. If in doubt, contact your local geodesist.", location=pyxb.utils.utility.Location('cs_projectionx.xsd', 23, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'projectionCode'), Projection, scope=cs_projectionx, documentation='A code to identify the type of projection.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 33, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'projectedFrom'), refNameString, scope=cs_projectionx, documentation='A pointer to the wellCRS that represents the geographic\n\t\t\t\t\tsystem from which this system was projected.', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 38, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stdParallel1'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude of first standard parallel.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 44, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stdParallel2'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude of second standard parallel, if used.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 49, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'centralMeridian'), planeAngleMeasure, scope=cs_projectionx, documentation='Longitude of the Y axis of the resulting map.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 54, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'originLatitude'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude at which the X axis intersects the central meridian.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 59, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'originLongitude'), planeAngleMeasure, scope=cs_projectionx, documentation='Longitude of the central meridian.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 64, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'latitude1'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude of the first point if the two-point specification \n\t\t\t\t\tof the central line is used.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 69, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'longitude1'), planeAngleMeasure, scope=cs_projectionx, documentation='Longitude of the first point if the two-point specification \n\t\t\t\t\tof the central line is used.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 75, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'latitude2'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude of the second point if the two-point specification \n\t\t\t\t\tof the central line is used.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 81, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'longitude2'), planeAngleMeasure, scope=cs_projectionx, documentation='Longitude of the second point if the two-point specification \n\t\t\t\t\tof the central line is used.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 87, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'latitudeForScale'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude of a point for which the scale factor is specified exactly. \n\t\t\t\t\tDefault to origin.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 93, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'longitudeForScale'), planeAngleMeasure, scope=cs_projectionx, documentation='Longitude of a point for which the scale factor is specified exactly. \n\t\t\t\t\tDefault to origin.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 99, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'trueScaleLatitude'), planeAngleMeasure, scope=cs_projectionx, documentation='Latitude at which the scale on the map is exact. If none is provided, \n\t\t\t\t\tscale is assumed to be exact at the equator.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 105, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'spheroidRadius'), lengthMeasure, scope=cs_projectionx, documentation='Spheroid radius.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 111, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'scaleFactor'), unitlessQuantity, scope=cs_projectionx, documentation='Ellipsoid scale factor.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 116, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'methodVariant'), ProjectionVariantsObliqueMercator, scope=cs_projectionx, documentation='Projection method variant - establishes minor variations of the projection. \n\t\t\t\t\tGeoshare proposal.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 121, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'perspectiveHeight'), lengthMeasure, scope=cs_projectionx, documentation='Height above the surface origin location from which the perspective is taken.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 127, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'zone'), geodeticZoneString, scope=cs_projectionx, documentation='Zone for the type of projection. Zones have values from 1 to 60\n\t\t\t\t\twith a required direction of "N" (North) or "S" (South). For example, "21N". ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 132, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'NADType'), NADTypes, scope=cs_projectionx, documentation='North American Datum type.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 138, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'falseEasting'), lengthMeasure, scope=cs_projectionx, documentation='Artificial value added to the X axis.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 143, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'falseNorthing'), lengthMeasure, scope=cs_projectionx, documentation='Artificial value added to the Y axis.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 148, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bearing'), planeAngleMeasure, scope=cs_projectionx, documentation='Bearing angle of the great circle with respect to north at the central \n\t\t\t\t\tpoint.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 153, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'hemisphere'), Hemispheres, scope=cs_projectionx, documentation='Is the projection in the northern hemisphere or the southern hemisphere.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 159, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=cs_projectionx, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 164, 3)))

cs_projectionx._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'parameter'), indexedObject, scope=cs_projectionx, documentation='Parameter describing the user-defined projection.  ', location=pyxb.utils.utility.Location('cs_projectionx.xsd', 169, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 23, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 38, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 44, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 49, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 54, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 59, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 64, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 69, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 75, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 81, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 87, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 93, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 99, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 105, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 111, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 116, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 121, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 127, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 132, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 138, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 143, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 148, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 153, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 159, 3))
    counters.add(cc_24)
    cc_25 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 164, 3))
    counters.add(cc_25)
    cc_26 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_projectionx.xsd', 169, 3))
    counters.add(cc_26)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameCRS')), pyxb.utils.utility.Location('cs_projectionx.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'projectionCode')), pyxb.utils.utility.Location('cs_projectionx.xsd', 33, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'projectedFrom')), pyxb.utils.utility.Location('cs_projectionx.xsd', 38, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stdParallel1')), pyxb.utils.utility.Location('cs_projectionx.xsd', 44, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stdParallel2')), pyxb.utils.utility.Location('cs_projectionx.xsd', 49, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'centralMeridian')), pyxb.utils.utility.Location('cs_projectionx.xsd', 54, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'originLatitude')), pyxb.utils.utility.Location('cs_projectionx.xsd', 59, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'originLongitude')), pyxb.utils.utility.Location('cs_projectionx.xsd', 64, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'latitude1')), pyxb.utils.utility.Location('cs_projectionx.xsd', 69, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'longitude1')), pyxb.utils.utility.Location('cs_projectionx.xsd', 75, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'latitude2')), pyxb.utils.utility.Location('cs_projectionx.xsd', 81, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'longitude2')), pyxb.utils.utility.Location('cs_projectionx.xsd', 87, 3))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'latitudeForScale')), pyxb.utils.utility.Location('cs_projectionx.xsd', 93, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'longitudeForScale')), pyxb.utils.utility.Location('cs_projectionx.xsd', 99, 3))
    st_13 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'trueScaleLatitude')), pyxb.utils.utility.Location('cs_projectionx.xsd', 105, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'spheroidRadius')), pyxb.utils.utility.Location('cs_projectionx.xsd', 111, 3))
    st_15 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'scaleFactor')), pyxb.utils.utility.Location('cs_projectionx.xsd', 116, 3))
    st_16 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'methodVariant')), pyxb.utils.utility.Location('cs_projectionx.xsd', 121, 3))
    st_17 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'perspectiveHeight')), pyxb.utils.utility.Location('cs_projectionx.xsd', 127, 3))
    st_18 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'zone')), pyxb.utils.utility.Location('cs_projectionx.xsd', 132, 3))
    st_19 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'NADType')), pyxb.utils.utility.Location('cs_projectionx.xsd', 138, 3))
    st_20 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'falseEasting')), pyxb.utils.utility.Location('cs_projectionx.xsd', 143, 3))
    st_21 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'falseNorthing')), pyxb.utils.utility.Location('cs_projectionx.xsd', 148, 3))
    st_22 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bearing')), pyxb.utils.utility.Location('cs_projectionx.xsd', 153, 3))
    st_23 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'hemisphere')), pyxb.utils.utility.Location('cs_projectionx.xsd', 159, 3))
    st_24 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_25, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_projectionx.xsd', 164, 3))
    st_25 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_26, False))
    symbol = pyxb.binding.content.ElementUse(cs_projectionx._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parameter')), pyxb.utils.utility.Location('cs_projectionx.xsd', 169, 3))
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
cs_projectionx._Automaton = _BuildAutomaton_9()




cs_refWellWellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellboreReference'), refNameString, scope=cs_refWellWellbore, documentation='A pointer the wellbore with which there is a relationship.', location=pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 26, 3)))

cs_refWellWellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellParent'), refNameString, scope=cs_refWellWellbore, documentation='A pointer to the well that contains the wellboreReference.\n\t\t\t\t\tThis is not needed unless the referenced wellbore is outside the \n\t\t\t\t\tcontext of a common parent well.', location=pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 31, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 31, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_refWellWellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellboreReference')), pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_refWellWellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellParent')), pyxb.utils.utility.Location('cs_refWellWellbore.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_refWellWellbore._Automaton = _BuildAutomaton_10()




cs_refWellWellboreRig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rigReference'), refNameString, scope=cs_refWellWellboreRig, documentation='A pointer to the rig with which there is a relationship.', location=pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 26, 3)))

cs_refWellWellboreRig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellboreParent'), refNameString, scope=cs_refWellWellboreRig, documentation='A pointer to the wellbore that contains the rigReference.\n\t\t\t\t\tThis is not needed unless the referenced rig is outside the \n\t\t\t\t\tcontext of a common parent wellbore.', location=pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 31, 3)))

cs_refWellWellboreRig._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellParent'), refNameString, scope=cs_refWellWellboreRig, documentation='A pointer to the well that contains the wellboreParent.\n\t\t\t\t\tThis is not needed unless the referenced wellbore is outside the \n\t\t\t\t\tcontext of a common parent well.', location=pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 38, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 31, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 38, 3))
    counters.add(cc_1)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_refWellWellboreRig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rigReference')), pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_refWellWellboreRig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellboreParent')), pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_refWellWellboreRig._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellParent')), pyxb.utils.utility.Location('cs_refWellWellboreRig.xsd', 38, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_2._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_refWellWellboreRig._Automaton = _BuildAutomaton_11()




obj_wells._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_wells, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_well.xsd', 35, 3)))

obj_wells._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'well'), obj_well, scope=obj_wells, documentation='Information about a single well.\n\t\t\t\t\tA well is a unique surface location from which wellbores are drilled \n\t\t\t\t\tinto the Earth for the purpose of either (1) finding or producing \n\t\t\t\t\tunderground resources; or (2) providing services related to the \n\t\t\t\t\tproduction of underground resources.  ', location=pyxb.utils.utility.Location('obj_well.xsd', 40, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_well.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wells._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_well.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wells._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'well')), pyxb.utils.utility.Location('obj_well.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 27, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 44, 4))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 56, 4))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 72, 4))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 90, 4))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 110, 4))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 125, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 133, 3))
    counters.add(cc_8)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellCRS')), pyxb.utils.utility.Location('cs_location.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'latitude')), pyxb.utils.utility.Location('cs_location.xsd', 45, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'longitude')), pyxb.utils.utility.Location('cs_location.xsd', 50, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'easting')), pyxb.utils.utility.Location('cs_location.xsd', 57, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'northing')), pyxb.utils.utility.Location('cs_location.xsd', 64, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'westing')), pyxb.utils.utility.Location('cs_location.xsd', 73, 5))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'southing')), pyxb.utils.utility.Location('cs_location.xsd', 81, 5))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'projectedX')), pyxb.utils.utility.Location('cs_location.xsd', 91, 5))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'projectedY')), pyxb.utils.utility.Location('cs_location.xsd', 100, 5))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'localX')), pyxb.utils.utility.Location('cs_location.xsd', 111, 5))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'localY')), pyxb.utils.utility.Location('cs_location.xsd', 117, 5))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'original')), pyxb.utils.utility.Location('cs_location.xsd', 125, 3))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_location.xsd', 133, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_12._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_location._Automaton = _BuildAutomaton_13()




cs_referencePoint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_referencePoint, documentation='Human recognizable context for the point.  ', location=pyxb.utils.utility.Location('cs_referencePoint.xsd', 24, 3)))

cs_referencePoint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), kindString, scope=cs_referencePoint, documentation="The kind of point. For example, \n\t\t\t\t\t'well reference point', 'platform reference point', 'sea surface',\n\t\t\t\t\t'sea bottom'.  ", location=pyxb.utils.utility.Location('cs_referencePoint.xsd', 29, 3)))

cs_referencePoint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'elevation'), wellElevationCoord, scope=cs_referencePoint, documentation='The gravity based elevation coordinate of this point \n\t\t\t\t\tas measured from a datum. Positive moving upward from the elevation datum. ', location=pyxb.utils.utility.Location('cs_referencePoint.xsd', 36, 3)))

cs_referencePoint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'measuredDepth'), measuredDepthCoord, scope=cs_referencePoint, documentation='The measured depth coordinate of this reference point.\n\t\t\t\t\tPositive moving toward the bottomhole from the measured depth datum.\n\t\t\t\t\tThis should be given when the reference is "downhole", such as an ocean \n\t\t\t\t\tbottom template, or when the reference point is also used as a vertical well datum.\n\t\t\t\t\tThe measured depth value can be used to determine if the reference point\n\t\t\t\t\tand a vertical well datum are at the same point.', location=pyxb.utils.utility.Location('cs_referencePoint.xsd', 42, 3)))

cs_referencePoint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'location'), cs_location, scope=cs_referencePoint, documentation='Two dimensional coordinates that locate the point.  ', location=pyxb.utils.utility.Location('cs_referencePoint.xsd', 52, 3)))

cs_referencePoint._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=cs_referencePoint, documentation='A textual description of the point.  ', location=pyxb.utils.utility.Location('cs_referencePoint.xsd', 57, 3)))
...
def _BuildAutomaton_14 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_referencePoint.xsd', 29, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_referencePoint.xsd', 36, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_referencePoint.xsd', 42, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_referencePoint.xsd', 57, 3))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_referencePoint._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_referencePoint.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_referencePoint._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('cs_referencePoint.xsd', 29, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_referencePoint._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'elevation')), pyxb.utils.utility.Location('cs_referencePoint.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_referencePoint._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'measuredDepth')), pyxb.utils.utility.Location('cs_referencePoint.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_referencePoint._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'location')), pyxb.utils.utility.Location('cs_referencePoint.xsd', 52, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_referencePoint._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_referencePoint.xsd', 57, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_5._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_referencePoint._Automaton = _BuildAutomaton_14()




cs_wellCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_wellCRS, documentation='Human recognizable context for the system. \n\t\t\t\t\tFor a geographic system this is commonly the name of the datum. ', location=pyxb.utils.utility.Location('cs_wellCRS.xsd', 31, 3)))

cs_wellCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mapProjection'), cs_projectionx, scope=cs_wellCRS, documentation='Map projection system.  ', location=pyxb.utils.utility.Location('cs_wellCRS.xsd', 43, 4)))

cs_wellCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'geographic'), cs_geodeticModel, scope=cs_wellCRS, documentation='Geographic system.  ', location=pyxb.utils.utility.Location('cs_wellCRS.xsd', 48, 4)))

cs_wellCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'localCRS'), cs_localCRS, scope=cs_wellCRS, documentation='Local (engineering) system.  ', location=pyxb.utils.utility.Location('cs_wellCRS.xsd', 53, 4)))

cs_wellCRS._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), descriptionString, scope=cs_wellCRS, documentation='A textual description of the system.  ', location=pyxb.utils.utility.Location('cs_wellCRS.xsd', 59, 3)))
...
def _BuildAutomaton_15 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellCRS.xsd', 37, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellCRS.xsd', 43, 4))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellCRS.xsd', 48, 4))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellCRS.xsd', 53, 4))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellCRS.xsd', 59, 3))
    counters.add(cc_4)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_wellCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_wellCRS.xsd', 31, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mapProjection')), pyxb.utils.utility.Location('cs_wellCRS.xsd', 43, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'geographic')), pyxb.utils.utility.Location('cs_wellCRS.xsd', 48, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'localCRS')), pyxb.utils.utility.Location('cs_wellCRS.xsd', 53, 4))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellCRS._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_wellCRS.xsd', 59, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_4._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_wellCRS._Automaton = _BuildAutomaton_15()




cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_wellDatum, documentation='The human understandable contextual name of the reference datum.', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 27, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'code'), ElevCodeEnum, scope=cs_wellDatum, documentation='The code value that represents the type of reference datum. \n\t\t\t\t\tThis may represent a point on a device (e.g., kelly bushing) or it may represent \n\t\t\t\t\ta vertical reference datum (e.g., mean sea level).', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 32, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'datumName'), wellKnownNameStruct, scope=cs_wellDatum, documentation="The name of the vertical reference datum in a particular naming system.\n\t\t\t\t\tThis should only be specified if the above 'code' represents some variation of sea level.\n\t\t\t\t\tAn optional short name (code) can also be specified. Specifying a well known datum is highly desired \n\t\t\t\t\tif the above code is a variant of sea level because sea level varies over time and space.\n\t\t\t\t\tAn example would be to specify a name of 'Caspian Sea' with a code of '5106' in\n\t\t\t\t\tthe 'EPSG' naming system.", location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 39, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'kind'), kindString, scope=cs_wellDatum, documentation="Since various activities may use different points as \n\t\t\t\t\tmeasurement datums, it is useful to characterize the point based on its usage. \n\t\t\t\t\tA well reference datum may have more than one such characterization. \n\t\t\t\t\tFor example, it may be the datum used by the driller and logger for measuring \n\t\t\t\t\ttheir depths. Example usage values would be 'permanent','driller', 'logger'\n\t\t\t\t\t'WRP' (well reference point) and 'SRP' (site reference point).", location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 49, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellbore'), cs_refWellWellbore, scope=cs_wellDatum, documentation='A pointer to the wellbore that contains the reference datum.\n\t\t\t\t\tThis should be specified if a measured depth is given.', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 59, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rig'), cs_refWellWellboreRig, scope=cs_wellDatum, documentation='A pointer to the rig that contains the device used \n\t\t\t\t\tas a reference datum. The rig may be associated with a wellbore in another well\n\t\t\t\t\t(e.g., pattern drilling using a rig on a track).', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 65, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'elevation'), wellElevationCoord, scope=cs_wellDatum, documentation='The gravity based elevation coordinate of this reference datum \n\t\t\t\t\tas measured from another datum. Positive moving upward from the elevation datum.\n\t\t\t\t\tAn elevation should be given unless this is a vertical reference datum (e.g., sea level). ', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 72, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'measuredDepth'), measuredDepthCoord, scope=cs_wellDatum, documentation='The measured depth coordinate of this reference datum\n\t\t\t\t\tas measured from another datum. The measured depth datum should either be the same as\n\t\t\t\t\tthe elevation datum or it should be relatable to the elevation datum through other datums.\n\t\t\t\t\tPositive moving toward the bottomhole from the measured depth datum.\n\t\t\t\t\tThis should be given when a local reference is "downhole", \n\t\t\t\t\tsuch as a kickoff point or ocean bottom template, and the borehole may not be vertical.\n\t\t\t\t\tIf a Depth is given then an Elevation should also be given.', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 79, 3)))

cs_wellDatum._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comment'), commentString, scope=cs_wellDatum, documentation='A contextual description of the well reference datum.', location=pyxb.utils.utility.Location('cs_wellDatum.xsd', 90, 3)))
...
def _BuildAutomaton_16 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 27, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 32, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 39, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 49, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 59, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 65, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 72, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 79, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_wellDatum.xsd', 90, 3))
    counters.add(cc_8)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'code')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'datumName')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 39, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'kind')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 49, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellbore')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 59, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rig')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 65, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'elevation')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 72, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'measuredDepth')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 79, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_wellDatum._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comment')), pyxb.utils.utility.Location('cs_wellDatum.xsd', 90, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_8._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_wellDatum._Automaton = _BuildAutomaton_16()




obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameLegal'), nameString, scope=obj_well, documentation='Legal name of the well.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 26, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numLicense'), nameString, scope=obj_well, documentation='License number of the well.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 31, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numGovt'), nameString, scope=obj_well, documentation='Government assigned well number.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 36, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimLicense'), timestamp, scope=obj_well, documentation='Date and time license  was issued.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 41, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'field'), nameString, scope=obj_well, documentation='Name of the field in which the well is located.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 46, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'country'), str32, scope=obj_well, documentation='Country in which well is located.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 51, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'state'), str32, scope=obj_well, documentation='State or province in which well is located.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 56, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'county'), str32, scope=obj_well, documentation='County in which the well is located.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 61, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'region'), str32, scope=obj_well, documentation='Geo-political region.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 66, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'district'), str32, scope=obj_well, documentation='Geo-political district name.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 71, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'block'), str32, scope=obj_well, documentation='Block name in which well is located.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 76, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'timeZone'), timeZone, scope=obj_well, documentation='The time zone in which well is located.  \n\t\t\t\t\tIt is the deviation in hours and minutes from UTC.\n\t\t\t\t\tThis should be the normal time zone at the well and not a seasonally \n\t\t\t\t\tadjusted value such as daylight savings time.\n\t\t\t\t\tWhile the time zone is optional in a date time value, it is strongly\n\t\t\t\t\tadvised that the zone always be specified in each date time value.\n\t\t\t\t\tThe time zone in a date time value may use seasonally adjusted values.', location=pyxb.utils.utility.Location('grp_well.xsd', 81, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operator'), nameString, scope=obj_well, documentation='Operator company name.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 92, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operatorDiv'), nameString, scope=obj_well, documentation='Division of operator company.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 97, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pcInterest'), dimensionlessMeasure, scope=obj_well, documentation='Interest for Operator. Commonly in percent.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 102, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numAPI'), str32, scope=obj_well, documentation='American Petroleum Institute well number.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 107, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'statusWell'), WellStatus, scope=obj_well, documentation='POSC Well status.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 112, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'purposeWell'), WellPurpose, scope=obj_well, documentation='POSC well purpose.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 117, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'fluidWell'), WellFluid, scope=obj_well, documentation='POSC well fluid. The type of fluid being produced from or injected \n\t\t\t\t\tinto a well facility. ', location=pyxb.utils.utility.Location('grp_well.xsd', 122, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'directionWell'), WellDirection, scope=obj_well, documentation='POSC well direction. The direction of flow of the fluids in a well facility\n\t\t\t\t\t(generally, injected or produced, or some combination). ', location=pyxb.utils.utility.Location('grp_well.xsd', 128, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimSpud'), timestamp, scope=obj_well, documentation='Date and time at which well was spudded.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 134, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimPa'), timestamp, scope=obj_well, documentation='Date and time at which well was plugged and abandoned.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 139, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellheadElevation'), wellElevationCoord, scope=obj_well, documentation='Elevation of wellhead relative to a wellDatum.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 144, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellDatum'), cs_wellDatum, scope=obj_well, documentation='A datum to which elevations and depths are referenced. ', location=pyxb.utils.utility.Location('grp_well.xsd', 149, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'groundElevation'), wellElevationCoord, scope=obj_well, documentation='Elevation of ground level (land rigs).  ', location=pyxb.utils.utility.Location('grp_well.xsd', 154, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'waterDepth'), wellVerticalDepthCoord, scope=obj_well, documentation='Depth of water (not land rigs).  ', location=pyxb.utils.utility.Location('grp_well.xsd', 159, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellLocation'), cs_location, scope=obj_well, documentation='the 2D coordinates of the well surface point in one coordinate reference system. \n\t\t\t\t\tThis is where the well crosses ground level on land and crosses the platform offshore.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 164, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'referencePoint'), cs_referencePoint, scope=obj_well, documentation='Defines a reference point within the context of the well.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 170, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellCRS'), cs_wellCRS, scope=obj_well, documentation='A coordinate reference system that was used within \n\t\t\t\t\tthe context of this well.  ', location=pyxb.utils.utility.Location('grp_well.xsd', 175, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_well, documentation='Human recognizable context for the well.  ', location=pyxb.utils.utility.Location('obj_well.xsd', 61, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_well, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_well.xsd', 71, 3)))

obj_well._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_well, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_well.xsd', 77, 3)))
...
def _BuildAutomaton_17 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_well.xsd', 66, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 26, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 31, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 36, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 41, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 46, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 51, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 56, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 61, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 66, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 71, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 76, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 81, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 92, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 97, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 102, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 107, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 112, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 117, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 122, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 128, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 134, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 139, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 144, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_well.xsd', 149, 3))
    counters.add(cc_24)
    cc_25 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 154, 3))
    counters.add(cc_25)
    cc_26 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_well.xsd', 159, 3))
    counters.add(cc_26)
    cc_27 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_well.xsd', 164, 3))
    counters.add(cc_27)
    cc_28 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_well.xsd', 170, 3))
    counters.add(cc_28)
    cc_29 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_well.xsd', 175, 3))
    counters.add(cc_29)
    cc_30 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_well.xsd', 71, 3))
    counters.add(cc_30)
    cc_31 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_well.xsd', 77, 3))
    counters.add(cc_31)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_well.xsd', 61, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameLegal')), pyxb.utils.utility.Location('grp_well.xsd', 26, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numLicense')), pyxb.utils.utility.Location('grp_well.xsd', 31, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numGovt')), pyxb.utils.utility.Location('grp_well.xsd', 36, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimLicense')), pyxb.utils.utility.Location('grp_well.xsd', 41, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'field')), pyxb.utils.utility.Location('grp_well.xsd', 46, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'country')), pyxb.utils.utility.Location('grp_well.xsd', 51, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'state')), pyxb.utils.utility.Location('grp_well.xsd', 56, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'county')), pyxb.utils.utility.Location('grp_well.xsd', 61, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'region')), pyxb.utils.utility.Location('grp_well.xsd', 66, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'district')), pyxb.utils.utility.Location('grp_well.xsd', 71, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'block')), pyxb.utils.utility.Location('grp_well.xsd', 76, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'timeZone')), pyxb.utils.utility.Location('grp_well.xsd', 81, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operator')), pyxb.utils.utility.Location('grp_well.xsd', 92, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operatorDiv')), pyxb.utils.utility.Location('grp_well.xsd', 97, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pcInterest')), pyxb.utils.utility.Location('grp_well.xsd', 102, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numAPI')), pyxb.utils.utility.Location('grp_well.xsd', 107, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'statusWell')), pyxb.utils.utility.Location('grp_well.xsd', 112, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'purposeWell')), pyxb.utils.utility.Location('grp_well.xsd', 117, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'fluidWell')), pyxb.utils.utility.Location('grp_well.xsd', 122, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'directionWell')), pyxb.utils.utility.Location('grp_well.xsd', 128, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimSpud')), pyxb.utils.utility.Location('grp_well.xsd', 134, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimPa')), pyxb.utils.utility.Location('grp_well.xsd', 139, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellheadElevation')), pyxb.utils.utility.Location('grp_well.xsd', 144, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellDatum')), pyxb.utils.utility.Location('grp_well.xsd', 149, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_25, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'groundElevation')), pyxb.utils.utility.Location('grp_well.xsd', 154, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_26, False))
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'waterDepth')), pyxb.utils.utility.Location('grp_well.xsd', 159, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellLocation')), pyxb.utils.utility.Location('grp_well.xsd', 164, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'referencePoint')), pyxb.utils.utility.Location('grp_well.xsd', 170, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellCRS')), pyxb.utils.utility.Location('grp_well.xsd', 175, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_well.xsd', 71, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(obj_well._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_well.xsd', 77, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
obj_well._Automaton = _BuildAutomaton_17()
