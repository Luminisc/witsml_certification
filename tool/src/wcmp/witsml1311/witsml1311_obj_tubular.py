...
# Generated 2026-06-22 15:32:50.318331 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:a3ee883a-cbc2-4aaa-9a1e-1bc063571f83')
...
class cs_bitRecord (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __diaPilot.name() : __diaPilot,
        __manufacturer.name() : __manufacturer,
        __typeBit.name() : __typeBit,
        __cost.name() : __cost,
        __codeIADC.name() : __codeIADC,
        __condInitInner.name() : __condInitInner,
        __condInitOuter.name() : __condInitOuter,
        __condInitDull.name() : __condInitDull,
        __condInitLocation.name() : __condInitLocation,
        __condInitBearing.name() : __condInitBearing,
        __condInitGauge.name() : __condInitGauge,
        __condInitOther.name() : __condInitOther,
        __condInitReason.name() : __condInitReason,
        __condFinalInner.name() : __condFinalInner,
        __condFinalOuter.name() : __condFinalOuter,
        __condFinalDull.name() : __condFinalDull,
        __condFinalLocation.name() : __condFinalLocation,
        __condFinalBearing.name() : __condFinalBearing,
        __condFinalGauge.name() : __condFinalGauge,
        __condFinalOther.name() : __condFinalOther,
        __condFinalReason.name() : __condFinalReason,
...
# Complex type {http://www.witsml.org/schemas/131}cs_holeOpener with content type ELEMENT_ONLY
class cs_holeOpener (pyxb.binding.basis.complexTypeDefinition):
...
# Complex type {http://www.witsml.org/schemas/131}cs_jar with content type ELEMENT_ONLY
class cs_jar (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __forDownTrip.name() : __forDownTrip,
        __forPmpOpen.name() : __forPmpOpen,
        __forSealFric.name() : __forSealFric,
...
# Complex type {http://www.witsml.org/schemas/131}cs_motor with content type ELEMENT_ONLY
class cs_motor (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __diaRotorNozzle.name() : __diaRotorNozzle,
        __clearanceBearBox.name() : __clearanceBearBox,
        __lobesRotor.name() : __lobesRotor,
        __lobesStator.name() : __lobesStator,
        __typeBearing.name() : __typeBearing,
        __tempOpMx.name() : __tempOpMx,
        __rotorCatcher.name() : __rotorCatcher,
        __dumpValve.name() : __dumpValve,
        __diaNozzle.name() : __diaNozzle,
        __rotatable.name() : __rotatable,
...
# Complex type {http://www.witsml.org/schemas/131}cs_mwdTool with content type ELEMENT_ONLY
class cs_mwdTool (pyxb.binding.basis.complexTypeDefinition):
...
# Complex type {http://www.witsml.org/schemas/131}cs_rotarySteerableTool with content type ELEMENT_ONLY
class cs_rotarySteerableTool (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __holeSizeMn.name() : __holeSizeMn,
        __holeSizeMx.name() : __holeSizeMx,
        __wobMx.name() : __wobMx,
        __operatingSpeed.name() : __operatingSpeed,
        __speedMx.name() : __speedMx,
        __flowRateMn.name() : __flowRateMn,
        __flowRateMx.name() : __flowRateMx,
        __downLinkFlowRateMn.name() : __downLinkFlowRateMn,
        __downLinkFlowRateMx.name() : __downLinkFlowRateMx,
        __pressLossFact.name() : __pressLossFact,
        __padCount.name() : __padCount,
        __padLen.name() : __padLen,
        __padWidth.name() : __padWidth,
        __padOffset.name() : __padOffset,
        __openPadOd.name() : __openPadOd,
...
# Complex type {http://www.witsml.org/schemas/131}obj_tubulars with content type ELEMENT_ONLY
class obj_tubulars (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_tubulars with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
...
# Complex type {http://www.witsml.org/schemas/131}cs_bend with content type ELEMENT_ONLY
class cs_bend (pyxb.binding.basis.complexTypeDefinition):
...
# Complex type {http://www.witsml.org/schemas/131}cs_connection with content type ELEMENT_ONLY
class cs_connection (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __od.name() : __od,
        __len.name() : __len,
        __typeThread.name() : __typeThread,
        __sizeThread.name() : __sizeThread,
        __tensYield.name() : __tensYield,
        __tqYield.name() : __tqYield,
        __position.name() : __position,
        __criticalCrossSection.name() : __criticalCrossSection,
...
# Complex type {http://www.witsml.org/schemas/131}cs_nameTag with content type ELEMENT_ONLY
class cs_nameTag (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __installationDate.name() : __installationDate,
...
# Complex type {http://www.witsml.org/schemas/131}cs_nozzle with content type ELEMENT_ONLY
class cs_nozzle (pyxb.binding.basis.complexTypeDefinition):
...
# Complex type {http://www.witsml.org/schemas/131}cs_sensor with content type ELEMENT_ONLY
class cs_sensor (pyxb.binding.basis.complexTypeDefinition):
...
# Complex type {http://www.witsml.org/schemas/131}cs_stabilizer with content type ELEMENT_ONLY
class cs_stabilizer (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __odBladeMn.name() : __odBladeMn,
        __distBladeBot.name() : __distBladeBot,
        __shapeBlade.name() : __shapeBlade,
...
# Complex type {http://www.witsml.org/schemas/131}cs_tubularComponent with content type ELEMENT_ONLY
class cs_tubularComponent (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({
        ...
        __odMx.name() : __odMx,
        __len.name() : __len,
        __lenJointAv.name() : __lenJointAv,
        __numJointStand.name() : __numJointStand,
        __wtPerLen.name() : __wtPerLen,
        __grade.name() : __grade,
        __odDrift.name() : __odDrift,
        __tensYield.name() : __tensYield,
        __tqYield.name() : __tqYield,
        __stressFatig.name() : __stressFatig,
        __lenFishneck.name() : __lenFishneck,
        __idFishneck.name() : __idFishneck,
        __odFishneck.name() : __odFishneck,
        __disp.name() : __disp,
        __presBurst.name() : __presBurst,
        __presCollapse.name() : __presCollapse,
        __classService.name() : __classService,
        __wearWall.name() : __wearWall,
        __thickWall.name() : __thickWall,
        __configCon.name() : __configCon,
        __bendStiffness.name() : __bendStiffness,
        __axialStiffness.name() : __axialStiffness,
        __torsionalStiffness.name() : __torsionalStiffness,
        __typeMaterial.name() : __typeMaterial,
        __doglegMx.name() : __doglegMx,
        __vendor.name() : __vendor,
        __model.name() : __model,
        __nameTag.name() : __nameTag,
        __bitRecord.name() : __bitRecord,
        __areaNozzleFlow.name() : __areaNozzleFlow,
        __nozzle.name() : __nozzle,
        __connection.name() : __connection,
        __jar.name() : __jar,
        __mwdTool.name() : __mwdTool,
        __motor.name() : __motor,
        __stabilizer.name() : __stabilizer,
        __bend.name() : __bend,
...
# Complex type {http://www.witsml.org/schemas/131}obj_tubular with content type ELEMENT_ONLY
class obj_tubular (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_tubular with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    ...
    _ElementMap.update({
        ...
        __diaHoleAssy.name() : __diaHoleAssy,
        __tubularComponent.name() : __tubularComponent,
...
cs_bitRecord._Automaton = _BuildAutomaton()
...
cs_commonData._Automaton = _BuildAutomaton_()
...
def _BuildAutomaton_2 ():
    ...
    st_0._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_customData._Automaton = _BuildAutomaton_2()
...
def _BuildAutomaton_3 ():
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_documentInfo._Automaton = _BuildAutomaton_3()
...
def _BuildAutomaton_4 ():
    ...
    st_3._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
fileCreationType._Automaton = _BuildAutomaton_4()
...
def _BuildAutomaton_5 ():
    ...
    st_3._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
securityInfoType._Automaton = _BuildAutomaton_5()
...
def _BuildAutomaton_6 ():
    ...
    st_0._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
auditType._Automaton = _BuildAutomaton_6()
...
def _BuildAutomaton_7 ():
    ...
    st_2._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
eventType._Automaton = _BuildAutomaton_7()
...
def _BuildAutomaton_8 ():
    ...
    st_4._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_holeOpener._Automaton = _BuildAutomaton_8()
...
def _BuildAutomaton_9 ():
    ...
    st_8._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_jar._Automaton = _BuildAutomaton_9()
...
def _BuildAutomaton_10 ():
    ...
    st_16._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_motor._Automaton = _BuildAutomaton_10()
...
def _BuildAutomaton_11 ():
    ...
    st_5._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_mwdTool._Automaton = _BuildAutomaton_11()
...
def _BuildAutomaton_12 ():
    ...
    st_20._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_rotarySteerableTool._Automaton = _BuildAutomaton_12()
...
def _BuildAutomaton_13 ():
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_tubulars._Automaton = _BuildAutomaton_13()
...
def _BuildAutomaton_14 ():
    ...
    st_2._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_bend._Automaton = _BuildAutomaton_14()
...
def _BuildAutomaton_15 ():
    ...
    st_11._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_connection._Automaton = _BuildAutomaton_15()
...
def _BuildAutomaton_16 ():
    ...
    st_7._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
cs_nameTag._Automaton = _BuildAutomaton_16()
...
def _BuildAutomaton_17 ():
    ...
    st_5._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_nozzle._Automaton = _BuildAutomaton_17()
...
def _BuildAutomaton_18 ():
    ...
    st_3._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_sensor._Automaton = _BuildAutomaton_18()
...
def _BuildAutomaton_19 ():
    ...
    st_8._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_stabilizer._Automaton = _BuildAutomaton_19()
...
def _BuildAutomaton_20 ():
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
cs_tubularComponent._Automaton = _BuildAutomaton_20()
...
def _BuildAutomaton_21 ():
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_tubular._Automaton = _BuildAutomaton_21()
