# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_sidewallCore.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:52:46.782726 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:4b11f88e-31f7-475e-a8a0-5b43e55b03fa')
...
class cs_show (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_show.xsd', 18, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}showRat uses Python identifier showRat
    __showRat = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'showRat'), 'showRat', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131showRat', False, pyxb.utils.utility.Location('cs_show.xsd', 23, 3), )
    ...
    __stainColor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stainColor'), 'stainColor', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131stainColor', False, pyxb.utils.utility.Location('cs_show.xsd', 28, 3), )
    ...
    __stainDistr = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stainDistr'), 'stainDistr', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131stainDistr', False, pyxb.utils.utility.Location('cs_show.xsd', 33, 3), )
    ...
    __stainPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stainPc'), 'stainPc', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131stainPc', False, pyxb.utils.utility.Location('cs_show.xsd', 38, 3), )
    ...
    __natFlorColor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'natFlorColor'), 'natFlorColor', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131natFlorColor', False, pyxb.utils.utility.Location('cs_show.xsd', 43, 3), )
    ...
    __natFlorPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'natFlorPc'), 'natFlorPc', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131natFlorPc', False, pyxb.utils.utility.Location('cs_show.xsd', 48, 3), )
    ...
    __natFlorLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'natFlorLevel'), 'natFlorLevel', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131natFlorLevel', False, pyxb.utils.utility.Location('cs_show.xsd', 53, 3), )
    ...
    __natFlorDesc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'natFlorDesc'), 'natFlorDesc', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131natFlorDesc', False, pyxb.utils.utility.Location('cs_show.xsd', 58, 3), )
    ...
    __cutColor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutColor'), 'cutColor', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutColor', False, pyxb.utils.utility.Location('cs_show.xsd', 63, 3), )
    ...
    __cutSpeed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutSpeed'), 'cutSpeed', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutSpeed', False, pyxb.utils.utility.Location('cs_show.xsd', 68, 3), )
    ...
    __cutStrength = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutStrength'), 'cutStrength', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutStrength', False, pyxb.utils.utility.Location('cs_show.xsd', 73, 3), )
    ...
    __cutForm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutForm'), 'cutForm', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutForm', False, pyxb.utils.utility.Location('cs_show.xsd', 78, 3), )
    ...
    __cutLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutLevel'), 'cutLevel', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutLevel', False, pyxb.utils.utility.Location('cs_show.xsd', 83, 3), )
    ...
    __cutFlorColor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutFlorColor'), 'cutFlorColor', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutFlorColor', False, pyxb.utils.utility.Location('cs_show.xsd', 88, 3), )
    ...
    __cutFlorSpeed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutFlorSpeed'), 'cutFlorSpeed', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutFlorSpeed', False, pyxb.utils.utility.Location('cs_show.xsd', 93, 3), )
    ...
    __cutFlorStrength = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutFlorStrength'), 'cutFlorStrength', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutFlorStrength', False, pyxb.utils.utility.Location('cs_show.xsd', 98, 3), )
    ...
    __cutFlorForm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutFlorForm'), 'cutFlorForm', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutFlorForm', False, pyxb.utils.utility.Location('cs_show.xsd', 103, 3), )
    ...
    __cutFlorLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cutFlorLevel'), 'cutFlorLevel', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131cutFlorLevel', False, pyxb.utils.utility.Location('cs_show.xsd', 108, 3), )
    ...
    __residueColor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'residueColor'), 'residueColor', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131residueColor', False, pyxb.utils.utility.Location('cs_show.xsd', 113, 3), )
    ...
    __showDesc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'showDesc'), 'showDesc', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131showDesc', False, pyxb.utils.utility.Location('cs_show.xsd', 118, 3), )
    ...
    __impregnatedLitho = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'impregnatedLitho'), 'impregnatedLitho', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131impregnatedLitho', False, pyxb.utils.utility.Location('cs_show.xsd', 123, 3), )
    ...
    __odor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'odor'), 'odor', '__httpwww_witsml_orgschemas131_cs_show_httpwww_witsml_orgschemas131odor', False, pyxb.utils.utility.Location('cs_show.xsd', 128, 3), )
...
class obj_sidewallCores (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 33, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_sidewallCores_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 35, 3), )
    ...
    __sidewallCore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sidewallCore'), 'sidewallCore', '__httpwww_witsml_orgschemas131_obj_sidewallCores_httpwww_witsml_orgschemas131sidewallCore', True, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 40, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_sidewallCores_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 46, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 46, 2)
...
class cs_lithology (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_lithology.xsd', 19, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}type uses Python identifier type
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131type', False, pyxb.utils.utility.Location('cs_lithology.xsd', 24, 3), )
    ...
    __codeLith = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'codeLith'), 'codeLith', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131codeLith', False, pyxb.utils.utility.Location('cs_lithology.xsd', 29, 3), )
    ...
    __lithPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lithPc'), 'lithPc', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131lithPc', False, pyxb.utils.utility.Location('cs_lithology.xsd', 35, 3), )
    ...
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('cs_lithology.xsd', 42, 3), )
    ...
    __lithClass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lithClass'), 'lithClass', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131lithClass', False, pyxb.utils.utility.Location('cs_lithology.xsd', 47, 3), )
    ...
    __grainType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'grainType'), 'grainType', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131grainType', False, pyxb.utils.utility.Location('cs_lithology.xsd', 52, 3), )
    ...
    __dunhamClass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dunhamClass'), 'dunhamClass', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131dunhamClass', False, pyxb.utils.utility.Location('cs_lithology.xsd', 57, 3), )
    ...
    __color = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'color'), 'color', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131color', False, pyxb.utils.utility.Location('cs_lithology.xsd', 62, 3), )
    ...
    __texture = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'texture'), 'texture', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131texture', False, pyxb.utils.utility.Location('cs_lithology.xsd', 67, 3), )
    ...
    __hardness = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'hardness'), 'hardness', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131hardness', False, pyxb.utils.utility.Location('cs_lithology.xsd', 72, 3), )
    ...
    __sizeGrain = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sizeGrain'), 'sizeGrain', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131sizeGrain', False, pyxb.utils.utility.Location('cs_lithology.xsd', 77, 3), )
    ...
    __roundness = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'roundness'), 'roundness', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131roundness', False, pyxb.utils.utility.Location('cs_lithology.xsd', 82, 3), )
    ...
    __sorting = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sorting'), 'sorting', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131sorting', False, pyxb.utils.utility.Location('cs_lithology.xsd', 87, 3), )
    ...
    __matrixCement = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'matrixCement'), 'matrixCement', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131matrixCement', False, pyxb.utils.utility.Location('cs_lithology.xsd', 92, 3), )
    ...
    __porosityVisible = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'porosityVisible'), 'porosityVisible', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131porosityVisible', False, pyxb.utils.utility.Location('cs_lithology.xsd', 97, 3), )
    ...
    __permeability = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'permeability'), 'permeability', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131permeability', False, pyxb.utils.utility.Location('cs_lithology.xsd', 102, 3), )
    ...
    __densShale = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'densShale'), 'densShale', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131densShale', False, pyxb.utils.utility.Location('cs_lithology.xsd', 107, 3), )
    ...
    __qualifier = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'qualifier'), 'qualifier', '__httpwww_witsml_orgschemas131_cs_lithology_httpwww_witsml_orgschemas131qualifier', True, pyxb.utils.utility.Location('cs_lithology.xsd', 112, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_lithology_uid', _module_typeBindings.uidString)
...
class cs_qualifier (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_qualifier.xsd', 19, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}type uses Python identifier type
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas131_cs_qualifier_httpwww_witsml_orgschemas131type', False, pyxb.utils.utility.Location('cs_qualifier.xsd', 24, 3), )
    ...
    __mdTop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdTop'), 'mdTop', '__httpwww_witsml_orgschemas131_cs_qualifier_httpwww_witsml_orgschemas131mdTop', False, pyxb.utils.utility.Location('cs_qualifier.xsd', 30, 4), )
    ...
    __mdBottom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBottom'), 'mdBottom', '__httpwww_witsml_orgschemas131_cs_qualifier_httpwww_witsml_orgschemas131mdBottom', False, pyxb.utils.utility.Location('cs_qualifier.xsd', 36, 4), )
    ...
    __abundance = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'abundance'), 'abundance', '__httpwww_witsml_orgschemas131_cs_qualifier_httpwww_witsml_orgschemas131abundance', False, pyxb.utils.utility.Location('cs_qualifier.xsd', 44, 3), )
    ...
    __abundanceCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'abundanceCode'), 'abundanceCode', '__httpwww_witsml_orgschemas131_cs_qualifier_httpwww_witsml_orgschemas131abundanceCode', False, pyxb.utils.utility.Location('cs_qualifier.xsd', 52, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_cs_qualifier_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('cs_qualifier.xsd', 62, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_qualifier_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
...
class cs_swcSample (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_swcSample.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'md'), 'md', '__httpwww_witsml_orgschemas131_cs_swcSample_httpwww_witsml_orgschemas131md', False, pyxb.utils.utility.Location('cs_swcSample.xsd', 25, 3), )
    ...
    __lithology = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lithology'), 'lithology', '__httpwww_witsml_orgschemas131_cs_swcSample_httpwww_witsml_orgschemas131lithology', False, pyxb.utils.utility.Location('cs_swcSample.xsd', 30, 3), )
    ...
    __show = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'show'), 'show', '__httpwww_witsml_orgschemas131_cs_swcSample_httpwww_witsml_orgschemas131show', False, pyxb.utils.utility.Location('cs_swcSample.xsd', 35, 3), )
    ...
    __nameFormation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), 'nameFormation', '__httpwww_witsml_orgschemas131_cs_swcSample_httpwww_witsml_orgschemas131nameFormation', False, pyxb.utils.utility.Location('cs_swcSample.xsd', 40, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comments'), 'comments', '__httpwww_witsml_orgschemas131_cs_swcSample_httpwww_witsml_orgschemas131comments', False, pyxb.utils.utility.Location('cs_swcSample.xsd', 45, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_swcSample_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
...
class obj_sidewallCore (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 55, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}dTimToolRun uses Python identifier dTimToolRun
    __dTimToolRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimToolRun'), 'dTimToolRun', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131dTimToolRun', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 23, 3), )
    ...
    __dTimToolPull = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimToolPull'), 'dTimToolPull', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131dTimToolPull', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 28, 3), )
    ...
    __mdToolReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdToolReference'), 'mdToolReference', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131mdToolReference', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 33, 3), )
    ...
    __coreReferenceLog = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'coreReferenceLog'), 'coreReferenceLog', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131coreReferenceLog', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 38, 3), )
    ...
    __mdCore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdCore'), 'mdCore', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131mdCore', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 43, 3), )
    ...
    __serviceCompany = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany'), 'serviceCompany', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131serviceCompany', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 48, 3), )
    ...
    __analysisContractor = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'analysisContractor'), 'analysisContractor', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131analysisContractor', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 53, 3), )
    ...
    __analysisBy = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'analysisBy'), 'analysisBy', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131analysisBy', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 58, 3), )
    ...
    __sidewallCoringTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sidewallCoringTool'), 'sidewallCoringTool', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131sidewallCoringTool', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 63, 3), )
    ...
    __diaHole = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'diaHole'), 'diaHole', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131diaHole', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 68, 3), )
    ...
    __diaPlug = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'diaPlug'), 'diaPlug', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131diaPlug', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 73, 3), )
    ...
    __numPlugsShot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numPlugsShot'), 'numPlugsShot', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131numPlugsShot', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 78, 3), )
    ...
    __numRecPlugs = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numRecPlugs'), 'numRecPlugs', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131numRecPlugs', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 83, 3), )
    ...
    __numMisfiredPlugs = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numMisfiredPlugs'), 'numMisfiredPlugs', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131numMisfiredPlugs', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 88, 3), )
    ...
    __numEmptyPlugs = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numEmptyPlugs'), 'numEmptyPlugs', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131numEmptyPlugs', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 93, 3), )
    ...
    __numLostPlugs = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numLostPlugs'), 'numLostPlugs', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131numLostPlugs', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 98, 3), )
    ...
    __numPaidPlugs = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numPaidPlugs'), 'numPaidPlugs', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131numPaidPlugs', False, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 103, 3), )
    ...
    __swcSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'swcSample'), 'swcSample', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131swcSample', True, pyxb.utils.utility.Location('grp_sidewallCore.xsd', 108, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 62, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 67, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 77, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_sidewallCore_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_sidewallCore.xsd', 83, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_sidewallCore_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_sidewallCore_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 90, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 90, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_sidewallCore_uidWellbore', _module_typeBindings.uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 96, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_sidewallCore.xsd', 96, 2)
...
cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'showRat'), ShowRating, scope=cs_show, documentation='Show Rating.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 23, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stainColor'), str16, scope=cs_show, documentation='Visible Stain Color.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 28, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stainDistr'), str16, scope=cs_show, documentation='Visible Stain Distribution.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 33, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stainPc'), areaPerAreaMeasure, scope=cs_show, documentation='Visible Stain (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_show.xsd', 38, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'natFlorColor'), str16, scope=cs_show, documentation='Natural Fluorescence Color.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 43, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'natFlorPc'), areaPerAreaMeasure, scope=cs_show, documentation='Natural fluorescence (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_show.xsd', 48, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'natFlorLevel'), ShowFluorescence, scope=cs_show, documentation='Natural fluorescence level.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 53, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'natFlorDesc'), shortDescriptionString, scope=cs_show, documentation='Natural fluorescence description.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 58, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutColor'), str16, scope=cs_show, documentation='Cut color.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 63, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutSpeed'), ShowSpeed, scope=cs_show, documentation='Cut speed.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 68, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutStrength'), str16, scope=cs_show, documentation='Cut strength.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 73, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutForm'), ShowLevel, scope=cs_show, documentation='Cut formulation.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 78, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutLevel'), str16, scope=cs_show, documentation='Cut level (Faint, Bright, etc.).  ', location=pyxb.utils.utility.Location('cs_show.xsd', 83, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutFlorColor'), str16, scope=cs_show, documentation='Cut fluorescence color.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 88, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutFlorSpeed'), ShowSpeed, scope=cs_show, documentation='Cut fluorescence speed.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 93, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutFlorStrength'), str16, scope=cs_show, documentation='Cut fluorescence strength.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 98, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutFlorForm'), ShowLevel, scope=cs_show, documentation='Cut fluorescence form.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 103, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cutFlorLevel'), ShowFluorescence, scope=cs_show, documentation='Cut fluorescence level.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 108, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'residueColor'), str16, scope=cs_show, documentation='Residue color.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 113, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'showDesc'), commentString, scope=cs_show, documentation='Free format show description.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 118, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'impregnatedLitho'), str32, scope=cs_show, documentation='Impregnated lithology.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 123, 3)))

cs_show._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'odor'), str32, scope=cs_show, documentation='Description of any hydrocarbon type odors smelled.  ', location=pyxb.utils.utility.Location('cs_show.xsd', 128, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 23, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 28, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 33, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 38, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 43, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 48, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 53, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 58, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 63, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 68, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 73, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 78, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 83, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 88, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 93, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 98, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 103, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 108, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 113, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 118, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 123, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_show.xsd', 128, 3))
    counters.add(cc_21)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'showRat')), pyxb.utils.utility.Location('cs_show.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stainColor')), pyxb.utils.utility.Location('cs_show.xsd', 28, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stainDistr')), pyxb.utils.utility.Location('cs_show.xsd', 33, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stainPc')), pyxb.utils.utility.Location('cs_show.xsd', 38, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'natFlorColor')), pyxb.utils.utility.Location('cs_show.xsd', 43, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'natFlorPc')), pyxb.utils.utility.Location('cs_show.xsd', 48, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'natFlorLevel')), pyxb.utils.utility.Location('cs_show.xsd', 53, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'natFlorDesc')), pyxb.utils.utility.Location('cs_show.xsd', 58, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutColor')), pyxb.utils.utility.Location('cs_show.xsd', 63, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutSpeed')), pyxb.utils.utility.Location('cs_show.xsd', 68, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutStrength')), pyxb.utils.utility.Location('cs_show.xsd', 73, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutForm')), pyxb.utils.utility.Location('cs_show.xsd', 78, 3))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutLevel')), pyxb.utils.utility.Location('cs_show.xsd', 83, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutFlorColor')), pyxb.utils.utility.Location('cs_show.xsd', 88, 3))
    st_13 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutFlorSpeed')), pyxb.utils.utility.Location('cs_show.xsd', 93, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutFlorStrength')), pyxb.utils.utility.Location('cs_show.xsd', 98, 3))
    st_15 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutFlorForm')), pyxb.utils.utility.Location('cs_show.xsd', 103, 3))
    st_16 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cutFlorLevel')), pyxb.utils.utility.Location('cs_show.xsd', 108, 3))
    st_17 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'residueColor')), pyxb.utils.utility.Location('cs_show.xsd', 113, 3))
    st_18 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'showDesc')), pyxb.utils.utility.Location('cs_show.xsd', 118, 3))
    st_19 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'impregnatedLitho')), pyxb.utils.utility.Location('cs_show.xsd', 123, 3))
    st_20 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(cs_show._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'odor')), pyxb.utils.utility.Location('cs_show.xsd', 128, 3))
...
obj_sidewallCores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_sidewallCores, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 35, 3)))

obj_sidewallCores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sidewallCore'), obj_sidewallCore, scope=obj_sidewallCores, documentation='A single sidewall core.  ', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 40, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCores._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCores._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sidewallCore')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), LithologyType, scope=cs_lithology, documentation='The type of lithology. ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 24, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'codeLith'), str16, scope=cs_lithology, documentation='Lithology official codes if desired. Operator typically \n\t\t\t\t\tto define what the codes are.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 29, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lithPc'), volumePerVolumeMeasurePercent, scope=cs_lithology, documentation='The lithology represents what portion of the sampled interval.\n\t\t\t\t\tThe total of the lithologies within an interval should add up to 100 percent.\n\t\t\t\t\tThe "undifferentiated" code should be used to fill out to 100.', location=pyxb.utils.utility.Location('cs_lithology.xsd', 35, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=cs_lithology, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 42, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lithClass'), str32, scope=cs_lithology, documentation='Lithology classification description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 47, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'grainType'), str32, scope=cs_lithology, documentation='Granulometry.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 52, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dunhamClass'), str32, scope=cs_lithology, documentation='Dunham limestone classification.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 57, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'color'), str16, scope=cs_lithology, documentation='Lithology color description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 62, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'texture'), str32, scope=cs_lithology, documentation='Lithology texture description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 67, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'hardness'), str32, scope=cs_lithology, documentation='Lithology hardness description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 72, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sizeGrain'), str32, scope=cs_lithology, documentation='Lithology grain size description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 77, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'roundness'), str32, scope=cs_lithology, documentation='Lithology roundness description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 82, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sorting'), str32, scope=cs_lithology, documentation='Lithology sorting description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 87, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'matrixCement'), str32, scope=cs_lithology, documentation='Lithology matrix/cement description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 92, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'porosityVisible'), str32, scope=cs_lithology, documentation='Lithology visible porosity description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 97, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'permeability'), str32, scope=cs_lithology, documentation='Lithology permeability description.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 102, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'densShale'), densityMeasure, scope=cs_lithology, documentation='Shale density for the interval.  ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 107, 3)))

cs_lithology._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'qualifier'), cs_qualifier, scope=cs_lithology, documentation='A single qualifier.\n\t\t\t\t\tIn mudlogging terms, a qualifier is a graphical symbol in the\n\t\t\t\t\tInterpreted Lithology column of the Formation Evaluation Log (aka "the\n\t\t\t\t\tmudlog").\n\t\t\t\t\tIn addition to the major lithologies (e.g., sand, shale, etc) existing in the\n\t\t\t\t\tsample, other minerals (present as accessories or inclusions e.g. chert,\n\t\t\t\t\tpyrite, glauconite) and fossils (forams, oyster shells, bryozoans, etc)\n\t\t\t\t\tmay exist and their abundance is generally categorized using ranges \n\t\t\t\t\tsuch as Trace (less than 10%), Common (10-25%) and\n\t\t\t\t\tAbundant (greater than 25%). These additional minerals and fossils can be of\n\t\t\t\t\tdisproportionately great diagnostic and descriptive value. For example,\n\t\t\t\t\tqualifiers can be used to indicate facies changes, marker beds or\n\t\t\t\t\tsomething that impacted drilling conditions. \n\t\t\t\t\tThese qualifiers (representing accessories, inclusions and/or fossils)\n\t\t\t\t\tare used to rapidly and graphically indicate to the recipient of the\n\t\t\t\t\tmudlog that a significant lithological event was encountered while\n\t\t\t\t\tdrilling the well. ', location=pyxb.utils.utility.Location('cs_lithology.xsd', 112, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 24, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 29, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 35, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 42, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 47, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 52, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 57, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 62, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 67, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 72, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 77, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 82, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 87, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 92, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 97, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 102, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 107, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_lithology.xsd', 112, 3))
    counters.add(cc_17)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('cs_lithology.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'codeLith')), pyxb.utils.utility.Location('cs_lithology.xsd', 29, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lithPc')), pyxb.utils.utility.Location('cs_lithology.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_lithology.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lithClass')), pyxb.utils.utility.Location('cs_lithology.xsd', 47, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'grainType')), pyxb.utils.utility.Location('cs_lithology.xsd', 52, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dunhamClass')), pyxb.utils.utility.Location('cs_lithology.xsd', 57, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'color')), pyxb.utils.utility.Location('cs_lithology.xsd', 62, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'texture')), pyxb.utils.utility.Location('cs_lithology.xsd', 67, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'hardness')), pyxb.utils.utility.Location('cs_lithology.xsd', 72, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sizeGrain')), pyxb.utils.utility.Location('cs_lithology.xsd', 77, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'roundness')), pyxb.utils.utility.Location('cs_lithology.xsd', 82, 3))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sorting')), pyxb.utils.utility.Location('cs_lithology.xsd', 87, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'matrixCement')), pyxb.utils.utility.Location('cs_lithology.xsd', 92, 3))
    st_13 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'porosityVisible')), pyxb.utils.utility.Location('cs_lithology.xsd', 97, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'permeability')), pyxb.utils.utility.Location('cs_lithology.xsd', 102, 3))
    st_15 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'densShale')), pyxb.utils.utility.Location('cs_lithology.xsd', 107, 3))
    st_16 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_lithology._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'qualifier')), pyxb.utils.utility.Location('cs_lithology.xsd', 112, 3))
    st_17 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_qualifier._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), QualifierType, scope=cs_qualifier, documentation='The type of qualifier.', location=pyxb.utils.utility.Location('cs_qualifier.xsd', 24, 3)))

cs_qualifier._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdTop'), measuredDepthCoord, scope=cs_qualifier, documentation='The measured depth at the top of the interval represented \n\t\t\t\t\t\tby the qualifier. This must be within the range of the parent geologic interval.', location=pyxb.utils.utility.Location('cs_qualifier.xsd', 30, 4)))

cs_qualifier._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBottom'), measuredDepthCoord, scope=cs_qualifier, documentation='The measured depth at the bottom of the interval represented by the qualifier.\n\t\t\t\t\t\tA point can be indicated by specifying bottom=top.\n\t\t\t\t\t\tThis must be within the range of the parent geologic interval.', location=pyxb.utils.utility.Location('cs_qualifier.xsd', 36, 4)))

cs_qualifier._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'abundance'), volumePerVolumeMeasurePercent, scope=cs_qualifier, documentation='The relative abundance of the qualifier.\n\t\t\t\t\tThis is usually estimated based on a "visual area" basis by inspecting the cuttings \n\t\t\t\t\tspread out on the shaker table. This either represents a point value or the \n\t\t\t\t\tupperbound of a range (e.g., 0% to 10%).', location=pyxb.utils.utility.Location('cs_qualifier.xsd', 44, 3)))

cs_qualifier._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'abundanceCode'), kindString, scope=cs_qualifier, documentation='A code associated with the relative abundance of the qualifier.\n\t\t\t\t\tFor example, "trace", "common" or "abundant". \n\t\t\t\t\tThis is generally a proprietary code. The interoperable semantics are provided\n\t\t\t\t\tby the above abundance value. The presumption is that the value range associated with\n\t\t\t\t\ta code is mapped to a single value. On the other end of an exchange, the single\n\t\t\t\t\tvalue is mapped to the range associated with the local codes on that end.', location=pyxb.utils.utility.Location('cs_qualifier.xsd', 52, 3)))

cs_qualifier._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), descriptionString, scope=cs_qualifier, documentation='A textual description of the qualifier.', location=pyxb.utils.utility.Location('cs_qualifier.xsd', 62, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_qualifier.xsd', 29, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_qualifier.xsd', 36, 4))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_qualifier.xsd', 44, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_qualifier.xsd', 52, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_qualifier.xsd', 62, 3))
    counters.add(cc_4)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_qualifier._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('cs_qualifier.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_qualifier._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdTop')), pyxb.utils.utility.Location('cs_qualifier.xsd', 30, 4))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_qualifier._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBottom')), pyxb.utils.utility.Location('cs_qualifier.xsd', 36, 4))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_qualifier._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'abundance')), pyxb.utils.utility.Location('cs_qualifier.xsd', 44, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_qualifier._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'abundanceCode')), pyxb.utils.utility.Location('cs_qualifier.xsd', 52, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_qualifier._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_qualifier.xsd', 62, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_swcSample._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'md'), measuredDepthCoord, scope=cs_swcSample, documentation='Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location('cs_swcSample.xsd', 25, 3)))

cs_swcSample._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lithology'), cs_lithology, scope=cs_swcSample, documentation='Set of Lithology records for the Interval  ', location=pyxb.utils.utility.Location('cs_swcSample.xsd', 30, 3)))

cs_swcSample._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'show'), cs_show, scope=cs_swcSample, documentation='Show description for the plug.  ', location=pyxb.utils.utility.Location('cs_swcSample.xsd', 35, 3)))

cs_swcSample._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), str32, scope=cs_swcSample, documentation='Name of formation penetrated.  ', location=pyxb.utils.utility.Location('cs_swcSample.xsd', 40, 3)))

cs_swcSample._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comments'), commentString, scope=cs_swcSample, documentation='Comments and remarks.  ', location=pyxb.utils.utility.Location('cs_swcSample.xsd', 45, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_swcSample.xsd', 30, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_swcSample.xsd', 35, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_swcSample.xsd', 40, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_swcSample.xsd', 45, 3))
    counters.add(cc_3)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_swcSample._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'md')), pyxb.utils.utility.Location('cs_swcSample.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_swcSample._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lithology')), pyxb.utils.utility.Location('cs_swcSample.xsd', 30, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_swcSample._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'show')), pyxb.utils.utility.Location('cs_swcSample.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_swcSample._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameFormation')), pyxb.utils.utility.Location('cs_swcSample.xsd', 40, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_swcSample._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comments')), pyxb.utils.utility.Location('cs_swcSample.xsd', 45, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimToolRun'), timestamp, scope=obj_sidewallCore, documentation='Date and time logging suite run in the hole.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 23, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimToolPull'), timestamp, scope=obj_sidewallCore, documentation='Date and time logging suite pulled out of the hole.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 28, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdToolReference'), measuredDepthCoord, scope=obj_sidewallCore, documentation='Tool reference measured depth.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 33, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'coreReferenceLog'), str32, scope=obj_sidewallCore, documentation='Reference log information.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 38, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdCore'), measuredDepthCoord, scope=obj_sidewallCore, documentation='Measured depth of core.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 43, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany'), nameString, scope=obj_sidewallCore, documentation='Name of contractor who provided the service.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 48, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'analysisContractor'), nameString, scope=obj_sidewallCore, documentation='Analysis company  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 53, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'analysisBy'), nameString, scope=obj_sidewallCore, documentation='Name of engineer analyzing sidewall core samples.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 58, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sidewallCoringTool'), str32, scope=obj_sidewallCore, documentation='Sidewall coring tool description.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 63, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'diaHole'), lengthMeasure, scope=obj_sidewallCore, documentation='Hole diameter.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 68, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'diaPlug'), lengthMeasure, scope=obj_sidewallCore, documentation='Diameter of plugs.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 73, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numPlugsShot'), nonNegativeCount, scope=obj_sidewallCore, documentation='Number of shots fired.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 78, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numRecPlugs'), nonNegativeCount, scope=obj_sidewallCore, documentation='Number of recovered plugs.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 83, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numMisfiredPlugs'), nonNegativeCount, scope=obj_sidewallCore, documentation='Number of plugs that misfired.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 88, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numEmptyPlugs'), nonNegativeCount, scope=obj_sidewallCore, documentation='Number of plugs that fired OK but were empty.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 93, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numLostPlugs'), nonNegativeCount, scope=obj_sidewallCore, documentation='Number of lost plugs.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 98, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numPaidPlugs'), nonNegativeCount, scope=obj_sidewallCore, documentation='Number of plugs paid for by client.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 103, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'swcSample'), cs_swcSample, scope=obj_sidewallCore, documentation='Set of plug sample descriptions.  ', location=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 108, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_sidewallCore, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 57, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_sidewallCore, documentation='Human recognizable context for the wellbore that contains the sidewall core.  ', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 62, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_sidewallCore, documentation='Human recognizable context for the sidewall core.  ', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 67, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_sidewallCore, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 77, 3)))

obj_sidewallCore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_sidewallCore, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 83, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 72, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 23, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 28, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 33, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 38, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 48, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 53, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 58, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 63, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 68, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 73, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 78, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 83, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 88, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 93, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 98, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 103, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_sidewallCore.xsd', 108, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 77, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_sidewallCore.xsd', 83, 3))
    counters.add(cc_19)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 57, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 62, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 67, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimToolRun')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 23, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimToolPull')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 28, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdToolReference')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 33, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'coreReferenceLog')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 38, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdCore')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 43, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 48, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'analysisContractor')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 53, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'analysisBy')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 58, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sidewallCoringTool')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 63, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'diaHole')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 68, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'diaPlug')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 73, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numPlugsShot')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 78, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numRecPlugs')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 83, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numMisfiredPlugs')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 88, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numEmptyPlugs')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 93, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numLostPlugs')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 98, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numPaidPlugs')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 103, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'swcSample')), pyxb.utils.utility.Location('grp_sidewallCore.xsd', 108, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 77, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_sidewallCore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_sidewallCore.xsd', 83, 3))
