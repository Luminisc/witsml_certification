# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_wellbore.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:53:10.676245 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:7b9392cb-6723-4b96-893a-6448b8cebb34')
...
class obj_wellbores (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 33, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_wellbores_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 35, 3), )
    ...
    __wellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellbore'), 'wellbore', '__httpwww_witsml_orgschemas131_obj_wellbores_httpwww_witsml_orgschemas131wellbore', True, pyxb.utils.utility.Location('obj_wellbore.xsd', 40, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_wellbores_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 48, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 48, 2)
...
class obj_wellbore (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 57, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}parentWellbore uses Python identifier parentWellbore
    __parentWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'parentWellbore'), 'parentWellbore', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131parentWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 23, 3), )
    ...
    __number = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'number'), 'number', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131number', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 28, 3), )
    ...
    __suffixAPI = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'suffixAPI'), 'suffixAPI', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131suffixAPI', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 33, 3), )
    ...
    __numGovt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numGovt'), 'numGovt', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131numGovt', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 38, 3), )
    ...
    __statusWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'statusWellbore'), 'statusWellbore', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131statusWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 43, 3), )
    ...
    __purposeWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'purposeWellbore'), 'purposeWellbore', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131purposeWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 48, 3), )
    ...
    __typeWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeWellbore'), 'typeWellbore', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131typeWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 53, 3), )
    ...
    __shape = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'shape'), 'shape', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131shape', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3), )
    ...
    __dTimKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimKickoff'), 'dTimKickoff', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131dTimKickoff', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3), )
    ...
    __achievedTD = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'achievedTD'), 'achievedTD', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131achievedTD', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3), )
    ...
    __mdCurrent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdCurrent'), 'mdCurrent', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131mdCurrent', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 75, 3), )
    ...
    __tvdCurrent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdCurrent'), 'tvdCurrent', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131tvdCurrent', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 81, 3), )
    ...
    __mdKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdKickoff'), 'mdKickoff', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131mdKickoff', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 87, 3), )
    ...
    __tvdKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdKickoff'), 'tvdKickoff', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131tvdKickoff', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 92, 3), )
    ...
    __mdPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdPlanned'), 'mdPlanned', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131mdPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 97, 3), )
    ...
    __tvdPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdPlanned'), 'tvdPlanned', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131tvdPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 102, 3), )
    ...
    __mdSubSeaPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdSubSeaPlanned'), 'mdSubSeaPlanned', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131mdSubSeaPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3), )
    ...
    __tvdSubSeaPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdSubSeaPlanned'), 'tvdSubSeaPlanned', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131tvdSubSeaPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 112, 3), )
    ...
    __dayTarget = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dayTarget'), 'dayTarget', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131dayTarget', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 117, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 59, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 64, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_wellbore_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 80, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_wellbore_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_wellbore_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 87, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 87, 2)
...
obj_wellbores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_wellbores, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 35, 3)))

obj_wellbores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellbore'), obj_wellbore, scope=obj_wellbores, documentation='Information about a single wellbore.\n\t\t\t\t\tA wellbore is a unique, oriented path from the bottom of a drilled \n\t\t\t\t\tborehole to the surface of the Earth. The path must not overlap or cross itself.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wellbores._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_wellbore.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wellbores._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellbore')), pyxb.utils.utility.Location('obj_wellbore.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'parentWellbore'), refNameString, scope=obj_wellbore, documentation='This is a pointer to the parent wellbore. No parent = starts from top.   ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 23, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'number'), str32, scope=obj_wellbore, documentation='Operator borehole number.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 28, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'suffixAPI'), nameString, scope=obj_wellbore, documentation='API suffix.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 33, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numGovt'), nameString, scope=obj_wellbore, documentation='Government assigned number.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 38, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'statusWellbore'), WellStatus, scope=obj_wellbore, documentation='POSC wellbore status.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 43, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'purposeWellbore'), WellPurpose, scope=obj_wellbore, documentation='POSC wellbore purpose.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 48, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeWellbore'), WellboreType, scope=obj_wellbore, documentation='Type of wellbore.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 53, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'shape'), WellboreShape, scope=obj_wellbore, documentation='POSC wellbore trajectory shape.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimKickoff'), timestamp, scope=obj_wellbore, documentation='Date and time of wellbore kickoff.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'achievedTD'), logicalBoolean, scope=obj_wellbore, documentation='True ("true" of "1") indicates that the wellbore has \n\t\t\t\t\tacheieved total depth. That is, drilling has completed. False ("false" or "0") indicates otherwise. \n\t\t\t\t\tNot given indicates that it is not known whether total depth has been reached.', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdCurrent'), measuredDepthCoord, scope=obj_wellbore, documentation='The current measured depth of the borehole. If status is plugged, \n\t\t\t\t\tindicates the maximum depth reached before plugging.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 75, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdCurrent'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='The current true vertical depth of the borehole.  If status is plugged, indicates the \n\t\t\t\t\tmaximum depth reached before plugging.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 81, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdKickoff'), measuredDepthCoord, scope=obj_wellbore, documentation='Kickoff measured depth of the wellbore. ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 87, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdKickoff'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='Kickoff true vertical depth of the wellbore.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 92, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdPlanned'), measuredDepthCoord, scope=obj_wellbore, documentation='Planned measured depth for the wellbore total depth.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 97, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdPlanned'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='Planned true vertical depth for the wellbore total depth.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 102, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdSubSeaPlanned'), measuredDepthCoord, scope=obj_wellbore, documentation='Planned measured for the wellbore total depth - with respect to seabed.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdSubSeaPlanned'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='Planned true vertical depth for the wellbore total depth - with respect to seabed.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 112, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dayTarget'), timeMeasure, scope=obj_wellbore, documentation='Target days for drilling wellbore.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 117, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_wellbore, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 59, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_wellbore, documentation='Human recognizable context for the wellbore.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 64, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_wellbore, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_wellbore, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 80, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 69, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 23, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 28, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 33, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 38, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 43, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 48, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 53, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 75, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 81, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 87, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 92, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 97, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 102, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 112, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 117, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 80, 3))
    counters.add(cc_21)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_wellbore.xsd', 59, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_wellbore.xsd', 64, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parentWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 23, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'number')), pyxb.utils.utility.Location('grp_wellbore.xsd', 28, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'suffixAPI')), pyxb.utils.utility.Location('grp_wellbore.xsd', 33, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numGovt')), pyxb.utils.utility.Location('grp_wellbore.xsd', 38, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'statusWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 43, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'purposeWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 48, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 53, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'shape')), pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimKickoff')), pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'achievedTD')), pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdCurrent')), pyxb.utils.utility.Location('grp_wellbore.xsd', 75, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdCurrent')), pyxb.utils.utility.Location('grp_wellbore.xsd', 81, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdKickoff')), pyxb.utils.utility.Location('grp_wellbore.xsd', 87, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdKickoff')), pyxb.utils.utility.Location('grp_wellbore.xsd', 92, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 97, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 102, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdSubSeaPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdSubSeaPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 112, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dayTarget')), pyxb.utils.utility.Location('grp_wellbore.xsd', 117, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_wellbore.xsd', 80, 3))
