...
class obj_bhaRuns (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_bhaRuns')
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_bhaRuns_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 35, 3), )
    ...
    __bhaRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'bhaRun'), 'bhaRun', '__httpwww_witsml_orgschemas131_obj_bhaRuns_httpwww_witsml_orgschemas131bhaRun', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 40, 3), )

    
    bhaRun = property(__bhaRun.value, __bhaRun.set, None, u'A single bottom hole assembly run.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas131_obj_bhaRuns_version', schemaVersionString, required=True)
...
Namespace.addCategoryObject('typeBinding', u'obj_bhaRuns', obj_bhaRuns)
...
class cs_drillingParams (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_drillingParams')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 19, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}eTimOpBit uses Python identifier eTimOpBit
    __eTimOpBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'eTimOpBit'), 'eTimOpBit', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131eTimOpBit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 24, 3), )

    
    eTimOpBit = property(__eTimOpBit.value, __eTimOpBit.set, None, u'Operating time spent by bit for run.  ')

    
    # Element {http://www.witsml.org/schemas/131}mdHoleStart uses Python identifier mdHoleStart
    __mdHoleStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdHoleStart'), 'mdHoleStart', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131mdHoleStart', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 29, 3), )

    
    mdHoleStart = property(__mdHoleStart.value, __mdHoleStart.set, None, u'Measured depth at start.  ')

    
    # Element {http://www.witsml.org/schemas/131}mdHoleStop uses Python identifier mdHoleStop
    __mdHoleStop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdHoleStop'), 'mdHoleStop', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131mdHoleStop', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 34, 3), )

    
    mdHoleStop = property(__mdHoleStop.value, __mdHoleStop.set, None, u'Measured depth at stop.  ')

    
    # Element {http://www.witsml.org/schemas/131}tubular uses Python identifier tubular
    __tubular = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tubular'), 'tubular', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tubular', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 39, 3), )

    
    tubular = property(__tubular.value, __tubular.set, None, u'A pointer to the tubular assembly.  ')

    
    # Element {http://www.witsml.org/schemas/131}hkldRot uses Python identifier hkldRot
    __hkldRot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'hkldRot'), 'hkldRot', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131hkldRot', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 44, 3), )

    
    hkldRot = property(__hkldRot.value, __hkldRot.set, None, u'Hookload - rotating.  ')

    
    # Element {http://www.witsml.org/schemas/131}overPull uses Python identifier overPull
    __overPull = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'overPull'), 'overPull', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131overPull', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 49, 3), )

    
    overPull = property(__overPull.value, __overPull.set, None, u'hkldUp-hkldRot.  ')

    
    # Element {http://www.witsml.org/schemas/131}slackOff uses Python identifier slackOff
    __slackOff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'slackOff'), 'slackOff', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131slackOff', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 54, 3), )

    
    slackOff = property(__slackOff.value, __slackOff.set, None, u'hkldRot-hkldDown.  ')

    
    # Element {http://www.witsml.org/schemas/131}hkldUp uses Python identifier hkldUp
    __hkldUp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'hkldUp'), 'hkldUp', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131hkldUp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 59, 3), )

    
    hkldUp = property(__hkldUp.value, __hkldUp.set, None, u'Hookload - string moving up.  ')

    
    # Element {http://www.witsml.org/schemas/131}hkldDn uses Python identifier hkldDn
    __hkldDn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'hkldDn'), 'hkldDn', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131hkldDn', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 64, 3), )

    
    hkldDn = property(__hkldDn.value, __hkldDn.set, None, u'Hookload - string moving down.  ')

    
    # Element {http://www.witsml.org/schemas/131}tqOnBotAv uses Python identifier tqOnBotAv
    __tqOnBotAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotAv'), 'tqOnBotAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tqOnBotAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 69, 3), )

    
    tqOnBotAv = property(__tqOnBotAv.value, __tqOnBotAv.set, None, u'Average Torque - on bottom.  ')

    
    # Element {http://www.witsml.org/schemas/131}tqOnBotMx uses Python identifier tqOnBotMx
    __tqOnBotMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotMx'), 'tqOnBotMx', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tqOnBotMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 74, 3), )

    
    tqOnBotMx = property(__tqOnBotMx.value, __tqOnBotMx.set, None, u'Maximum torque - on bottom.  ')

    
    # Element {http://www.witsml.org/schemas/131}tqOnBotMn uses Python identifier tqOnBotMn
    __tqOnBotMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotMn'), 'tqOnBotMn', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tqOnBotMn', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 79, 3), )

    
    tqOnBotMn = property(__tqOnBotMn.value, __tqOnBotMn.set, None, u'Minimum torque - on bottom.  ')

    
    # Element {http://www.witsml.org/schemas/131}tqOffBotAv uses Python identifier tqOffBotAv
    __tqOffBotAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tqOffBotAv'), 'tqOffBotAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tqOffBotAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 84, 3), )

    
    tqOffBotAv = property(__tqOffBotAv.value, __tqOffBotAv.set, None, u'Average torque - off bottom.  ')

    
    # Element {http://www.witsml.org/schemas/131}tqDhAv uses Python identifier tqDhAv
    __tqDhAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tqDhAv'), 'tqDhAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tqDhAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 89, 3), )

    
    tqDhAv = property(__tqDhAv.value, __tqDhAv.set, None, u'Average torque - downhole.  ')

    
    # Element {http://www.witsml.org/schemas/131}wtAboveJar uses Python identifier wtAboveJar
    __wtAboveJar = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wtAboveJar'), 'wtAboveJar', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wtAboveJar', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 94, 3), )

    
    wtAboveJar = property(__wtAboveJar.value, __wtAboveJar.set, None, u'Weight above jars.  ')

    
    # Element {http://www.witsml.org/schemas/131}wtBelowJar uses Python identifier wtBelowJar
    __wtBelowJar = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wtBelowJar'), 'wtBelowJar', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wtBelowJar', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 99, 3), )

    
    wtBelowJar = property(__wtBelowJar.value, __wtBelowJar.set, None, u'Weight below jars.  ')

    
    # Element {http://www.witsml.org/schemas/131}wtMud uses Python identifier wtMud
    __wtMud = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wtMud'), 'wtMud', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wtMud', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 104, 3), )

    
    wtMud = property(__wtMud.value, __wtMud.set, None, u'Mud density.  ')

    
    # Element {http://www.witsml.org/schemas/131}flowratePump uses Python identifier flowratePump
    __flowratePump = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'flowratePump'), 'flowratePump', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131flowratePump', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 109, 3), )

    
    flowratePump = property(__flowratePump.value, __flowratePump.set, None, u'Pump flow rate.  ')

    
    # Element {http://www.witsml.org/schemas/131}powBit uses Python identifier powBit
    __powBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'powBit'), 'powBit', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131powBit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 114, 3), )

    
    powBit = property(__powBit.value, __powBit.set, None, u'Bit hydraulic.  ')

    
    # Element {http://www.witsml.org/schemas/131}velNozzleAv uses Python identifier velNozzleAv
    __velNozzleAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'velNozzleAv'), 'velNozzleAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131velNozzleAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 119, 3), )

    
    velNozzleAv = property(__velNozzleAv.value, __velNozzleAv.set, None, u'Bit nozzle average velocity.  ')

    
    # Element {http://www.witsml.org/schemas/131}presDropBit uses Python identifier presDropBit
    __presDropBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'presDropBit'), 'presDropBit', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131presDropBit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 124, 3), )

    
    presDropBit = property(__presDropBit.value, __presDropBit.set, None, u'Pressure drop in bit.  ')

    
    # Element {http://www.witsml.org/schemas/131}cTimHold uses Python identifier cTimHold
    __cTimHold = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'cTimHold'), 'cTimHold', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131cTimHold', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 129, 3), )

    
    cTimHold = property(__cTimHold.value, __cTimHold.set, None, u'Time spent on hold from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/131}cTimSteering uses Python identifier cTimSteering
    __cTimSteering = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'cTimSteering'), 'cTimSteering', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131cTimSteering', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 134, 3), )

    
    cTimSteering = property(__cTimSteering.value, __cTimSteering.set, None, u'Time spent steering from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/131}cTimDrillRot uses Python identifier cTimDrillRot
    __cTimDrillRot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'cTimDrillRot'), 'cTimDrillRot', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131cTimDrillRot', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 139, 3), )

    
    cTimDrillRot = property(__cTimDrillRot.value, __cTimDrillRot.set, None, u'Time spent rotary drilling from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/131}cTimDrillSlid uses Python identifier cTimDrillSlid
    __cTimDrillSlid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'cTimDrillSlid'), 'cTimDrillSlid', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131cTimDrillSlid', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 144, 3), )

    
    cTimDrillSlid = property(__cTimDrillSlid.value, __cTimDrillSlid.set, None, u'Time spent slide drilling from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/131}cTimCirc uses Python identifier cTimCirc
    __cTimCirc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'cTimCirc'), 'cTimCirc', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131cTimCirc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 149, 3), )

    
    cTimCirc = property(__cTimCirc.value, __cTimCirc.set, None, u'Time spent circulating from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/131}cTimReam uses Python identifier cTimReam
    __cTimReam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'cTimReam'), 'cTimReam', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131cTimReam', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 154, 3), )

    
    cTimReam = property(__cTimReam.value, __cTimReam.set, None, u'Time spent reaming from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/131}distDrillRot uses Python identifier distDrillRot
    __distDrillRot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'distDrillRot'), 'distDrillRot', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131distDrillRot', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 159, 3), )

    
    distDrillRot = property(__distDrillRot.value, __distDrillRot.set, None, u'Distance drilled - rotating.  ')

    
    # Element {http://www.witsml.org/schemas/131}distDrillSlid uses Python identifier distDrillSlid
    __distDrillSlid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'distDrillSlid'), 'distDrillSlid', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131distDrillSlid', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 164, 3), )

    
    distDrillSlid = property(__distDrillSlid.value, __distDrillSlid.set, None, u'Distance drilled - sliding  ')

    
    # Element {http://www.witsml.org/schemas/131}distReam uses Python identifier distReam
    __distReam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'distReam'), 'distReam', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131distReam', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 169, 3), )

    
    distReam = property(__distReam.value, __distReam.set, None, u'Distance reamed.  ')

    
    # Element {http://www.witsml.org/schemas/131}distHold uses Python identifier distHold
    __distHold = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'distHold'), 'distHold', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131distHold', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 174, 3), )

    
    distHold = property(__distHold.value, __distHold.set, None, u'Distance covered while holding angle with a steerable drilling assembly.  ')

    
    # Element {http://www.witsml.org/schemas/131}distSteering uses Python identifier distSteering
    __distSteering = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'distSteering'), 'distSteering', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131distSteering', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 179, 3), )

    
    distSteering = property(__distSteering.value, __distSteering.set, None, u'Distance covered while actively steering with a steerable drilling assembly.  ')

    
    # Element {http://www.witsml.org/schemas/131}rpmAv uses Python identifier rpmAv
    __rpmAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rpmAv'), 'rpmAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131rpmAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 184, 3), )

    
    rpmAv = property(__rpmAv.value, __rpmAv.set, None, u'Average turn rate (commonly in rpm) through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/131}rpmMx uses Python identifier rpmMx
    __rpmMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rpmMx'), 'rpmMx', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131rpmMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 189, 3), )

    
    rpmMx = property(__rpmMx.value, __rpmMx.set, None, u'Maximum turn rate (commonly in rpm).  ')

    
    # Element {http://www.witsml.org/schemas/131}rpmMn uses Python identifier rpmMn
    __rpmMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rpmMn'), 'rpmMn', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131rpmMn', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 194, 3), )

    
    rpmMn = property(__rpmMn.value, __rpmMn.set, None, u'Minimum turn rate (commonly in rpm).  ')

    
    # Element {http://www.witsml.org/schemas/131}rpmAvDh uses Python identifier rpmAvDh
    __rpmAvDh = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rpmAvDh'), 'rpmAvDh', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131rpmAvDh', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 199, 3), )

    
    rpmAvDh = property(__rpmAvDh.value, __rpmAvDh.set, None, u'Average turn rate (commonly in rpm) downhole.  ')

    
    # Element {http://www.witsml.org/schemas/131}ropAv uses Python identifier ropAv
    __ropAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'ropAv'), 'ropAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131ropAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 204, 3), )

    
    ropAv = property(__ropAv.value, __ropAv.set, None, u'Average rate of penetration through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/131}ropMx uses Python identifier ropMx
    __ropMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'ropMx'), 'ropMx', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131ropMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 209, 3), )

    
    ropMx = property(__ropMx.value, __ropMx.set, None, u'Maximum rate of penetration through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/131}ropMn uses Python identifier ropMn
    __ropMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'ropMn'), 'ropMn', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131ropMn', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 214, 3), )

    
    ropMn = property(__ropMn.value, __ropMn.set, None, u'Minimum rate of penetration through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/131}wobAv uses Python identifier wobAv
    __wobAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wobAv'), 'wobAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wobAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 219, 3), )

    
    wobAv = property(__wobAv.value, __wobAv.set, None, u'Surface weight on bit - average through interval.  ')

    
    # Element {http://www.witsml.org/schemas/131}wobMx uses Python identifier wobMx
    __wobMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wobMx'), 'wobMx', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wobMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 224, 3), )

    
    wobMx = property(__wobMx.value, __wobMx.set, None, u'Weight on bit - maximum.  ')

    
    # Element {http://www.witsml.org/schemas/131}wobMn uses Python identifier wobMn
    __wobMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wobMn'), 'wobMn', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wobMn', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 229, 3), )

    
    wobMn = property(__wobMn.value, __wobMn.set, None, u'Weight on bit - minimum.  ')

    
    # Element {http://www.witsml.org/schemas/131}wobAvDh uses Python identifier wobAvDh
    __wobAvDh = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'wobAvDh'), 'wobAvDh', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131wobAvDh', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 234, 3), )

    
    wobAvDh = property(__wobAvDh.value, __wobAvDh.set, None, u'Weight on bit - average downhole.  ')

    
    # Element {http://www.witsml.org/schemas/131}reasonTrip uses Python identifier reasonTrip
    __reasonTrip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'reasonTrip'), 'reasonTrip', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131reasonTrip', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 239, 3), )

    
    reasonTrip = property(__reasonTrip.value, __reasonTrip.set, None, u'Reason for trip.  ')

    
    # Element {http://www.witsml.org/schemas/131}objectiveBha uses Python identifier objectiveBha
    __objectiveBha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectiveBha'), 'objectiveBha', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131objectiveBha', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 244, 3), )

    
    objectiveBha = property(__objectiveBha.value, __objectiveBha.set, None, u'Objective of bottom hole assembly.  ')

    
    # Element {http://www.witsml.org/schemas/131}aziTop uses Python identifier aziTop
    __aziTop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'aziTop'), 'aziTop', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131aziTop', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 249, 3), )

    
    aziTop = property(__aziTop.value, __aziTop.set, None, u'Azimuth at start measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/131}aziBottom uses Python identifier aziBottom
    __aziBottom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'aziBottom'), 'aziBottom', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131aziBottom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 254, 3), )

    
    aziBottom = property(__aziBottom.value, __aziBottom.set, None, u'Azimuth at stop measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/131}inclStart uses Python identifier inclStart
    __inclStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'inclStart'), 'inclStart', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131inclStart', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 259, 3), )

    
    inclStart = property(__inclStart.value, __inclStart.set, None, u'Inclination at start measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/131}inclMx uses Python identifier inclMx
    __inclMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'inclMx'), 'inclMx', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131inclMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 264, 3), )

    
    inclMx = property(__inclMx.value, __inclMx.set, None, u'Maximum inclination.  ')

    
    # Element {http://www.witsml.org/schemas/131}inclMn uses Python identifier inclMn
    __inclMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'inclMn'), 'inclMn', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131inclMn', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 269, 3), )

    
    inclMn = property(__inclMn.value, __inclMn.set, None, u'Minimum inclination.  ')

    
    # Element {http://www.witsml.org/schemas/131}inclStop uses Python identifier inclStop
    __inclStop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'inclStop'), 'inclStop', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131inclStop', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 274, 3), )

    
    inclStop = property(__inclStop.value, __inclStop.set, None, u'Inclination at stop measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/131}tempMudDhMx uses Python identifier tempMudDhMx
    __tempMudDhMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tempMudDhMx'), 'tempMudDhMx', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131tempMudDhMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 279, 3), )

    
    tempMudDhMx = property(__tempMudDhMx.value, __tempMudDhMx.set, None, u'Maximum mud temperature downhole during run.  ')

    
    # Element {http://www.witsml.org/schemas/131}presPumpAv uses Python identifier presPumpAv
    __presPumpAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'presPumpAv'), 'presPumpAv', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131presPumpAv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 284, 3), )

    
    presPumpAv = property(__presPumpAv.value, __presPumpAv.set, None, u'Average pump pressure.  ')

    
    # Element {http://www.witsml.org/schemas/131}flowrateBit uses Python identifier flowrateBit
    __flowrateBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'flowrateBit'), 'flowrateBit', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131flowrateBit', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 289, 3), )

    
    flowrateBit = property(__flowrateBit.value, __flowrateBit.set, None, u'Flow rate at bit.  ')

    
    # Element {http://www.witsml.org/schemas/131}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'comments'), 'comments', '__httpwww_witsml_orgschemas131_cs_drillingParams_httpwww_witsml_orgschemas131comments', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 294, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_drillingParams_uid', uidString)
...
Namespace.addCategoryObject('typeBinding', u'cs_drillingParams', cs_drillingParams)
...
class obj_bhaRun (pyxb.binding.basis.complexTypeDefinition):
    ...
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_bhaRun')
    ...
    # Element {http://www.witsml.org/schemas/131}tubular uses Python identifier tubular
    __tubular = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tubular'), 'tubular', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131tubular', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 24, 3), )

    
    tubular = property(__tubular.value, __tubular.set, None, u'This represents a foreign key to the tubular (assembly) \n\t\t\t\t\tthat was utilized in this run.')

    
    # Element {http://www.witsml.org/schemas/131}dTimStart uses Python identifier dTimStart
    __dTimStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimStart'), 'dTimStart', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131dTimStart', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 30, 3), )
    ...
    __dTimStop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimStop'), 'dTimStop', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131dTimStop', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 35, 3), )

    
    dTimStop = property(__dTimStop.value, __dTimStop.set, None, u'Date and time that activities stopped.  ')

    
    # Element {http://www.witsml.org/schemas/131}dTimStartDrilling uses Python identifier dTimStartDrilling
    __dTimStartDrilling = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimStartDrilling'), 'dTimStartDrilling', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131dTimStartDrilling', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 40, 3), )

    
    dTimStartDrilling = property(__dTimStartDrilling.value, __dTimStartDrilling.set, None, u'Start on bottom - date and time.  ')

    
    # Element {http://www.witsml.org/schemas/131}dTimStopDrilling uses Python identifier dTimStopDrilling
    __dTimStopDrilling = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimStopDrilling'), 'dTimStopDrilling', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131dTimStopDrilling', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 45, 3), )

    
    dTimStopDrilling = property(__dTimStopDrilling.value, __dTimStopDrilling.set, None, u'Start off bottom - date and time.  ')

    
    # Element {http://www.witsml.org/schemas/131}planDogleg uses Python identifier planDogleg
    __planDogleg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'planDogleg'), 'planDogleg', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131planDogleg', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 50, 3), )

    
    planDogleg = property(__planDogleg.value, __planDogleg.set, None, u'Planned dogleg severity.  ')

    
    # Element {http://www.witsml.org/schemas/131}actDogleg uses Python identifier actDogleg
    __actDogleg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'actDogleg'), 'actDogleg', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131actDogleg', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 55, 3), )

    
    actDogleg = property(__actDogleg.value, __actDogleg.set, None, u'Actual dogleg severity.  ')

    
    # Element {http://www.witsml.org/schemas/131}actDoglegMx uses Python identifier actDoglegMx
    __actDoglegMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'actDoglegMx'), 'actDoglegMx', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131actDoglegMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 60, 3), )

    
    actDoglegMx = property(__actDoglegMx.value, __actDoglegMx.set, None, u'Actual dogleg severity - Maximum.  ')

    
    # Element {http://www.witsml.org/schemas/131}statusBha uses Python identifier statusBha
    __statusBha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'statusBha'), 'statusBha', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131statusBha', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 65, 3), )

    
    statusBha = property(__statusBha.value, __statusBha.set, None, u'Bottom hole assembly status.')

    
    # Element {http://www.witsml.org/schemas/131}numBitRun uses Python identifier numBitRun
    __numBitRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'numBitRun'), 'numBitRun', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131numBitRun', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 70, 3), )

    
    numBitRun = property(__numBitRun.value, __numBitRun.set, None, u'Bit run number.  ')

    
    # Element {http://www.witsml.org/schemas/131}numStringRun uses Python identifier numStringRun
    __numStringRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'numStringRun'), 'numStringRun', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131numStringRun', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 75, 3), )

    
    numStringRun = property(__numStringRun.value, __numStringRun.set, None, u'The BHA (drilling string) run number. ')

    
    # Element {http://www.witsml.org/schemas/131}reasonTrip uses Python identifier reasonTrip
    __reasonTrip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'reasonTrip'), 'reasonTrip', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131reasonTrip', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 80, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}objectiveBha uses Python identifier objectiveBha
    __objectiveBha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'objectiveBha'), 'objectiveBha', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131objectiveBha', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 85, 3), )
    ...
    __drillingParams = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'drillingParams'), 'drillingParams', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131drillingParams', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 90, 3), )

    
    drillingParams = property(__drillingParams.value, __drillingParams.set, None, u'Drilling parameters.  ')

    
    # Element {http://www.witsml.org/schemas/131}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 62, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, u'Human recognizable context for the wellbore that contains the bottom hole assembly. ')

    
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 67, 3), )

    
    name = property(__name.value, __name.set, None, u'Human recognizable context for the run.  ')

    
    # Element {http://www.witsml.org/schemas/131}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 77, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_bhaRun_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 83, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_bhaRun_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_bhaRun_uidWell', uidString)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_bhaRun_uidWellbore', uidString)
...
Namespace.addCategoryObject('typeBinding', u'obj_bhaRun', obj_bhaRun)
...
obj_bhaRuns._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_bhaRuns, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 35, 3)))

obj_bhaRuns._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'bhaRun'), obj_bhaRun, scope=obj_bhaRuns, documentation=u'A single bottom hole assembly run.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_bhaRuns._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_bhaRuns._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'bhaRun')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'eTimOpBit'), timeMeasure, scope=cs_drillingParams, documentation=u'Operating time spent by bit for run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 24, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdHoleStart'), measuredDepthCoord, scope=cs_drillingParams, documentation=u'Measured depth at start.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 29, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdHoleStop'), measuredDepthCoord, scope=cs_drillingParams, documentation=u'Measured depth at stop.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 34, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tubular'), refNameString, scope=cs_drillingParams, documentation=u'A pointer to the tubular assembly.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 39, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'hkldRot'), forceMeasure, scope=cs_drillingParams, documentation=u'Hookload - rotating.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 44, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'overPull'), forceMeasure, scope=cs_drillingParams, documentation=u'hkldUp-hkldRot.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 49, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'slackOff'), forceMeasure, scope=cs_drillingParams, documentation=u'hkldRot-hkldDown.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 54, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'hkldUp'), forceMeasure, scope=cs_drillingParams, documentation=u'Hookload - string moving up.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 59, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'hkldDn'), forceMeasure, scope=cs_drillingParams, documentation=u'Hookload - string moving down.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 64, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotAv'), momentOfForceMeasure, scope=cs_drillingParams, documentation=u'Average Torque - on bottom.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 69, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotMx'), momentOfForceMeasure, scope=cs_drillingParams, documentation=u'Maximum torque - on bottom.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 74, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotMn'), momentOfForceMeasure, scope=cs_drillingParams, documentation=u'Minimum torque - on bottom.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 79, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tqOffBotAv'), momentOfForceMeasure, scope=cs_drillingParams, documentation=u'Average torque - off bottom.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 84, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tqDhAv'), momentOfForceMeasure, scope=cs_drillingParams, documentation=u'Average torque - downhole.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 89, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wtAboveJar'), forceMeasure, scope=cs_drillingParams, documentation=u'Weight above jars.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 94, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wtBelowJar'), forceMeasure, scope=cs_drillingParams, documentation=u'Weight below jars.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 99, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wtMud'), densityMeasure, scope=cs_drillingParams, documentation=u'Mud density.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 104, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'flowratePump'), volumeFlowRateMeasure, scope=cs_drillingParams, documentation=u'Pump flow rate.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 109, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'powBit'), powerMeasure, scope=cs_drillingParams, documentation=u'Bit hydraulic.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 114, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'velNozzleAv'), velocityMeasure, scope=cs_drillingParams, documentation=u'Bit nozzle average velocity.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 119, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'presDropBit'), pressureMeasure, scope=cs_drillingParams, documentation=u'Pressure drop in bit.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 124, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cTimHold'), timeMeasure, scope=cs_drillingParams, documentation=u'Time spent on hold from start of bit run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 129, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cTimSteering'), timeMeasure, scope=cs_drillingParams, documentation=u'Time spent steering from start of bit run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 134, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cTimDrillRot'), timeMeasure, scope=cs_drillingParams, documentation=u'Time spent rotary drilling from start of bit run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 139, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cTimDrillSlid'), timeMeasure, scope=cs_drillingParams, documentation=u'Time spent slide drilling from start of bit run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 144, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cTimCirc'), timeMeasure, scope=cs_drillingParams, documentation=u'Time spent circulating from start of bit run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 149, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'cTimReam'), timeMeasure, scope=cs_drillingParams, documentation=u'Time spent reaming from start of bit run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 154, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'distDrillRot'), lengthMeasure, scope=cs_drillingParams, documentation=u'Distance drilled - rotating.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 159, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'distDrillSlid'), lengthMeasure, scope=cs_drillingParams, documentation=u'Distance drilled - sliding  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 164, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'distReam'), lengthMeasure, scope=cs_drillingParams, documentation=u'Distance reamed.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 169, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'distHold'), lengthMeasure, scope=cs_drillingParams, documentation=u'Distance covered while holding angle with a steerable drilling assembly.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 174, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'distSteering'), lengthMeasure, scope=cs_drillingParams, documentation=u'Distance covered while actively steering with a steerable drilling assembly.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 179, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rpmAv'), anglePerTimeMeasure, scope=cs_drillingParams, documentation=u'Average turn rate (commonly in rpm) through Interval.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 184, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rpmMx'), anglePerTimeMeasure, scope=cs_drillingParams, documentation=u'Maximum turn rate (commonly in rpm).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 189, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rpmMn'), anglePerTimeMeasure, scope=cs_drillingParams, documentation=u'Minimum turn rate (commonly in rpm).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 194, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rpmAvDh'), anglePerTimeMeasure, scope=cs_drillingParams, documentation=u'Average turn rate (commonly in rpm) downhole.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 199, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ropAv'), velocityMeasure, scope=cs_drillingParams, documentation=u'Average rate of penetration through Interval.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 204, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ropMx'), velocityMeasure, scope=cs_drillingParams, documentation=u'Maximum rate of penetration through Interval.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 209, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ropMn'), velocityMeasure, scope=cs_drillingParams, documentation=u'Minimum rate of penetration through Interval.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 214, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wobAv'), forceMeasure, scope=cs_drillingParams, documentation=u'Surface weight on bit - average through interval.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 219, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wobMx'), forceMeasure, scope=cs_drillingParams, documentation=u'Weight on bit - maximum.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 224, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wobMn'), forceMeasure, scope=cs_drillingParams, documentation=u'Weight on bit - minimum.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 229, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'wobAvDh'), forceMeasure, scope=cs_drillingParams, documentation=u'Weight on bit - average downhole.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 234, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'reasonTrip'), commentString, scope=cs_drillingParams, documentation=u'Reason for trip.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 239, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectiveBha'), commentString, scope=cs_drillingParams, documentation=u'Objective of bottom hole assembly.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 244, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'aziTop'), planeAngleMeasure, scope=cs_drillingParams, documentation=u'Azimuth at start measured depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 249, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'aziBottom'), planeAngleMeasure, scope=cs_drillingParams, documentation=u'Azimuth at stop measured depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 254, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'inclStart'), planeAngleMeasure, scope=cs_drillingParams, documentation=u'Inclination at start measured depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 259, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'inclMx'), planeAngleMeasure, scope=cs_drillingParams, documentation=u'Maximum inclination.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 264, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'inclMn'), planeAngleMeasure, scope=cs_drillingParams, documentation=u'Minimum inclination.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 269, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'inclStop'), planeAngleMeasure, scope=cs_drillingParams, documentation=u'Inclination at stop measured depth.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 274, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tempMudDhMx'), thermodynamicTemperatureMeasure, scope=cs_drillingParams, documentation=u'Maximum mud temperature downhole during run.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 279, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'presPumpAv'), pressureMeasure, scope=cs_drillingParams, documentation=u'Average pump pressure.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 284, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'flowrateBit'), volumeFlowRateMeasure, scope=cs_drillingParams, documentation=u'Flow rate at bit.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 289, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'comments'), commentString, scope=cs_drillingParams, documentation=u'Comments and remarks.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 294, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 29, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 39, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 44, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 49, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 54, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 59, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 64, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 69, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 74, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 79, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 84, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 89, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 94, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 99, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 104, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 109, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 114, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 119, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 124, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 129, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 134, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 139, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 144, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 149, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 154, 3))
    counters.add(cc_24)
    cc_25 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 159, 3))
    counters.add(cc_25)
    cc_26 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 164, 3))
    counters.add(cc_26)
    cc_27 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 169, 3))
    counters.add(cc_27)
    cc_28 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 174, 3))
    counters.add(cc_28)
    cc_29 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 179, 3))
    counters.add(cc_29)
    cc_30 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 184, 3))
    counters.add(cc_30)
    cc_31 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 189, 3))
    counters.add(cc_31)
    cc_32 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 194, 3))
    counters.add(cc_32)
    cc_33 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 199, 3))
    counters.add(cc_33)
    cc_34 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 204, 3))
    counters.add(cc_34)
    cc_35 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 209, 3))
    counters.add(cc_35)
    cc_36 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 214, 3))
    counters.add(cc_36)
    cc_37 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 219, 3))
    counters.add(cc_37)
    cc_38 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 224, 3))
    counters.add(cc_38)
    cc_39 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 229, 3))
    counters.add(cc_39)
    cc_40 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 234, 3))
    counters.add(cc_40)
    cc_41 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 239, 3))
    counters.add(cc_41)
    cc_42 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 244, 3))
    counters.add(cc_42)
    cc_43 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 249, 3))
    counters.add(cc_43)
    cc_44 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 254, 3))
    counters.add(cc_44)
    cc_45 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 259, 3))
    counters.add(cc_45)
    cc_46 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 264, 3))
    counters.add(cc_46)
    cc_47 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 269, 3))
    counters.add(cc_47)
    cc_48 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 274, 3))
    counters.add(cc_48)
    cc_49 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 279, 3))
    counters.add(cc_49)
    cc_50 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 284, 3))
    counters.add(cc_50)
    cc_51 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 289, 3))
    counters.add(cc_51)
    cc_52 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 294, 3))
    counters.add(cc_52)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'eTimOpBit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdHoleStart')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 29, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdHoleStop')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 34, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tubular')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 39, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'hkldRot')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 44, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'overPull')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 49, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'slackOff')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 54, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'hkldUp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 59, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'hkldDn')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 64, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 69, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 74, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tqOnBotMn')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 79, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tqOffBotAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 84, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tqDhAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 89, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wtAboveJar')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 94, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wtBelowJar')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 99, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wtMud')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 104, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'flowratePump')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 109, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'powBit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 114, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'velNozzleAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 119, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'presDropBit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 124, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cTimHold')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 129, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cTimSteering')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 134, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cTimDrillRot')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 139, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cTimDrillSlid')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 144, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cTimCirc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 149, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'cTimReam')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 154, 3))
    st_26 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_26)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_25, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'distDrillRot')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 159, 3))
    st_27 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_27)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_26, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'distDrillSlid')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 164, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'distReam')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 169, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'distHold')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 174, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'distSteering')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 179, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rpmAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 184, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rpmMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 189, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rpmMn')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 194, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rpmAvDh')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 199, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ropAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 204, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ropMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 209, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ropMn')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 214, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wobAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 219, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wobMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 224, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wobMn')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 229, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'wobAvDh')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 234, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'reasonTrip')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 239, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectiveBha')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 244, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'aziTop')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 249, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'aziBottom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 254, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inclStart')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 259, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inclMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 264, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inclMn')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 269, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'inclStop')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 274, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tempMudDhMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 279, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'presPumpAv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 284, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'flowrateBit')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 289, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'comments')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_drillingParams.xsd', 294, 3))
...
obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tubular'), refNameString, scope=obj_bhaRun, documentation=u'This represents a foreign key to the tubular (assembly) \n\t\t\t\t\tthat was utilized in this run.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 24, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimStart'), timestamp, scope=obj_bhaRun, documentation=u'Date and time that activities started.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 30, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimStop'), timestamp, scope=obj_bhaRun, documentation=u'Date and time that activities stopped.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 35, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimStartDrilling'), timestamp, scope=obj_bhaRun, documentation=u'Start on bottom - date and time.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 40, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimStopDrilling'), timestamp, scope=obj_bhaRun, documentation=u'Start off bottom - date and time.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 45, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'planDogleg'), anglePerLengthMeasure, scope=obj_bhaRun, documentation=u'Planned dogleg severity.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 50, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'actDogleg'), anglePerLengthMeasure, scope=obj_bhaRun, documentation=u'Actual dogleg severity.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 55, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'actDoglegMx'), anglePerLengthMeasure, scope=obj_bhaRun, documentation=u'Actual dogleg severity - Maximum.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 60, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'statusBha'), BhaStatus, scope=obj_bhaRun, documentation=u'Bottom hole assembly status.', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 65, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'numBitRun'), nameString, scope=obj_bhaRun, documentation=u'Bit run number.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 70, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'numStringRun'), positiveCount, scope=obj_bhaRun, documentation=u'The BHA (drilling string) run number. ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 75, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'reasonTrip'), commentString, scope=obj_bhaRun, documentation=u'Reason for trip.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 80, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'objectiveBha'), commentString, scope=obj_bhaRun, documentation=u'Objective of bottom hole assembly.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 85, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'drillingParams'), cs_drillingParams, scope=obj_bhaRun, documentation=u'Drilling parameters.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 90, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_bhaRun, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 57, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_bhaRun, documentation=u'Human recognizable context for the wellbore that contains the bottom hole assembly. ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 62, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_bhaRun, documentation=u'Human recognizable context for the run.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 67, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_bhaRun, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 77, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_bhaRun, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 83, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 30, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 35, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 40, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 45, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 50, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 55, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 60, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 65, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 70, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 75, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 80, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 85, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 90, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 72, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 77, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 83, 3))
    counters.add(cc_15)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tubular')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimStart')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 30, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimStop')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimStartDrilling')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 40, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimStopDrilling')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 45, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'planDogleg')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 50, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'actDogleg')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 55, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'actDoglegMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 60, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'statusBha')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 65, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'numBitRun')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 70, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'numStringRun')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 75, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'reasonTrip')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 80, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'objectiveBha')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 85, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'drillingParams')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_bhaRun.xsd', 90, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 57, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 62, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 67, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 77, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_bhaRun.xsd', 83, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    transitions = []
    transitions.append(fac.Transition(st_0, [
