# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_formationMarker.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:52:23.260742 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:10cd828a-3b8b-46ce-9db6-3f256369a1d9')
...
class obj_formationMarkers (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 33, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_formationMarkers_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 35, 3), )
    ...
    __formationMarker = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'formationMarker'), 'formationMarker', '__httpwww_witsml_orgschemas131_obj_formationMarkers_httpwww_witsml_orgschemas131formationMarker', True, pyxb.utils.utility.Location('obj_formationMarker.xsd', 40, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_formationMarkers_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 46, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 46, 2)
...
class obj_formationMarker (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 55, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}mdPrognosed uses Python identifier mdPrognosed
    __mdPrognosed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdPrognosed'), 'mdPrognosed', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131mdPrognosed', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 23, 3), )
    ...
    __tvdPrognosed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdPrognosed'), 'tvdPrognosed', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131tvdPrognosed', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 28, 3), )
    ...
    __mdTopSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdTopSample'), 'mdTopSample', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131mdTopSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 33, 3), )
    ...
    __tvdTopSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdTopSample'), 'tvdTopSample', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131tvdTopSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 38, 3), )
    ...
    __thicknessBed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed'), 'thicknessBed', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131thicknessBed', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 43, 3), )
    ...
    __thicknessApparent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thicknessApparent'), 'thicknessApparent', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131thicknessApparent', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 48, 3), )
    ...
    __thicknessPerpen = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen'), 'thicknessPerpen', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131thicknessPerpen', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 53, 3), )
    ...
    __mdLogSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdLogSample'), 'mdLogSample', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131mdLogSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 58, 3), )
    ...
    __tvdLogSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdLogSample'), 'tvdLogSample', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131tvdLogSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 63, 3), )
    ...
    __dip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dip'), 'dip', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131dip', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 68, 3), )
    ...
    __dipDirection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dipDirection'), 'dipDirection', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131dipDirection', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 73, 3), )
    ...
    __nameFormation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), 'nameFormation', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131nameFormation', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 83, 3), )
    ...
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 88, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 62, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 67, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_formationMarker_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 83, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_formationMarker_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_formationMarker_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 90, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 90, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_formationMarker_uidWellbore', _module_typeBindings.uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 96, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 96, 2)
...
obj_formationMarkers._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_formationMarkers, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 35, 3)))

obj_formationMarkers._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'formationMarker'), obj_formationMarker, scope=obj_formationMarkers, documentation='A single formation marker.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarkers._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_formationMarkers._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'formationMarker')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdPrognosed'), measuredDepthCoord, scope=obj_formationMarker, documentation='Prognosed measured depth.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 23, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdPrognosed'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation='Prognosed true vertical depth.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 28, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdTopSample'), measuredDepthCoord, scope=obj_formationMarker, documentation='Sampled measured depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 33, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdTopSample'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation='Sampled true vertical depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 38, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed'), lengthMeasure, scope=obj_formationMarker, documentation='Bed Thickness.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 43, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessApparent'), lengthMeasure, scope=obj_formationMarker, documentation='Formation exposed along the wellbore.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 48, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen'), lengthMeasure, scope=obj_formationMarker, documentation='Perpendicular thickness.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 53, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdLogSample'), measuredDepthCoord, scope=obj_formationMarker, documentation='Logged measured depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 58, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdLogSample'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation='Logged true vertical depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 63, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dip'), planeAngleMeasure, scope=obj_formationMarker, documentation='Angle of dip with respect to horizontal.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 68, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dipDirection'), planeAngleMeasure, scope=obj_formationMarker, documentation='Interpreted downdip direction.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 73, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic'), str32, scope=obj_formationMarker, documentation='Chronostratigraphic classification.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 78, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), str32, scope=obj_formationMarker, documentation='Formation name.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 83, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=obj_formationMarker, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 88, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_formationMarker, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 57, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_formationMarker, documentation='Human recognizable context for the wellbore that contains the formation marker.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 62, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_formationMarker, documentation='Human recognizable context for the formation marker.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 67, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_formationMarker, documentation='A container element that contains elements that are common to all data \n\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_formationMarker, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 83, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 72, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 23, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 28, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 38, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 43, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 48, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 53, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 58, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 63, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 68, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 73, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 78, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 83, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 88, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 83, 3))
    counters.add(cc_15)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 57, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 62, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 67, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdPrognosed')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 23, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdPrognosed')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 28, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdTopSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 33, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdTopSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 38, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 43, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thicknessApparent')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 48, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 53, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdLogSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 58, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdLogSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 63, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dip')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 68, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dipDirection')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 73, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 78, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameFormation')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 83, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 88, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 83, 3))
