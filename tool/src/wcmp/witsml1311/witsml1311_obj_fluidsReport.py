# .\witsml1311_obj_fluidsReport.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2013-06-21 14:46:44.547000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:4c8c6bae-daab-11e2-8c95-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/131}obj_fluidsReports with content type ELEMENT_ONLY
class obj_fluidsReports (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_fluidsReports with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_fluidsReports')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 33, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_fluidsReports_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 35, 3), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/131}fluidsReport uses Python identifier fluidsReport
    __fluidsReport = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'fluidsReport'), 'fluidsReport', '__httpwww_witsml_orgschemas131_obj_fluidsReports_httpwww_witsml_orgschemas131fluidsReport', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 40, 3), )

    
    fluidsReport = property(__fluidsReport.value, __fluidsReport.set, None, u'A single fluids report.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas131_obj_fluidsReports_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 46, 2)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 46, 2)
...
Namespace.addCategoryObject('typeBinding', u'obj_fluidsReports', obj_fluidsReports)
...
# Complex type {http://www.witsml.org/schemas/131}cs_fluid with content type ELEMENT_ONLY
class cs_fluid (pyxb.binding.basis.complexTypeDefinition):
    """ WITSML - fluids component schema """
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_fluid')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 19, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}type uses Python identifier type
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'type'), 'type', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131type', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 24, 3), )

    
    type = property(__type.value, __type.set, None, u'Description for the type of object.  ')

    
    # Element {http://www.witsml.org/schemas/131}locationSample uses Python identifier locationSample
    __locationSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'locationSample'), 'locationSample', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131locationSample', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 29, 3), )

    
    locationSample = property(__locationSample.value, __locationSample.set, None, u'Sample location.  ')

    
    # Element {http://www.witsml.org/schemas/131}dTim uses Python identifier dTim
    __dTim = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTim'), 'dTim', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131dTim', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 34, 3), )

    
    dTim = property(__dTim.value, __dTim.set, None, u'The time when fluid readings were recorded.  ')

    
    # Element {http://www.witsml.org/schemas/131}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'md'), 'md', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131md', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 39, 3), )

    
    md = property(__md.value, __md.set, None, u'The measured depth when fluid readings were recorded. ')

    
    # Element {http://www.witsml.org/schemas/131}density uses Python identifier density
    __density = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'density'), 'density', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131density', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 44, 3), )

    
    density = property(__density.value, __density.set, None, u'Fluid density.  ')

    
    # Element {http://www.witsml.org/schemas/131}visFunnel uses Python identifier visFunnel
    __visFunnel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'visFunnel'), 'visFunnel', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131visFunnel', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 49, 3), )

    
    visFunnel = property(__visFunnel.value, __visFunnel.set, None, u'Funnel viscosity in seconds.  ')

    
    # Element {http://www.witsml.org/schemas/131}tempVis uses Python identifier tempVis
    __tempVis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tempVis'), 'tempVis', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131tempVis', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 54, 3), )

    
    tempVis = property(__tempVis.value, __tempVis.set, None, u'Funnel viscosity temperature.  ')

    
    # Element {http://www.witsml.org/schemas/131}pv uses Python identifier pv
    __pv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'pv'), 'pv', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131pv', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 59, 3), )

    
    pv = property(__pv.value, __pv.set, None, u'Plastic viscosity.  ')

    
    # Element {http://www.witsml.org/schemas/131}yp uses Python identifier yp
    __yp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'yp'), 'yp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131yp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 64, 3), )

    
    yp = property(__yp.value, __yp.set, None, u'Yield point (Bingham and Herschel Bulkley models).  ')

    
    # Element {http://www.witsml.org/schemas/131}gel10Sec uses Python identifier gel10Sec
    __gel10Sec = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'gel10Sec'), 'gel10Sec', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131gel10Sec', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 69, 3), )

    
    gel10Sec = property(__gel10Sec.value, __gel10Sec.set, None, u'10 second gels.  ')

    
    # Element {http://www.witsml.org/schemas/131}gel10Min uses Python identifier gel10Min
    __gel10Min = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'gel10Min'), 'gel10Min', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131gel10Min', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 74, 3), )

    
    gel10Min = property(__gel10Min.value, __gel10Min.set, None, u'10 minute gels.  ')

    
    # Element {http://www.witsml.org/schemas/131}gel30Min uses Python identifier gel30Min
    __gel30Min = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'gel30Min'), 'gel30Min', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131gel30Min', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 79, 3), )

    
    gel30Min = property(__gel30Min.value, __gel30Min.set, None, u'30 minute gels.  ')

    
    # Element {http://www.witsml.org/schemas/131}filterCakeLtlp uses Python identifier filterCakeLtlp
    __filterCakeLtlp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'filterCakeLtlp'), 'filterCakeLtlp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131filterCakeLtlp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 84, 3), )

    
    filterCakeLtlp = property(__filterCakeLtlp.value, __filterCakeLtlp.set, None, u'Filter cake thickness at low (normal) temperature and pressure.  ')

    
    # Element {http://www.witsml.org/schemas/131}filtrateLtlp uses Python identifier filtrateLtlp
    __filtrateLtlp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'filtrateLtlp'), 'filtrateLtlp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131filtrateLtlp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 89, 3), )

    
    filtrateLtlp = property(__filtrateLtlp.value, __filtrateLtlp.set, None, u'API water loss (low temperature and pressure mud filtrate measurement) (ml/30min)  ')

    
    # Element {http://www.witsml.org/schemas/131}tempHthp uses Python identifier tempHthp
    __tempHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tempHthp'), 'tempHthp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131tempHthp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 94, 3), )

    
    tempHthp = property(__tempHthp.value, __tempHthp.set, None, u'High temperature high pressure (HTHP) temperature.  ')

    
    # Element {http://www.witsml.org/schemas/131}presHthp uses Python identifier presHthp
    __presHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'presHthp'), 'presHthp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131presHthp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 99, 3), )

    
    presHthp = property(__presHthp.value, __presHthp.set, None, u'High temperature high pressure (HTHP) pressure.  ')

    
    # Element {http://www.witsml.org/schemas/131}filtrateHthp uses Python identifier filtrateHthp
    __filtrateHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'filtrateHthp'), 'filtrateHthp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131filtrateHthp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 104, 3), )

    
    filtrateHthp = property(__filtrateHthp.value, __filtrateHthp.set, None, u'High temperature high pressure (HTHP) filtrate (volume per 30min).  ')

    
    # Element {http://www.witsml.org/schemas/131}filterCakeHthp uses Python identifier filterCakeHthp
    __filterCakeHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'filterCakeHthp'), 'filterCakeHthp', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131filterCakeHthp', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 109, 3), )

    
    filterCakeHthp = property(__filterCakeHthp.value, __filterCakeHthp.set, None, u'High temperature high pressure (HTHP) Filter cake thickness.  ')

    
    # Element {http://www.witsml.org/schemas/131}solidsPc uses Python identifier solidsPc
    __solidsPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'solidsPc'), 'solidsPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131solidsPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 114, 3), )

    
    solidsPc = property(__solidsPc.value, __solidsPc.set, None, u'Solids percentage from retort (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}waterPc uses Python identifier waterPc
    __waterPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'waterPc'), 'waterPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131waterPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 119, 3), )

    
    waterPc = property(__waterPc.value, __waterPc.set, None, u'Water content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}oilPc uses Python identifier oilPc
    __oilPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'oilPc'), 'oilPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131oilPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 124, 3), )

    
    oilPc = property(__oilPc.value, __oilPc.set, None, u'Oil content from retort (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}sandPc uses Python identifier sandPc
    __sandPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sandPc'), 'sandPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131sandPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 129, 3), )

    
    sandPc = property(__sandPc.value, __sandPc.set, None, u'Sand content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}solidsLowGravPc uses Python identifier solidsLowGravPc
    __solidsLowGravPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'solidsLowGravPc'), 'solidsLowGravPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131solidsLowGravPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 134, 3), )

    
    solidsLowGravPc = property(__solidsLowGravPc.value, __solidsLowGravPc.set, None, u'Low gravity solids (%).  ')

    
    # Element {http://www.witsml.org/schemas/131}solidsCalcPc uses Python identifier solidsCalcPc
    __solidsCalcPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'solidsCalcPc'), 'solidsCalcPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131solidsCalcPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 139, 3), )

    
    solidsCalcPc = property(__solidsCalcPc.value, __solidsCalcPc.set, None, u'Solids content (calculated) (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}baritePc uses Python identifier baritePc
    __baritePc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'baritePc'), 'baritePc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131baritePc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 144, 3), )

    
    baritePc = property(__baritePc.value, __baritePc.set, None, u'Barite content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}lcm uses Python identifier lcm
    __lcm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'lcm'), 'lcm', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131lcm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 149, 3), )

    
    lcm = property(__lcm.value, __lcm.set, None, u'Lost circulation material.  ')

    
    # Element {http://www.witsml.org/schemas/131}mbt uses Python identifier mbt
    __mbt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mbt'), 'mbt', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131mbt', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 154, 3), )

    
    mbt = property(__mbt.value, __mbt.set, None, u'Cation exchange capacity (CEC) of the mud sample as measured by methylene blue titration (MBT).  ')

    
    # Element {http://www.witsml.org/schemas/131}ph uses Python identifier ph
    __ph = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'ph'), 'ph', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131ph', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 159, 3), )

    
    ph = property(__ph.value, __ph.set, None, u'Mud pH.  ')

    
    # Element {http://www.witsml.org/schemas/131}tempPh uses Python identifier tempPh
    __tempPh = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tempPh'), 'tempPh', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131tempPh', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 164, 3), )

    
    tempPh = property(__tempPh.value, __tempPh.set, None, u'Mud pH measurement temperature.  ')

    
    # Element {http://www.witsml.org/schemas/131}pm uses Python identifier pm
    __pm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'pm'), 'pm', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131pm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 169, 3), )

    
    pm = property(__pm.value, __pm.set, None, u'Phenolphthalein alkalinity of whole mud.  ')

    
    # Element {http://www.witsml.org/schemas/131}pmFiltrate uses Python identifier pmFiltrate
    __pmFiltrate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'pmFiltrate'), 'pmFiltrate', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131pmFiltrate', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 174, 3), )

    
    pmFiltrate = property(__pmFiltrate.value, __pmFiltrate.set, None, u'Phenolphthalein alkalinity of mud filtrate.  ')

    
    # Element {http://www.witsml.org/schemas/131}mf uses Python identifier mf
    __mf = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mf'), 'mf', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131mf', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 179, 3), )

    
    mf = property(__mf.value, __mf.set, None, u'Methyl orange alkalinity of filtrate.  ')

    
    # Element {http://www.witsml.org/schemas/131}alkalinityP1 uses Python identifier alkalinityP1
    __alkalinityP1 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'alkalinityP1'), 'alkalinityP1', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131alkalinityP1', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 184, 3), )

    
    alkalinityP1 = property(__alkalinityP1.value, __alkalinityP1.set, None, u'Mud alkalinity P1 from alternate alkalinity method (volume in ml of 0.02N acid \n\t\t\t\t\tto reach the phenolphthalein endpoint).  ')

    
    # Element {http://www.witsml.org/schemas/131}alkalinityP2 uses Python identifier alkalinityP2
    __alkalinityP2 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'alkalinityP2'), 'alkalinityP2', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131alkalinityP2', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 190, 3), )

    
    alkalinityP2 = property(__alkalinityP2.value, __alkalinityP2.set, None, u'Mud alkalinity P2 from alternate alkalinity method (volume in ml of 0.02N acid\n\t\t\t\t\tto titrate the reagent mixture to the phenolphthalein endpoint).  ')

    
    # Element {http://www.witsml.org/schemas/131}chloride uses Python identifier chloride
    __chloride = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'chloride'), 'chloride', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131chloride', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 196, 3), )

    
    chloride = property(__chloride.value, __chloride.set, None, u'Chloride content.  ')

    
    # Element {http://www.witsml.org/schemas/131}calcium uses Python identifier calcium
    __calcium = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'calcium'), 'calcium', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131calcium', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 201, 3), )

    
    calcium = property(__calcium.value, __calcium.set, None, u'Calcium content.  ')

    
    # Element {http://www.witsml.org/schemas/131}magnesium uses Python identifier magnesium
    __magnesium = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'magnesium'), 'magnesium', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131magnesium', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 206, 3), )

    
    magnesium = property(__magnesium.value, __magnesium.set, None, u'Magnesium content.  ')

    
    # Element {http://www.witsml.org/schemas/131}potassium uses Python identifier potassium
    __potassium = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'potassium'), 'potassium', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131potassium', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 211, 3), )

    
    potassium = property(__potassium.value, __potassium.set, None, u'Potassium content.  ')

    
    # Element {http://www.witsml.org/schemas/131}rheometer uses Python identifier rheometer
    __rheometer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'rheometer'), 'rheometer', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131rheometer', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 216, 3), )

    
    rheometer = property(__rheometer.value, __rheometer.set, None, u'One or more sets of rheometer readings at given temperature and pressure.  ')

    
    # Element {http://www.witsml.org/schemas/131}brinePc uses Python identifier brinePc
    __brinePc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'brinePc'), 'brinePc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131brinePc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 221, 3), )

    
    brinePc = property(__brinePc.value, __brinePc.set, None, u'Brine content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}lime uses Python identifier lime
    __lime = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'lime'), 'lime', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131lime', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 226, 3), )

    
    lime = property(__lime.value, __lime.set, None, u'Lime content.  ')

    
    # Element {http://www.witsml.org/schemas/131}electStab uses Python identifier electStab
    __electStab = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'electStab'), 'electStab', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131electStab', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 231, 3), )

    
    electStab = property(__electStab.value, __electStab.set, None, u'Measurement of the emulsion stability and oil-wetting capability in oil-based muds.  ')

    
    # Element {http://www.witsml.org/schemas/131}calciumChloride uses Python identifier calciumChloride
    __calciumChloride = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'calciumChloride'), 'calciumChloride', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131calciumChloride', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 236, 3), )

    
    calciumChloride = property(__calciumChloride.value, __calciumChloride.set, None, u'Calcium chloride content.  ')

    
    # Element {http://www.witsml.org/schemas/131}company uses Python identifier company
    __company = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'company'), 'company', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131company', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 241, 3), )

    
    company = property(__company.value, __company.set, None, u'Name of company.  ')

    
    # Element {http://www.witsml.org/schemas/131}engineer uses Python identifier engineer
    __engineer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'engineer'), 'engineer', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131engineer', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 246, 3), )

    
    engineer = property(__engineer.value, __engineer.set, None, u'Engineer name  ')

    
    # Element {http://www.witsml.org/schemas/131}asg uses Python identifier asg
    __asg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'asg'), 'asg', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131asg', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 251, 3), )

    
    asg = property(__asg.value, __asg.set, None, u'Average specific gravity of solids.  ')

    
    # Element {http://www.witsml.org/schemas/131}solidsHiGravPc uses Python identifier solidsHiGravPc
    __solidsHiGravPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'solidsHiGravPc'), 'solidsHiGravPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131solidsHiGravPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 256, 3), )

    
    solidsHiGravPc = property(__solidsHiGravPc.value, __solidsHiGravPc.set, None, u'Solids high gravity (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}polymer uses Python identifier polymer
    __polymer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'polymer'), 'polymer', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131polymer', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 261, 3), )

    
    polymer = property(__polymer.value, __polymer.set, None, u'Polymers present in mud system.  ')

    
    # Element {http://www.witsml.org/schemas/131}polyType uses Python identifier polyType
    __polyType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'polyType'), 'polyType', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131polyType', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 266, 3), )

    
    polyType = property(__polyType.value, __polyType.set, None, u'Type of polymers present in mud system.  ')

    
    # Element {http://www.witsml.org/schemas/131}solCorPc uses Python identifier solCorPc
    __solCorPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'solCorPc'), 'solCorPc', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131solCorPc', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 271, 3), )

    
    solCorPc = property(__solCorPc.value, __solCorPc.set, None, u'Solids corrected for Chloride content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/131}oilCtg uses Python identifier oilCtg
    __oilCtg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'oilCtg'), 'oilCtg', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131oilCtg', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 276, 3), )

    
    oilCtg = property(__oilCtg.value, __oilCtg.set, None, u'Oil on Cuttings.  ')

    
    # Element {http://www.witsml.org/schemas/131}hardnessCa uses Python identifier hardnessCa
    __hardnessCa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'hardnessCa'), 'hardnessCa', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131hardnessCa', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 281, 3), )

    
    hardnessCa = property(__hardnessCa.value, __hardnessCa.set, None, u'Total calcium hardness.  ')

    
    # Element {http://www.witsml.org/schemas/131}sulfide uses Python identifier sulfide
    __sulfide = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sulfide'), 'sulfide', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131sulfide', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 286, 3), )

    
    sulfide = property(__sulfide.value, __sulfide.set, None, u'Sulfide content.  ')

    
    # Element {http://www.witsml.org/schemas/131}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'comments'), 'comments', '__httpwww_witsml_orgschemas131_cs_fluid_httpwww_witsml_orgschemas131comments', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 291, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_fluid_uid', uidString)
...
Namespace.addCategoryObject('typeBinding', u'cs_fluid', cs_fluid)


# Complex type {http://www.witsml.org/schemas/131}cs_rheometer with content type ELEMENT_ONLY
class cs_rheometer (pyxb.binding.basis.complexTypeDefinition):
    """ WITSML - Rheometer Component Schema """
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'cs_rheometer')
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 19, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}tempRheom uses Python identifier tempRheom
    __tempRheom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tempRheom'), 'tempRheom', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131tempRheom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 24, 3), )

    
    tempRheom = property(__tempRheom.value, __tempRheom.set, None, u'Rheometer temperature.  ')

    
    # Element {http://www.witsml.org/schemas/131}presRheom uses Python identifier presRheom
    __presRheom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'presRheom'), 'presRheom', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131presRheom', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 29, 3), )

    
    presRheom = property(__presRheom.value, __presRheom.set, None, u'Rheometer pressure.  ')

    
    # Element {http://www.witsml.org/schemas/131}vis3Rpm uses Python identifier vis3Rpm
    __vis3Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'vis3Rpm'), 'vis3Rpm', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131vis3Rpm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 34, 3), )

    
    vis3Rpm = property(__vis3Rpm.value, __vis3Rpm.set, None, u'3 RPM viscometer reading  ')

    
    # Element {http://www.witsml.org/schemas/131}vis6Rpm uses Python identifier vis6Rpm
    __vis6Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'vis6Rpm'), 'vis6Rpm', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131vis6Rpm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 39, 3), )

    
    vis6Rpm = property(__vis6Rpm.value, __vis6Rpm.set, None, u'6 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/131}vis100Rpm uses Python identifier vis100Rpm
    __vis100Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'vis100Rpm'), 'vis100Rpm', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131vis100Rpm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 44, 3), )

    
    vis100Rpm = property(__vis100Rpm.value, __vis100Rpm.set, None, u'100 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/131}vis200Rpm uses Python identifier vis200Rpm
    __vis200Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'vis200Rpm'), 'vis200Rpm', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131vis200Rpm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 49, 3), )

    
    vis200Rpm = property(__vis200Rpm.value, __vis200Rpm.set, None, u'200 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/131}vis300Rpm uses Python identifier vis300Rpm
    __vis300Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'vis300Rpm'), 'vis300Rpm', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131vis300Rpm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 54, 3), )

    
    vis300Rpm = property(__vis300Rpm.value, __vis300Rpm.set, None, u'300 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/131}vis600Rpm uses Python identifier vis600Rpm
    __vis600Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'vis600Rpm'), 'vis600Rpm', '__httpwww_witsml_orgschemas131_cs_rheometer_httpwww_witsml_orgschemas131vis600Rpm', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 59, 3), )

    
    vis600Rpm = property(__vis600Rpm.value, __vis600Rpm.set, None, u'600 RPM viscometer reading.  ')

    
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_rheometer_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
...
Namespace.addCategoryObject('typeBinding', u'cs_rheometer', cs_rheometer)


# Complex type {http://www.witsml.org/schemas/131}obj_fluidsReport with content type ELEMENT_ONLY
class obj_fluidsReport (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_fluidsReport with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_fluidsReport')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 55, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}dTim uses Python identifier dTim
    __dTim = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTim'), 'dTim', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131dTim', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 23, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'md'), 'md', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131md', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 28, 3), )
    ...
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'tvd'), 'tvd', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131tvd', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 33, 3), )

    
    tvd = property(__tvd.value, __tvd.set, None, u'Vertical depth of the measurements.  ')

    
    # Element {http://www.witsml.org/schemas/131}numReport uses Python identifier numReport
    __numReport = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'numReport'), 'numReport', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131numReport', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 38, 3), )

    
    numReport = property(__numReport.value, __numReport.set, None, u'Fluids report number.  ')

    
    # Element {http://www.witsml.org/schemas/131}fluid uses Python identifier fluid
    __fluid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'fluid'), 'fluid', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131fluid', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 43, 3), )

    
    fluid = property(__fluid.value, __fluid.set, None, u'A Fluid record.  ')

    
    # Element {http://www.witsml.org/schemas/131}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 62, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, u'Human recognizable context for the wellbore that contains the fluids report.  ')

    
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 67, 3), )

    
    name = property(__name.value, __name.set, None, u'Human recognizable context for the fluids report.  ')

    
    # Element {http://www.witsml.org/schemas/131}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 77, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_fluidsReport_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 83, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_fluidsReport_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_fluidsReport_uidWell', uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 90, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 90, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_fluidsReport_uidWellbore', uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 96, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 96, 2)
...
Namespace.addCategoryObject('typeBinding', u'obj_fluidsReport', obj_fluidsReport)
...
fluidsReports = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fluidsReports'), obj_fluidsReports, documentation=u'The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 25, 1))
...
obj_fluidsReports._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_fluidsReports, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 35, 3)))

obj_fluidsReports._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fluidsReport'), obj_fluidsReport, scope=obj_fluidsReports, documentation=u'A single fluids report.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReports._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReports._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fluidsReport')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_fluidsReports._Automaton = _BuildAutomaton_7()




cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'type'), str32, scope=cs_fluid, documentation=u'Description for the type of object.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 24, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'locationSample'), str32, scope=cs_fluid, documentation=u'Sample location.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 29, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTim'), timestamp, scope=cs_fluid, documentation=u'The time when fluid readings were recorded.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 34, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'md'), measuredDepthCoord, scope=cs_fluid, documentation=u'The measured depth when fluid readings were recorded. ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 39, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'density'), densityMeasure, scope=cs_fluid, documentation=u'Fluid density.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 44, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'visFunnel'), timeMeasure, scope=cs_fluid, documentation=u'Funnel viscosity in seconds.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 49, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tempVis'), thermodynamicTemperatureMeasure, scope=cs_fluid, documentation=u'Funnel viscosity temperature.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 54, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pv'), dynamicViscosityMeasure, scope=cs_fluid, documentation=u'Plastic viscosity.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 59, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'yp'), pressureMeasure, scope=cs_fluid, documentation=u'Yield point (Bingham and Herschel Bulkley models).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 64, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'gel10Sec'), pressureMeasure, scope=cs_fluid, documentation=u'10 second gels.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 69, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'gel10Min'), pressureMeasure, scope=cs_fluid, documentation=u'10 minute gels.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 74, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'gel30Min'), pressureMeasure, scope=cs_fluid, documentation=u'30 minute gels.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 79, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'filterCakeLtlp'), lengthMeasure, scope=cs_fluid, documentation=u'Filter cake thickness at low (normal) temperature and pressure.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 84, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'filtrateLtlp'), volumeMeasure, scope=cs_fluid, documentation=u'API water loss (low temperature and pressure mud filtrate measurement) (ml/30min)  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 89, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tempHthp'), thermodynamicTemperatureMeasure, scope=cs_fluid, documentation=u'High temperature high pressure (HTHP) temperature.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 94, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'presHthp'), pressureMeasure, scope=cs_fluid, documentation=u'High temperature high pressure (HTHP) pressure.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 99, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'filtrateHthp'), volumeMeasure, scope=cs_fluid, documentation=u'High temperature high pressure (HTHP) filtrate (volume per 30min).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 104, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'filterCakeHthp'), lengthMeasure, scope=cs_fluid, documentation=u'High temperature high pressure (HTHP) Filter cake thickness.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 109, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'solidsPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Solids percentage from retort (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 114, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'waterPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Water content (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 119, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'oilPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Oil content from retort (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 124, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sandPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Sand content (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 129, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'solidsLowGravPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Low gravity solids (%).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 134, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'solidsCalcPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Solids content (calculated) (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 139, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'baritePc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Barite content (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 144, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lcm'), densityMeasure, scope=cs_fluid, documentation=u'Lost circulation material.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 149, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mbt'), equivalentPerMassMeasure, scope=cs_fluid, documentation=u'Cation exchange capacity (CEC) of the mud sample as measured by methylene blue titration (MBT).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 154, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'ph'), unitlessQuantity, scope=cs_fluid, documentation=u'Mud pH.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 159, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tempPh'), thermodynamicTemperatureMeasure, scope=cs_fluid, documentation=u'Mud pH measurement temperature.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 164, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pm'), volumeMeasure, scope=cs_fluid, documentation=u'Phenolphthalein alkalinity of whole mud.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 169, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'pmFiltrate'), volumeMeasure, scope=cs_fluid, documentation=u'Phenolphthalein alkalinity of mud filtrate.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 174, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mf'), volumeMeasure, scope=cs_fluid, documentation=u'Methyl orange alkalinity of filtrate.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 179, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'alkalinityP1'), volumeMeasure, scope=cs_fluid, documentation=u'Mud alkalinity P1 from alternate alkalinity method (volume in ml of 0.02N acid \n\t\t\t\t\tto reach the phenolphthalein endpoint).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 184, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'alkalinityP2'), volumeMeasure, scope=cs_fluid, documentation=u'Mud alkalinity P2 from alternate alkalinity method (volume in ml of 0.02N acid\n\t\t\t\t\tto titrate the reagent mixture to the phenolphthalein endpoint).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 190, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'chloride'), densityMeasure, scope=cs_fluid, documentation=u'Chloride content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 196, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'calcium'), densityMeasure, scope=cs_fluid, documentation=u'Calcium content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 201, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'magnesium'), densityMeasure, scope=cs_fluid, documentation=u'Magnesium content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 206, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'potassium'), densityMeasure, scope=cs_fluid, documentation=u'Potassium content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 211, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'rheometer'), cs_rheometer, scope=cs_fluid, documentation=u'One or more sets of rheometer readings at given temperature and pressure.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 216, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'brinePc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Brine content (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 221, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'lime'), densityMeasure, scope=cs_fluid, documentation=u'Lime content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 226, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'electStab'), electricPotentialMeasure, scope=cs_fluid, documentation=u'Measurement of the emulsion stability and oil-wetting capability in oil-based muds.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 231, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'calciumChloride'), densityMeasure, scope=cs_fluid, documentation=u'Calcium chloride content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 236, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'company'), str32, scope=cs_fluid, documentation=u'Name of company.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 241, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'engineer'), nameString, scope=cs_fluid, documentation=u'Engineer name  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 246, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'asg'), unitlessQuantity, scope=cs_fluid, documentation=u'Average specific gravity of solids.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 251, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'solidsHiGravPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Solids high gravity (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 256, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'polymer'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Polymers present in mud system.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 261, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'polyType'), str32, scope=cs_fluid, documentation=u'Type of polymers present in mud system.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 266, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'solCorPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation=u'Solids corrected for Chloride content (commonly in percent).  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 271, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'oilCtg'), massConcentrationMeasure, scope=cs_fluid, documentation=u'Oil on Cuttings.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 276, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'hardnessCa'), massConcentrationMeasure, scope=cs_fluid, documentation=u'Total calcium hardness.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 281, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sulfide'), densityMeasure, scope=cs_fluid, documentation=u'Sulfide content.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 286, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'comments'), commentString, scope=cs_fluid, documentation=u'Comments and remarks.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 291, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 24, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 29, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 34, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 39, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 44, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 49, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 54, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 59, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 64, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 69, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 74, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 79, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 84, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 89, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 94, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 99, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 104, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 109, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 114, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 119, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 124, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 129, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 134, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 139, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 144, 3))
    counters.add(cc_24)
    cc_25 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 149, 3))
    counters.add(cc_25)
    cc_26 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 154, 3))
    counters.add(cc_26)
    cc_27 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 159, 3))
    counters.add(cc_27)
    cc_28 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 164, 3))
    counters.add(cc_28)
    cc_29 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 169, 3))
    counters.add(cc_29)
    cc_30 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 174, 3))
    counters.add(cc_30)
    cc_31 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 179, 3))
    counters.add(cc_31)
    cc_32 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 184, 3))
    counters.add(cc_32)
    cc_33 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 190, 3))
    counters.add(cc_33)
    cc_34 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 196, 3))
    counters.add(cc_34)
    cc_35 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 201, 3))
    counters.add(cc_35)
    cc_36 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 206, 3))
    counters.add(cc_36)
    cc_37 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 211, 3))
    counters.add(cc_37)
    cc_38 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 216, 3))
    counters.add(cc_38)
    cc_39 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 221, 3))
    counters.add(cc_39)
    cc_40 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 226, 3))
    counters.add(cc_40)
    cc_41 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 231, 3))
    counters.add(cc_41)
    cc_42 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 236, 3))
    counters.add(cc_42)
    cc_43 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 241, 3))
    counters.add(cc_43)
    cc_44 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 246, 3))
    counters.add(cc_44)
    cc_45 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 251, 3))
    counters.add(cc_45)
    cc_46 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 256, 3))
    counters.add(cc_46)
    cc_47 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 261, 3))
    counters.add(cc_47)
    cc_48 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 266, 3))
    counters.add(cc_48)
    cc_49 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 271, 3))
    counters.add(cc_49)
    cc_50 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 276, 3))
    counters.add(cc_50)
    cc_51 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 281, 3))
    counters.add(cc_51)
    cc_52 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 286, 3))
    counters.add(cc_52)
    cc_53 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 291, 3))
    counters.add(cc_53)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'type')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'locationSample')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 29, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTim')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 34, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'md')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 39, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'density')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 44, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'visFunnel')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 49, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tempVis')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 54, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'pv')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 59, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'yp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 64, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'gel10Sec')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 69, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'gel10Min')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 74, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'gel30Min')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 79, 3))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'filterCakeLtlp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 84, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'filtrateLtlp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 89, 3))
    st_13 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tempHthp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 94, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'presHthp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 99, 3))
    st_15 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'filtrateHthp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 104, 3))
    st_16 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'filterCakeHthp')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 109, 3))
    st_17 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'solidsPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 114, 3))
    st_18 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'waterPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 119, 3))
    st_19 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'oilPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 124, 3))
    st_20 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sandPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 129, 3))
    st_21 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'solidsLowGravPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 134, 3))
    st_22 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'solidsCalcPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 139, 3))
    st_23 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'baritePc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 144, 3))
    st_24 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_25, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lcm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 149, 3))
    st_25 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_26, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mbt')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 154, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'ph')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 159, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tempPh')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 164, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'pm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 169, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'pmFiltrate')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 174, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mf')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 179, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'alkalinityP1')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 184, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'alkalinityP2')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 190, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'chloride')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 196, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'calcium')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 201, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'magnesium')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 206, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'potassium')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 211, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'rheometer')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 216, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'brinePc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 221, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'lime')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 226, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'electStab')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 231, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'calciumChloride')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 236, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'company')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 241, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'engineer')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 246, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'asg')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 251, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'solidsHiGravPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 256, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'polymer')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 261, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'polyType')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 266, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'solCorPc')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 271, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'oilCtg')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 276, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'hardnessCa')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 281, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sulfide')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 286, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'comments')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_fluid.xsd', 291, 3))
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
cs_fluid._Automaton = _BuildAutomaton_8()




cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tempRheom'), thermodynamicTemperatureMeasure, scope=cs_rheometer, documentation=u'Rheometer temperature.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 24, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'presRheom'), pressureMeasure, scope=cs_rheometer, documentation=u'Rheometer pressure.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 29, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'vis3Rpm'), unitlessQuantity, scope=cs_rheometer, documentation=u'3 RPM viscometer reading  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 34, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'vis6Rpm'), unitlessQuantity, scope=cs_rheometer, documentation=u'6 RPM viscometer reading.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 39, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'vis100Rpm'), unitlessQuantity, scope=cs_rheometer, documentation=u'100 RPM viscometer reading.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 44, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'vis200Rpm'), unitlessQuantity, scope=cs_rheometer, documentation=u'200 RPM viscometer reading.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 49, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'vis300Rpm'), unitlessQuantity, scope=cs_rheometer, documentation=u'300 RPM viscometer reading.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 54, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'vis600Rpm'), unitlessQuantity, scope=cs_rheometer, documentation=u'600 RPM viscometer reading.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 59, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 24, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 29, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 34, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 39, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 44, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 49, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 54, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 59, 3))
    counters.add(cc_7)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tempRheom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'presRheom')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 29, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'vis3Rpm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 34, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'vis6Rpm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 39, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'vis100Rpm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 44, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'vis200Rpm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 49, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'vis300Rpm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 54, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'vis600Rpm')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_rheometer.xsd', 59, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_7._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_rheometer._Automaton = _BuildAutomaton_9()




obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTim'), timestamp, scope=obj_fluidsReport, documentation=u'Date and time the information is related to.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 23, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'md'), measuredDepthCoord, scope=obj_fluidsReport, documentation=u'Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 28, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'tvd'), wellVerticalDepthCoord, scope=obj_fluidsReport, documentation=u'Vertical depth of the measurements.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 33, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'numReport'), positiveCount, scope=obj_fluidsReport, documentation=u'Fluids report number.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 38, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'fluid'), cs_fluid, scope=obj_fluidsReport, documentation=u'A Fluid record.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 43, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_fluidsReport, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 57, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), nameString, scope=obj_fluidsReport, documentation=u'Human recognizable context for the wellbore that contains the fluids report.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 62, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=obj_fluidsReport, documentation=u'Human recognizable context for the fluids report.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 67, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'commonData'), cs_commonData, scope=obj_fluidsReport, documentation=u'A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 77, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'customData'), cs_customData, scope=obj_fluidsReport, documentation=u'A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 83, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 33, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 38, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 43, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 72, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 77, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 83, 3))
    counters.add(cc_5)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTim')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'md')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 28, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'tvd')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 33, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'numReport')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 38, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'fluid')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_fluidsReport.xsd', 43, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 57, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 62, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 67, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 77, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_fluidsReport.xsd', 83, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_fluidsReport._Automaton = _BuildAutomaton_10()
