# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_risk.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:52:43.869783 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:a1174624-ac29-4aeb-b471-f4ff6f55f218')
...
class obj_risks (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_risk.xsd', 34, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_risks_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_risk.xsd', 36, 3), )
    ...
    __risk = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'risk'), 'risk', '__httpwww_witsml_orgschemas131_obj_risks_httpwww_witsml_orgschemas131risk', True, pyxb.utils.utility.Location('obj_risk.xsd', 41, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_risks_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_risk.xsd', 47, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_risk.xsd', 47, 2)
...
class obj_risk (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_risk.xsd', 56, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}objectReference uses Python identifier objectReference
    __objectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), 'objectReference', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131objectReference', False, pyxb.utils.utility.Location('grp_risk.xsd', 23, 3), )
    ...
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131type', False, pyxb.utils.utility.Location('grp_risk.xsd', 28, 3), )
    ...
    __category = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'category'), 'category', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131category', False, pyxb.utils.utility.Location('grp_risk.xsd', 33, 3), )
    ...
    __subCategory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'subCategory'), 'subCategory', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131subCategory', False, pyxb.utils.utility.Location('grp_risk.xsd', 38, 3), )
    ...
    __extendCategory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extendCategory'), 'extendCategory', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131extendCategory', False, pyxb.utils.utility.Location('grp_risk.xsd', 43, 3), )
    ...
    __affectedPersonnel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'affectedPersonnel'), 'affectedPersonnel', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131affectedPersonnel', True, pyxb.utils.utility.Location('grp_risk.xsd', 48, 3), )
    ...
    __dTimStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimStart'), 'dTimStart', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131dTimStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 53, 3), )
    ...
    __dTimEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimEnd'), 'dTimEnd', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131dTimEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 58, 3), )
    ...
    __mdHoleStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart'), 'mdHoleStart', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131mdHoleStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 63, 3), )
    ...
    __mdHoleEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdHoleEnd'), 'mdHoleEnd', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131mdHoleEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 68, 3), )
    ...
    __tvdHoleStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleStart'), 'tvdHoleStart', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131tvdHoleStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 73, 3), )
    ...
    __tvdHoleEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleEnd'), 'tvdHoleEnd', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131tvdHoleEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 78, 3), )
    ...
    __mdBitStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBitStart'), 'mdBitStart', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131mdBitStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 83, 3), )
    ...
    __mdBitEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBitEnd'), 'mdBitEnd', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131mdBitEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 88, 3), )
    ...
    __diaHole = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'diaHole'), 'diaHole', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131diaHole', False, pyxb.utils.utility.Location('grp_risk.xsd', 93, 3), )
    ...
    __severityLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'severityLevel'), 'severityLevel', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131severityLevel', False, pyxb.utils.utility.Location('grp_risk.xsd', 98, 3), )
    ...
    __probabilityLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'probabilityLevel'), 'probabilityLevel', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131probabilityLevel', False, pyxb.utils.utility.Location('grp_risk.xsd', 104, 3), )
    ...
    __summary = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'summary'), 'summary', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131summary', False, pyxb.utils.utility.Location('grp_risk.xsd', 110, 3), )
    ...
    __details = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'details'), 'details', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131details', False, pyxb.utils.utility.Location('grp_risk.xsd', 115, 3), )
    ...
    __identification = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'identification'), 'identification', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131identification', False, pyxb.utils.utility.Location('grp_risk.xsd', 120, 3), )
    ...
    __contingency = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'contingency'), 'contingency', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131contingency', False, pyxb.utils.utility.Location('grp_risk.xsd', 125, 3), )
    ...
    __mitigation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mitigation'), 'mitigation', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131mitigation', True, pyxb.utils.utility.Location('grp_risk.xsd', 130, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('obj_risk.xsd', 58, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('obj_risk.xsd', 63, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_risk.xsd', 68, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_risk.xsd', 78, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_risk_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_risk.xsd', 84, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_risk_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_risk_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_risk.xsd', 91, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_risk.xsd', 91, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_risk_uidWellbore', _module_typeBindings.uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_risk.xsd', 97, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_risk.xsd', 97, 2)
...
obj_risks._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_risks, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 36, 3)))

obj_risks._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'risk'), obj_risk, scope=obj_risks, documentation='A single risk.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 41, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 36, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risks._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_risk.xsd', 36, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_risks._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'risk')), pyxb.utils.utility.Location('obj_risk.xsd', 41, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), refObjectString, scope=obj_risk, documentation='A reference to an object that is defined within the context of a wellbore.', location=pyxb.utils.utility.Location('grp_risk.xsd', 23, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), RiskType, scope=obj_risk, documentation='The type of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 28, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'category'), RiskCategory, scope=obj_risk, documentation='The category of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 33, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'subCategory'), RiskSubCategory, scope=obj_risk, documentation='The sub category of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 38, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extendCategory'), kindString, scope=obj_risk, documentation='Custom string to further categorize the risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 43, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'affectedPersonnel'), RiskAffectedPersonnel, scope=obj_risk, documentation='The personnel afected by the risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 48, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimStart'), timestamp, scope=obj_risk, documentation='Date and time that activities started.', location=pyxb.utils.utility.Location('grp_risk.xsd', 53, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimEnd'), timestamp, scope=obj_risk, documentation='Date and time that activities were completed.', location=pyxb.utils.utility.Location('grp_risk.xsd', 58, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart'), measuredDepthCoord, scope=obj_risk, documentation='Measured Depth at start of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 63, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdHoleEnd'), measuredDepthCoord, scope=obj_risk, documentation='Measured Depth at end of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 68, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleStart'), wellVerticalDepthCoord, scope=obj_risk, documentation='True Vertical Depth at start of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 73, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleEnd'), wellVerticalDepthCoord, scope=obj_risk, documentation='True Vertical Depth at end of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 78, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBitStart'), measuredDepthCoord, scope=obj_risk, documentation='Measured depth of bit at start of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 83, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBitEnd'), measuredDepthCoord, scope=obj_risk, documentation='Measured depth of bit at end of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 88, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'diaHole'), lengthMeasure, scope=obj_risk, documentation='Hole diameter.  ', location=pyxb.utils.utility.Location('grp_risk.xsd', 93, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'severityLevel'), levelIntegerCode, scope=obj_risk, documentation='Severity Level of the Risk. \n\t\t\t\t\tValues of 1 through 5 with 1 being the lowest.', location=pyxb.utils.utility.Location('grp_risk.xsd', 98, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'probabilityLevel'), levelIntegerCode, scope=obj_risk, documentation='Probability Level of the Risk.\n\t\t\t\t\tValues of 1 through 5 with 1 being the lowest.', location=pyxb.utils.utility.Location('grp_risk.xsd', 104, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'summary'), descriptionString, scope=obj_risk, documentation='summary description of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 110, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'details'), descriptionString, scope=obj_risk, documentation='Complete description of Risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 115, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'identification'), descriptionString, scope=obj_risk, documentation='Details for identifing the Risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 120, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'contingency'), descriptionString, scope=obj_risk, documentation='Plan of action if the Risk materializes.', location=pyxb.utils.utility.Location('grp_risk.xsd', 125, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mitigation'), descriptionString, scope=obj_risk, documentation='Plan of action to ensure the risk does not materialize.', location=pyxb.utils.utility.Location('grp_risk.xsd', 130, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_risk, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 58, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_risk, documentation='Human recognizable context for the wellbore that contains the risk.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 63, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_risk, documentation='Human recognizable context for the risk.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 68, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_risk, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 78, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_risk, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_risk.xsd', 84, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 73, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 23, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 38, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 43, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 48, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 53, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 58, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 63, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 68, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 73, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 78, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 83, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 88, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 93, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 98, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 104, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 110, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 115, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 120, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 125, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 130, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 78, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 84, 3))
    counters.add(cc_22)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_risk.xsd', 58, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_risk.xsd', 63, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_risk.xsd', 68, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectReference')), pyxb.utils.utility.Location('grp_risk.xsd', 23, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('grp_risk.xsd', 28, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'category')), pyxb.utils.utility.Location('grp_risk.xsd', 33, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'subCategory')), pyxb.utils.utility.Location('grp_risk.xsd', 38, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extendCategory')), pyxb.utils.utility.Location('grp_risk.xsd', 43, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'affectedPersonnel')), pyxb.utils.utility.Location('grp_risk.xsd', 48, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimStart')), pyxb.utils.utility.Location('grp_risk.xsd', 53, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 58, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart')), pyxb.utils.utility.Location('grp_risk.xsd', 63, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdHoleEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 68, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleStart')), pyxb.utils.utility.Location('grp_risk.xsd', 73, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 78, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBitStart')), pyxb.utils.utility.Location('grp_risk.xsd', 83, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBitEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 88, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'diaHole')), pyxb.utils.utility.Location('grp_risk.xsd', 93, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'severityLevel')), pyxb.utils.utility.Location('grp_risk.xsd', 98, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'probabilityLevel')), pyxb.utils.utility.Location('grp_risk.xsd', 104, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'summary')), pyxb.utils.utility.Location('grp_risk.xsd', 110, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'details')), pyxb.utils.utility.Location('grp_risk.xsd', 115, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'identification')), pyxb.utils.utility.Location('grp_risk.xsd', 120, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'contingency')), pyxb.utils.utility.Location('grp_risk.xsd', 125, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mitigation')), pyxb.utils.utility.Location('grp_risk.xsd', 130, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_risk.xsd', 78, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_risk.xsd', 84, 3))
