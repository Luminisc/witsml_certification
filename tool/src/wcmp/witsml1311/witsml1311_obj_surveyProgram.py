# .\witsml1311_obj_surveyProgram.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2013-06-21 14:47:06.882000 by PyXB version 1.2.1
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:59ec0900-daab-11e2-aeba-08002718187b')
...
# Complex type {http://www.witsml.org/schemas/131}obj_surveyPrograms with content type ELEMENT_ONLY
class obj_surveyPrograms (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/131}obj_surveyPrograms with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, u'obj_surveyPrograms')
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 33, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_surveyPrograms_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 35, 3), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, u'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/131}surveyProgram uses Python identifier surveyProgram
    __surveyProgram = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'surveyProgram'), 'surveyProgram', '__httpwww_witsml_orgschemas131_obj_surveyPrograms_httpwww_witsml_orgschemas131surveyProgram', True, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 40, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'version'), 'version', '__httpwww_witsml_orgschemas131_obj_surveyPrograms_version', schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 46, 2)
    __version._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 46, 2)
...
# Complex type {http://www.witsml.org/schemas/131}cs_surveySection with content type ELEMENT_ONLY
class cs_surveySection (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 19, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}sequence uses Python identifier sequence
    __sequence = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'sequence'), 'sequence', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131sequence', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 24, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 29, 3), )

    
    name = property(__name.value, __name.set, None, u'Name of survey program section.  ')

    
    # Element {http://www.witsml.org/schemas/131}mdStart uses Python identifier mdStart
    __mdStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdStart'), 'mdStart', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131mdStart', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 34, 3), )

    
    mdStart = property(__mdStart.value, __mdStart.set, None, u'Hole measured depth at which the survey run will begin/began.  ')

    
    # Element {http://www.witsml.org/schemas/131}mdEnd uses Python identifier mdEnd
    __mdEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'mdEnd'), 'mdEnd', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131mdEnd', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 39, 3), )

    
    mdEnd = property(__mdEnd.value, __mdEnd.set, None, u'Hole measured depth at which the survey run will end/ended.  ')

    
    # Element {http://www.witsml.org/schemas/131}nameSurveyCompany uses Python identifier nameSurveyCompany
    __nameSurveyCompany = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameSurveyCompany'), 'nameSurveyCompany', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131nameSurveyCompany', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 44, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}nameTool uses Python identifier nameTool
    __nameTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameTool'), 'nameTool', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131nameTool', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 49, 3), )

    
    nameTool = property(__nameTool.value, __nameTool.set, None, u'Name of survey tool to be used / used for this section.  ')

    
    # Element {http://www.witsml.org/schemas/131}typeTool uses Python identifier typeTool
    __typeTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'typeTool'), 'typeTool', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131typeTool', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 54, 3), )

    
    typeTool = property(__typeTool.value, __typeTool.set, None, u'Type of tool used.  ')

    
    # Element {http://www.witsml.org/schemas/131}modelError uses Python identifier modelError
    __modelError = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'modelError'), 'modelError', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131modelError', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 59, 3), )

    
    modelError = property(__modelError.value, __modelError.set, None, u'Error model used to calculate ellipses of uncertainty.  ')

    
    # Element {http://www.witsml.org/schemas/131}overwrite uses Python identifier overwrite
    __overwrite = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'overwrite'), 'overwrite', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131overwrite', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 64, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}frequencyMx uses Python identifier frequencyMx
    __frequencyMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'frequencyMx'), 'frequencyMx', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131frequencyMx', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 70, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}itemState uses Python identifier itemState
    __itemState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'itemState'), 'itemState', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131itemState', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 76, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'comments'), 'comments', '__httpwww_witsml_orgschemas131_cs_surveySection_httpwww_witsml_orgschemas131comments', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 81, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_surveySection_uid', uidString)
...
# Complex type {http://www.witsml.org/schemas/131}obj_surveyProgram with content type ELEMENT_ONLY
class obj_surveyProgram (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 55, 1)
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}surveyVer uses Python identifier surveyVer
    __surveyVer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'surveyVer'), 'surveyVer', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131surveyVer', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 23, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}dTimTrajProg uses Python identifier dTimTrajProg
    __dTimTrajProg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'dTimTrajProg'), 'dTimTrajProg', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131dTimTrajProg', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 28, 3), )
    ...
    __engineer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'engineer'), 'engineer', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131engineer', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 33, 3), )

    
    engineer = property(__engineer.value, __engineer.set, None, u'Name of engineer.  ')

    
    # Element {http://www.witsml.org/schemas/131}final uses Python identifier final
    __final = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'final'), 'final', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131final', False, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 38, 3), )

    
    final = property(__final.value, __final.set, None, u'Is program a final or intermediate/preliminary?  ')

    
    # Element {http://www.witsml.org/schemas/131}surveySection uses Python identifier surveySection
    __surveySection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'surveySection'), 'surveySection', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131surveySection', True, pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 43, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 62, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'name'), 'name', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 67, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, u'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_surveyProgram_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 83, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_surveyProgram_uid', uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\attgrp_uid.xsd', 20, 2)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_surveyProgram_uidWell', uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 90, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 90, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, u'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_surveyProgram_uidWellbore', uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 96, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 96, 2)
...
obj_surveyPrograms._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'documentInfo'), cs_documentInfo, scope=obj_surveyPrograms, documentation=u'Information about the XML message instance.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 35, 3)))

obj_surveyPrograms._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'surveyProgram'), obj_surveyProgram, scope=obj_surveyPrograms, documentation=u'A single survey program .  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_surveyPrograms._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'documentInfo')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_surveyPrograms._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyProgram')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_surveyPrograms._Automaton = _BuildAutomaton_7()




cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'sequence'), positiveCount, scope=cs_surveySection, documentation=u'Order in which program sections will be executed / were executed.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 24, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'name'), nameString, scope=cs_surveySection, documentation=u'Name of survey program section.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 29, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdStart'), measuredDepthCoord, scope=cs_surveySection, documentation=u'Hole measured depth at which the survey run will begin/began.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 34, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'mdEnd'), measuredDepthCoord, scope=cs_surveySection, documentation=u'Hole measured depth at which the survey run will end/ended.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 39, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameSurveyCompany'), nameString, scope=cs_surveySection, documentation=u'Company who will run / has run sruvey tool.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 44, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameTool'), nameString, scope=cs_surveySection, documentation=u'Name of survey tool to be used / used for this section.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 49, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'typeTool'), nameString, scope=cs_surveySection, documentation=u'Type of tool used.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 54, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'modelError'), nameString, scope=cs_surveySection, documentation=u'Error model used to calculate ellipses of uncertainty.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 59, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'overwrite'), logicalBoolean, scope=cs_surveySection, documentation=u'Normally true, higher index trajectory takes precedence over overlapping \n\t\t\t\t\tsection of previous trajectory.  Values are "true" (or "1") and "false" (or "0").', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 64, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'frequencyMx'), lengthMeasure, scope=cs_surveySection, documentation=u'Maximum allowable depth frequency for survey stations for this survey run.\n\t\t\t\t\t', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 70, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'itemState'), ItemState, scope=cs_surveySection, documentation=u'The item state for the data object.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 76, 3)))

cs_surveySection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'comments'), commentString, scope=cs_surveySection, documentation=u'Comments and remarks.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 81, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 29, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 59, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 64, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 70, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 76, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 81, 3))
    counters.add(cc_5)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'sequence')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 29, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdStart')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 34, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'mdEnd')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 39, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameSurveyCompany')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 44, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameTool')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 49, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'typeTool')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 54, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'modelError')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 59, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'overwrite')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 64, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'frequencyMx')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 70, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'itemState')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 76, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_surveySection._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'comments')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\cs_surveySection.xsd', 81, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
cs_surveySection._Automaton = _BuildAutomaton_8()




obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'surveyVer'), positiveCount, scope=obj_surveyProgram, documentation=u'Survey version number, incremented every time the program is modified.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 23, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'dTimTrajProg'), timestamp, scope=obj_surveyProgram, documentation=u'Date and time trajectory program was created or edited.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 28, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'engineer'), str32, scope=obj_surveyProgram, documentation=u'Name of engineer.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 33, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'final'), str16, scope=obj_surveyProgram, documentation=u'Is program a final or intermediate/preliminary?  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 38, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'surveySection'), cs_surveySection, scope=obj_surveyProgram, documentation=u'Survey section object.  ', location=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 43, 3)))

obj_surveyProgram._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'nameWell'), nameString, scope=obj_surveyProgram, documentation=u'Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 57, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 28, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 38, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0L, max=None, metadata=pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 43, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 72, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 77, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0L, max=1L, metadata=pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 83, 3))
    counters.add(cc_6)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveyVer')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 23, 3))
    st_0 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'dTimTrajProg')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 28, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'engineer')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 33, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'final')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 38, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'surveySection')), pyxb.utils.utility.Location(u'o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\grp_surveyProgram.xsd', 43, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWell')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 57, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'nameWellbore')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 62, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'name')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 67, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'commonData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 77, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_surveyProgram._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'customData')), pyxb.utils.utility.Location('o:\\1\\witsml_certification\\trunk\\src\\wsvt\\schemas\\WITSML_v1.3.1.1_Data_Schema\\obj_surveyProgram.xsd', 83, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_surveyProgram._Automaton = _BuildAutomaton_9()
