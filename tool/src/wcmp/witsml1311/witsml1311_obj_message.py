# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_message.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:52:28.810689 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:8121dfdd-b94f-4c9e-943b-339f9dfb9f19')
...
class obj_messages (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_message.xsd', 33, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_messages_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_message.xsd', 35, 3), )
    ...
    __message = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'message'), 'message', '__httpwww_witsml_orgschemas131_obj_messages_httpwww_witsml_orgschemas131message', True, pyxb.utils.utility.Location('obj_message.xsd', 40, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_messages_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_message.xsd', 46, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_message.xsd', 46, 2)
...
class obj_message (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_message.xsd', 55, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}objectReference uses Python identifier objectReference
    __objectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), 'objectReference', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131objectReference', False, pyxb.utils.utility.Location('grp_message.xsd', 23, 3), )
    ...
    __subObjectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'subObjectReference'), 'subObjectReference', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131subObjectReference', False, pyxb.utils.utility.Location('grp_message.xsd', 29, 3), )
    ...
    __dTim = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTim'), 'dTim', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131dTim', False, pyxb.utils.utility.Location('grp_message.xsd', 36, 3), )
    ...
    __activityCode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'activityCode'), 'activityCode', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131activityCode', False, pyxb.utils.utility.Location('grp_message.xsd', 41, 3), )
    ...
    __detailActivity = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'detailActivity'), 'detailActivity', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131detailActivity', False, pyxb.utils.utility.Location('grp_message.xsd', 46, 3), )
    ...
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'md'), 'md', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131md', False, pyxb.utils.utility.Location('grp_message.xsd', 51, 3), )
    ...
    __mdBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBit'), 'mdBit', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131mdBit', False, pyxb.utils.utility.Location('grp_message.xsd', 56, 3), )
    ...
    __typeMessage = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeMessage'), 'typeMessage', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131typeMessage', False, pyxb.utils.utility.Location('grp_message.xsd', 61, 3), )
    ...
    __messageText = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'messageText'), 'messageText', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131messageText', False, pyxb.utils.utility.Location('grp_message.xsd', 66, 3), )
    ...
    __param = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'param'), 'param', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131param', True, pyxb.utils.utility.Location('grp_message.xsd', 71, 3), )
    ...
    __severity = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'severity'), 'severity', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131severity', False, pyxb.utils.utility.Location('grp_message.xsd', 76, 3), )
    ...
    __warnProbability = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'warnProbability'), 'warnProbability', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131warnProbability', False, pyxb.utils.utility.Location('grp_message.xsd', 81, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('obj_message.xsd', 57, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('obj_message.xsd', 62, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_message.xsd', 67, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_message.xsd', 77, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_message_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_message.xsd', 83, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_message_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_message_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_message.xsd', 90, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_message.xsd', 90, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_message_uidWellbore', _module_typeBindings.uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_message.xsd', 96, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_message.xsd', 96, 2)
...
obj_messages._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_messages, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_message.xsd', 35, 3)))

obj_messages._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'message'), obj_message, scope=obj_messages, documentation='A single message.  ', location=pyxb.utils.utility.Location('obj_message.xsd', 40, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_message.xsd', 35, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_messages._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_message.xsd', 35, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_messages._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'message')), pyxb.utils.utility.Location('obj_message.xsd', 40, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), refObjectString, scope=obj_message, documentation='A reference to an object that is defined within the \n\t\t\t\t\tcontext of a wellbore.', location=pyxb.utils.utility.Location('grp_message.xsd', 23, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'subObjectReference'), refObjectString, scope=obj_message, documentation='A reference to an sub-object that is defined within the \n\t\t\t\t\tcontext of the object referenced by objectReference.\n\t\t\t\t\tThis should only refer to recurring components of a growing object.', location=pyxb.utils.utility.Location('grp_message.xsd', 29, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTim'), timestamp, scope=obj_message, documentation='Date and time the information is related to.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 36, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'activityCode'), ActivityCode, scope=obj_message, documentation='A code used to define rig activity.', location=pyxb.utils.utility.Location('grp_message.xsd', 41, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'detailActivity'), str32, scope=obj_message, documentation='Custom string to further define an activity.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 46, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'md'), measuredDepthCoord, scope=obj_message, documentation='Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 51, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBit'), measuredDepthCoord, scope=obj_message, documentation='Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 56, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeMessage'), MessageType, scope=obj_message, documentation='Message type.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 61, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'messageText'), commentString, scope=obj_message, documentation='Message text. ', location=pyxb.utils.utility.Location('grp_message.xsd', 66, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'param'), indexedObject, scope=obj_message, documentation='Any extra numeric data.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 71, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'severity'), MessageSeverity, scope=obj_message, documentation='Severity of incident.  ', location=pyxb.utils.utility.Location('grp_message.xsd', 76, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'warnProbability'), MessageProbability, scope=obj_message, documentation='A warning probability (applies to warning).', location=pyxb.utils.utility.Location('grp_message.xsd', 81, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_message, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_message.xsd', 57, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_message, documentation='Human recognizable context for the wellbore that contains the message.  ', location=pyxb.utils.utility.Location('obj_message.xsd', 62, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_message, documentation='Human recognizable context for the risk.  ', location=pyxb.utils.utility.Location('obj_message.xsd', 67, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_message, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_message.xsd', 77, 3)))

obj_message._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_message, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_message.xsd', 83, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_message.xsd', 72, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 23, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 29, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 41, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 46, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 51, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 56, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 66, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_message.xsd', 71, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 76, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_message.xsd', 81, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_message.xsd', 77, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_message.xsd', 83, 3))
    counters.add(cc_12)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_message.xsd', 57, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_message.xsd', 62, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_message.xsd', 67, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectReference')), pyxb.utils.utility.Location('grp_message.xsd', 23, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'subObjectReference')), pyxb.utils.utility.Location('grp_message.xsd', 29, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTim')), pyxb.utils.utility.Location('grp_message.xsd', 36, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'activityCode')), pyxb.utils.utility.Location('grp_message.xsd', 41, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'detailActivity')), pyxb.utils.utility.Location('grp_message.xsd', 46, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'md')), pyxb.utils.utility.Location('grp_message.xsd', 51, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBit')), pyxb.utils.utility.Location('grp_message.xsd', 56, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeMessage')), pyxb.utils.utility.Location('grp_message.xsd', 61, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'messageText')), pyxb.utils.utility.Location('grp_message.xsd', 66, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'param')), pyxb.utils.utility.Location('grp_message.xsd', 71, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'severity')), pyxb.utils.utility.Location('grp_message.xsd', 76, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'warnProbability')), pyxb.utils.utility.Location('grp_message.xsd', 81, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_message.xsd', 77, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_message._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_message.xsd', 83, 3))
