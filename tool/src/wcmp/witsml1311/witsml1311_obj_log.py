# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1311/witsml1311_obj_log.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:aca2769132b0274e00b9254c973534926b1b1a29
# Generated 2026-06-09 17:52:25.752085 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:8e2d4482-8eed-4c95-a0db-71d54efb2909')
...
class cs_logData (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_logData.xsd', 18, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}data uses Python identifier data
    __data = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'data'), 'data', '__httpwww_witsml_orgschemas131_cs_logData_httpwww_witsml_orgschemas131data', True, pyxb.utils.utility.Location('cs_logData.xsd', 24, 3), )
...
class obj_logs (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_log.xsd', 34, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}documentInfo uses Python identifier documentInfo
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas131_obj_logs_httpwww_witsml_orgschemas131documentInfo', False, pyxb.utils.utility.Location('obj_log.xsd', 36, 3), )
    ...
    __log = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'log'), 'log', '__httpwww_witsml_orgschemas131_obj_logs_httpwww_witsml_orgschemas131log', True, pyxb.utils.utility.Location('obj_log.xsd', 41, 3), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas131_obj_logs_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_log.xsd', 47, 2)
    __version._UseLocation = pyxb.utils.utility.Location('obj_log.xsd', 47, 2)
...
class cs_axisDefinition (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_axisDefinition.xsd', 19, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}order uses Python identifier order
    __order = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'order'), 'order', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131order', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 26, 3), )
    ...
    __count = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'count'), 'count', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131count', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 56, 3), )
    ...
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 61, 3), )
    ...
    __propertyType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'propertyType'), 'propertyType', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131propertyType', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 66, 3), )
    ...
    __uom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'uom'), 'uom', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131uom', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 71, 3), )
    ...
    __doubleValues = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'doubleValues'), 'doubleValues', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131doubleValues', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 77, 4), )
    ...
    __stringValues = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stringValues'), 'stringValues', '__httpwww_witsml_orgschemas131_cs_axisDefinition_httpwww_witsml_orgschemas131stringValues', False, pyxb.utils.utility.Location('cs_axisDefinition.xsd', 86, 4), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_axisDefinition_uid', _module_typeBindings.uidString)
...
class cs_logCurveInfo (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}mnemonic uses Python identifier mnemonic
    __mnemonic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mnemonic'), 'mnemonic', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131mnemonic', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 25, 3), )
    ...
    __classWitsml = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'classWitsml'), 'classWitsml', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131classWitsml', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 31, 3), )
    ...
    __unit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'unit'), 'unit', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131unit', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 37, 3), )
    ...
    __mnemAlias = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mnemAlias'), 'mnemAlias', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131mnemAlias', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 42, 3), )
    ...
    __nullValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), 'nullValue', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131nullValue', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3), )
    ...
    __alternateIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'alternateIndex'), 'alternateIndex', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131alternateIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3), )
    ...
    __wellDatum = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellDatum'), 'wellDatum', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131wellDatum', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 66, 3), )
    ...
    __minIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'minIndex'), 'minIndex', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131minIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 72, 3), )
    ...
    __maxIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'maxIndex'), 'maxIndex', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131maxIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 78, 3), )
    ...
    __minDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'minDateTimeIndex'), 'minDateTimeIndex', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131minDateTimeIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 84, 3), )
    ...
    __maxDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'maxDateTimeIndex'), 'maxDateTimeIndex', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131maxDateTimeIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 91, 3), )
    ...
    __columnIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'columnIndex'), 'columnIndex', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131columnIndex', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 98, 3), )
    ...
    __curveDescription = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'curveDescription'), 'curveDescription', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131curveDescription', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3), )
    ...
    __sensorOffset = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sensorOffset'), 'sensorOffset', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131sensorOffset', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 109, 3), )
    ...
    __dataSource = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dataSource'), 'dataSource', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131dataSource', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 117, 3), )
    ...
    __densData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'densData'), 'densData', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131densData', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 122, 3), )
    ...
    __traceState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'traceState'), 'traceState', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131traceState', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 127, 3), )
    ...
    __traceOrigin = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'traceOrigin'), 'traceOrigin', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131traceOrigin', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 132, 3), )
    ...
    __typeLogData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeLogData'), 'typeLogData', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131typeLogData', False, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3), )
    ...
    __axisDefinition = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'axisDefinition'), 'axisDefinition', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_httpwww_witsml_orgschemas131axisDefinition', True, pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_cs_logCurveInfo_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
...
class obj_log (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_log.xsd', 56, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/131}objectGrowing uses Python identifier objectGrowing
    __objectGrowing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectGrowing'), 'objectGrowing', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131objectGrowing', False, pyxb.utils.utility.Location('grp_log.xsd', 24, 3), )
    ...
    __dataRowCount = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dataRowCount'), 'dataRowCount', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131dataRowCount', False, pyxb.utils.utility.Location('grp_log.xsd', 36, 3), )
    ...
    __serviceCompany = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany'), 'serviceCompany', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131serviceCompany', False, pyxb.utils.utility.Location('grp_log.xsd', 45, 3), )
    ...
    __runNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'runNumber'), 'runNumber', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131runNumber', False, pyxb.utils.utility.Location('grp_log.xsd', 50, 3), )
    ...
    __bhaRunNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'bhaRunNumber'), 'bhaRunNumber', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131bhaRunNumber', False, pyxb.utils.utility.Location('grp_log.xsd', 56, 3), )
    ...
    __pass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'pass'), 'pass_', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131pass', False, pyxb.utils.utility.Location('grp_log.xsd', 61, 3), )
    ...
    __creationDate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'creationDate'), 'creationDate', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131creationDate', False, pyxb.utils.utility.Location('grp_log.xsd', 66, 3), )
    ...
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131description', False, pyxb.utils.utility.Location('grp_log.xsd', 71, 3), )
    ...
    __indexType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'indexType'), 'indexType', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131indexType', False, pyxb.utils.utility.Location('grp_log.xsd', 76, 3), )
    ...
    __startIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'startIndex'), 'startIndex', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131startIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 89, 4), )
    ...
    __endIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'endIndex'), 'endIndex', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131endIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 97, 4), )
    ...
    __stepIncrement = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'stepIncrement'), 'stepIncrement', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131stepIncrement', False, pyxb.utils.utility.Location('grp_log.xsd', 105, 4), )
    ...
    __startDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex'), 'startDateTimeIndex', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131startDateTimeIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 113, 4), )
    ...
    __endDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex'), 'endDateTimeIndex', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131endDateTimeIndex', False, pyxb.utils.utility.Location('grp_log.xsd', 121, 4), )
    ...
    __direction = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'direction'), 'direction', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131direction', False, pyxb.utils.utility.Location('grp_log.xsd', 130, 3), )
    ...
    __indexCurve = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'indexCurve'), 'indexCurve', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131indexCurve', False, pyxb.utils.utility.Location('grp_log.xsd', 139, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}nullValue uses Python identifier nullValue
    __nullValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), 'nullValue', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131nullValue', False, pyxb.utils.utility.Location('grp_log.xsd', 146, 3), )
    ...
    __logParam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'logParam'), 'logParam', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131logParam', True, pyxb.utils.utility.Location('grp_log.xsd', 160, 3), )
    ...
    __logCurveInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'logCurveInfo'), 'logCurveInfo', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131logCurveInfo', True, pyxb.utils.utility.Location('grp_log.xsd', 165, 3), )
    ...
    __logData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'logData'), 'logData', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131logData', False, pyxb.utils.utility.Location('grp_log.xsd', 170, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131nameWell', False, pyxb.utils.utility.Location('obj_log.xsd', 58, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131nameWellbore', False, pyxb.utils.utility.Location('obj_log.xsd', 63, 3), )
    ...
    # Element {http://www.witsml.org/schemas/131}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131name', False, pyxb.utils.utility.Location('obj_log.xsd', 68, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131commonData', False, pyxb.utils.utility.Location('obj_log.xsd', 78, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas131_obj_log_httpwww_witsml_orgschemas131customData', False, pyxb.utils.utility.Location('obj_log.xsd', 84, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas131_obj_log_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 20, 2)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas131_obj_log_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_log.xsd', 91, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_log.xsd', 91, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas131_obj_log_uidWellbore', _module_typeBindings.uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_log.xsd', 97, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_log.xsd', 97, 2)
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_logData.xsd', 24, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_logData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'data')), pyxb.utils.utility.Location('cs_logData.xsd', 24, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_logs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_logs, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 36, 3)))

obj_logs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'log'), obj_log, scope=obj_logs, documentation='A single log.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 41, 3)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 36, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_logs._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_log.xsd', 36, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_logs._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'log')), pyxb.utils.utility.Location('obj_log.xsd', 41, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'order'), positiveCount, scope=cs_axisDefinition, documentation="The order of this axis. The order should  \n\t\t\t\t\tbegin with one and increment by one for each additional axis. \n\t\t\t\t\tThe order indicates how fast the index of the axis varies \n\t\t\t\t\tin the serialized list of values. \n\t\t\t\t\tThe index of an axis with an order of one varies the slowest.\n\t\t\t\t\tThe index of an axis with an order of two varies the next slowest. \n\t\t\t\t\tAnd so on. This is the same ordering that is used in the C programming language.\n\t\t\t\t\tFor example, the following array:\n\t\t\t\t\t\t         [   x axis  ]\n\t\t\t\t\t\t   |     z11  z12  z13\n\t\t\t\t\t\ty axis:  z21  z22  z23\n\t\t\t\t\t\t   |     z31  z32  z33\n\t\t\t\t\t\t   |     z41  z42  z43\n\t\t\t\t\tmay be encoded as follows:\n\t\t\t\t\t\taxisDefinition[order=1].name='x'\n\t\t\t\t\t\taxisDefinition[order=1].count='3'\n\t\t\t\t\t\taxisDefinition[order=2].name='y'\n\t\t\t\t\t\taxisDefinition[order=2].count='4'\n\t\t\t\t\t\t{ z11 z21 z31 z41 z12 z22 z32 z42 z13 z23 z33 z43 }\n\t\t\t\t\tor alternatively:\n\t\t\t\t\t\taxisDefinition[order=1].name='y'\n\t\t\t\t\t\taxisDefinition[order=1].count='4'\n\t\t\t\t\t\taxisDefinition[order=2].name='x'\n\t\t\t\t\t\taxisDefinition[order=2].count='3'\n\t\t\t\t\t\t{ z11 z12 z13 z21 z22 z23 z31 z32 z33 z41 z42 z43 }\n\t\t\t\t\t", location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 26, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'count'), positiveCount, scope=cs_axisDefinition, documentation='The count of elements along this axis of the array.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 56, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_axisDefinition, documentation='The name of the array axis.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 61, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'propertyType'), nameString, scope=cs_axisDefinition, documentation='The property type by which the array axis is classified.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 66, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'uom'), uomString, scope=cs_axisDefinition, documentation='A string representing the units of measure of the axis values.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 71, 3)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'doubleValues'), listOfDouble, scope=cs_axisDefinition, documentation="The serialziation of the axis positions of an array as a \n\t\t\t\t\t\twhitespace-delimited list values of type xsd:double.  If the length of this list\n\t\t\t\t\t\tis less than 'count' then the difference in the last two values represents the increment\n\t\t\t\t\t\tto be used to fill out the list. For example, the list '2 4' with count=4 \n\t\t\t\t\t\trepresents the  list '2 4 6 8'.", location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 77, 4)))

cs_axisDefinition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stringValues'), listOfString, scope=cs_axisDefinition, documentation='The serialziation of the axis positions of an array as \n\t\t\t\t\t\ta whitespace-delimited list values of type xsd:String.\n\t\t\t\t\t\tNote: the serialization of string elements with embedded whitespace cannot \n\t\t\t\t\t\tbe properly decoded.', location=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 86, 4)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 61, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 66, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 71, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 77, 4))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_axisDefinition.xsd', 86, 4))
    counters.add(cc_4)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'order')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'count')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 56, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 61, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'propertyType')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 66, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'uom')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 71, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'doubleValues')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 77, 4))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_axisDefinition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stringValues')), pyxb.utils.utility.Location('cs_axisDefinition.xsd', 86, 4))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mnemonic'), str32, scope=cs_logCurveInfo, documentation='The curve name.  \n\t\t\t\t\tThis must be unique for all curves in a log.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 25, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'classWitsml'), RealtimeData, scope=cs_logCurveInfo, documentation='The curve classification obtained from a lookup in the vendors \n\t\t\t\tmnemonic catalog.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 31, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'unit'), uomString, scope=cs_logCurveInfo, documentation='Unit of measurement of the data values. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 37, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mnemAlias'), str32, scope=cs_logCurveInfo, documentation='Name alias for this trace.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 42, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), encodedValueString, scope=cs_logCurveInfo, documentation='An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e. when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value is defined in the logCurveInfo, it overrides any null value specified at the \n\t\t\t\t\tlogHeader level. An empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'alternateIndex'), logicalBoolean, scope=cs_logCurveInfo, documentation='True (true or 1) if this curve is a candidate to be a primary index.\n\t\t\t\t\tFalse (false or 0) or not given, indicates otherwise.\n\t\t\t\t\tAn index curve should monotonically change when sorted on its own values (i.e., no duplicates). ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellDatum'), refNameString, scope=cs_logCurveInfo, documentation='A pointer to the wellDatum that represents the values of this trace.\n\t\t\t\t\tThis is only relevant for measured depths, vertical depths or elevations.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 66, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'minIndex'), genericMeasure, scope=cs_logCurveInfo, documentation='The minimum index value at which the first valid data point is located. \n\t\t\t\t\tThis value will be properly set by the server to reflect data in the returned document.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 72, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'maxIndex'), genericMeasure, scope=cs_logCurveInfo, documentation='The maximum index value at which the last valid data point is located.\n\t\t\t\t\tThis value will be properly set by the server to reflect data in the returned document. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 78, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'minDateTimeIndex'), timestamp, scope=cs_logCurveInfo, documentation='The minimum index value at which the first valid data point\n\t\t\t\t\tis located. This value will be properly set by the server to reflect data \n\t\t\t\t\tin the returned document. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 84, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'maxDateTimeIndex'), timestamp, scope=cs_logCurveInfo, documentation='The maximum index value at which the last valid data point \n\t\t\t\t\tis located. This value will be properly set by the server to reflect data \n\t\t\t\t\tin the returned document. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 91, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'columnIndex'), nonNegativeCount, scope=cs_logCurveInfo, documentation='A 1-based index of data in the LOGDATA.DATA section.\n\t\t\t\t\tA value of zero indicates an implied curve with no values in the data record.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 98, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'curveDescription'), descriptionString, scope=cs_logCurveInfo, documentation='Description of the curve.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sensorOffset'), lengthMeasure, scope=cs_logCurveInfo, documentation='Offset of sensor from drill bit.  \n\t\t\t\t\tThis element is only informative. The measured depth values\n\t\t\t\t\tare at the actual depth (not bit depth from which you must \n\t\t\t\t\tsubtract the offset).', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 109, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dataSource'), str32, scope=cs_logCurveInfo, documentation='Data source, could be tool name/id.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 117, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'densData'), perLengthMeasure, scope=cs_logCurveInfo, documentation='Data density of sample in samples per length unit.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 122, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'traceState'), LogTraceState, scope=cs_logCurveInfo, documentation='State of trace data.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 127, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'traceOrigin'), LogTraceOrigin, scope=cs_logCurveInfo, documentation='Origin of trace data.  ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 132, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeLogData'), LogDataType, scope=cs_logCurveInfo, documentation='Log data type. ', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3)))

cs_logCurveInfo._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'axisDefinition'), cs_axisDefinition, scope=cs_logCurveInfo, documentation='Indicates that the curve is an array curve (i.e., multi-valued samples), \n\t\t\t\t\tand provides meta data by which an axis of the array can be understood.', location=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 31, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 37, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 42, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 66, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 72, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 78, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 84, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 91, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 109, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 117, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 122, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 127, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 132, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3))
    counters.add(cc_17)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mnemonic')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 25, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'classWitsml')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'unit')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mnemAlias')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nullValue')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 47, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'alternateIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 59, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellDatum')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 66, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'minIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 72, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'maxIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 78, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'minDateTimeIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 84, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'maxDateTimeIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 91, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'columnIndex')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 98, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'curveDescription')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 104, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sensorOffset')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 109, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dataSource')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 117, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'densData')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 122, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'traceState')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 127, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'traceOrigin')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 132, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeLogData')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 137, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_logCurveInfo._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'axisDefinition')), pyxb.utils.utility.Location('cs_logCurveInfo.xsd', 142, 3))
...
obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectGrowing'), logicalBoolean, scope=obj_log, documentation='Whether or not the log is growing. \n\t\t\t\t\tTrue ("true" or "1") indicates the that the log is still growing \n\t\t\t\t\tin size (that is, logData values are still being added).\n\t\t\t\t\tFor example, it may be connected to a realtime stream.\n\t\t\t\t\tFalse ("false" or "0") indicates that the log is \n\t\t\t\t\tclosed (that is, no further logData values will be added).\n\t\t\t\t\tNot given indicates that the status of the log is not known.\n\t\t\t\t\tThis value is only relevant within the context of a server.', location=pyxb.utils.utility.Location('grp_log.xsd', 24, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dataRowCount'), positiveBigCount, scope=obj_log, documentation='The number of data rows in the persistent log. \n\t\t\t\t\tIf a value is specified for this element in a query then the \n\t\t\t\t\tserver will limit the number of data rows in the result\n\t\t\t\t\tbut the return value will still be the number of data rows in \n\t\t\t\t\tthe persistent log.', location=pyxb.utils.utility.Location('grp_log.xsd', 36, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany'), nameString, scope=obj_log, documentation='Name of contractor who provided the service.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 45, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'runNumber'), str16, scope=obj_log, documentation='Log run number. This should normally be a number; however \n\t\t\t\t\tsome legacy systems encode other information in this value.', location=pyxb.utils.utility.Location('grp_log.xsd', 50, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bhaRunNumber'), positiveCount, scope=obj_log, documentation='The bottom hole assembly run number associated with this log.', location=pyxb.utils.utility.Location('grp_log.xsd', 56, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pass'), str16, scope=obj_log, documentation='Identifies the pass within the run.', location=pyxb.utils.utility.Location('grp_log.xsd', 61, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'creationDate'), timestamp, scope=obj_log, documentation='Date and time that the log was created.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 66, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=obj_log, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 71, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'indexType'), LogIndexType, scope=obj_log, documentation='Primary index type.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 76, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'startIndex'), genericMeasure, scope=obj_log, documentation='When the log header defines the direction as "Increasing", \n\t\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first valid data point\n\t\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\t\tis the starting (maximum) index value at which the first valid data point is located.', location=pyxb.utils.utility.Location('grp_log.xsd', 89, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'endIndex'), genericMeasure, scope=obj_log, documentation='When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\tis the ending (maximum) index value at which the last valid data point is located.  \n\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t(minimum) index value at which the last valid data point is located.', location=pyxb.utils.utility.Location('grp_log.xsd', 97, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'stepIncrement'), ratioGenericMeasure, scope=obj_log, documentation='The sampling increment. Set to zero for unequal sampling.\n\t\t\t\t\t\tThis would only apply if the curve was sorted on its own values.\n\t\t\t\t\t\tFor curves that are originally sampled at a constant increment, this value should\n\t\t\t\t\t\tbe retained because the calculated values may have cumulative errors.', location=pyxb.utils.utility.Location('grp_log.xsd', 105, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex'), timestamp, scope=obj_log, documentation='When the log header defines the direction as "Increasing", \n\t\t\t\t\tthe startIndex is the starting (minimum) index value at which the first valid data point\n\t\t\t\t\tis located.  When the log header defines the direction as "Decreasing", the startIndex \n\t\t\t\t\tis the starting (maximum) index value at which the first valid data point is located.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 113, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex'), timestamp, scope=obj_log, documentation='When the log header defines the direction as "Increasing", the endIndex \n\t\t\t\t\tis the ending (maximum) index value at which the last valid data point is located.  \n\t\t\t\t\tWhen the log header defines the direction as Decreasing, the endIndex is the ending \n\t\t\t\t\t(minimum) index value at which the last valid data point is located.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 121, 4)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'direction'), LogIndexDirection, scope=obj_log, documentation='The sort order of the data row index values in the XML instance.\n\t\t\t\t\tFor an "Increasing" direction the index value of consecutive data nodes are ascending.\n\t\t\t\t\tFor a "Decreasing" direction the index value of consecutive data nodes are descending.\n\t\t\t\t\tThe default direction is "Increasing".  The direction of a log cannot be changed \n\t\t\t\t\tonce it has been created. That is, this value cannot be updated in a server.', location=pyxb.utils.utility.Location('grp_log.xsd', 130, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'indexCurve'), indexCurve, scope=obj_log, documentation='The mnemonic of the index curve plus the column index.\n\t\t\t\t\tA column index of zero indicates an implied trace whose values start at startIndex \n\t\t\t\t\tand increment by stepIncrement for each row.', location=pyxb.utils.utility.Location('grp_log.xsd', 139, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nullValue'), encodedValueString, scope=obj_log, documentation='An empty string is the default representation of a null value for a \n\t\t\t\t\tcurve (i.e. when the null value representation is not explicitly defined). \n\t\t\t\t\tIf a null value representation is defined for a log, this becomes the default for all curves\n\t\t\t\t\tin that log (but can be overridden at the curve level).  \n\t\t\t\t\tAn empty string is always a valid null value representation in the comma delimited list.\n\t\t\t\t\tAn empty string is not a valid null value representation within a space delimited array.\n\t\t\t\t\tSpecifying a null value also makes it easier to transform data back to a \n\t\t\t\t\tlegacy format without having to scan the data to insure that the null pattern \n\t\t\t\t\tdoes not exist in the data. \n\t\t\t\t\t', location=pyxb.utils.utility.Location('grp_log.xsd', 146, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'logParam'), indexedObject, scope=obj_log, documentation='Log parameters.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 160, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'logCurveInfo'), cs_logCurveInfo, scope=obj_log, documentation='Container element for the log curve information.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 165, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'logData'), cs_logData, scope=obj_log, documentation='Container for one or more "rows" of log data.  ', location=pyxb.utils.utility.Location('grp_log.xsd', 170, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_log, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 58, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_log, documentation='Human recognizable context for the wellbore that contains the log.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 63, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_log, documentation='Human recognizable context for the log.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 68, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_log, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_log.xsd', 78, 3)))

obj_log._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_log, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_log.xsd', 84, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 73, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 24, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 36, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 45, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 50, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 56, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 61, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 66, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 71, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 89, 4))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 97, 4))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 105, 4))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 113, 4))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 121, 4))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 130, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 146, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_log.xsd', 160, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_log.xsd', 165, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_log.xsd', 170, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 78, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_log.xsd', 84, 3))
    counters.add(cc_20)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_log.xsd', 58, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_log.xsd', 63, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_log.xsd', 68, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectGrowing')), pyxb.utils.utility.Location('grp_log.xsd', 24, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dataRowCount')), pyxb.utils.utility.Location('grp_log.xsd', 36, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'serviceCompany')), pyxb.utils.utility.Location('grp_log.xsd', 45, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'runNumber')), pyxb.utils.utility.Location('grp_log.xsd', 50, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bhaRunNumber')), pyxb.utils.utility.Location('grp_log.xsd', 56, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pass')), pyxb.utils.utility.Location('grp_log.xsd', 61, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'creationDate')), pyxb.utils.utility.Location('grp_log.xsd', 66, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('grp_log.xsd', 71, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'indexType')), pyxb.utils.utility.Location('grp_log.xsd', 76, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'startIndex')), pyxb.utils.utility.Location('grp_log.xsd', 89, 4))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'endIndex')), pyxb.utils.utility.Location('grp_log.xsd', 97, 4))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'stepIncrement')), pyxb.utils.utility.Location('grp_log.xsd', 105, 4))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex')), pyxb.utils.utility.Location('grp_log.xsd', 113, 4))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex')), pyxb.utils.utility.Location('grp_log.xsd', 121, 4))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'direction')), pyxb.utils.utility.Location('grp_log.xsd', 130, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'indexCurve')), pyxb.utils.utility.Location('grp_log.xsd', 139, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nullValue')), pyxb.utils.utility.Location('grp_log.xsd', 146, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'logParam')), pyxb.utils.utility.Location('grp_log.xsd', 160, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'logCurveInfo')), pyxb.utils.utility.Location('grp_log.xsd', 165, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'logData')), pyxb.utils.utility.Location('grp_log.xsd', 170, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_log.xsd', 78, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_log._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_log.xsd', 84, 3))
