# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_toolErrorModel.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:17:26.464251 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:02f32dab-6c4d-472b-85d1-77b1f9d77788')
...
class cs_iscwsaAuthorizationData (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 20, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}author uses Python identifier author
    __author = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'author'), 'author', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriesauthor', False, pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 26, 3), )
    ...
    __source = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'source'), 'source', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriessource', False, pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 31, 3), )
    ...
    __authority = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'authority'), 'authority', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriesauthority', False, pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 36, 3), )
    ...
    __status = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'status'), 'status', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriesstatus', False, pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 41, 3), )
    ...
    __version = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'version'), 'version', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriesversion', False, pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 46, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}comment uses Python identifier comment
    __comment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comment'), 'comment', '__httpwww_witsml_orgschemas1series_cs_iscwsaAuthorizationData_httpwww_witsml_orgschemas1seriescomment', False, pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 51, 3), )
...
_module_typeBindings.cs_iscwsaAuthorizationData = cs_iscwsaAuthorizationData
...
class cs_iscwsaModelParameters (pyxb.binding.basis.complexTypeDefinition):
    ...
    __switching = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'switching'), 'switching', '__httpwww_witsml_orgschemas1series_cs_iscwsaModelParameters_httpwww_witsml_orgschemas1seriesswitching', False, pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 41, 3), )
...
_module_typeBindings.cs_iscwsaModelParameters = cs_iscwsaModelParameters
...
class obj_toolErrorModels (_ImportedBinding__abs.abstractObject):
    """Complex type {http://www.witsml.org/schemas/1series}obj_toolErrorModels with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_toolErrorModels')
    _XSDLocation = pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_toolErrorModels_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 45, 5), )
    ...
    __toolErrorModel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'toolErrorModel'), 'toolErrorModel', '__httpwww_witsml_orgschemas1series_obj_toolErrorModels_httpwww_witsml_orgschemas1seriestoolErrorModel', True, pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 50, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_toolErrorModels_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 56, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 56, 4)
...
_module_typeBindings.obj_toolErrorModels = obj_toolErrorModels
...
class cs_iscwsaErrorTermValue (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 22, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}term uses Python identifier term
    __term = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'term'), 'term', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesterm', False, pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 30, 3), )
    ...
    __prop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'prop'), 'prop', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesprop', False, pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 37, 3), )
    ...
    __bias = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'bias'), 'bias', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesbias', False, pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 42, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'value'), 'value_', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriesvalue', False, pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 47, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}comment uses Python identifier comment
    __comment = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comment'), 'comment', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_httpwww_witsml_orgschemas1seriescomment', False, pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 54, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTermValue_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaErrorTermValue = cs_iscwsaErrorTermValue
...
class cs_iscwsaSurveyToolOperatingCondition (pyxb.binding.basis.complexTypeDefinition):
    ...
    __min = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'min'), 'min', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesmin', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3), )
    ...
    __max = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'max'), 'max', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesmax', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'value'), 'value_', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_httpwww_witsml_orgschemas1seriesvalue', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingCondition_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaSurveyToolOperatingCondition = cs_iscwsaSurveyToolOperatingCondition
...
class cs_iscwsaSurveyToolOperatingInterval (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mode uses Python identifier mode
    __mode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mode'), 'mode', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesmode', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 30, 3), )
    ...
    __start = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'start'), 'start', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesstart', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 35, 3), )
    ...
    __end = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'end'), 'end', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesend', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 40, 3), )
    ...
    __speed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'speed'), 'speed', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_httpwww_witsml_orgschemas1seriesspeed', False, pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaSurveyToolOperatingInterval_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaSurveyToolOperatingInterval = cs_iscwsaSurveyToolOperatingInterval
...
class obj_toolErrorModel (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 67, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}authorization uses Python identifier authorization
    __authorization = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'authorization'), 'authorization', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesauthorization', False, pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 30, 3), )
    ...
    __typeSurveyTool = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeSurveyTool'), 'typeSurveyTool', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriestypeSurveyTool', False, pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 35, 3), )
    ...
    __operatingInterval = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'operatingInterval'), 'operatingInterval', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesoperatingInterval', True, pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 47, 3), )
    ...
    __modelParameters = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'modelParameters'), 'modelParameters', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesmodelParameters', False, pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 53, 3), )
    ...
    __useErrorTermSet = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'useErrorTermSet'), 'useErrorTermSet', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesuseErrorTermSet', False, pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 59, 3), )
    ...
    __errorTermValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'errorTermValue'), 'errorTermValue', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1serieserrorTermValue', True, pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 65, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 73, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 83, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 89, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_toolErrorModel_uid', _module_typeBindings.uidString)
...
_module_typeBindings.obj_toolErrorModel = obj_toolErrorModel
...
cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'author'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Person responsible for the information.', location=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 26, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'source'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Source from which the information is derived.', location=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 31, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'authority'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Person or collective body responsible for authorizing the information.', location=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 36, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'status'), AuthorizationStatus, scope=cs_iscwsaAuthorizationData, documentation='Authorization state of the information.', location=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 41, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'version'), nameString, scope=cs_iscwsaAuthorizationData, documentation='Version name or number.', location=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 46, 3)))

cs_iscwsaAuthorizationData._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comment'), commentString, scope=cs_iscwsaAuthorizationData, documentation='A comment about the object. \n\t\t\t\t\tThis should include information regarding the derivation of the information.', location=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 51, 3)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 26, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 31, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 46, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 51, 3))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'author')), pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'source')), pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'authority')), pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'status')), pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'version')), pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaAuthorizationData._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comment')), pyxb.utils.utility.Location('cs_iscwsaAuthorizationData.xsd', 51, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'misalignmentMode'), ErrorModelMisalignmentMode, scope=cs_iscwsaModelParameters, documentation='Choice of mathmatical modelling of misalignment.', location=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 26, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gyroInitialization'), planeAngleMeasure, scope=cs_iscwsaModelParameters, documentation='Inclination at which gyro initialization occurs.', location=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 31, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gyroReinitializationDistance'), lengthMeasure, scope=cs_iscwsaModelParameters, documentation='Maximum length of continuous survey before re-initialisation.', location=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 36, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'switching'), logicalBoolean, scope=cs_iscwsaModelParameters, documentation='True if the survey tool is rotated at inclinations greater than 90 degrees.', location=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 41, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'noiseReductionFactor'), gtZeroAndLeOne, scope=cs_iscwsaModelParameters, documentation='Factor applied to Random Noise error terms depending on mode of gyro initialisation.\n\t\t\t\t\tValues must be greater than zero and less than or equal to 1.', location=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 46, 3)))

cs_iscwsaModelParameters._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gyroRunningSpeed'), velocityMeasure, scope=cs_iscwsaModelParameters, documentation='Speed at which the tool traverses the wellbore during continuous survey.', location=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 52, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 31, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 36, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 41, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 46, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 52, 3))
    counters.add(cc_4)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'misalignmentMode')), pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gyroInitialization')), pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gyroReinitializationDistance')), pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'switching')), pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'noiseReductionFactor')), pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaModelParameters._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gyroRunningSpeed')), pyxb.utils.utility.Location('cs_iscwsaModelParameters.xsd', 52, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_toolErrorModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_toolErrorModels, documentation='Information about the XML message instance.', location=pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 45, 5)))

obj_toolErrorModels._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'toolErrorModel'), obj_toolErrorModel, scope=obj_toolErrorModels, documentation='A single error Term Source.', location=pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 50, 5)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 45, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModels._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 45, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModels._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'toolErrorModel')), pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 50, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'term'), refNameString, scope=cs_iscwsaErrorTermValue, documentation='A pointer to the errorTerm represented by this value.\n\t\t\t\t\tThis term must exist in the toolErrorTermSet referenced by the parent of this node.\n\t\t\t\t\tThe same term may only be referenced once in the model.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 30, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'prop'), ErrorPropagationMode, scope=cs_iscwsaErrorTermValue, documentation='This is the propagation mode for this term in this model.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 37, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bias'), pyxb.binding.datatypes.double, scope=cs_iscwsaErrorTermValue, documentation='The mean or expected value of the variance.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 42, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'value'), measureOrQuantity, scope=cs_iscwsaErrorTermValue, documentation='The value of the error term in this model.\n\t\t\t\t\tThe unit of measure must be in the set allowed by the \n\t\t\t\t\tmeasure class of the referenced error term.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 47, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comment'), commentString, scope=cs_iscwsaErrorTermValue, documentation='A textual comment about this error term value.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 54, 3)))

cs_iscwsaErrorTermValue._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaErrorTermValue, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 59, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 42, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 54, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 59, 3))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'term')), pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 30, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'prop')), pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 37, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bias')), pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 42, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'value')), pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 47, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comment')), pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 54, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTermValue._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaErrorTermValue.xsd', 59, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'parameter'), nameString, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='A particular constraint.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'min'), genericMeasure, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='The least value the constraint may take.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'max'), genericMeasure, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='The greatest value the constraint may take.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'value'), str32, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='A fixed value that the constraint must take.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3)))

cs_iscwsaSurveyToolOperatingCondition._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaSurveyToolOperatingCondition, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3))
    counters.add(cc_4)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parameter')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 29, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'min')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 34, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'max')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 39, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'value')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 44, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingCondition._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingCondition.xsd', 49, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mode'), SurveyToolOperatingMode, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Tool operating mode over this interval.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 30, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'start'), planeAngleMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Inclination at which mode commences.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 35, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'end'), planeAngleMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Inclination at which mode terminates.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 40, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'speed'), velocityMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Running speed for continuous surveys.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sampleRate'), timeMeasure, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Time between survey samples for continuous surveys.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3)))

cs_iscwsaSurveyToolOperatingInterval._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaSurveyToolOperatingInterval, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3)))
...
def _BuildAutomaton_14 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3))
    counters.add(cc_2)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mode')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 30, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'start')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 35, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'end')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 40, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'speed')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 45, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sampleRate')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 50, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaSurveyToolOperatingInterval._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaSurveyToolOperatingInterval.xsd', 55, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
def _BuildAutomaton_15 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 78, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 30, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 35, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 41, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 47, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 53, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 59, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 83, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 89, 3))
    counters.add(cc_8)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 73, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'authorization')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 30, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeSurveyTool')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 35, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operatingCondition')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operatingInterval')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 47, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'modelParameters')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 53, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'useErrorTermSet')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 59, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'errorTermValue')), pyxb.utils.utility.Location('grp_toolErrorModel.xsd', 65, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 83, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorModel._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_toolErrorModel.xsd', 89, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
toolErrorModels._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
