# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_toolErrorTermSet.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:17:30.910121 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:3fa28a4a-64e3-4adb-965f-41c744f582d8')
...
class cs_iscwsaNomenclature (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}parameter uses Python identifier parameter
    __parameter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'parameter'), 'parameter', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclature_httpwww_witsml_orgschemas1seriesparameter', True, pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 27, 3), )
    ...
    __function = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'function'), 'function', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclature_httpwww_witsml_orgschemas1seriesfunction', True, pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 33, 3), )
    ...
    __constant = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'constant'), 'constant', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclature_httpwww_witsml_orgschemas1seriesconstant', True, pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 39, 3), )
...
_module_typeBindings.cs_iscwsaNomenclature = cs_iscwsaNomenclature
...
class obj_toolErrorTermSets (_ImportedBinding__abs.abstractObject):
    """Complex type {http://www.witsml.org/schemas/1series}obj_toolErrorTermSets with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_toolErrorTermSets')
    _XSDLocation = pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSets_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 45, 5), )
    ...
    __toolErrorTermSet = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'toolErrorTermSet'), 'toolErrorTermSet', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSets_httpwww_witsml_orgschemas1seriestoolErrorTermSet', True, pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 50, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSets_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 56, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 56, 4)
...
_module_typeBindings.obj_toolErrorTermSets = obj_toolErrorTermSets
...
class cs_iscwsaErrorCoefficient (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}azi uses Python identifier azi
    __azi = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'azi'), 'azi', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorCoefficient_httpwww_witsml_orgschemas1seriesazi', False, pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 28, 7), )
    ...
    __inc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'inc'), 'inc', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorCoefficient_httpwww_witsml_orgschemas1seriesinc', False, pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 33, 7), )
    ...
    __depth = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'depth'), 'depth', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorCoefficient_httpwww_witsml_orgschemas1seriesdepth', False, pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 38, 7), )
    ...
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvd'), 'tvd', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorCoefficient_httpwww_witsml_orgschemas1seriestvd', False, pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 43, 7), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorCoefficient_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaErrorCoefficient = cs_iscwsaErrorCoefficient
...
class cs_iscwsaErrorTerm (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 22, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 29, 3), )
    ...
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1seriestype', False, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 35, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}measureClass uses Python identifier measureClass
    __measureClass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'measureClass'), 'measureClass', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1seriesmeasureClass', False, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 40, 3), )
    ...
    __label = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'label'), 'label', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1serieslabel', False, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 46, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 52, 3), )
    ...
    __errorCoefficient = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'errorCoefficient'), 'errorCoefficient', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1serieserrorCoefficient', True, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 58, 3), )
    ...
    __operatingMode = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'operatingMode'), 'operatingMode', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1seriesoperatingMode', True, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 63, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 69, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaErrorTerm_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaErrorTerm = cs_iscwsaErrorTerm
...
class cs_iscwsaNameAndDescription (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_cs_iscwsaNameAndDescription_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 28, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_cs_iscwsaNameAndDescription_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 33, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_iscwsaNameAndDescription_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 38, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaNameAndDescription_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaNameAndDescription = cs_iscwsaNameAndDescription
...
class cs_iscwsaNomenclatureConstant (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclatureConstant_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 27, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}value uses Python identifier value_
    __value = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'value'), 'value_', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclatureConstant_httpwww_witsml_orgschemas1seriesvalue', False, pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 32, 3), )
    ...
    __unit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'unit'), 'unit', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclatureConstant_httpwww_witsml_orgschemas1seriesunit', False, pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 37, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclatureConstant_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 43, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_iscwsaNomenclatureConstant_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_iscwsaNomenclatureConstant = cs_iscwsaNomenclatureConstant
...
class obj_toolErrorTermSet (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 67, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}authorization uses Python identifier authorization
    __authorization = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'authorization'), 'authorization', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_httpwww_witsml_orgschemas1seriesauthorization', False, pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 28, 3), )
    ...
    __nomenclature = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nomenclature'), 'nomenclature', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_httpwww_witsml_orgschemas1seriesnomenclature', False, pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 33, 3), )
    ...
    __errorTerm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'errorTerm'), 'errorTerm', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_httpwww_witsml_orgschemas1serieserrorTerm', True, pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 38, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 72, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 82, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 88, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_toolErrorTermSet_uid', _module_typeBindings.uidString)
...
_module_typeBindings.obj_toolErrorTermSet = obj_toolErrorTermSet
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 27, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 39, 3))
    counters.add(cc_2)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclature._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parameter')), pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclature._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'function')), pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 33, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclature._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'constant')), pyxb.utils.utility.Location('cs_iscwsaNomenclature.xsd', 39, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_toolErrorTermSets._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_toolErrorTermSets, documentation='Information about the XML message instance.', location=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 45, 5)))

obj_toolErrorTermSets._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'toolErrorTermSet'), obj_toolErrorTermSet, scope=obj_toolErrorTermSets, documentation='A single error term set.', location=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 50, 5)))
...
def _BuildAutomaton_8 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 45, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSets._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 45, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSets._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'toolErrorTermSet')), pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 50, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_iscwsaErrorCoefficient._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'azi'), commentString, scope=cs_iscwsaErrorCoefficient, documentation='Measured horizontal azimuth.', location=pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 28, 7)))

cs_iscwsaErrorCoefficient._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'inc'), commentString, scope=cs_iscwsaErrorCoefficient, documentation='Measured deviation from vertical.', location=pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 33, 7)))

cs_iscwsaErrorCoefficient._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'depth'), commentString, scope=cs_iscwsaErrorCoefficient, documentation='Measured depth along the wellbore.', location=pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 38, 7)))

cs_iscwsaErrorCoefficient._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvd'), commentString, scope=cs_iscwsaErrorCoefficient, documentation='True Vertical Depth.', location=pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 43, 7)))

cs_iscwsaErrorCoefficient._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaErrorCoefficient, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 49, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 49, 3))
    counters.add(cc_0)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorCoefficient._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'azi')), pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 28, 7))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorCoefficient._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'inc')), pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 33, 7))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorCoefficient._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'depth')), pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 38, 7))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorCoefficient._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvd')), pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 43, 7))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorCoefficient._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaErrorCoefficient.xsd', 49, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_4, [
...
cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_iscwsaErrorTerm, documentation='This is the unique mnemonic for this term. \n\t\t\t\t\tFor example, "ABIX" or "DECR".', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 29, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), ErrorTermSource, scope=cs_iscwsaErrorTerm, documentation='The class of the error source.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 35, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'measureClass'), MeasureClass, scope=cs_iscwsaErrorTerm, documentation='The kind of quantity that the term represents.\n\t\t\t\t\tThis constrains the unit that can be used for any errorTermValues.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 40, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'label'), nameString, scope=cs_iscwsaErrorTerm, documentation='Human-readable name for the term, may be presented in \n\t\t\t\t\tapplication software. E.g., "MWD: X-Acceleromter Bias with Z-Axis Corr."', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 46, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=cs_iscwsaErrorTerm, documentation='Human-readable name for the term, may be presented in \n\t\t\t\t\tapplication software. E.g., "MWD: X-Acceleromter Bias with Z-Axis Corr."', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 52, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'errorCoefficient'), cs_iscwsaErrorCoefficient, scope=cs_iscwsaErrorTerm, documentation='Describes what measurement(s) the error variance(s) apply to.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 58, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'operatingMode'), SurveyToolOperatingMode, scope=cs_iscwsaErrorTerm, documentation='Operating mode that is valid for this error term.\n\t\t\t\t\tIn the absence of this element assume Stationary.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 63, 3)))

cs_iscwsaErrorTerm._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaErrorTerm, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 69, 3)))
...
def _BuildAutomaton_13 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 35, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 40, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 52, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 63, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 69, 3))
    counters.add(cc_4)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 29, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 35, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'measureClass')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 40, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'label')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 46, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 52, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'errorCoefficient')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 58, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'operatingMode')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 63, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaErrorTerm._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaErrorTerm.xsd', 69, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_iscwsaNameAndDescription._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_iscwsaNameAndDescription, documentation='The name of the item.', location=pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 28, 3)))

cs_iscwsaNameAndDescription._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=cs_iscwsaNameAndDescription, documentation='A textual description of the item.', location=pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 33, 3)))

cs_iscwsaNameAndDescription._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaNameAndDescription, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 38, 3)))
...
def _BuildAutomaton_14 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 38, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNameAndDescription._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 28, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNameAndDescription._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 33, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNameAndDescription._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaNameAndDescription.xsd', 38, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
cs_iscwsaNomenclatureConstant._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=cs_iscwsaNomenclatureConstant, documentation='The name of the constant.', location=pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 27, 3)))

cs_iscwsaNomenclatureConstant._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'value'), pyxb.binding.datatypes.double, scope=cs_iscwsaNomenclatureConstant, documentation='The value of the constant.', location=pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 32, 3)))

cs_iscwsaNomenclatureConstant._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'unit'), uomString, scope=cs_iscwsaNomenclatureConstant, documentation='The unit of measure of the constant.\n\t\t\t\t\tThis value must match an acronym from the WITSML unit of measure dictionary.', location=pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 37, 3)))

cs_iscwsaNomenclatureConstant._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=cs_iscwsaNomenclatureConstant, documentation='A textual description of the constant.', location=pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 43, 3)))

cs_iscwsaNomenclatureConstant._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_iscwsaNomenclatureConstant, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 48, 3)))
...
def _BuildAutomaton_15 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 48, 3))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclatureConstant._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclatureConstant._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'value')), pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclatureConstant._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'unit')), pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclatureConstant._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 43, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_iscwsaNomenclatureConstant._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_iscwsaNomenclatureConstant.xsd', 48, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_toolErrorTermSet._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'authorization'), cs_iscwsaAuthorizationData, scope=obj_toolErrorTermSet, documentation='The definitive source for this set of error terms.', location=pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 28, 3)))

obj_toolErrorTermSet._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nomenclature'), cs_iscwsaNomenclature, scope=obj_toolErrorTermSet, documentation='Defines the nomenclature used in the error terms.', location=pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 33, 3)))

obj_toolErrorTermSet._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'errorTerm'), cs_iscwsaErrorTerm, scope=obj_toolErrorTermSet, documentation='Defines an error term.', location=pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 38, 3)))

obj_toolErrorTermSet._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_toolErrorTermSet, documentation='Human-readable name for the set of terms.', location=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 72, 3)))

obj_toolErrorTermSet._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_toolErrorTermSet, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 82, 3)))

obj_toolErrorTermSet._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_toolErrorTermSet, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 88, 3)))
...
def _BuildAutomaton_16 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 77, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 28, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 33, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 38, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 82, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 88, 3))
    counters.add(cc_5)
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSet._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 72, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSet._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'authorization')), pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 28, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSet._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nomenclature')), pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 33, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSet._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'errorTerm')), pyxb.utils.utility.Location('grp_toolErrorTermSet.xsd', 38, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSet._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 82, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_toolErrorTermSet._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_toolErrorTermSet.xsd', 88, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
toolErrorTermSets._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
