# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_changeLog.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:15:43.980375 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:264fb93a-473b-46fc-adb8-1bbf3d5faf84')
...
class obj_changeLogs (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_changeLogs')
    _XSDLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 44, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_changeLogs_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 51, 5), )
    ...
    __changeLog = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'changeLog'), 'changeLog', '__httpwww_witsml_orgschemas1series_obj_changeLogs_httpwww_witsml_orgschemas1serieschangeLog', True, pyxb.utils.utility.Location('obj_changeLog.xsd', 56, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_changeLogs_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 62, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 62, 4)
...
_module_typeBindings.obj_changeLogs = obj_changeLogs
...
class cs_changeHistory (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_changeHistory.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}dTimChange uses Python identifier dTimChange
    __dTimChange = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimChange'), 'dTimChange', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesdTimChange', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 27, 3), )
    ...
    __changeType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'changeType'), 'changeType', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1serieschangeType', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 32, 3), )
    ...
    __objectGrowingState = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectGrowingState'), 'objectGrowingState', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesobjectGrowingState', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 37, 3), )
    ...
    __updatedHeader = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'updatedHeader'), 'updatedHeader', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesupdatedHeader', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 42, 3), )
    ...
    __changeInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'changeInfo'), 'changeInfo', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1serieschangeInfo', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 47, 3), )
    ...
    __startIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'startIndex'), 'startIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesstartIndex', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 52, 3), )
    ...
    __endIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'endIndex'), 'endIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesendIndex', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 57, 3), )
    ...
    __startDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex'), 'startDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesstartDateTimeIndex', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 62, 3), )
    ...
    __endDateTimeIndex = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex'), 'endDateTimeIndex', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesendDateTimeIndex', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 67, 3), )
    ...
    __mnemonics = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mnemonics'), 'mnemonics', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesmnemonics', False, pyxb.utils.utility.Location('cs_changeHistory.xsd', 72, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_changeHistory_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_changeHistory.xsd', 77, 3), )
    ...
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_changeHistory_uid', _module_typeBindings.uidString)
...
_module_typeBindings.cs_changeHistory = cs_changeHistory
...
class obj_changeLog (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 73, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}sourceName uses Python identifier sourceName
    __sourceName = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sourceName'), 'sourceName', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriessourceName', False, pyxb.utils.utility.Location('grp_changeLog.xsd', 26, 3), )
    ...
    __lastChangeType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lastChangeType'), 'lastChangeType', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1serieslastChangeType', False, pyxb.utils.utility.Location('grp_changeLog.xsd', 31, 3), )
    ...
    __lastChangeInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lastChangeInfo'), 'lastChangeInfo', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1serieslastChangeInfo', False, pyxb.utils.utility.Location('grp_changeLog.xsd', 37, 3), )
    ...
    __changeHistory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'changeHistory'), 'changeHistory', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1serieschangeHistory', True, pyxb.utils.utility.Location('grp_changeLog.xsd', 42, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 79, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 87, 3), )
    ...
    __nameObject = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameObject'), 'nameObject', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesnameObject', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 95, 3), )
    ...
    __objectType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectType'), 'objectType', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriesobjectType', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 101, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 111, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_changeLog_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_changeLog.xsd', 117, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_changeLog_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_changeLog_uidWell', _module_typeBindings.uidString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 124, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 124, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_changeLog_uidWellbore', _module_typeBindings.uidString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 132, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 132, 2)
    ...
    __uidObject = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidObject'), 'uidObject', '__httpwww_witsml_orgschemas1series_obj_changeLog_uidObject', _module_typeBindings.uidString, required=True)
    __uidObject._DeclarationLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 140, 2)
    __uidObject._UseLocation = pyxb.utils.utility.Location('obj_changeLog.xsd', 140, 2)
...
_module_typeBindings.obj_changeLog = obj_changeLog
...
obj_changeLogs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_changeLogs, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 51, 5)))

obj_changeLogs._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'changeLog'), obj_changeLog, scope=obj_changeLogs, documentation='Defines a singular changeLog object.', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 56, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 51, 5))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 56, 5))
    counters.add(cc_1)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLogs._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_changeLog.xsd', 51, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLogs._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'changeLog')), pyxb.utils.utility.Location('obj_changeLog.xsd', 56, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimChange'), timestamp, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 27, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'changeType'), ChangeInfoType, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 32, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectGrowingState'), logicalBoolean, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 37, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'updatedHeader'), logicalBoolean, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 42, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'changeInfo'), commentString, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 47, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'startIndex'), genericMeasure, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 52, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'endIndex'), genericMeasure, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 57, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex'), timestamp, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 62, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex'), timestamp, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 67, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mnemonics'), commentString, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 72, 3)))

cs_changeHistory._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_changeHistory, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('cs_changeHistory.xsd', 77, 3)))
...
def _BuildAutomaton_7 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 37, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 42, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 47, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 52, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 57, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 62, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 67, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 72, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_changeHistory.xsd', 77, 3))
    counters.add(cc_8)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimChange')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'changeType')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectGrowingState')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'updatedHeader')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'changeInfo')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 47, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'startIndex')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 52, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'endIndex')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 57, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'startDateTimeIndex')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 62, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'endDateTimeIndex')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 67, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mnemonics')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 72, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_changeHistory._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_changeHistory.xsd', 77, 3))
...
obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sourceName'), nameString, scope=obj_changeLog, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('grp_changeLog.xsd', 26, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lastChangeType'), ChangeInfoType, scope=obj_changeLog, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('grp_changeLog.xsd', 31, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lastChangeInfo'), commentString, scope=obj_changeLog, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('grp_changeLog.xsd', 37, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'changeHistory'), cs_changeHistory, scope=obj_changeLog, documentation='See the API specification for a description of the use of this data.', location=pyxb.utils.utility.Location('grp_changeLog.xsd', 42, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_changeLog, documentation='Human recognizable contextual name for a Well.\n\t\t\t\t\tThis should match the value of element nameWell in the changed object.\n\t\t\t\t\tIf the changed object is well then this value will not be defined.\n\t\t\t\t\tThis is required for objects which are a direct or indirect child of a well.', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 79, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_changeLog, documentation='Human recognizable contextual name for the Wellbore.\n\t\t\t\t\tThis should match the value of element nameWellbore in the changed object.\n\t\t\t\t\tIf the changed object is well or wellbore then this value will not be defined.\n\t\t\t\t\tThis is required for objects which are a direct or indirect child of a wellbore.', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 87, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameObject'), nameString, scope=obj_changeLog, documentation='Human recognizable contextual name for the object.\n\t\t\t\t\tThis should match the value of the name element in the changed object.', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 95, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectType'), nameString, scope=obj_changeLog, documentation='The schema name of the (singular) object that changed. For example, "trajectory".', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 101, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_changeLog, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 111, 3)))

obj_changeLog._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_changeLog, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_changeLog.xsd', 117, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 79, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 87, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 106, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_changeLog.xsd', 26, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_changeLog.xsd', 37, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_changeLog.xsd', 42, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 111, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_changeLog.xsd', 117, 3))
    counters.add(cc_7)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_changeLog.xsd', 79, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_changeLog.xsd', 87, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameObject')), pyxb.utils.utility.Location('obj_changeLog.xsd', 95, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectType')), pyxb.utils.utility.Location('obj_changeLog.xsd', 101, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sourceName')), pyxb.utils.utility.Location('grp_changeLog.xsd', 26, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lastChangeType')), pyxb.utils.utility.Location('grp_changeLog.xsd', 31, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lastChangeInfo')), pyxb.utils.utility.Location('grp_changeLog.xsd', 37, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'changeHistory')), pyxb.utils.utility.Location('grp_changeLog.xsd', 42, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_changeLog.xsd', 111, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_changeLog._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_changeLog.xsd', 117, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
changeLogs._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
