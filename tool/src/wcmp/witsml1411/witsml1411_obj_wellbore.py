# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_wellbore.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:17:55.756670 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:aa96966d-3391-456d-9c44-657cb43941a8')
...
class obj_wellbores (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_wellbores')
    _XSDLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_wellbores_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 48, 5), )
    ...
    __wellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellbore'), 'wellbore', '__httpwww_witsml_orgschemas1series_obj_wellbores_httpwww_witsml_orgschemas1serieswellbore', True, pyxb.utils.utility.Location('obj_wellbore.xsd', 53, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_wellbores_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 61, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 61, 4)
...
_module_typeBindings.obj_wellbores = obj_wellbores
...
class obj_wellbore (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 72, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}parentWellbore uses Python identifier parentWellbore
    __parentWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'parentWellbore'), 'parentWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesparentWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 25, 3), )
    ...
    __number = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'number'), 'number', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesnumber', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 30, 3), )
    ...
    __suffixAPI = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'suffixAPI'), 'suffixAPI', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriessuffixAPI', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 35, 3), )
    ...
    __numGovt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numGovt'), 'numGovt', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesnumGovt', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 40, 3), )
    ...
    __statusWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'statusWellbore'), 'statusWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesstatusWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 45, 3), )
    ...
    __isActive = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'isActive'), 'isActive', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesisActive', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 50, 3), )
    ...
    __purposeWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'purposeWellbore'), 'purposeWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriespurposeWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3), )
    ...
    __typeWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeWellbore'), 'typeWellbore', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestypeWellbore', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3), )
    ...
    __shape = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'shape'), 'shape', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesshape', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3), )
    ...
    __dTimKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimKickoff'), 'dTimKickoff', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesdTimKickoff', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 73, 3), )
    ...
    __achievedTD = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'achievedTD'), 'achievedTD', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesachievedTD', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 78, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'md'), 'md', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmd', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 85, 3), )
    ...
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvd'), 'tvd', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvd', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 96, 3), )
    ...
    __mdBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBit'), 'mdBit', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdBit', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3), )
    ...
    __tvdBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdBit'), 'tvdBit', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdBit', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 118, 3), )
    ...
    __mdKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdKickoff'), 'mdKickoff', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdKickoff', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 129, 3), )
    ...
    __tvdKickoff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdKickoff'), 'tvdKickoff', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdKickoff', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 134, 3), )
    ...
    __mdPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdPlanned'), 'mdPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 139, 3), )
    ...
    __tvdPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdPlanned'), 'tvdPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 144, 3), )
    ...
    __mdSubSeaPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdSubSeaPlanned'), 'mdSubSeaPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesmdSubSeaPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 149, 3), )
    ...
    __tvdSubSeaPlanned = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdSubSeaPlanned'), 'tvdSubSeaPlanned', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriestvdSubSeaPlanned', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 154, 3), )
    ...
    __dayTarget = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dayTarget'), 'dayTarget', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesdayTarget', False, pyxb.utils.utility.Location('grp_wellbore.xsd', 159, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 79, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 89, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_wellbore_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_wellbore.xsd', 95, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_wellbore_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_wellbore_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 102, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_wellbore.xsd', 102, 2)
...
_module_typeBindings.obj_wellbore = obj_wellbore
...
obj_wellbores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_wellbores, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 48, 5)))

obj_wellbores._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wellbore'), obj_wellbore, scope=obj_wellbores, documentation='Information about a single wellbore.\n\t\t\t\t\t\t\tA wellbore is a unique, oriented path from the bottom of a drilled \n\t\t\t\t\t\t\tborehole to the surface of the Earth. The path must not overlap or cross itself.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wellbores._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_wellbore.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wellbores._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellbore')), pyxb.utils.utility.Location('obj_wellbore.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'parentWellbore'), refNameString, scope=obj_wellbore, documentation='This is a pointer to the parent wellbore. No parent = starts from top.   ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 25, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'number'), str32, scope=obj_wellbore, documentation='Operator borehole number.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 30, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'suffixAPI'), nameString, scope=obj_wellbore, documentation='API suffix.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 35, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numGovt'), nameString, scope=obj_wellbore, documentation='Government assigned number.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 40, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'statusWellbore'), WellStatus, scope=obj_wellbore, documentation='POSC wellbore status.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 45, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'isActive'), logicalBoolean, scope=obj_wellbore, documentation='True (="1" or "true") indicates that the wellbore is active.\n\t\t\t\t\tFalse (="0" or "false") indicates otherwise. It is the servers responsibility to \n\t\t\t\t\tset this value based on its available internal data (e.g., what objects are changing).', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 50, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'purposeWellbore'), WellPurpose, scope=obj_wellbore, documentation='POSC wellbore purpose.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeWellbore'), WellboreType, scope=obj_wellbore, documentation='Type of wellbore.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'shape'), WellboreShape, scope=obj_wellbore, documentation='POSC wellbore trajectory shape.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimKickoff'), timestamp, scope=obj_wellbore, documentation='Date and time of wellbore kickoff.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 73, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'achievedTD'), logicalBoolean, scope=obj_wellbore, documentation='True ("true" of "1") indicates that the wellbore has \n\t\t\t\t\tacheieved total depth. That is, drilling has completed. False ("false" or "0") indicates otherwise. \n\t\t\t\t\tNot given indicates that it is not known whether total depth has been reached.', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 78, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'md'), measuredDepthCoord, scope=obj_wellbore, documentation='The measured depth of the borehole. \n\t\t\t\t\tIf status is plugged, indicates the maximum depth reached before plugging.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 85, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvd'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='The  true vertical depth of the borehole.  \n\t\t\t\t\tIf status is plugged, indicates the maximum depth reached before plugging. \n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 96, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBit'), measuredDepthCoord, scope=obj_wellbore, documentation='The measured depth of the bit. \n\t\t\t\t\tIf isActive=false then this value is not relevant.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdBit'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='The true vertical depth of the bit.\n\t\t\t\t\tIf isActive=false then this value is not relevant.\n\t\t\t\t\tIt is recommended that this value be updated about every 10 minutes by an assigned \n\t\t\t\t\traw data provider at a site.', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 118, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdKickoff'), measuredDepthCoord, scope=obj_wellbore, documentation='Kickoff measured depth of the wellbore. ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 129, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdKickoff'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='Kickoff true vertical depth of the wellbore.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 134, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdPlanned'), measuredDepthCoord, scope=obj_wellbore, documentation='Planned measured depth for the wellbore total depth.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 139, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdPlanned'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='Planned true vertical depth for the wellbore total depth.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 144, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdSubSeaPlanned'), measuredDepthCoord, scope=obj_wellbore, documentation='Planned measured for the wellbore total depth - with respect to seabed.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 149, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdSubSeaPlanned'), wellVerticalDepthCoord, scope=obj_wellbore, documentation='Planned true vertical depth for the wellbore total depth - with respect to seabed.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 154, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dayTarget'), timeMeasure, scope=obj_wellbore, documentation='Target days for drilling wellbore.  ', location=pyxb.utils.utility.Location('grp_wellbore.xsd', 159, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_wellbore, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_wellbore, documentation='Human recognizable context for the wellbore.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 79, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_wellbore, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 89, 3)))

obj_wellbore._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_wellbore, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_wellbore.xsd', 95, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 84, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 25, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 30, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 35, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 40, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 45, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 50, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 73, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 78, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 85, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 96, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 118, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 129, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 134, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 139, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 144, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 149, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 154, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_wellbore.xsd', 159, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 89, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_wellbore.xsd', 95, 3))
    counters.add(cc_24)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_wellbore.xsd', 74, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_wellbore.xsd', 79, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parentWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 25, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'number')), pyxb.utils.utility.Location('grp_wellbore.xsd', 30, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'suffixAPI')), pyxb.utils.utility.Location('grp_wellbore.xsd', 35, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numGovt')), pyxb.utils.utility.Location('grp_wellbore.xsd', 40, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'statusWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 45, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'isActive')), pyxb.utils.utility.Location('grp_wellbore.xsd', 50, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'purposeWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 58, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeWellbore')), pyxb.utils.utility.Location('grp_wellbore.xsd', 63, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'shape')), pyxb.utils.utility.Location('grp_wellbore.xsd', 68, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimKickoff')), pyxb.utils.utility.Location('grp_wellbore.xsd', 73, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'achievedTD')), pyxb.utils.utility.Location('grp_wellbore.xsd', 78, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'md')), pyxb.utils.utility.Location('grp_wellbore.xsd', 85, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvd')), pyxb.utils.utility.Location('grp_wellbore.xsd', 96, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBit')), pyxb.utils.utility.Location('grp_wellbore.xsd', 107, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdBit')), pyxb.utils.utility.Location('grp_wellbore.xsd', 118, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdKickoff')), pyxb.utils.utility.Location('grp_wellbore.xsd', 129, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdKickoff')), pyxb.utils.utility.Location('grp_wellbore.xsd', 134, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 139, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 144, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdSubSeaPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 149, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdSubSeaPlanned')), pyxb.utils.utility.Location('grp_wellbore.xsd', 154, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dayTarget')), pyxb.utils.utility.Location('grp_wellbore.xsd', 159, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_wellbore.xsd', 89, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(obj_wellbore._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_wellbore.xsd', 95, 3))
...
wellbores._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
