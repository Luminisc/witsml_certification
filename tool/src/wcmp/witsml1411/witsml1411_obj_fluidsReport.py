# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_fluidsReport.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:16:16.513492 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:842a8628-e310-4055-ae54-48bc67019472')
...
# Complex type {http://www.witsml.org/schemas/1series}obj_fluidsReports with content type ELEMENT_ONLY
class obj_fluidsReports (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_fluidsReports')
    _XSDLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_fluidsReports_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 48, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, 'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}fluidsReport uses Python identifier fluidsReport
    __fluidsReport = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'fluidsReport'), 'fluidsReport', '__httpwww_witsml_orgschemas1series_obj_fluidsReports_httpwww_witsml_orgschemas1seriesfluidsReport', True, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 53, 5), )

    
    fluidsReport = property(__fluidsReport.value, __fluidsReport.set, None, 'A single fluids report.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_fluidsReports_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 59, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 59, 4)
    ...
    _ElementMap.update({
        ...
        __fluidsReport.name() : __fluidsReport
    })
    _AttributeMap.update({
        __version.name() : __version
    })
_module_typeBindings.obj_fluidsReports = obj_fluidsReports
Namespace.addCategoryObject('typeBinding', 'obj_fluidsReports', obj_fluidsReports)
...
# Complex type {http://www.witsml.org/schemas/1series}cs_fluid with content type ELEMENT_ONLY
class cs_fluid (pyxb.binding.basis.complexTypeDefinition):
    """ WITSML - fluids component schema """
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_fluid')
    _XSDLocation = pyxb.utils.utility.Location('cs_fluid.xsd', 22, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}type uses Python identifier type
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriestype', False, pyxb.utils.utility.Location('cs_fluid.xsd', 27, 3), )

    
    type = property(__type.value, __type.set, None, 'Description for the type of fluid.  ')

    
    # Element {http://www.witsml.org/schemas/1series}locationSample uses Python identifier locationSample
    __locationSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'locationSample'), 'locationSample', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieslocationSample', False, pyxb.utils.utility.Location('cs_fluid.xsd', 33, 3), )

    
    locationSample = property(__locationSample.value, __locationSample.set, None, 'Sample location.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dTim uses Python identifier dTim
    __dTim = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTim'), 'dTim', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesdTim', False, pyxb.utils.utility.Location('cs_fluid.xsd', 38, 3), )

    
    dTim = property(__dTim.value, __dTim.set, None, 'The time when fluid readings were recorded. ')

    
    # Element {http://www.witsml.org/schemas/1series}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'md'), 'md', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesmd', False, pyxb.utils.utility.Location('cs_fluid.xsd', 43, 3), )

    
    md = property(__md.value, __md.set, None, 'The measured depth where the fluid readings were recorded.')

    
    # Element {http://www.witsml.org/schemas/1series}tvd uses Python identifier tvd
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvd'), 'tvd', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriestvd', False, pyxb.utils.utility.Location('cs_fluid.xsd', 49, 3), )

    
    tvd = property(__tvd.value, __tvd.set, None, 'The true vertical depth where the fluid readings were recorded.')

    
    # Element {http://www.witsml.org/schemas/1series}presBopRating uses Python identifier presBopRating
    __presBopRating = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'presBopRating'), 'presBopRating', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespresBopRating', False, pyxb.utils.utility.Location('cs_fluid.xsd', 55, 3), )

    
    presBopRating = property(__presBopRating.value, __presBopRating.set, None, 'Maximum pressure rating of the blow out preventer.')

    
    # Element {http://www.witsml.org/schemas/1series}mudClass uses Python identifier mudClass
    __mudClass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mudClass'), 'mudClass', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesmudClass', False, pyxb.utils.utility.Location('cs_fluid.xsd', 61, 3), )

    
    mudClass = property(__mudClass.value, __mudClass.set, None, 'The class of the drilling fluid.')

    
    # Element {http://www.witsml.org/schemas/1series}density uses Python identifier density
    __density = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'density'), 'density', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesdensity', False, pyxb.utils.utility.Location('cs_fluid.xsd', 67, 3), )

    
    density = property(__density.value, __density.set, None, 'Fluid density.  ')

    
    # Element {http://www.witsml.org/schemas/1series}visFunnel uses Python identifier visFunnel
    __visFunnel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'visFunnel'), 'visFunnel', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesvisFunnel', False, pyxb.utils.utility.Location('cs_fluid.xsd', 72, 3), )

    
    visFunnel = property(__visFunnel.value, __visFunnel.set, None, 'Funnel viscosity in seconds.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tempVis uses Python identifier tempVis
    __tempVis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tempVis'), 'tempVis', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriestempVis', False, pyxb.utils.utility.Location('cs_fluid.xsd', 77, 3), )

    
    tempVis = property(__tempVis.value, __tempVis.set, None, 'Funnel viscosity temperature.  ')

    
    # Element {http://www.witsml.org/schemas/1series}pv uses Python identifier pv
    __pv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'pv'), 'pv', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespv', False, pyxb.utils.utility.Location('cs_fluid.xsd', 82, 3), )

    
    pv = property(__pv.value, __pv.set, None, 'Plastic viscosity.  ')

    
    # Element {http://www.witsml.org/schemas/1series}yp uses Python identifier yp
    __yp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'yp'), 'yp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesyp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 87, 3), )

    
    yp = property(__yp.value, __yp.set, None, 'Yield point (Bingham and Herschel Bulkley models).  ')

    
    # Element {http://www.witsml.org/schemas/1series}gel10Sec uses Python identifier gel10Sec
    __gel10Sec = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'gel10Sec'), 'gel10Sec', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesgel10Sec', False, pyxb.utils.utility.Location('cs_fluid.xsd', 92, 3), )

    
    gel10Sec = property(__gel10Sec.value, __gel10Sec.set, None, '10 second gels.  ')

    
    # Element {http://www.witsml.org/schemas/1series}gel10Min uses Python identifier gel10Min
    __gel10Min = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'gel10Min'), 'gel10Min', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesgel10Min', False, pyxb.utils.utility.Location('cs_fluid.xsd', 97, 3), )

    
    gel10Min = property(__gel10Min.value, __gel10Min.set, None, '10 minute gels.  ')

    
    # Element {http://www.witsml.org/schemas/1series}gel30Min uses Python identifier gel30Min
    __gel30Min = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'gel30Min'), 'gel30Min', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesgel30Min', False, pyxb.utils.utility.Location('cs_fluid.xsd', 102, 3), )

    
    gel30Min = property(__gel30Min.value, __gel30Min.set, None, '30 minute gels.  ')

    
    # Element {http://www.witsml.org/schemas/1series}filterCakeLtlp uses Python identifier filterCakeLtlp
    __filterCakeLtlp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'filterCakeLtlp'), 'filterCakeLtlp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesfilterCakeLtlp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 107, 3), )

    
    filterCakeLtlp = property(__filterCakeLtlp.value, __filterCakeLtlp.set, None, 'Filter cake thickness at low (normal) temperature and pressure.  ')

    
    # Element {http://www.witsml.org/schemas/1series}filtrateLtlp uses Python identifier filtrateLtlp
    __filtrateLtlp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'filtrateLtlp'), 'filtrateLtlp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesfiltrateLtlp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 112, 3), )

    
    filtrateLtlp = property(__filtrateLtlp.value, __filtrateLtlp.set, None, 'API water loss (low temperature and pressure mud filtrate measurement) (volume per 30min).  ')

    
    # Element {http://www.witsml.org/schemas/1series}tempHthp uses Python identifier tempHthp
    __tempHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tempHthp'), 'tempHthp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriestempHthp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 118, 3), )

    
    tempHthp = property(__tempHthp.value, __tempHthp.set, None, 'High temperature high pressure (HTHP) temperature.  ')

    
    # Element {http://www.witsml.org/schemas/1series}presHthp uses Python identifier presHthp
    __presHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'presHthp'), 'presHthp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespresHthp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 123, 3), )

    
    presHthp = property(__presHthp.value, __presHthp.set, None, 'High temperature high pressure (HTHP) pressure.  ')

    
    # Element {http://www.witsml.org/schemas/1series}filtrateHthp uses Python identifier filtrateHthp
    __filtrateHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'filtrateHthp'), 'filtrateHthp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesfiltrateHthp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 128, 3), )

    
    filtrateHthp = property(__filtrateHthp.value, __filtrateHthp.set, None, 'High temperature high pressure (HTHP) filtrate (volume per 30min).  ')

    
    # Element {http://www.witsml.org/schemas/1series}filterCakeHthp uses Python identifier filterCakeHthp
    __filterCakeHthp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'filterCakeHthp'), 'filterCakeHthp', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesfilterCakeHthp', False, pyxb.utils.utility.Location('cs_fluid.xsd', 133, 3), )

    
    filterCakeHthp = property(__filterCakeHthp.value, __filterCakeHthp.set, None, 'High temperature high pressure (HTHP) Filter cake thickness.  ')

    
    # Element {http://www.witsml.org/schemas/1series}solidsPc uses Python identifier solidsPc
    __solidsPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'solidsPc'), 'solidsPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessolidsPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 138, 3), )

    
    solidsPc = property(__solidsPc.value, __solidsPc.set, None, 'Solids percentage from retort (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}waterPc uses Python identifier waterPc
    __waterPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'waterPc'), 'waterPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieswaterPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 143, 3), )

    
    waterPc = property(__waterPc.value, __waterPc.set, None, 'Water content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}oilPc uses Python identifier oilPc
    __oilPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'oilPc'), 'oilPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesoilPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 148, 3), )

    
    oilPc = property(__oilPc.value, __oilPc.set, None, 'Oil content from retort (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}sandPc uses Python identifier sandPc
    __sandPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sandPc'), 'sandPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessandPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 153, 3), )

    
    sandPc = property(__sandPc.value, __sandPc.set, None, 'Sand content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}solidsLowGravPc uses Python identifier solidsLowGravPc
    __solidsLowGravPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'solidsLowGravPc'), 'solidsLowGravPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessolidsLowGravPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 158, 3), )

    
    solidsLowGravPc = property(__solidsLowGravPc.value, __solidsLowGravPc.set, None, 'Low gravity solids (%).  ')

    
    # Element {http://www.witsml.org/schemas/1series}solidsCalcPc uses Python identifier solidsCalcPc
    __solidsCalcPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'solidsCalcPc'), 'solidsCalcPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessolidsCalcPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 163, 3), )

    
    solidsCalcPc = property(__solidsCalcPc.value, __solidsCalcPc.set, None, 'Solids content (calculated) (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}baritePc uses Python identifier baritePc
    __baritePc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'baritePc'), 'baritePc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesbaritePc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 168, 3), )

    
    baritePc = property(__baritePc.value, __baritePc.set, None, 'Barite content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}lcm uses Python identifier lcm
    __lcm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lcm'), 'lcm', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieslcm', False, pyxb.utils.utility.Location('cs_fluid.xsd', 173, 3), )

    
    lcm = property(__lcm.value, __lcm.set, None, 'Lost circulation material.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mbt uses Python identifier mbt
    __mbt = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mbt'), 'mbt', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesmbt', False, pyxb.utils.utility.Location('cs_fluid.xsd', 178, 3), )

    
    mbt = property(__mbt.value, __mbt.set, None, 'Cation exchange capacity (CEC) of the mud sample as measured by methylene blue titration (MBT).  ')

    
    # Element {http://www.witsml.org/schemas/1series}ph uses Python identifier ph
    __ph = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ph'), 'ph', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesph', False, pyxb.utils.utility.Location('cs_fluid.xsd', 183, 3), )

    
    ph = property(__ph.value, __ph.set, None, 'Mud pH.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tempPh uses Python identifier tempPh
    __tempPh = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tempPh'), 'tempPh', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriestempPh', False, pyxb.utils.utility.Location('cs_fluid.xsd', 188, 3), )

    
    tempPh = property(__tempPh.value, __tempPh.set, None, 'Mud pH measurement temperature.  ')

    
    # Element {http://www.witsml.org/schemas/1series}pm uses Python identifier pm
    __pm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'pm'), 'pm', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespm', False, pyxb.utils.utility.Location('cs_fluid.xsd', 193, 3), )

    
    pm = property(__pm.value, __pm.set, None, 'Phenolphthalein alkalinity of whole mud.  ')

    
    # Element {http://www.witsml.org/schemas/1series}pmFiltrate uses Python identifier pmFiltrate
    __pmFiltrate = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'pmFiltrate'), 'pmFiltrate', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespmFiltrate', False, pyxb.utils.utility.Location('cs_fluid.xsd', 198, 3), )

    
    pmFiltrate = property(__pmFiltrate.value, __pmFiltrate.set, None, 'Phenolphthalein alkalinity of mud filtrate.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mf uses Python identifier mf
    __mf = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mf'), 'mf', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesmf', False, pyxb.utils.utility.Location('cs_fluid.xsd', 203, 3), )

    
    mf = property(__mf.value, __mf.set, None, 'Methyl orange alkalinity of filtrate.  ')

    
    # Element {http://www.witsml.org/schemas/1series}alkalinityP1 uses Python identifier alkalinityP1
    __alkalinityP1 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'alkalinityP1'), 'alkalinityP1', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesalkalinityP1', False, pyxb.utils.utility.Location('cs_fluid.xsd', 208, 3), )

    
    alkalinityP1 = property(__alkalinityP1.value, __alkalinityP1.set, None, 'Mud alkalinity P1 from alternate alkalinity method (volume in ml of 0.02N acid \n\t\t\t\t\tto reach the phenolphthalein endpoint).  ')

    
    # Element {http://www.witsml.org/schemas/1series}alkalinityP2 uses Python identifier alkalinityP2
    __alkalinityP2 = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'alkalinityP2'), 'alkalinityP2', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesalkalinityP2', False, pyxb.utils.utility.Location('cs_fluid.xsd', 214, 3), )

    
    alkalinityP2 = property(__alkalinityP2.value, __alkalinityP2.set, None, 'Mud alkalinity P2 from alternate alkalinity method (volume in ml of 0.02N acid\n\t\t\t\t\tto titrate the reagent mixture to the phenolphthalein endpoint).  ')

    
    # Element {http://www.witsml.org/schemas/1series}chloride uses Python identifier chloride
    __chloride = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'chloride'), 'chloride', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieschloride', False, pyxb.utils.utility.Location('cs_fluid.xsd', 220, 3), )

    
    chloride = property(__chloride.value, __chloride.set, None, 'Chloride content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}calcium uses Python identifier calcium
    __calcium = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'calcium'), 'calcium', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriescalcium', False, pyxb.utils.utility.Location('cs_fluid.xsd', 225, 3), )

    
    calcium = property(__calcium.value, __calcium.set, None, 'Calcium content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}magnesium uses Python identifier magnesium
    __magnesium = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'magnesium'), 'magnesium', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesmagnesium', False, pyxb.utils.utility.Location('cs_fluid.xsd', 230, 3), )

    
    magnesium = property(__magnesium.value, __magnesium.set, None, 'Magnesium content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}potassium uses Python identifier potassium
    __potassium = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'potassium'), 'potassium', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespotassium', False, pyxb.utils.utility.Location('cs_fluid.xsd', 235, 3), )

    
    potassium = property(__potassium.value, __potassium.set, None, 'Potassium content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}rheometer uses Python identifier rheometer
    __rheometer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rheometer'), 'rheometer', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesrheometer', True, pyxb.utils.utility.Location('cs_fluid.xsd', 240, 3), )

    
    rheometer = property(__rheometer.value, __rheometer.set, None, 'One or more sets of rheometer readings at given temperature and pressure.  ')

    
    # Element {http://www.witsml.org/schemas/1series}brinePc uses Python identifier brinePc
    __brinePc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'brinePc'), 'brinePc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesbrinePc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 245, 3), )

    
    brinePc = property(__brinePc.value, __brinePc.set, None, 'Brine content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}lime uses Python identifier lime
    __lime = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lime'), 'lime', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieslime', False, pyxb.utils.utility.Location('cs_fluid.xsd', 250, 3), )

    
    lime = property(__lime.value, __lime.set, None, 'Lime content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}electStab uses Python identifier electStab
    __electStab = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'electStab'), 'electStab', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieselectStab', False, pyxb.utils.utility.Location('cs_fluid.xsd', 255, 3), )

    
    electStab = property(__electStab.value, __electStab.set, None, 'Measurement of the emulsion stability and oil-wetting capability in oil-based muds.  ')

    
    # Element {http://www.witsml.org/schemas/1series}calciumChloride uses Python identifier calciumChloride
    __calciumChloride = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'calciumChloride'), 'calciumChloride', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriescalciumChloride', False, pyxb.utils.utility.Location('cs_fluid.xsd', 260, 3), )

    
    calciumChloride = property(__calciumChloride.value, __calciumChloride.set, None, 'Calcium chloride content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}company uses Python identifier company
    __company = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'company'), 'company', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriescompany', False, pyxb.utils.utility.Location('cs_fluid.xsd', 265, 3), )

    
    company = property(__company.value, __company.set, None, 'Name of company.  ')

    
    # Element {http://www.witsml.org/schemas/1series}engineer uses Python identifier engineer
    __engineer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'engineer'), 'engineer', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesengineer', False, pyxb.utils.utility.Location('cs_fluid.xsd', 270, 3), )

    
    engineer = property(__engineer.value, __engineer.set, None, 'Engineer name  ')

    
    # Element {http://www.witsml.org/schemas/1series}asg uses Python identifier asg
    __asg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'asg'), 'asg', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesasg', False, pyxb.utils.utility.Location('cs_fluid.xsd', 275, 3), )

    
    asg = property(__asg.value, __asg.set, None, 'Average specific gravity of solids.  ')

    
    # Element {http://www.witsml.org/schemas/1series}solidsHiGravPc uses Python identifier solidsHiGravPc
    __solidsHiGravPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'solidsHiGravPc'), 'solidsHiGravPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessolidsHiGravPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 280, 3), )

    
    solidsHiGravPc = property(__solidsHiGravPc.value, __solidsHiGravPc.set, None, 'Solids high gravity (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}polymer uses Python identifier polymer
    __polymer = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'polymer'), 'polymer', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespolymer', False, pyxb.utils.utility.Location('cs_fluid.xsd', 285, 3), )

    
    polymer = property(__polymer.value, __polymer.set, None, 'Polymers present in mud system.  ')

    
    # Element {http://www.witsml.org/schemas/1series}polyType uses Python identifier polyType
    __polyType = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'polyType'), 'polyType', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriespolyType', False, pyxb.utils.utility.Location('cs_fluid.xsd', 290, 3), )

    
    polyType = property(__polyType.value, __polyType.set, None, 'Type of polymers present in mud system.  ')

    
    # Element {http://www.witsml.org/schemas/1series}solCorPc uses Python identifier solCorPc
    __solCorPc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'solCorPc'), 'solCorPc', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessolCorPc', False, pyxb.utils.utility.Location('cs_fluid.xsd', 295, 3), )

    
    solCorPc = property(__solCorPc.value, __solCorPc.set, None, 'Solids corrected for Chloride content (commonly in percent).  ')

    
    # Element {http://www.witsml.org/schemas/1series}oilCtg uses Python identifier oilCtg
    __oilCtg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'oilCtg'), 'oilCtg', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesoilCtg', False, pyxb.utils.utility.Location('cs_fluid.xsd', 300, 3), )

    
    oilCtg = property(__oilCtg.value, __oilCtg.set, None, 'Oil on Cuttings.  ')

    
    # Element {http://www.witsml.org/schemas/1series}hardnessCa uses Python identifier hardnessCa
    __hardnessCa = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'hardnessCa'), 'hardnessCa', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1serieshardnessCa', False, pyxb.utils.utility.Location('cs_fluid.xsd', 305, 3), )

    
    hardnessCa = property(__hardnessCa.value, __hardnessCa.set, None, 'Total calcium hardness.  ')

    
    # Element {http://www.witsml.org/schemas/1series}sulfide uses Python identifier sulfide
    __sulfide = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sulfide'), 'sulfide', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriessulfide', False, pyxb.utils.utility.Location('cs_fluid.xsd', 310, 3), )

    
    sulfide = property(__sulfide.value, __sulfide.set, None, 'Sulfide content.  ')

    
    # Element {http://www.witsml.org/schemas/1series}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comments'), 'comments', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriescomments', False, pyxb.utils.utility.Location('cs_fluid.xsd', 315, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_fluid_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_fluid.xsd', 320, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_fluid_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    ...
    _ElementMap.update({
        __type.name() : __type,
        __locationSample.name() : __locationSample,
        __dTim.name() : __dTim,
        __md.name() : __md,
        __tvd.name() : __tvd,
        __presBopRating.name() : __presBopRating,
        __mudClass.name() : __mudClass,
        __density.name() : __density,
        __visFunnel.name() : __visFunnel,
        __tempVis.name() : __tempVis,
        __pv.name() : __pv,
        __yp.name() : __yp,
        __gel10Sec.name() : __gel10Sec,
        __gel10Min.name() : __gel10Min,
        __gel30Min.name() : __gel30Min,
        __filterCakeLtlp.name() : __filterCakeLtlp,
        __filtrateLtlp.name() : __filtrateLtlp,
        __tempHthp.name() : __tempHthp,
        __presHthp.name() : __presHthp,
        __filtrateHthp.name() : __filtrateHthp,
        __filterCakeHthp.name() : __filterCakeHthp,
        __solidsPc.name() : __solidsPc,
        __waterPc.name() : __waterPc,
        __oilPc.name() : __oilPc,
        __sandPc.name() : __sandPc,
        __solidsLowGravPc.name() : __solidsLowGravPc,
        __solidsCalcPc.name() : __solidsCalcPc,
        __baritePc.name() : __baritePc,
        __lcm.name() : __lcm,
        __mbt.name() : __mbt,
        __ph.name() : __ph,
        __tempPh.name() : __tempPh,
        __pm.name() : __pm,
        __pmFiltrate.name() : __pmFiltrate,
        __mf.name() : __mf,
        __alkalinityP1.name() : __alkalinityP1,
        __alkalinityP2.name() : __alkalinityP2,
        __chloride.name() : __chloride,
        __calcium.name() : __calcium,
        __magnesium.name() : __magnesium,
        __potassium.name() : __potassium,
        __rheometer.name() : __rheometer,
        __brinePc.name() : __brinePc,
        __lime.name() : __lime,
        __electStab.name() : __electStab,
        __calciumChloride.name() : __calciumChloride,
        __company.name() : __company,
        __engineer.name() : __engineer,
        __asg.name() : __asg,
        __solidsHiGravPc.name() : __solidsHiGravPc,
        __polymer.name() : __polymer,
        __polyType.name() : __polyType,
        __solCorPc.name() : __solCorPc,
        __oilCtg.name() : __oilCtg,
        __hardnessCa.name() : __hardnessCa,
        __sulfide.name() : __sulfide,
        __comments.name() : __comments,
        __extensionNameValue.name() : __extensionNameValue
    })
    _AttributeMap.update({
...
_module_typeBindings.cs_fluid = cs_fluid
Namespace.addCategoryObject('typeBinding', 'cs_fluid', cs_fluid)


# Complex type {http://www.witsml.org/schemas/1series}cs_rheometer with content type ELEMENT_ONLY
class cs_rheometer (pyxb.binding.basis.complexTypeDefinition):
    """ WITSML - Rheometer Component Schema """
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'cs_rheometer')
    _XSDLocation = pyxb.utils.utility.Location('cs_rheometer.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}tempRheom uses Python identifier tempRheom
    __tempRheom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tempRheom'), 'tempRheom', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriestempRheom', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 26, 3), )

    
    tempRheom = property(__tempRheom.value, __tempRheom.set, None, 'Rheometer temperature.  ')

    
    # Element {http://www.witsml.org/schemas/1series}presRheom uses Python identifier presRheom
    __presRheom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'presRheom'), 'presRheom', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriespresRheom', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 31, 3), )

    
    presRheom = property(__presRheom.value, __presRheom.set, None, 'Rheometer pressure.  ')

    
    # Element {http://www.witsml.org/schemas/1series}vis3Rpm uses Python identifier vis3Rpm
    __vis3Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'vis3Rpm'), 'vis3Rpm', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesvis3Rpm', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 36, 3), )

    
    vis3Rpm = property(__vis3Rpm.value, __vis3Rpm.set, None, '3 RPM viscometer reading  ')

    
    # Element {http://www.witsml.org/schemas/1series}vis6Rpm uses Python identifier vis6Rpm
    __vis6Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'vis6Rpm'), 'vis6Rpm', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesvis6Rpm', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 41, 3), )

    
    vis6Rpm = property(__vis6Rpm.value, __vis6Rpm.set, None, '6 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/1series}vis100Rpm uses Python identifier vis100Rpm
    __vis100Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'vis100Rpm'), 'vis100Rpm', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesvis100Rpm', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 46, 3), )

    
    vis100Rpm = property(__vis100Rpm.value, __vis100Rpm.set, None, '100 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/1series}vis200Rpm uses Python identifier vis200Rpm
    __vis200Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'vis200Rpm'), 'vis200Rpm', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesvis200Rpm', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 51, 3), )

    
    vis200Rpm = property(__vis200Rpm.value, __vis200Rpm.set, None, '200 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/1series}vis300Rpm uses Python identifier vis300Rpm
    __vis300Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'vis300Rpm'), 'vis300Rpm', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesvis300Rpm', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 56, 3), )

    
    vis300Rpm = property(__vis300Rpm.value, __vis300Rpm.set, None, '300 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/1series}vis600Rpm uses Python identifier vis600Rpm
    __vis600Rpm = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'vis600Rpm'), 'vis600Rpm', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesvis600Rpm', False, pyxb.utils.utility.Location('cs_rheometer.xsd', 61, 3), )

    
    vis600Rpm = property(__vis600Rpm.value, __vis600Rpm.set, None, '600 RPM viscometer reading.  ')

    
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_rheometer_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_rheometer.xsd', 66, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_rheometer_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    ...
    _ElementMap.update({
        __tempRheom.name() : __tempRheom,
        __presRheom.name() : __presRheom,
        __vis3Rpm.name() : __vis3Rpm,
        __vis6Rpm.name() : __vis6Rpm,
        __vis100Rpm.name() : __vis100Rpm,
        __vis200Rpm.name() : __vis200Rpm,
        __vis300Rpm.name() : __vis300Rpm,
        __vis600Rpm.name() : __vis600Rpm,
        __extensionNameValue.name() : __extensionNameValue
    })
    _AttributeMap.update({
        __uid.name() : __uid
    })
_module_typeBindings.cs_rheometer = cs_rheometer
Namespace.addCategoryObject('typeBinding', 'cs_rheometer', cs_rheometer)


# Complex type {http://www.witsml.org/schemas/1series}obj_fluidsReport with content type ELEMENT_ONLY
class obj_fluidsReport (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/1series}obj_fluidsReport with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_fluidsReport')
    _XSDLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 70, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}dTim uses Python identifier dTim
    __dTim = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTim'), 'dTim', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesdTim', False, pyxb.utils.utility.Location('grp_fluidsReport.xsd', 25, 3), )

    
    dTim = property(__dTim.value, __dTim.set, None, 'Date and time the information is related to.  ')

    
    # Element {http://www.witsml.org/schemas/1series}md uses Python identifier md
    __md = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'md'), 'md', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesmd', False, pyxb.utils.utility.Location('grp_fluidsReport.xsd', 30, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}tvd uses Python identifier tvd
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvd'), 'tvd', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriestvd', False, pyxb.utils.utility.Location('grp_fluidsReport.xsd', 35, 3), )

    
    tvd = property(__tvd.value, __tvd.set, None, 'Vertical depth of the measurements.  ')

    
    # Element {http://www.witsml.org/schemas/1series}numReport uses Python identifier numReport
    __numReport = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numReport'), 'numReport', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesnumReport', False, pyxb.utils.utility.Location('grp_fluidsReport.xsd', 40, 3), )

    
    numReport = property(__numReport.value, __numReport.set, None, 'Fluids report number.  ')

    
    # Element {http://www.witsml.org/schemas/1series}fluid uses Python identifier fluid
    __fluid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'fluid'), 'fluid', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesfluid', True, pyxb.utils.utility.Location('grp_fluidsReport.xsd', 45, 3), )

    
    fluid = property(__fluid.value, __fluid.set, None, 'A Fluid record.  ')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 72, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 77, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, 'Human recognizable context for the wellbore that contains the fluids report.  ')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 82, 3), )

    
    name = property(__name.value, __name.set, None, 'Human recognizable context for the fluids report.  ')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 92, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_fluidsReport.xsd', 98, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 105, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 105, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_fluidsReport_uidWellbore', _module_typeBindings.uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 112, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_fluidsReport.xsd', 112, 2)
    ...
    _ElementMap.update({
        ...
        __md.name() : __md,
        __tvd.name() : __tvd,
        __numReport.name() : __numReport,
        __fluid.name() : __fluid,
...
_module_typeBindings.obj_fluidsReport = obj_fluidsReport
Namespace.addCategoryObject('typeBinding', 'obj_fluidsReport', obj_fluidsReport)
...
fluidsReports = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'fluidsReports'), obj_fluidsReports, documentation='The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 32, 1))
Namespace.addCategoryObject('elementBinding', fluidsReports.name().localName(), fluidsReports)
...
obj_fluidsReports._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_fluidsReports, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 48, 5)))

obj_fluidsReports._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'fluidsReport'), obj_fluidsReport, scope=obj_fluidsReports, documentation='A single fluids report.  ', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReports._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReports._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'fluidsReport')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_fluidsReports._Automaton = _BuildAutomaton_6()
...
cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), str32, scope=cs_fluid, documentation='Description for the type of fluid.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 27, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'locationSample'), str32, scope=cs_fluid, documentation='Sample location.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 33, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTim'), timestamp, scope=cs_fluid, documentation='The time when fluid readings were recorded. ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 38, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'md'), measuredDepthCoord, scope=cs_fluid, documentation='The measured depth where the fluid readings were recorded.', location=pyxb.utils.utility.Location('cs_fluid.xsd', 43, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvd'), wellVerticalDepthCoord, scope=cs_fluid, documentation='The true vertical depth where the fluid readings were recorded.', location=pyxb.utils.utility.Location('cs_fluid.xsd', 49, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'presBopRating'), pressureMeasure, scope=cs_fluid, documentation='Maximum pressure rating of the blow out preventer.', location=pyxb.utils.utility.Location('cs_fluid.xsd', 55, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mudClass'), MudClass, scope=cs_fluid, documentation='The class of the drilling fluid.', location=pyxb.utils.utility.Location('cs_fluid.xsd', 61, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'density'), densityMeasure, scope=cs_fluid, documentation='Fluid density.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 67, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'visFunnel'), timeMeasure, scope=cs_fluid, documentation='Funnel viscosity in seconds.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 72, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tempVis'), thermodynamicTemperatureMeasure, scope=cs_fluid, documentation='Funnel viscosity temperature.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 77, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pv'), dynamicViscosityMeasure, scope=cs_fluid, documentation='Plastic viscosity.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 82, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'yp'), pressureMeasure, scope=cs_fluid, documentation='Yield point (Bingham and Herschel Bulkley models).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 87, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gel10Sec'), pressureMeasure, scope=cs_fluid, documentation='10 second gels.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 92, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gel10Min'), pressureMeasure, scope=cs_fluid, documentation='10 minute gels.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 97, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'gel30Min'), pressureMeasure, scope=cs_fluid, documentation='30 minute gels.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 102, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'filterCakeLtlp'), lengthMeasure, scope=cs_fluid, documentation='Filter cake thickness at low (normal) temperature and pressure.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 107, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'filtrateLtlp'), volumeMeasure, scope=cs_fluid, documentation='API water loss (low temperature and pressure mud filtrate measurement) (volume per 30min).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 112, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tempHthp'), thermodynamicTemperatureMeasure, scope=cs_fluid, documentation='High temperature high pressure (HTHP) temperature.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 118, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'presHthp'), pressureMeasure, scope=cs_fluid, documentation='High temperature high pressure (HTHP) pressure.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 123, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'filtrateHthp'), volumeMeasure, scope=cs_fluid, documentation='High temperature high pressure (HTHP) filtrate (volume per 30min).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 128, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'filterCakeHthp'), lengthMeasure, scope=cs_fluid, documentation='High temperature high pressure (HTHP) Filter cake thickness.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 133, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'solidsPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Solids percentage from retort (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 138, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'waterPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Water content (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 143, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'oilPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Oil content from retort (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 148, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sandPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Sand content (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 153, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'solidsLowGravPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Low gravity solids (%).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 158, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'solidsCalcPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Solids content (calculated) (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 163, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'baritePc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Barite content (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 168, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lcm'), densityMeasure, scope=cs_fluid, documentation='Lost circulation material.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 173, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mbt'), equivalentPerMassMeasure, scope=cs_fluid, documentation='Cation exchange capacity (CEC) of the mud sample as measured by methylene blue titration (MBT).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 178, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ph'), unitlessQuantity, scope=cs_fluid, documentation='Mud pH.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 183, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tempPh'), thermodynamicTemperatureMeasure, scope=cs_fluid, documentation='Mud pH measurement temperature.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 188, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pm'), volumeMeasure, scope=cs_fluid, documentation='Phenolphthalein alkalinity of whole mud.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 193, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'pmFiltrate'), volumeMeasure, scope=cs_fluid, documentation='Phenolphthalein alkalinity of mud filtrate.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 198, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mf'), volumeMeasure, scope=cs_fluid, documentation='Methyl orange alkalinity of filtrate.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 203, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'alkalinityP1'), volumeMeasure, scope=cs_fluid, documentation='Mud alkalinity P1 from alternate alkalinity method (volume in ml of 0.02N acid \n\t\t\t\t\tto reach the phenolphthalein endpoint).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 208, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'alkalinityP2'), volumeMeasure, scope=cs_fluid, documentation='Mud alkalinity P2 from alternate alkalinity method (volume in ml of 0.02N acid\n\t\t\t\t\tto titrate the reagent mixture to the phenolphthalein endpoint).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 214, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'chloride'), densityMeasure, scope=cs_fluid, documentation='Chloride content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 220, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'calcium'), densityMeasure, scope=cs_fluid, documentation='Calcium content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 225, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'magnesium'), densityMeasure, scope=cs_fluid, documentation='Magnesium content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 230, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'potassium'), densityMeasure, scope=cs_fluid, documentation='Potassium content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 235, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rheometer'), cs_rheometer, scope=cs_fluid, documentation='One or more sets of rheometer readings at given temperature and pressure.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 240, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'brinePc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Brine content (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 245, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lime'), densityMeasure, scope=cs_fluid, documentation='Lime content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 250, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'electStab'), electricPotentialMeasure, scope=cs_fluid, documentation='Measurement of the emulsion stability and oil-wetting capability in oil-based muds.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 255, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'calciumChloride'), densityMeasure, scope=cs_fluid, documentation='Calcium chloride content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 260, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'company'), str32, scope=cs_fluid, documentation='Name of company.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 265, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'engineer'), nameString, scope=cs_fluid, documentation='Engineer name  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 270, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'asg'), unitlessQuantity, scope=cs_fluid, documentation='Average specific gravity of solids.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 275, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'solidsHiGravPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Solids high gravity (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 280, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'polymer'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Polymers present in mud system.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 285, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'polyType'), str32, scope=cs_fluid, documentation='Type of polymers present in mud system.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 290, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'solCorPc'), volumePerVolumeMeasure, scope=cs_fluid, documentation='Solids corrected for Chloride content (commonly in percent).  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 295, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'oilCtg'), massConcentrationMeasure, scope=cs_fluid, documentation='Oil on Cuttings.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 300, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'hardnessCa'), massConcentrationMeasure, scope=cs_fluid, documentation='Total calcium hardness.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 305, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sulfide'), densityMeasure, scope=cs_fluid, documentation='Sulfide content.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 310, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comments'), commentString, scope=cs_fluid, documentation='Comments and remarks.  ', location=pyxb.utils.utility.Location('cs_fluid.xsd', 315, 3)))

cs_fluid._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_fluid, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_fluid.xsd', 320, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 27, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 33, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 38, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 43, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 49, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 55, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 61, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 67, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 72, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 77, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 82, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 87, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 92, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 97, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 102, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 107, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 112, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 118, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 123, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 128, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 133, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 138, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 143, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 148, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 153, 3))
    counters.add(cc_24)
    cc_25 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 158, 3))
    counters.add(cc_25)
    cc_26 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 163, 3))
    counters.add(cc_26)
    cc_27 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 168, 3))
    counters.add(cc_27)
    cc_28 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 173, 3))
    counters.add(cc_28)
    cc_29 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 178, 3))
    counters.add(cc_29)
    cc_30 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 183, 3))
    counters.add(cc_30)
    cc_31 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 188, 3))
    counters.add(cc_31)
    cc_32 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 193, 3))
    counters.add(cc_32)
    cc_33 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 198, 3))
    counters.add(cc_33)
    cc_34 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 203, 3))
    counters.add(cc_34)
    cc_35 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 208, 3))
    counters.add(cc_35)
    cc_36 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 214, 3))
    counters.add(cc_36)
    cc_37 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 220, 3))
    counters.add(cc_37)
    cc_38 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 225, 3))
    counters.add(cc_38)
    cc_39 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 230, 3))
    counters.add(cc_39)
    cc_40 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 235, 3))
    counters.add(cc_40)
    cc_41 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 240, 3))
    counters.add(cc_41)
    cc_42 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 245, 3))
    counters.add(cc_42)
    cc_43 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 250, 3))
    counters.add(cc_43)
    cc_44 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 255, 3))
    counters.add(cc_44)
    cc_45 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 260, 3))
    counters.add(cc_45)
    cc_46 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 265, 3))
    counters.add(cc_46)
    cc_47 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 270, 3))
    counters.add(cc_47)
    cc_48 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 275, 3))
    counters.add(cc_48)
    cc_49 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 280, 3))
    counters.add(cc_49)
    cc_50 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 285, 3))
    counters.add(cc_50)
    cc_51 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 290, 3))
    counters.add(cc_51)
    cc_52 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 295, 3))
    counters.add(cc_52)
    cc_53 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 300, 3))
    counters.add(cc_53)
    cc_54 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 305, 3))
    counters.add(cc_54)
    cc_55 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 310, 3))
    counters.add(cc_55)
    cc_56 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 315, 3))
    counters.add(cc_56)
    cc_57 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_fluid.xsd', 320, 3))
    counters.add(cc_57)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('cs_fluid.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'locationSample')), pyxb.utils.utility.Location('cs_fluid.xsd', 33, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTim')), pyxb.utils.utility.Location('cs_fluid.xsd', 38, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'md')), pyxb.utils.utility.Location('cs_fluid.xsd', 43, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvd')), pyxb.utils.utility.Location('cs_fluid.xsd', 49, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'presBopRating')), pyxb.utils.utility.Location('cs_fluid.xsd', 55, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mudClass')), pyxb.utils.utility.Location('cs_fluid.xsd', 61, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'density')), pyxb.utils.utility.Location('cs_fluid.xsd', 67, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'visFunnel')), pyxb.utils.utility.Location('cs_fluid.xsd', 72, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tempVis')), pyxb.utils.utility.Location('cs_fluid.xsd', 77, 3))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pv')), pyxb.utils.utility.Location('cs_fluid.xsd', 82, 3))
    st_10 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'yp')), pyxb.utils.utility.Location('cs_fluid.xsd', 87, 3))
    st_11 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gel10Sec')), pyxb.utils.utility.Location('cs_fluid.xsd', 92, 3))
    st_12 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gel10Min')), pyxb.utils.utility.Location('cs_fluid.xsd', 97, 3))
    st_13 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'gel30Min')), pyxb.utils.utility.Location('cs_fluid.xsd', 102, 3))
    st_14 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'filterCakeLtlp')), pyxb.utils.utility.Location('cs_fluid.xsd', 107, 3))
    st_15 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'filtrateLtlp')), pyxb.utils.utility.Location('cs_fluid.xsd', 112, 3))
    st_16 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tempHthp')), pyxb.utils.utility.Location('cs_fluid.xsd', 118, 3))
    st_17 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'presHthp')), pyxb.utils.utility.Location('cs_fluid.xsd', 123, 3))
    st_18 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'filtrateHthp')), pyxb.utils.utility.Location('cs_fluid.xsd', 128, 3))
    st_19 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'filterCakeHthp')), pyxb.utils.utility.Location('cs_fluid.xsd', 133, 3))
    st_20 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'solidsPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 138, 3))
    st_21 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'waterPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 143, 3))
    st_22 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'oilPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 148, 3))
    st_23 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sandPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 153, 3))
    st_24 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_25, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'solidsLowGravPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 158, 3))
    st_25 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_26, False))
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'solidsCalcPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 163, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'baritePc')), pyxb.utils.utility.Location('cs_fluid.xsd', 168, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lcm')), pyxb.utils.utility.Location('cs_fluid.xsd', 173, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mbt')), pyxb.utils.utility.Location('cs_fluid.xsd', 178, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ph')), pyxb.utils.utility.Location('cs_fluid.xsd', 183, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tempPh')), pyxb.utils.utility.Location('cs_fluid.xsd', 188, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pm')), pyxb.utils.utility.Location('cs_fluid.xsd', 193, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'pmFiltrate')), pyxb.utils.utility.Location('cs_fluid.xsd', 198, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mf')), pyxb.utils.utility.Location('cs_fluid.xsd', 203, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'alkalinityP1')), pyxb.utils.utility.Location('cs_fluid.xsd', 208, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'alkalinityP2')), pyxb.utils.utility.Location('cs_fluid.xsd', 214, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'chloride')), pyxb.utils.utility.Location('cs_fluid.xsd', 220, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'calcium')), pyxb.utils.utility.Location('cs_fluid.xsd', 225, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'magnesium')), pyxb.utils.utility.Location('cs_fluid.xsd', 230, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'potassium')), pyxb.utils.utility.Location('cs_fluid.xsd', 235, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rheometer')), pyxb.utils.utility.Location('cs_fluid.xsd', 240, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'brinePc')), pyxb.utils.utility.Location('cs_fluid.xsd', 245, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lime')), pyxb.utils.utility.Location('cs_fluid.xsd', 250, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'electStab')), pyxb.utils.utility.Location('cs_fluid.xsd', 255, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'calciumChloride')), pyxb.utils.utility.Location('cs_fluid.xsd', 260, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'company')), pyxb.utils.utility.Location('cs_fluid.xsd', 265, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'engineer')), pyxb.utils.utility.Location('cs_fluid.xsd', 270, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'asg')), pyxb.utils.utility.Location('cs_fluid.xsd', 275, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'solidsHiGravPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 280, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'polymer')), pyxb.utils.utility.Location('cs_fluid.xsd', 285, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'polyType')), pyxb.utils.utility.Location('cs_fluid.xsd', 290, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'solCorPc')), pyxb.utils.utility.Location('cs_fluid.xsd', 295, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'oilCtg')), pyxb.utils.utility.Location('cs_fluid.xsd', 300, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'hardnessCa')), pyxb.utils.utility.Location('cs_fluid.xsd', 305, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sulfide')), pyxb.utils.utility.Location('cs_fluid.xsd', 310, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comments')), pyxb.utils.utility.Location('cs_fluid.xsd', 315, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_fluid._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_fluid.xsd', 320, 3))
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
cs_fluid._Automaton = _BuildAutomaton_10()




cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tempRheom'), thermodynamicTemperatureMeasure, scope=cs_rheometer, documentation='Rheometer temperature.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 26, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'presRheom'), pressureMeasure, scope=cs_rheometer, documentation='Rheometer pressure.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 31, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'vis3Rpm'), unitlessQuantity, scope=cs_rheometer, documentation='3 RPM viscometer reading  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 36, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'vis6Rpm'), unitlessQuantity, scope=cs_rheometer, documentation='6 RPM viscometer reading.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 41, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'vis100Rpm'), unitlessQuantity, scope=cs_rheometer, documentation='100 RPM viscometer reading.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 46, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'vis200Rpm'), unitlessQuantity, scope=cs_rheometer, documentation='200 RPM viscometer reading.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 51, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'vis300Rpm'), unitlessQuantity, scope=cs_rheometer, documentation='300 RPM viscometer reading.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 56, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'vis600Rpm'), unitlessQuantity, scope=cs_rheometer, documentation='600 RPM viscometer reading.  ', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 61, 3)))

cs_rheometer._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_rheometer, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_rheometer.xsd', 66, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 26, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 31, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 36, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 41, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 46, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 51, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 56, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 61, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_rheometer.xsd', 66, 3))
    counters.add(cc_8)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tempRheom')), pyxb.utils.utility.Location('cs_rheometer.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'presRheom')), pyxb.utils.utility.Location('cs_rheometer.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'vis3Rpm')), pyxb.utils.utility.Location('cs_rheometer.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'vis6Rpm')), pyxb.utils.utility.Location('cs_rheometer.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'vis100Rpm')), pyxb.utils.utility.Location('cs_rheometer.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'vis200Rpm')), pyxb.utils.utility.Location('cs_rheometer.xsd', 51, 3))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'vis300Rpm')), pyxb.utils.utility.Location('cs_rheometer.xsd', 56, 3))
    st_6 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'vis600Rpm')), pyxb.utils.utility.Location('cs_rheometer.xsd', 61, 3))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_rheometer._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_rheometer.xsd', 66, 3))
    st_8 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_8._set_transitionSet(transitions)
    return fac.Automaton(states, counters, True, containing_state=None)
cs_rheometer._Automaton = _BuildAutomaton_11()




obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTim'), timestamp, scope=obj_fluidsReport, documentation='Date and time the information is related to.  ', location=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 25, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'md'), measuredDepthCoord, scope=obj_fluidsReport, documentation='Along hole measured depth of measurement from the drill datum.  ', location=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 30, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvd'), wellVerticalDepthCoord, scope=obj_fluidsReport, documentation='Vertical depth of the measurements.  ', location=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 35, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numReport'), positiveCount, scope=obj_fluidsReport, documentation='Fluids report number.  ', location=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 40, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'fluid'), cs_fluid, scope=obj_fluidsReport, documentation='A Fluid record.  ', location=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 45, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_fluidsReport, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 72, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_fluidsReport, documentation='Human recognizable context for the wellbore that contains the fluids report.  ', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 77, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_fluidsReport, documentation='Human recognizable context for the fluids report.  ', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 82, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_fluidsReport, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 92, 3)))

obj_fluidsReport._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_fluidsReport, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 98, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 87, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 35, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 40, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_fluidsReport.xsd', 45, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 92, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_fluidsReport.xsd', 98, 3))
    counters.add(cc_5)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 72, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 77, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 82, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTim')), pyxb.utils.utility.Location('grp_fluidsReport.xsd', 25, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'md')), pyxb.utils.utility.Location('grp_fluidsReport.xsd', 30, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvd')), pyxb.utils.utility.Location('grp_fluidsReport.xsd', 35, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numReport')), pyxb.utils.utility.Location('grp_fluidsReport.xsd', 40, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'fluid')), pyxb.utils.utility.Location('grp_fluidsReport.xsd', 45, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 92, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_fluidsReport._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_fluidsReport.xsd', 98, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_9._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_fluidsReport._Automaton = _BuildAutomaton_12()


fluidsReports._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
