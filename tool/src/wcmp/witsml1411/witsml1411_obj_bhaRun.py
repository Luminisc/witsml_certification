...
# Complex type {http://www.witsml.org/schemas/1series}obj_bhaRuns with content type ELEMENT_ONLY
class obj_bhaRuns (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_bhaRuns')
    _XSDLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_bhaRuns_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_bhaRun.xsd', 48, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, 'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}bhaRun uses Python identifier bhaRun
    __bhaRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'bhaRun'), 'bhaRun', '__httpwww_witsml_orgschemas1series_obj_bhaRuns_httpwww_witsml_orgschemas1seriesbhaRun', True, pyxb.utils.utility.Location('obj_bhaRun.xsd', 53, 5), )

    
    bhaRun = property(__bhaRun.value, __bhaRun.set, None, 'A single bottom hole assembly run. \n\t\t\t\t\t\t\tThis represents the period beginning when the BHA enters the hole until it leaves the hole. ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_bhaRuns_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 61, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 61, 4)
...
_module_typeBindings.obj_bhaRuns = obj_bhaRuns
...
# Complex type {http://www.witsml.org/schemas/1series}obj_bhaRun with content type ELEMENT_ONLY
class obj_bhaRun (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 72, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}tubular uses Python identifier tubular
    __tubular = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tubular'), 'tubular', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriestubular', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 26, 3), )
    ...
    __dTimStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimStart'), 'dTimStart', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesdTimStart', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 32, 3), )

    
    dTimStart = property(__dTimStart.value, __dTimStart.set, None, 'Date and time that activities started.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dTimStop uses Python identifier dTimStop
    __dTimStop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimStop'), 'dTimStop', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesdTimStop', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 37, 3), )

    
    dTimStop = property(__dTimStop.value, __dTimStop.set, None, 'Date and time that activities stopped.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dTimStartDrilling uses Python identifier dTimStartDrilling
    __dTimStartDrilling = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimStartDrilling'), 'dTimStartDrilling', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesdTimStartDrilling', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 42, 3), )

    
    dTimStartDrilling = property(__dTimStartDrilling.value, __dTimStartDrilling.set, None, 'Start on bottom - date and time.  ')

    
    # Element {http://www.witsml.org/schemas/1series}dTimStopDrilling uses Python identifier dTimStopDrilling
    __dTimStopDrilling = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimStopDrilling'), 'dTimStopDrilling', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesdTimStopDrilling', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 47, 3), )

    
    dTimStopDrilling = property(__dTimStopDrilling.value, __dTimStopDrilling.set, None, 'Start off bottom - date and time.  ')

    
    # Element {http://www.witsml.org/schemas/1series}planDogleg uses Python identifier planDogleg
    __planDogleg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'planDogleg'), 'planDogleg', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesplanDogleg', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 52, 3), )

    
    planDogleg = property(__planDogleg.value, __planDogleg.set, None, 'Planned dogleg severity.  ')

    
    # Element {http://www.witsml.org/schemas/1series}actDogleg uses Python identifier actDogleg
    __actDogleg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'actDogleg'), 'actDogleg', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesactDogleg', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 57, 3), )

    
    actDogleg = property(__actDogleg.value, __actDogleg.set, None, 'Actual dogleg severity.  ')

    
    # Element {http://www.witsml.org/schemas/1series}actDoglegMx uses Python identifier actDoglegMx
    __actDoglegMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'actDoglegMx'), 'actDoglegMx', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesactDoglegMx', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 62, 3), )

    
    actDoglegMx = property(__actDoglegMx.value, __actDoglegMx.set, None, 'Actual dogleg severity - Maximum.  ')

    
    # Element {http://www.witsml.org/schemas/1series}statusBha uses Python identifier statusBha
    __statusBha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'statusBha'), 'statusBha', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesstatusBha', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 67, 3), )

    
    statusBha = property(__statusBha.value, __statusBha.set, None, 'Bottom hole assembly status.')

    
    # Element {http://www.witsml.org/schemas/1series}numBitRun uses Python identifier numBitRun
    __numBitRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numBitRun'), 'numBitRun', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesnumBitRun', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 72, 3), )

    
    numBitRun = property(__numBitRun.value, __numBitRun.set, None, 'Bit run number.  ')

    
    # Element {http://www.witsml.org/schemas/1series}numStringRun uses Python identifier numStringRun
    __numStringRun = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'numStringRun'), 'numStringRun', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesnumStringRun', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 77, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}reasonTrip uses Python identifier reasonTrip
    __reasonTrip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'reasonTrip'), 'reasonTrip', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesreasonTrip', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 82, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}objectiveBha uses Python identifier objectiveBha
    __objectiveBha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectiveBha'), 'objectiveBha', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesobjectiveBha', False, pyxb.utils.utility.Location('grp_bhaRun.xsd', 87, 3), )

    
    objectiveBha = property(__objectiveBha.value, __objectiveBha.set, None, 'Objective of bottom hole assembly.  ')

    
    # Element {http://www.witsml.org/schemas/1series}drillingParams uses Python identifier drillingParams
    __drillingParams = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'drillingParams'), 'drillingParams', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesdrillingParams', True, pyxb.utils.utility.Location('grp_bhaRun.xsd', 92, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_bhaRun.xsd', 74, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_bhaRun.xsd', 79, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_bhaRun.xsd', 84, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_bhaRun.xsd', 94, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_bhaRun_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_bhaRun.xsd', 100, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_bhaRun_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_bhaRun_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 107, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 107, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_bhaRun_uidWellbore', _module_typeBindings.uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 114, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_bhaRun.xsd', 114, 2)
...
_module_typeBindings.obj_bhaRun = obj_bhaRun
...
obj_bhaRuns._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_bhaRuns, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 48, 5)))

obj_bhaRuns._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'bhaRun'), obj_bhaRun, scope=obj_bhaRuns, documentation='A single bottom hole assembly run. \n\t\t\t\t\t\t\tThis represents the period beginning when the BHA enters the hole until it leaves the hole. ', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_bhaRun.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_bhaRuns._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_bhaRuns._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'bhaRun')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_bhaRuns._Automaton = _BuildAutomaton_6()
...
obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tubular'), refNameString, scope=obj_bhaRun, documentation='This represents a foreign key to the tubular (assembly) \n\t\t\t\t\tthat was utilized in this run.', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 26, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimStart'), timestamp, scope=obj_bhaRun, documentation='Date and time that activities started.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 32, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimStop'), timestamp, scope=obj_bhaRun, documentation='Date and time that activities stopped.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 37, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimStartDrilling'), timestamp, scope=obj_bhaRun, documentation='Start on bottom - date and time.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 42, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimStopDrilling'), timestamp, scope=obj_bhaRun, documentation='Start off bottom - date and time.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 47, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'planDogleg'), anglePerLengthMeasure, scope=obj_bhaRun, documentation='Planned dogleg severity.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 52, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'actDogleg'), anglePerLengthMeasure, scope=obj_bhaRun, documentation='Actual dogleg severity.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 57, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'actDoglegMx'), anglePerLengthMeasure, scope=obj_bhaRun, documentation='Actual dogleg severity - Maximum.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 62, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'statusBha'), BhaStatus, scope=obj_bhaRun, documentation='Bottom hole assembly status.', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 67, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numBitRun'), nameString, scope=obj_bhaRun, documentation='Bit run number.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 72, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'numStringRun'), positiveCount, scope=obj_bhaRun, documentation='The BHA (drilling string) run number. ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 77, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'reasonTrip'), commentString, scope=obj_bhaRun, documentation='Reason for trip.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 82, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectiveBha'), commentString, scope=obj_bhaRun, documentation='Objective of bottom hole assembly.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 87, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'drillingParams'), cs_drillingParams, scope=obj_bhaRun, documentation='Drilling parameters.  ', location=pyxb.utils.utility.Location('grp_bhaRun.xsd', 92, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_bhaRun, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 74, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_bhaRun, documentation='Human recognizable context for the wellbore that contains the bottom hole assembly. ', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 79, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_bhaRun, documentation='Human recognizable context for the run.  ', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 84, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_bhaRun, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 94, 3)))

obj_bhaRun._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_bhaRun, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_bhaRun.xsd', 100, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_bhaRun.xsd', 89, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 32, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 37, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 42, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 47, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 52, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 57, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 62, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 67, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 72, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 77, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 82, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 87, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_bhaRun.xsd', 92, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_bhaRun.xsd', 94, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_bhaRun.xsd', 100, 3))
    counters.add(cc_15)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 74, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 79, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 84, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tubular')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 26, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimStart')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 32, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimStop')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 37, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimStartDrilling')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 42, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimStopDrilling')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 47, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'planDogleg')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 52, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'actDogleg')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 57, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'actDoglegMx')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 62, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'statusBha')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 67, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numBitRun')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 72, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'numStringRun')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 77, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'reasonTrip')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 82, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectiveBha')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 87, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'drillingParams')), pyxb.utils.utility.Location('grp_bhaRun.xsd', 92, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 94, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_bhaRun._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_bhaRun.xsd', 100, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_18._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_bhaRun._Automaton = _BuildAutomaton_11()


bhaRuns._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
