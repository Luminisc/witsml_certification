# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_formationMarker.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:16:21.208132 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:b08ed673-02c3-4425-bb30-9579886acc6d')
...
class obj_formationMarkers (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_formationMarkers')
    _XSDLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_formationMarkers_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 48, 5), )
    ...
    __formationMarker = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'formationMarker'), 'formationMarker', '__httpwww_witsml_orgschemas1series_obj_formationMarkers_httpwww_witsml_orgschemas1seriesformationMarker', True, pyxb.utils.utility.Location('obj_formationMarker.xsd', 53, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_formationMarkers_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 59, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 59, 4)
...
_module_typeBindings.obj_formationMarkers = obj_formationMarkers
...
class obj_formationMarker (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 70, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}mdPrognosed uses Python identifier mdPrognosed
    __mdPrognosed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdPrognosed'), 'mdPrognosed', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesmdPrognosed', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 25, 3), )
    ...
    __tvdPrognosed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdPrognosed'), 'tvdPrognosed', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriestvdPrognosed', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 30, 3), )
    ...
    __mdTopSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdTopSample'), 'mdTopSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesmdTopSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 35, 3), )
    ...
    __tvdTopSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdTopSample'), 'tvdTopSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriestvdTopSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 40, 3), )
    ...
    __thicknessBed = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed'), 'thicknessBed', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesthicknessBed', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 45, 3), )

    
    thicknessBed = property(__thicknessBed.value, __thicknessBed.set, None, 'Vertical thickness.')

    
    # Element {http://www.witsml.org/schemas/1series}thicknessApparent uses Python identifier thicknessApparent
    __thicknessApparent = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thicknessApparent'), 'thicknessApparent', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesthicknessApparent', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 50, 3), )
    ...
    __thicknessPerpen = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen'), 'thicknessPerpen', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesthicknessPerpen', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 55, 3), )

    
    thicknessPerpen = property(__thicknessPerpen.value, __thicknessPerpen.set, None, 'True Stratigraphic thickness.')

    
    # Element {http://www.witsml.org/schemas/1series}mdLogSample uses Python identifier mdLogSample
    __mdLogSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdLogSample'), 'mdLogSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesmdLogSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 60, 3), )
    ...
    __tvdLogSample = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdLogSample'), 'tvdLogSample', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriestvdLogSample', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 65, 3), )
    ...
    __dip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dip'), 'dip', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdip', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 70, 3), )
    ...
    __dipDirection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dipDirection'), 'dipDirection', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdipDirection', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 75, 3), )

    
    dipDirection = property(__dipDirection.value, __dipDirection.set, None, 'Interpreted downdip direction.  ')

    
    # Element {http://www.witsml.org/schemas/1series}lithostratigraphic uses Python identifier lithostratigraphic
    __lithostratigraphic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lithostratigraphic'), 'lithostratigraphic', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1serieslithostratigraphic', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 80, 3), )

    
    lithostratigraphic = property(__lithostratigraphic.value, __lithostratigraphic.set, None, 'Lithostratigraphic classification.  ')

    
    # Element {http://www.witsml.org/schemas/1series}chronostratigraphic uses Python identifier chronostratigraphic
    __chronostratigraphic = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic'), 'chronostratigraphic', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1serieschronostratigraphic', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 86, 3), )
    ...
    __nameFormation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), 'nameFormation', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameFormation', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 92, 3), )

    
    nameFormation = property(__nameFormation.value, __nameFormation.set, None, 'DEPRECATED. Formerly defined as name of formation penetrated, now deprecated to be replaced by\n\t\t\t\t\tlithostratigraphic with kind=formation.  ')

    
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('grp_formationMarker.xsd', 99, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 72, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 82, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 92, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_formationMarker_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_formationMarker.xsd', 98, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_formationMarker_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_formationMarker_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 105, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 105, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_formationMarker_uidWellbore', _module_typeBindings.uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 112, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_formationMarker.xsd', 112, 2)
    ...
    _ElementMap.update({
        ...
        __lithostratigraphic.name() : __lithostratigraphic,
...
_module_typeBindings.obj_formationMarker = obj_formationMarker
...
obj_formationMarkers._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_formationMarkers, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 48, 5)))

obj_formationMarkers._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'formationMarker'), obj_formationMarker, scope=obj_formationMarkers, documentation='A single formation marker.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarkers._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_formationMarkers._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'formationMarker')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdPrognosed'), measuredDepthCoord, scope=obj_formationMarker, documentation='Prognosed measured depth.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 25, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdPrognosed'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation='Prognosed true vertical depth.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 30, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdTopSample'), measuredDepthCoord, scope=obj_formationMarker, documentation='Sampled measured depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 35, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdTopSample'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation='Sampled true vertical depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 40, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed'), lengthMeasure, scope=obj_formationMarker, documentation='Vertical thickness.', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 45, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessApparent'), lengthMeasure, scope=obj_formationMarker, documentation='Formation exposed along the wellbore.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 50, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen'), lengthMeasure, scope=obj_formationMarker, documentation='True Stratigraphic thickness.', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 55, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdLogSample'), measuredDepthCoord, scope=obj_formationMarker, documentation='Logged measured depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 60, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdLogSample'), wellVerticalDepthCoord, scope=obj_formationMarker, documentation='Logged true vertical depth at top of marker.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 65, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dip'), planeAngleMeasure, scope=obj_formationMarker, documentation='Angle of dip with respect to horizontal.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 70, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dipDirection'), planeAngleMeasure, scope=obj_formationMarker, documentation='Interpreted downdip direction.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 75, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lithostratigraphic'), lithostratigraphyStruct, scope=obj_formationMarker, documentation='Lithostratigraphic classification.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 80, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic'), chronostratigraphyStruct, scope=obj_formationMarker, documentation='Chronostratigraphic classification.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 86, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameFormation'), nameString, scope=obj_formationMarker, documentation='DEPRECATED. Formerly defined as name of formation penetrated, now deprecated to be replaced by\n\t\t\t\t\tlithostratigraphic with kind=formation.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 92, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'description'), commentString, scope=obj_formationMarker, documentation='Description of item and details.  ', location=pyxb.utils.utility.Location('grp_formationMarker.xsd', 99, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_formationMarker, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 72, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_formationMarker, documentation='Human recognizable context for the wellbore that contains the formation marker.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_formationMarker, documentation='Human recognizable context for the formation marker.  ', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 82, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_formationMarker, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 92, 3)))

obj_formationMarker._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_formationMarker, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_formationMarker.xsd', 98, 3)))
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 87, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 25, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 30, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 40, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 45, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 50, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 55, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 60, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 65, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 70, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 75, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 80, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 86, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 92, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_formationMarker.xsd', 99, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 92, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_formationMarker.xsd', 98, 3))
    counters.add(cc_16)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 72, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 77, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 82, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdPrognosed')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 25, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdPrognosed')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 30, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdTopSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 35, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdTopSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 40, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thicknessBed')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 45, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thicknessApparent')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 50, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thicknessPerpen')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 55, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdLogSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 60, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdLogSample')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 65, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dip')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 70, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dipDirection')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 75, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lithostratigraphic')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 80, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'chronostratigraphic')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 86, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameFormation')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 92, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('grp_formationMarker.xsd', 99, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 92, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_formationMarker._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_formationMarker.xsd', 98, 3))
...
formationMarkers._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
