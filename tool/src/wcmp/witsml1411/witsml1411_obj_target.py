# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_target.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:17:21.413609 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:9707c5bf-3848-4aca-abe3-201238ebcc49')
...
class obj_targets (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_targets')
    _XSDLocation = pyxb.utils.utility.Location('obj_target.xsd', 41, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_targets_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_target.xsd', 48, 5), )
    ...
    __target = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'target'), 'target', '__httpwww_witsml_orgschemas1series_obj_targets_httpwww_witsml_orgschemas1seriestarget', True, pyxb.utils.utility.Location('obj_target.xsd', 53, 5), )
    ...
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_targets_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_target.xsd', 59, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_target.xsd', 59, 4)
...
_module_typeBindings.obj_targets = obj_targets
...
class cs_location (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_location.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}wellCRS uses Python identifier wellCRS
    __wellCRS = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wellCRS'), 'wellCRS', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieswellCRS', False, pyxb.utils.utility.Location('cs_location.xsd', 37, 3), )
    ...
    __latitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'latitude'), 'latitude', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieslatitude', False, pyxb.utils.utility.Location('cs_location.xsd', 51, 5), )
    ...
    __longitude = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'longitude'), 'longitude', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieslongitude', False, pyxb.utils.utility.Location('cs_location.xsd', 56, 5), )
    ...
    __easting = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'easting'), 'easting', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieseasting', False, pyxb.utils.utility.Location('cs_location.xsd', 66, 5), )
    ...
    __northing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'northing'), 'northing', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriesnorthing', False, pyxb.utils.utility.Location('cs_location.xsd', 73, 5), )
    ...
    __westing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'westing'), 'westing', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieswesting', False, pyxb.utils.utility.Location('cs_location.xsd', 85, 5), )
    ...
    __southing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'southing'), 'southing', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriessouthing', False, pyxb.utils.utility.Location('cs_location.xsd', 93, 5), )
    ...
    __projectedX = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'projectedX'), 'projectedX', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriesprojectedX', False, pyxb.utils.utility.Location('cs_location.xsd', 106, 5), )
    ...
    __projectedY = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'projectedY'), 'projectedY', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriesprojectedY', False, pyxb.utils.utility.Location('cs_location.xsd', 115, 5), )
    ...
    __localX = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'localX'), 'localX', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieslocalX', False, pyxb.utils.utility.Location('cs_location.xsd', 129, 5), )
    ...
    __localY = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'localY'), 'localY', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1serieslocalY', False, pyxb.utils.utility.Location('cs_location.xsd', 135, 5), )
    ...
    __original = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'original'), 'original', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriesoriginal', False, pyxb.utils.utility.Location('cs_location.xsd', 143, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}description uses Python identifier description
    __description = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'description'), 'description', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriesdescription', False, pyxb.utils.utility.Location('cs_location.xsd', 151, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_location_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_location.xsd', 157, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_location_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_location = cs_location
...
class cs_targetSection (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_targetSection.xsd', 22, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}sectNumber uses Python identifier sectNumber
    __sectNumber = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'sectNumber'), 'sectNumber', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1seriessectNumber', False, pyxb.utils.utility.Location('cs_targetSection.xsd', 27, 3), )
    ...
    __typeTargetSectionScope = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeTargetSectionScope'), 'typeTargetSectionScope', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1seriestypeTargetSectionScope', False, pyxb.utils.utility.Location('cs_targetSection.xsd', 32, 3), )
    ...
    __lenRadius = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lenRadius'), 'lenRadius', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1serieslenRadius', False, pyxb.utils.utility.Location('cs_targetSection.xsd', 37, 3), )
    ...
    __angleArc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'angleArc'), 'angleArc', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1seriesangleArc', False, pyxb.utils.utility.Location('cs_targetSection.xsd', 42, 3), )
    ...
    __thickAbove = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thickAbove'), 'thickAbove', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1seriesthickAbove', False, pyxb.utils.utility.Location('cs_targetSection.xsd', 48, 3), )
    ...
    __thickBelow = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thickBelow'), 'thickBelow', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1seriesthickBelow', False, pyxb.utils.utility.Location('cs_targetSection.xsd', 55, 3), )
    ...
    __location = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'location'), 'location', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1serieslocation', True, pyxb.utils.utility.Location('cs_targetSection.xsd', 62, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_targetSection_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_targetSection.xsd', 69, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_targetSection_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
...
_module_typeBindings.cs_targetSection = cs_targetSection
...
class obj_target (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('obj_target.xsd', 70, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}parentTarget uses Python identifier parentTarget
    __parentTarget = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'parentTarget'), 'parentTarget', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesparentTarget', False, pyxb.utils.utility.Location('grp_target.xsd', 27, 3), )
    ...
    __dispNsCenter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dispNsCenter'), 'dispNsCenter', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdispNsCenter', False, pyxb.utils.utility.Location('grp_target.xsd', 33, 3), )
    ...
    __dispEwCenter = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dispEwCenter'), 'dispEwCenter', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdispEwCenter', False, pyxb.utils.utility.Location('grp_target.xsd', 38, 3), )
    ...
    __tvd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvd'), 'tvd', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriestvd', False, pyxb.utils.utility.Location('grp_target.xsd', 43, 3), )
    ...
    __dispNsOffset = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dispNsOffset'), 'dispNsOffset', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdispNsOffset', False, pyxb.utils.utility.Location('grp_target.xsd', 48, 3), )
    ...
    __dispEwOffset = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dispEwOffset'), 'dispEwOffset', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdispEwOffset', False, pyxb.utils.utility.Location('grp_target.xsd', 53, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}thickAbove uses Python identifier thickAbove
    __thickAbove = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thickAbove'), 'thickAbove', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesthickAbove', False, pyxb.utils.utility.Location('grp_target.xsd', 58, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}thickBelow uses Python identifier thickBelow
    __thickBelow = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'thickBelow'), 'thickBelow', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesthickBelow', False, pyxb.utils.utility.Location('grp_target.xsd', 63, 3), )
    ...
    __dip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dip'), 'dip', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdip', False, pyxb.utils.utility.Location('grp_target.xsd', 68, 3), )
    ...
    __strike = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'strike'), 'strike', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesstrike', False, pyxb.utils.utility.Location('grp_target.xsd', 73, 3), )
    ...
    __rotation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rotation'), 'rotation', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesrotation', False, pyxb.utils.utility.Location('grp_target.xsd', 78, 3), )
    ...
    __lenMajorAxis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'lenMajorAxis'), 'lenMajorAxis', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1serieslenMajorAxis', False, pyxb.utils.utility.Location('grp_target.xsd', 83, 3), )
    ...
    __widMinorAxis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'widMinorAxis'), 'widMinorAxis', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1serieswidMinorAxis', False, pyxb.utils.utility.Location('grp_target.xsd', 89, 3), )
    ...
    __typeTargetScope = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'typeTargetScope'), 'typeTargetScope', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriestypeTargetScope', False, pyxb.utils.utility.Location('grp_target.xsd', 95, 3), )
    ...
    __dispNsSectOrig = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dispNsSectOrig'), 'dispNsSectOrig', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdispNsSectOrig', False, pyxb.utils.utility.Location('grp_target.xsd', 100, 3), )
    ...
    __dispEwSectOrig = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dispEwSectOrig'), 'dispEwSectOrig', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesdispEwSectOrig', False, pyxb.utils.utility.Location('grp_target.xsd', 105, 3), )
    ...
    __aziRef = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'aziRef'), 'aziRef', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesaziRef', False, pyxb.utils.utility.Location('grp_target.xsd', 111, 3), )
    ...
    __catTarg = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'catTarg'), 'catTarg', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriescatTarg', False, pyxb.utils.utility.Location('grp_target.xsd', 116, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}location uses Python identifier location
    __location = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'location'), 'location', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1serieslocation', True, pyxb.utils.utility.Location('grp_target.xsd', 121, 3), )
    ...
    __targetSection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'targetSection'), 'targetSection', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriestargetSection', True, pyxb.utils.utility.Location('grp_target.xsd', 127, 3), )
    ...
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_target.xsd', 72, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_target.xsd', 77, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_target.xsd', 82, 3), )
    ...
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_target.xsd', 92, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_target_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_target.xsd', 98, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_target_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_target_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_target.xsd', 105, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_target.xsd', 105, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_target_uidWellbore', _module_typeBindings.uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_target.xsd', 112, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_target.xsd', 112, 2)
...
_module_typeBindings.obj_target = obj_target
...
obj_targets._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_targets, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_target.xsd', 48, 5)))

obj_targets._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'target'), obj_target, scope=obj_targets, documentation='A single target.  ', location=pyxb.utils.utility.Location('obj_target.xsd', 53, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_target.xsd', 48, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_targets._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_target.xsd', 48, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_targets._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'target')), pyxb.utils.utility.Location('obj_target.xsd', 53, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
...
def _BuildAutomaton_10 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 37, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 143, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_location.xsd', 151, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_location.xsd', 157, 3))
    counters.add(cc_3)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wellCRS')), pyxb.utils.utility.Location('cs_location.xsd', 37, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'latitude')), pyxb.utils.utility.Location('cs_location.xsd', 51, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'longitude')), pyxb.utils.utility.Location('cs_location.xsd', 56, 5))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'easting')), pyxb.utils.utility.Location('cs_location.xsd', 66, 5))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'northing')), pyxb.utils.utility.Location('cs_location.xsd', 73, 5))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'westing')), pyxb.utils.utility.Location('cs_location.xsd', 85, 5))
    st_5 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'southing')), pyxb.utils.utility.Location('cs_location.xsd', 93, 5))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'projectedX')), pyxb.utils.utility.Location('cs_location.xsd', 106, 5))
    st_7 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'projectedY')), pyxb.utils.utility.Location('cs_location.xsd', 115, 5))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'localX')), pyxb.utils.utility.Location('cs_location.xsd', 129, 5))
    st_9 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'localY')), pyxb.utils.utility.Location('cs_location.xsd', 135, 5))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'original')), pyxb.utils.utility.Location('cs_location.xsd', 143, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'description')), pyxb.utils.utility.Location('cs_location.xsd', 151, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_location._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_location.xsd', 157, 3))
...
cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'sectNumber'), positiveCount, scope=cs_targetSection, documentation='Sequence number of section, 1,2,3.  ', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 27, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeTargetSectionScope'), TargetSectionScope, scope=cs_targetSection, documentation='Section scope: Line or Arc.  ', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 32, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lenRadius'), lengthMeasure, scope=cs_targetSection, documentation='Length of straight line section or radius of arc for continuous curve section.  ', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 37, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'angleArc'), planeAngleMeasure, scope=cs_targetSection, documentation='Direction of straight line section or radius of arc for continuous curve section.  \n\t\t\t\t', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 42, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thickAbove'), lengthMeasure, scope=cs_targetSection, documentation='Height of target above center point at the start of the section.  \n\t\t\t\t\tIn the case of an arc, the thickness above should vary linearly with the arc length.  \n\t\t\t\t\t', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 48, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thickBelow'), lengthMeasure, scope=cs_targetSection, documentation='Depth of target below center point at the start of the section.  \n\t\t\t\t\tIn the case of an arc, the thickness below should vary linearly with the arc length.  \n\t\t\t\t\t', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 55, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'location'), cs_location, scope=cs_targetSection, documentation='The 2D coordinates of the item at the start of the section.  \n\t\t\t\t\tThis is redundant information and can be computed by starting at the section origin and applying \n\t\t\t\t\tthe sequence of angleArcs and lenRadius.  ', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 62, 3)))

cs_targetSection._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_targetSection, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_targetSection.xsd', 69, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_targetSection.xsd', 37, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_targetSection.xsd', 42, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_targetSection.xsd', 48, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_targetSection.xsd', 55, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_targetSection.xsd', 62, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_targetSection.xsd', 69, 3))
    counters.add(cc_5)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'sectNumber')), pyxb.utils.utility.Location('cs_targetSection.xsd', 27, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeTargetSectionScope')), pyxb.utils.utility.Location('cs_targetSection.xsd', 32, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lenRadius')), pyxb.utils.utility.Location('cs_targetSection.xsd', 37, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'angleArc')), pyxb.utils.utility.Location('cs_targetSection.xsd', 42, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thickAbove')), pyxb.utils.utility.Location('cs_targetSection.xsd', 48, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thickBelow')), pyxb.utils.utility.Location('cs_targetSection.xsd', 55, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'location')), pyxb.utils.utility.Location('cs_targetSection.xsd', 62, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_targetSection._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_targetSection.xsd', 69, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    transitions = []
    transitions.append(fac.Transition(st_1, [
...
obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'parentTarget'), refNameString, scope=obj_target, documentation='A pointer to the parent target. This represents a relationship \n\t\t\t\t\tbetween a drillers and geological target.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 27, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dispNsCenter'), lengthMeasure, scope=obj_target, documentation='Northing of target center point in map coordinates.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 33, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dispEwCenter'), lengthMeasure, scope=obj_target, documentation='Easting of target center point in map coordinates.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 38, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvd'), wellVerticalDepthCoord, scope=obj_target, documentation='Vertical depth of the measurements.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 43, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dispNsOffset'), lengthMeasure, scope=obj_target, documentation='North-south offset of target intercept point from shape center.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 48, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dispEwOffset'), lengthMeasure, scope=obj_target, documentation='East-west offset of target intercept point from shape center.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 53, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thickAbove'), lengthMeasure, scope=obj_target, documentation='Height of target above center point.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 58, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'thickBelow'), lengthMeasure, scope=obj_target, documentation='Depth of target below center point.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 63, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dip'), planeAngleMeasure, scope=obj_target, documentation='Angle of dip with respect to horizontal.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 68, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'strike'), planeAngleMeasure, scope=obj_target, documentation='Direction of dip with respect to north azimuth reference.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 73, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rotation'), planeAngleMeasure, scope=obj_target, documentation='Direction of target geometry with respect to north azimuth reference.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 78, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'lenMajorAxis'), lengthMeasure, scope=obj_target, documentation='Distance from center to perimeter in rotation direction.  \n\t\t\t\t\tThis may be ignored depending on the value of typeTargetScope.', location=pyxb.utils.utility.Location('grp_target.xsd', 83, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'widMinorAxis'), lengthMeasure, scope=obj_target, documentation='Distance from center to perimeter at 90 deg to rotation direction.  \n\t\t\t\t\tThis may be ignored depending on the value of typeTargetScope. ', location=pyxb.utils.utility.Location('grp_target.xsd', 89, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'typeTargetScope'), TargetScope, scope=obj_target, documentation='The type of scope of the drilling target.', location=pyxb.utils.utility.Location('grp_target.xsd', 95, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dispNsSectOrig'), lengthMeasure, scope=obj_target, documentation='Origin north-south used as starting point for sections, mandatory parameter when sections are used..  ', location=pyxb.utils.utility.Location('grp_target.xsd', 100, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dispEwSectOrig'), lengthMeasure, scope=obj_target, documentation='Origin east-west used as starting point for sections, mandatory parameter when sections are used.\n\t\t\t\t\t', location=pyxb.utils.utility.Location('grp_target.xsd', 105, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'aziRef'), AziRef, scope=obj_target, documentation='Specifies the definition of north.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 111, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'catTarg'), TargetCategory, scope=obj_target, documentation='Geological or drillers target.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 116, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'location'), cs_location, scope=obj_target, documentation='The 2D coordinates of the item at the start of the \n\t\t\t\t\tsection. The location object is mandatory for the first section starting point.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 121, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'targetSection'), cs_targetSection, scope=obj_target, documentation='Sections describing target. These may be ignored depending on the value of typeTargetScope.  ', location=pyxb.utils.utility.Location('grp_target.xsd', 127, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_target, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_target.xsd', 72, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_target, documentation='Human recognizable context for the wellbore that contains the target.  ', location=pyxb.utils.utility.Location('obj_target.xsd', 77, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_target, documentation='Human recognizable context for the target.  ', location=pyxb.utils.utility.Location('obj_target.xsd', 82, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_target, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_target.xsd', 92, 3)))

obj_target._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_target, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_target.xsd', 98, 3)))
...
def _BuildAutomaton_12 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_target.xsd', 87, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 27, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 33, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 38, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 43, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 48, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 53, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 58, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 63, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 68, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 73, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 78, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 83, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 89, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 95, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 100, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 105, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 111, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_target.xsd', 116, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_target.xsd', 121, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_target.xsd', 127, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_target.xsd', 92, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_target.xsd', 98, 3))
    counters.add(cc_22)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_target.xsd', 72, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_target.xsd', 77, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_target.xsd', 82, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'parentTarget')), pyxb.utils.utility.Location('grp_target.xsd', 27, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dispNsCenter')), pyxb.utils.utility.Location('grp_target.xsd', 33, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dispEwCenter')), pyxb.utils.utility.Location('grp_target.xsd', 38, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvd')), pyxb.utils.utility.Location('grp_target.xsd', 43, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dispNsOffset')), pyxb.utils.utility.Location('grp_target.xsd', 48, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dispEwOffset')), pyxb.utils.utility.Location('grp_target.xsd', 53, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thickAbove')), pyxb.utils.utility.Location('grp_target.xsd', 58, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'thickBelow')), pyxb.utils.utility.Location('grp_target.xsd', 63, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dip')), pyxb.utils.utility.Location('grp_target.xsd', 68, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'strike')), pyxb.utils.utility.Location('grp_target.xsd', 73, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rotation')), pyxb.utils.utility.Location('grp_target.xsd', 78, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'lenMajorAxis')), pyxb.utils.utility.Location('grp_target.xsd', 83, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'widMinorAxis')), pyxb.utils.utility.Location('grp_target.xsd', 89, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'typeTargetScope')), pyxb.utils.utility.Location('grp_target.xsd', 95, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dispNsSectOrig')), pyxb.utils.utility.Location('grp_target.xsd', 100, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dispEwSectOrig')), pyxb.utils.utility.Location('grp_target.xsd', 105, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'aziRef')), pyxb.utils.utility.Location('grp_target.xsd', 111, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'catTarg')), pyxb.utils.utility.Location('grp_target.xsd', 116, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'location')), pyxb.utils.utility.Location('grp_target.xsd', 121, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'targetSection')), pyxb.utils.utility.Location('grp_target.xsd', 127, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_target.xsd', 92, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_target._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_target.xsd', 98, 3))
...
targets._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
