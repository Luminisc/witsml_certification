# /mnt/c/_Work/_Tools/witsml_v1.4.1.1_certification/tool/src/wcmp/witsml1411/witsml1411_obj_risk.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:bff9e1cadb696f69d77e8e135b7b2cb67426d3a5
# Generated 2026-06-09 18:17:00.270662 by PyXB version 1.2.6 using Python 3.11.2.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:eae2c1e0-f6bc-43a0-93ee-ad77af06e60b')
...
# Complex type {http://www.witsml.org/schemas/1series}obj_risks with content type ELEMENT_ONLY
class obj_risks (_ImportedBinding__abs.abstractObject):
    """"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_risks')
    _XSDLocation = pyxb.utils.utility.Location('obj_risk.xsd', 42, 1)
    ...
    __documentInfo = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), 'documentInfo', '__httpwww_witsml_orgschemas1series_obj_risks_httpwww_witsml_orgschemas1seriesdocumentInfo', False, pyxb.utils.utility.Location('obj_risk.xsd', 49, 5), )

    
    documentInfo = property(__documentInfo.value, __documentInfo.set, None, 'Information about the XML message instance.  ')

    
    # Element {http://www.witsml.org/schemas/1series}risk uses Python identifier risk
    __risk = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'risk'), 'risk', '__httpwww_witsml_orgschemas1series_obj_risks_httpwww_witsml_orgschemas1seriesrisk', True, pyxb.utils.utility.Location('obj_risk.xsd', 54, 5), )

    
    risk = property(__risk.value, __risk.set, None, 'A single risk.  ')

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__httpwww_witsml_orgschemas1series_obj_risks_version', _module_typeBindings.schemaVersionString, required=True)
    __version._DeclarationLocation = pyxb.utils.utility.Location('obj_risk.xsd', 60, 4)
    __version._UseLocation = pyxb.utils.utility.Location('obj_risk.xsd', 60, 4)
...
_module_typeBindings.obj_risks = obj_risks
Namespace.addCategoryObject('typeBinding', 'obj_risks', obj_risks)
...
# Complex type {http://www.witsml.org/schemas/1series}cs_drillingParams with content type ELEMENT_ONLY
class cs_drillingParams (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('cs_drillingParams.xsd', 21, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}eTimOpBit uses Python identifier eTimOpBit
    __eTimOpBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'eTimOpBit'), 'eTimOpBit', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieseTimOpBit', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 26, 3), )

    
    eTimOpBit = property(__eTimOpBit.value, __eTimOpBit.set, None, 'Operating time spent by bit for run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdHoleStart uses Python identifier mdHoleStart
    __mdHoleStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart'), 'mdHoleStart', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesmdHoleStart', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 31, 3), )

    
    mdHoleStart = property(__mdHoleStart.value, __mdHoleStart.set, None, 'Measured depth at start.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mdHoleStop uses Python identifier mdHoleStop
    __mdHoleStop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStop'), 'mdHoleStop', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesmdHoleStop', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 36, 3), )

    
    mdHoleStop = property(__mdHoleStop.value, __mdHoleStop.set, None, 'Measured depth at stop.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tubular uses Python identifier tubular
    __tubular = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tubular'), 'tubular', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestubular', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 41, 3), )

    
    tubular = property(__tubular.value, __tubular.set, None, 'A pointer to the tubular assembly.  ')

    
    # Element {http://www.witsml.org/schemas/1series}hkldRot uses Python identifier hkldRot
    __hkldRot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'hkldRot'), 'hkldRot', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieshkldRot', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 46, 3), )

    
    hkldRot = property(__hkldRot.value, __hkldRot.set, None, 'Hookload - rotating.  ')

    
    # Element {http://www.witsml.org/schemas/1series}overPull uses Python identifier overPull
    __overPull = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'overPull'), 'overPull', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesoverPull', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 51, 3), )

    
    overPull = property(__overPull.value, __overPull.set, None, 'hkldUp-hkldRot.  ')

    
    # Element {http://www.witsml.org/schemas/1series}slackOff uses Python identifier slackOff
    __slackOff = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'slackOff'), 'slackOff', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesslackOff', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 56, 3), )

    
    slackOff = property(__slackOff.value, __slackOff.set, None, 'hkldRot-hkldDown.  ')

    
    # Element {http://www.witsml.org/schemas/1series}hkldUp uses Python identifier hkldUp
    __hkldUp = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'hkldUp'), 'hkldUp', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieshkldUp', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 61, 3), )

    
    hkldUp = property(__hkldUp.value, __hkldUp.set, None, 'Hookload - string moving up.  ')

    
    # Element {http://www.witsml.org/schemas/1series}hkldDn uses Python identifier hkldDn
    __hkldDn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'hkldDn'), 'hkldDn', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieshkldDn', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 66, 3), )

    
    hkldDn = property(__hkldDn.value, __hkldDn.set, None, 'Hookload - string moving down.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tqOnBotAv uses Python identifier tqOnBotAv
    __tqOnBotAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotAv'), 'tqOnBotAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestqOnBotAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 71, 3), )

    
    tqOnBotAv = property(__tqOnBotAv.value, __tqOnBotAv.set, None, 'Average Torque - on bottom.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tqOnBotMx uses Python identifier tqOnBotMx
    __tqOnBotMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotMx'), 'tqOnBotMx', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestqOnBotMx', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 76, 3), )

    
    tqOnBotMx = property(__tqOnBotMx.value, __tqOnBotMx.set, None, 'Maximum torque - on bottom.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tqOnBotMn uses Python identifier tqOnBotMn
    __tqOnBotMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotMn'), 'tqOnBotMn', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestqOnBotMn', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 81, 3), )

    
    tqOnBotMn = property(__tqOnBotMn.value, __tqOnBotMn.set, None, 'Minimum torque - on bottom.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tqOffBotAv uses Python identifier tqOffBotAv
    __tqOffBotAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tqOffBotAv'), 'tqOffBotAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestqOffBotAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 86, 3), )

    
    tqOffBotAv = property(__tqOffBotAv.value, __tqOffBotAv.set, None, 'Average torque - off bottom.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tqDhAv uses Python identifier tqDhAv
    __tqDhAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tqDhAv'), 'tqDhAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestqDhAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 91, 3), )

    
    tqDhAv = property(__tqDhAv.value, __tqDhAv.set, None, 'Average torque - downhole.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wtAboveJar uses Python identifier wtAboveJar
    __wtAboveJar = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wtAboveJar'), 'wtAboveJar', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswtAboveJar', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 96, 3), )

    
    wtAboveJar = property(__wtAboveJar.value, __wtAboveJar.set, None, 'Weight above jars.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wtBelowJar uses Python identifier wtBelowJar
    __wtBelowJar = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wtBelowJar'), 'wtBelowJar', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswtBelowJar', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 101, 3), )

    
    wtBelowJar = property(__wtBelowJar.value, __wtBelowJar.set, None, 'Weight below jars.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wtMud uses Python identifier wtMud
    __wtMud = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wtMud'), 'wtMud', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswtMud', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 106, 3), )

    
    wtMud = property(__wtMud.value, __wtMud.set, None, 'Mud density.  ')

    
    # Element {http://www.witsml.org/schemas/1series}flowratePump uses Python identifier flowratePump
    __flowratePump = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'flowratePump'), 'flowratePump', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesflowratePump', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 111, 3), )

    
    flowratePump = property(__flowratePump.value, __flowratePump.set, None, 'Pump flow rate.  ')

    
    # Element {http://www.witsml.org/schemas/1series}powBit uses Python identifier powBit
    __powBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'powBit'), 'powBit', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriespowBit', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 116, 3), )

    
    powBit = property(__powBit.value, __powBit.set, None, 'Bit hydraulic.  ')

    
    # Element {http://www.witsml.org/schemas/1series}velNozzleAv uses Python identifier velNozzleAv
    __velNozzleAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'velNozzleAv'), 'velNozzleAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesvelNozzleAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 121, 3), )

    
    velNozzleAv = property(__velNozzleAv.value, __velNozzleAv.set, None, 'Bit nozzle average velocity.  ')

    
    # Element {http://www.witsml.org/schemas/1series}presDropBit uses Python identifier presDropBit
    __presDropBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'presDropBit'), 'presDropBit', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriespresDropBit', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 126, 3), )

    
    presDropBit = property(__presDropBit.value, __presDropBit.set, None, 'Pressure drop in bit.  ')

    
    # Element {http://www.witsml.org/schemas/1series}cTimHold uses Python identifier cTimHold
    __cTimHold = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cTimHold'), 'cTimHold', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescTimHold', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 131, 3), )

    
    cTimHold = property(__cTimHold.value, __cTimHold.set, None, 'Time spent on hold from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}cTimSteering uses Python identifier cTimSteering
    __cTimSteering = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cTimSteering'), 'cTimSteering', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescTimSteering', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 136, 3), )

    
    cTimSteering = property(__cTimSteering.value, __cTimSteering.set, None, 'Time spent steering from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}cTimDrillRot uses Python identifier cTimDrillRot
    __cTimDrillRot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cTimDrillRot'), 'cTimDrillRot', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescTimDrillRot', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 141, 3), )

    
    cTimDrillRot = property(__cTimDrillRot.value, __cTimDrillRot.set, None, 'Time spent rotary drilling from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}cTimDrillSlid uses Python identifier cTimDrillSlid
    __cTimDrillSlid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cTimDrillSlid'), 'cTimDrillSlid', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescTimDrillSlid', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 146, 3), )

    
    cTimDrillSlid = property(__cTimDrillSlid.value, __cTimDrillSlid.set, None, 'Time spent slide drilling from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}cTimCirc uses Python identifier cTimCirc
    __cTimCirc = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cTimCirc'), 'cTimCirc', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescTimCirc', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 151, 3), )

    
    cTimCirc = property(__cTimCirc.value, __cTimCirc.set, None, 'Time spent circulating from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}cTimReam uses Python identifier cTimReam
    __cTimReam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'cTimReam'), 'cTimReam', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescTimReam', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 156, 3), )

    
    cTimReam = property(__cTimReam.value, __cTimReam.set, None, 'Time spent reaming from start of bit run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}distDrillRot uses Python identifier distDrillRot
    __distDrillRot = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'distDrillRot'), 'distDrillRot', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesdistDrillRot', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 161, 3), )

    
    distDrillRot = property(__distDrillRot.value, __distDrillRot.set, None, 'Distance drilled - rotating.  ')

    
    # Element {http://www.witsml.org/schemas/1series}distDrillSlid uses Python identifier distDrillSlid
    __distDrillSlid = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'distDrillSlid'), 'distDrillSlid', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesdistDrillSlid', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 166, 3), )

    
    distDrillSlid = property(__distDrillSlid.value, __distDrillSlid.set, None, 'Distance drilled - sliding  ')

    
    # Element {http://www.witsml.org/schemas/1series}distReam uses Python identifier distReam
    __distReam = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'distReam'), 'distReam', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesdistReam', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 171, 3), )

    
    distReam = property(__distReam.value, __distReam.set, None, 'Distance reamed.  ')

    
    # Element {http://www.witsml.org/schemas/1series}distHold uses Python identifier distHold
    __distHold = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'distHold'), 'distHold', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesdistHold', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 176, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}distSteering uses Python identifier distSteering
    __distSteering = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'distSteering'), 'distSteering', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesdistSteering', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 181, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}rpmAv uses Python identifier rpmAv
    __rpmAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rpmAv'), 'rpmAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesrpmAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 186, 3), )

    
    rpmAv = property(__rpmAv.value, __rpmAv.set, None, 'Average turn rate (commonly in rpm) through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/1series}rpmMx uses Python identifier rpmMx
    __rpmMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rpmMx'), 'rpmMx', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesrpmMx', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 191, 3), )

    
    rpmMx = property(__rpmMx.value, __rpmMx.set, None, 'Maximum turn rate (commonly in rpm).  ')

    
    # Element {http://www.witsml.org/schemas/1series}rpmMn uses Python identifier rpmMn
    __rpmMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rpmMn'), 'rpmMn', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesrpmMn', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 196, 3), )

    
    rpmMn = property(__rpmMn.value, __rpmMn.set, None, 'Minimum turn rate (commonly in rpm).  ')

    
    # Element {http://www.witsml.org/schemas/1series}rpmAvDh uses Python identifier rpmAvDh
    __rpmAvDh = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'rpmAvDh'), 'rpmAvDh', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesrpmAvDh', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 201, 3), )

    
    rpmAvDh = property(__rpmAvDh.value, __rpmAvDh.set, None, 'Average turn rate (commonly in rpm) downhole.  ')

    
    # Element {http://www.witsml.org/schemas/1series}ropAv uses Python identifier ropAv
    __ropAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ropAv'), 'ropAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesropAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 206, 3), )

    
    ropAv = property(__ropAv.value, __ropAv.set, None, 'Average rate of penetration through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/1series}ropMx uses Python identifier ropMx
    __ropMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ropMx'), 'ropMx', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesropMx', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 211, 3), )

    
    ropMx = property(__ropMx.value, __ropMx.set, None, 'Maximum rate of penetration through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/1series}ropMn uses Python identifier ropMn
    __ropMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'ropMn'), 'ropMn', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesropMn', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 216, 3), )

    
    ropMn = property(__ropMn.value, __ropMn.set, None, 'Minimum rate of penetration through Interval.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wobAv uses Python identifier wobAv
    __wobAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wobAv'), 'wobAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswobAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 221, 3), )

    
    wobAv = property(__wobAv.value, __wobAv.set, None, 'Surface weight on bit - average through interval.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wobMx uses Python identifier wobMx
    __wobMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wobMx'), 'wobMx', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswobMx', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 226, 3), )

    
    wobMx = property(__wobMx.value, __wobMx.set, None, 'Weight on bit - maximum.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wobMn uses Python identifier wobMn
    __wobMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wobMn'), 'wobMn', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswobMn', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 231, 3), )

    
    wobMn = property(__wobMn.value, __wobMn.set, None, 'Weight on bit - minimum.  ')

    
    # Element {http://www.witsml.org/schemas/1series}wobAvDh uses Python identifier wobAvDh
    __wobAvDh = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'wobAvDh'), 'wobAvDh', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1serieswobAvDh', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 236, 3), )

    
    wobAvDh = property(__wobAvDh.value, __wobAvDh.set, None, 'Weight on bit - average downhole.  ')

    
    # Element {http://www.witsml.org/schemas/1series}reasonTrip uses Python identifier reasonTrip
    __reasonTrip = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'reasonTrip'), 'reasonTrip', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesreasonTrip', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 241, 3), )

    
    reasonTrip = property(__reasonTrip.value, __reasonTrip.set, None, 'Reason for trip.  ')

    
    # Element {http://www.witsml.org/schemas/1series}objectiveBha uses Python identifier objectiveBha
    __objectiveBha = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectiveBha'), 'objectiveBha', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesobjectiveBha', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 246, 3), )

    
    objectiveBha = property(__objectiveBha.value, __objectiveBha.set, None, 'Objective of bottom hole assembly.  ')

    
    # Element {http://www.witsml.org/schemas/1series}aziTop uses Python identifier aziTop
    __aziTop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'aziTop'), 'aziTop', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesaziTop', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 251, 3), )

    
    aziTop = property(__aziTop.value, __aziTop.set, None, 'Azimuth at start measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}aziBottom uses Python identifier aziBottom
    __aziBottom = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'aziBottom'), 'aziBottom', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesaziBottom', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 256, 3), )

    
    aziBottom = property(__aziBottom.value, __aziBottom.set, None, 'Azimuth at stop measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}inclStart uses Python identifier inclStart
    __inclStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'inclStart'), 'inclStart', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesinclStart', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 261, 3), )

    
    inclStart = property(__inclStart.value, __inclStart.set, None, 'Inclination at start measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}inclMx uses Python identifier inclMx
    __inclMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'inclMx'), 'inclMx', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesinclMx', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 266, 3), )

    
    inclMx = property(__inclMx.value, __inclMx.set, None, 'Maximum inclination.  ')

    
    # Element {http://www.witsml.org/schemas/1series}inclMn uses Python identifier inclMn
    __inclMn = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'inclMn'), 'inclMn', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesinclMn', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 271, 3), )

    
    inclMn = property(__inclMn.value, __inclMn.set, None, 'Minimum inclination.  ')

    
    # Element {http://www.witsml.org/schemas/1series}inclStop uses Python identifier inclStop
    __inclStop = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'inclStop'), 'inclStop', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesinclStop', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 276, 3), )

    
    inclStop = property(__inclStop.value, __inclStop.set, None, 'Inclination at stop measured depth.  ')

    
    # Element {http://www.witsml.org/schemas/1series}tempMudDhMx uses Python identifier tempMudDhMx
    __tempMudDhMx = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tempMudDhMx'), 'tempMudDhMx', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriestempMudDhMx', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 281, 3), )

    
    tempMudDhMx = property(__tempMudDhMx.value, __tempMudDhMx.set, None, 'Maximum mud temperature downhole during run.  ')

    
    # Element {http://www.witsml.org/schemas/1series}presPumpAv uses Python identifier presPumpAv
    __presPumpAv = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'presPumpAv'), 'presPumpAv', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriespresPumpAv', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 286, 3), )

    
    presPumpAv = property(__presPumpAv.value, __presPumpAv.set, None, 'Average pump pressure.  ')

    
    # Element {http://www.witsml.org/schemas/1series}flowrateBit uses Python identifier flowrateBit
    __flowrateBit = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'flowrateBit'), 'flowrateBit', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesflowrateBit', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 291, 3), )

    
    flowrateBit = property(__flowrateBit.value, __flowrateBit.set, None, 'Flow rate at bit.  ')

    
    # Element {http://www.witsml.org/schemas/1series}mudClass uses Python identifier mudClass
    __mudClass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mudClass'), 'mudClass', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesmudClass', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3), )

    
    mudClass = property(__mudClass.value, __mudClass.set, None, 'The class of the drilling fluid.')

    
    # Element {http://www.witsml.org/schemas/1series}mudSubClass uses Python identifier mudSubClass
    __mudSubClass = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mudSubClass'), 'mudSubClass', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesmudSubClass', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 302, 3), )

    
    mudSubClass = property(__mudSubClass.value, __mudSubClass.set, None, 'Mud Subtype at event occurrence.')

    
    # Element {http://www.witsml.org/schemas/1series}comments uses Python identifier comments
    __comments = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'comments'), 'comments', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriescomments', False, pyxb.utils.utility.Location('cs_drillingParams.xsd', 308, 3), )
    ...
    # Element {http://www.witsml.org/schemas/1series}extensionNameValue uses Python identifier extensionNameValue
    __extensionNameValue = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), 'extensionNameValue', '__httpwww_witsml_orgschemas1series_cs_drillingParams_httpwww_witsml_orgschemas1seriesextensionNameValue', True, pyxb.utils.utility.Location('cs_drillingParams.xsd', 313, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_cs_drillingParams_uid', _module_typeBindings.uidString)
    __uid._DeclarationLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    __uid._UseLocation = pyxb.utils.utility.Location('attgrp_uid.xsd', 22, 2)
    ...
    _ElementMap.update({
        ...
        __mudClass.name() : __mudClass,
        __mudSubClass.name() : __mudSubClass,
        __comments.name() : __comments,
        __extensionNameValue.name() : __extensionNameValue
    })
    _AttributeMap.update({
...
_module_typeBindings.cs_drillingParams = cs_drillingParams
...
# Complex type {http://www.witsml.org/schemas/1series}obj_risk with content type ELEMENT_ONLY
class obj_risk (pyxb.binding.basis.complexTypeDefinition):
    """Complex type {http://www.witsml.org/schemas/1series}obj_risk with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'obj_risk')
    _XSDLocation = pyxb.utils.utility.Location('obj_risk.xsd', 71, 1)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element {http://www.witsml.org/schemas/1series}objectReference uses Python identifier objectReference
    __objectReference = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), 'objectReference', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesobjectReference', False, pyxb.utils.utility.Location('grp_risk.xsd', 28, 3), )

    
    objectReference = property(__objectReference.value, __objectReference.set, None, 'A reference to an object that is defined within the context of a wellbore.')

    
    # Element {http://www.witsml.org/schemas/1series}type uses Python identifier type
    __type = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'type'), 'type', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriestype', False, pyxb.utils.utility.Location('grp_risk.xsd', 33, 3), )

    
    type = property(__type.value, __type.set, None, 'The type of risk.')

    
    # Element {http://www.witsml.org/schemas/1series}category uses Python identifier category
    __category = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'category'), 'category', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriescategory', False, pyxb.utils.utility.Location('grp_risk.xsd', 38, 3), )

    
    category = property(__category.value, __category.set, None, 'The category of risk.')

    
    # Element {http://www.witsml.org/schemas/1series}subCategory uses Python identifier subCategory
    __subCategory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'subCategory'), 'subCategory', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriessubCategory', False, pyxb.utils.utility.Location('grp_risk.xsd', 43, 3), )

    
    subCategory = property(__subCategory.value, __subCategory.set, None, 'The sub category of risk.')

    
    # Element {http://www.witsml.org/schemas/1series}extendCategory uses Python identifier extendCategory
    __extendCategory = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'extendCategory'), 'extendCategory', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesextendCategory', False, pyxb.utils.utility.Location('grp_risk.xsd', 48, 3), )

    
    extendCategory = property(__extendCategory.value, __extendCategory.set, None, 'Custom string to further categorize the risk.')

    
    # Element {http://www.witsml.org/schemas/1series}affectedPersonnel uses Python identifier affectedPersonnel
    __affectedPersonnel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'affectedPersonnel'), 'affectedPersonnel', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesaffectedPersonnel', True, pyxb.utils.utility.Location('grp_risk.xsd', 53, 3), )

    
    affectedPersonnel = property(__affectedPersonnel.value, __affectedPersonnel.set, None, 'The personnel afected by the risk.')

    
    # Element {http://www.witsml.org/schemas/1series}dTimStart uses Python identifier dTimStart
    __dTimStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimStart'), 'dTimStart', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesdTimStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 58, 3), )

    
    dTimStart = property(__dTimStart.value, __dTimStart.set, None, 'Date and time that activities started.')

    
    # Element {http://www.witsml.org/schemas/1series}dTimEnd uses Python identifier dTimEnd
    __dTimEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'dTimEnd'), 'dTimEnd', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesdTimEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 63, 3), )

    
    dTimEnd = property(__dTimEnd.value, __dTimEnd.set, None, 'Date and time that activities were completed.')

    
    # Element {http://www.witsml.org/schemas/1series}mdHoleStart uses Python identifier mdHoleStart
    __mdHoleStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart'), 'mdHoleStart', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesmdHoleStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 68, 3), )

    
    mdHoleStart = property(__mdHoleStart.value, __mdHoleStart.set, None, 'Measured Depth at start of activity.')

    
    # Element {http://www.witsml.org/schemas/1series}mdHoleEnd uses Python identifier mdHoleEnd
    __mdHoleEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdHoleEnd'), 'mdHoleEnd', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesmdHoleEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 73, 3), )

    
    mdHoleEnd = property(__mdHoleEnd.value, __mdHoleEnd.set, None, 'Measured Depth at end of activity.')

    
    # Element {http://www.witsml.org/schemas/1series}tvdHoleStart uses Python identifier tvdHoleStart
    __tvdHoleStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleStart'), 'tvdHoleStart', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriestvdHoleStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 78, 3), )

    
    tvdHoleStart = property(__tvdHoleStart.value, __tvdHoleStart.set, None, 'True Vertical Depth at start of activity.')

    
    # Element {http://www.witsml.org/schemas/1series}tvdHoleEnd uses Python identifier tvdHoleEnd
    __tvdHoleEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleEnd'), 'tvdHoleEnd', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriestvdHoleEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 83, 3), )

    
    tvdHoleEnd = property(__tvdHoleEnd.value, __tvdHoleEnd.set, None, 'True Vertical Depth at end of activity.')

    
    # Element {http://www.witsml.org/schemas/1series}mdBitStart uses Python identifier mdBitStart
    __mdBitStart = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBitStart'), 'mdBitStart', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesmdBitStart', False, pyxb.utils.utility.Location('grp_risk.xsd', 88, 3), )

    
    mdBitStart = property(__mdBitStart.value, __mdBitStart.set, None, 'Measured depth of bit at start of activity.')

    
    # Element {http://www.witsml.org/schemas/1series}mdBitEnd uses Python identifier mdBitEnd
    __mdBitEnd = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mdBitEnd'), 'mdBitEnd', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesmdBitEnd', False, pyxb.utils.utility.Location('grp_risk.xsd', 93, 3), )

    
    mdBitEnd = property(__mdBitEnd.value, __mdBitEnd.set, None, 'Measured depth of bit at end of activity.')

    
    # Element {http://www.witsml.org/schemas/1series}diaHole uses Python identifier diaHole
    __diaHole = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'diaHole'), 'diaHole', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesdiaHole', False, pyxb.utils.utility.Location('grp_risk.xsd', 98, 3), )

    
    diaHole = property(__diaHole.value, __diaHole.set, None, 'Hole diameter.  ')

    
    # Element {http://www.witsml.org/schemas/1series}severityLevel uses Python identifier severityLevel
    __severityLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'severityLevel'), 'severityLevel', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesseverityLevel', False, pyxb.utils.utility.Location('grp_risk.xsd', 103, 3), )

    
    severityLevel = property(__severityLevel.value, __severityLevel.set, None, 'Severity Level of the Risk. \n\t\t\t\t\tValues of 1 through 5 with 1 being the lowest.')

    
    # Element {http://www.witsml.org/schemas/1series}probabilityLevel uses Python identifier probabilityLevel
    __probabilityLevel = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'probabilityLevel'), 'probabilityLevel', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesprobabilityLevel', False, pyxb.utils.utility.Location('grp_risk.xsd', 109, 3), )

    
    probabilityLevel = property(__probabilityLevel.value, __probabilityLevel.set, None, 'Probability Level of the Risk.\n\t\t\t\t\tValues of 1 through 5 with 1 being the lowest.')

    
    # Element {http://www.witsml.org/schemas/1series}summary uses Python identifier summary
    __summary = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'summary'), 'summary', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriessummary', False, pyxb.utils.utility.Location('grp_risk.xsd', 115, 3), )

    
    summary = property(__summary.value, __summary.set, None, 'summary description of risk.')

    
    # Element {http://www.witsml.org/schemas/1series}details uses Python identifier details
    __details = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'details'), 'details', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesdetails', False, pyxb.utils.utility.Location('grp_risk.xsd', 120, 3), )

    
    details = property(__details.value, __details.set, None, 'Complete description of Risk.')

    
    # Element {http://www.witsml.org/schemas/1series}identification uses Python identifier identification
    __identification = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'identification'), 'identification', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesidentification', False, pyxb.utils.utility.Location('grp_risk.xsd', 125, 3), )

    
    identification = property(__identification.value, __identification.set, None, 'Details for identifing the Risk.')

    
    # Element {http://www.witsml.org/schemas/1series}contingency uses Python identifier contingency
    __contingency = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'contingency'), 'contingency', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriescontingency', False, pyxb.utils.utility.Location('grp_risk.xsd', 130, 3), )

    
    contingency = property(__contingency.value, __contingency.set, None, 'Plan of action if the Risk materializes.')

    
    # Element {http://www.witsml.org/schemas/1series}mitigation uses Python identifier mitigation
    __mitigation = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'mitigation'), 'mitigation', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesmitigation', True, pyxb.utils.utility.Location('grp_risk.xsd', 135, 3), )

    
    mitigation = property(__mitigation.value, __mitigation.set, None, 'Plan of action to ensure the risk does not materialize.')

    
    # Element {http://www.witsml.org/schemas/1series}nameWell uses Python identifier nameWell
    __nameWell = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), 'nameWell', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesnameWell', False, pyxb.utils.utility.Location('obj_risk.xsd', 73, 3), )
    ...
    __nameWellbore = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), 'nameWellbore', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesnameWellbore', False, pyxb.utils.utility.Location('obj_risk.xsd', 78, 3), )

    
    nameWellbore = property(__nameWellbore.value, __nameWellbore.set, None, 'Human recognizable context for the wellbore that contains the risk.  ')

    
    # Element {http://www.witsml.org/schemas/1series}name uses Python identifier name
    __name = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'name'), 'name', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriesname', False, pyxb.utils.utility.Location('obj_risk.xsd', 83, 3), )

    
    name = property(__name.value, __name.set, None, 'Human recognizable context for the risk.  ')

    
    # Element {http://www.witsml.org/schemas/1series}commonData uses Python identifier commonData
    __commonData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'commonData'), 'commonData', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriescommonData', False, pyxb.utils.utility.Location('obj_risk.xsd', 93, 3), )
    ...
    __customData = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(Namespace, 'customData'), 'customData', '__httpwww_witsml_orgschemas1series_obj_risk_httpwww_witsml_orgschemas1seriescustomData', False, pyxb.utils.utility.Location('obj_risk.xsd', 99, 3), )
    ...
    # Attribute uid uses Python identifier uid
    __uid = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uid'), 'uid', '__httpwww_witsml_orgschemas1series_obj_risk_uid', _module_typeBindings.uidString)
    ...
    __uidWell = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWell'), 'uidWell', '__httpwww_witsml_orgschemas1series_obj_risk_uidWell', _module_typeBindings.uidParentString)
    __uidWell._DeclarationLocation = pyxb.utils.utility.Location('obj_risk.xsd', 106, 2)
    __uidWell._UseLocation = pyxb.utils.utility.Location('obj_risk.xsd', 106, 2)
    ...
    __uidWellbore = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uidWellbore'), 'uidWellbore', '__httpwww_witsml_orgschemas1series_obj_risk_uidWellbore', _module_typeBindings.uidParentString)
    __uidWellbore._DeclarationLocation = pyxb.utils.utility.Location('obj_risk.xsd', 113, 2)
    __uidWellbore._UseLocation = pyxb.utils.utility.Location('obj_risk.xsd', 113, 2)
    ...
    _ElementMap.update({
        ...
        __subCategory.name() : __subCategory,
        __extendCategory.name() : __extendCategory,
        __affectedPersonnel.name() : __affectedPersonnel,
        __dTimStart.name() : __dTimStart,
        __dTimEnd.name() : __dTimEnd,
        __mdHoleStart.name() : __mdHoleStart,
        __mdHoleEnd.name() : __mdHoleEnd,
        __tvdHoleStart.name() : __tvdHoleStart,
        __tvdHoleEnd.name() : __tvdHoleEnd,
        __mdBitStart.name() : __mdBitStart,
        __mdBitEnd.name() : __mdBitEnd,
        __diaHole.name() : __diaHole,
        __severityLevel.name() : __severityLevel,
        __probabilityLevel.name() : __probabilityLevel,
        __summary.name() : __summary,
        __details.name() : __details,
        __identification.name() : __identification,
        __contingency.name() : __contingency,
        __mitigation.name() : __mitigation,
...
_module_typeBindings.obj_risk = obj_risk
Namespace.addCategoryObject('typeBinding', 'obj_risk', obj_risk)
...
risks = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'risks'), obj_risks, documentation='The WITSML API mandated plural root element which allows \n\t\t\tmultiple singular objects to be sent. The plural name is formed by adding\n\t\t\tan "s" to the singular name.', location=pyxb.utils.utility.Location('obj_risk.xsd', 33, 1))
Namespace.addCategoryObject('elementBinding', risks.name().localName(), risks)
...
obj_risks._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'documentInfo'), cs_documentInfo, scope=obj_risks, documentation='Information about the XML message instance.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 49, 5)))

obj_risks._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'risk'), obj_risk, scope=obj_risks, documentation='A single risk.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 54, 5)))
...
def _BuildAutomaton_6 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 49, 5))
    counters.add(cc_0)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risks._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'documentInfo')), pyxb.utils.utility.Location('obj_risk.xsd', 49, 5))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_risks._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'risk')), pyxb.utils.utility.Location('obj_risk.xsd', 54, 5))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_risks._Automaton = _BuildAutomaton_6()
...
cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'eTimOpBit'), timeMeasure, scope=cs_drillingParams, documentation='Operating time spent by bit for run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 26, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart'), measuredDepthCoord, scope=cs_drillingParams, documentation='Measured depth at start.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 31, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStop'), measuredDepthCoord, scope=cs_drillingParams, documentation='Measured depth at stop.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 36, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tubular'), refNameString, scope=cs_drillingParams, documentation='A pointer to the tubular assembly.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 41, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'hkldRot'), forceMeasure, scope=cs_drillingParams, documentation='Hookload - rotating.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 46, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'overPull'), forceMeasure, scope=cs_drillingParams, documentation='hkldUp-hkldRot.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 51, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'slackOff'), forceMeasure, scope=cs_drillingParams, documentation='hkldRot-hkldDown.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 56, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'hkldUp'), forceMeasure, scope=cs_drillingParams, documentation='Hookload - string moving up.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 61, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'hkldDn'), forceMeasure, scope=cs_drillingParams, documentation='Hookload - string moving down.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 66, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotAv'), momentOfForceMeasure, scope=cs_drillingParams, documentation='Average Torque - on bottom.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 71, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotMx'), momentOfForceMeasure, scope=cs_drillingParams, documentation='Maximum torque - on bottom.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 76, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotMn'), momentOfForceMeasure, scope=cs_drillingParams, documentation='Minimum torque - on bottom.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 81, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tqOffBotAv'), momentOfForceMeasure, scope=cs_drillingParams, documentation='Average torque - off bottom.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 86, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tqDhAv'), momentOfForceMeasure, scope=cs_drillingParams, documentation='Average torque - downhole.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 91, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wtAboveJar'), forceMeasure, scope=cs_drillingParams, documentation='Weight above jars.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 96, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wtBelowJar'), forceMeasure, scope=cs_drillingParams, documentation='Weight below jars.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 101, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wtMud'), densityMeasure, scope=cs_drillingParams, documentation='Mud density.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 106, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'flowratePump'), volumeFlowRateMeasure, scope=cs_drillingParams, documentation='Pump flow rate.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 111, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'powBit'), powerMeasure, scope=cs_drillingParams, documentation='Bit hydraulic.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 116, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'velNozzleAv'), velocityMeasure, scope=cs_drillingParams, documentation='Bit nozzle average velocity.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 121, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'presDropBit'), pressureMeasure, scope=cs_drillingParams, documentation='Pressure drop in bit.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 126, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cTimHold'), timeMeasure, scope=cs_drillingParams, documentation='Time spent on hold from start of bit run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 131, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cTimSteering'), timeMeasure, scope=cs_drillingParams, documentation='Time spent steering from start of bit run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 136, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cTimDrillRot'), timeMeasure, scope=cs_drillingParams, documentation='Time spent rotary drilling from start of bit run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 141, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cTimDrillSlid'), timeMeasure, scope=cs_drillingParams, documentation='Time spent slide drilling from start of bit run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 146, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cTimCirc'), timeMeasure, scope=cs_drillingParams, documentation='Time spent circulating from start of bit run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 151, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'cTimReam'), timeMeasure, scope=cs_drillingParams, documentation='Time spent reaming from start of bit run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 156, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'distDrillRot'), lengthMeasure, scope=cs_drillingParams, documentation='Distance drilled - rotating.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 161, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'distDrillSlid'), lengthMeasure, scope=cs_drillingParams, documentation='Distance drilled - sliding  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 166, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'distReam'), lengthMeasure, scope=cs_drillingParams, documentation='Distance reamed.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 171, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'distHold'), lengthMeasure, scope=cs_drillingParams, documentation='Distance covered while holding angle with a steerable drilling assembly.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 176, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'distSteering'), lengthMeasure, scope=cs_drillingParams, documentation='Distance covered while actively steering with a steerable drilling assembly.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 181, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rpmAv'), anglePerTimeMeasure, scope=cs_drillingParams, documentation='Average turn rate (commonly in rpm) through Interval.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 186, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rpmMx'), anglePerTimeMeasure, scope=cs_drillingParams, documentation='Maximum turn rate (commonly in rpm).  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 191, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rpmMn'), anglePerTimeMeasure, scope=cs_drillingParams, documentation='Minimum turn rate (commonly in rpm).  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 196, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'rpmAvDh'), anglePerTimeMeasure, scope=cs_drillingParams, documentation='Average turn rate (commonly in rpm) downhole.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 201, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ropAv'), velocityMeasure, scope=cs_drillingParams, documentation='Average rate of penetration through Interval.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 206, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ropMx'), velocityMeasure, scope=cs_drillingParams, documentation='Maximum rate of penetration through Interval.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 211, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'ropMn'), velocityMeasure, scope=cs_drillingParams, documentation='Minimum rate of penetration through Interval.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 216, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wobAv'), forceMeasure, scope=cs_drillingParams, documentation='Surface weight on bit - average through interval.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 221, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wobMx'), forceMeasure, scope=cs_drillingParams, documentation='Weight on bit - maximum.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 226, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wobMn'), forceMeasure, scope=cs_drillingParams, documentation='Weight on bit - minimum.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 231, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'wobAvDh'), forceMeasure, scope=cs_drillingParams, documentation='Weight on bit - average downhole.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 236, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'reasonTrip'), commentString, scope=cs_drillingParams, documentation='Reason for trip.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 241, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectiveBha'), commentString, scope=cs_drillingParams, documentation='Objective of bottom hole assembly.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 246, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'aziTop'), planeAngleMeasure, scope=cs_drillingParams, documentation='Azimuth at start measured depth.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 251, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'aziBottom'), planeAngleMeasure, scope=cs_drillingParams, documentation='Azimuth at stop measured depth.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 256, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'inclStart'), planeAngleMeasure, scope=cs_drillingParams, documentation='Inclination at start measured depth.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 261, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'inclMx'), planeAngleMeasure, scope=cs_drillingParams, documentation='Maximum inclination.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 266, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'inclMn'), planeAngleMeasure, scope=cs_drillingParams, documentation='Minimum inclination.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 271, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'inclStop'), planeAngleMeasure, scope=cs_drillingParams, documentation='Inclination at stop measured depth.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 276, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tempMudDhMx'), thermodynamicTemperatureMeasure, scope=cs_drillingParams, documentation='Maximum mud temperature downhole during run.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 281, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'presPumpAv'), pressureMeasure, scope=cs_drillingParams, documentation='Average pump pressure.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 286, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'flowrateBit'), volumeFlowRateMeasure, scope=cs_drillingParams, documentation='Flow rate at bit.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 291, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mudClass'), MudClass, scope=cs_drillingParams, documentation='The class of the drilling fluid.', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mudSubClass'), MudSubClass, scope=cs_drillingParams, documentation='Mud Subtype at event occurrence.', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 302, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'comments'), commentString, scope=cs_drillingParams, documentation='Comments and remarks.  ', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 308, 3)))

cs_drillingParams._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue'), cs_extensionNameValue, scope=cs_drillingParams, documentation='Extensions to the schema based on a name-value construct.', location=pyxb.utils.utility.Location('cs_drillingParams.xsd', 313, 3)))
...
def _BuildAutomaton_9 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 31, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 41, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 46, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 51, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 56, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 61, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 66, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 71, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 76, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 81, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 86, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 91, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 96, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 101, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 106, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 111, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 116, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 121, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 126, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 131, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 136, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 141, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 146, 3))
    counters.add(cc_22)
    cc_23 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 151, 3))
    counters.add(cc_23)
    cc_24 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 156, 3))
    counters.add(cc_24)
    cc_25 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 161, 3))
    counters.add(cc_25)
    cc_26 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 166, 3))
    counters.add(cc_26)
    cc_27 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 171, 3))
    counters.add(cc_27)
    cc_28 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 176, 3))
    counters.add(cc_28)
    cc_29 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 181, 3))
    counters.add(cc_29)
    cc_30 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 186, 3))
    counters.add(cc_30)
    cc_31 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 191, 3))
    counters.add(cc_31)
    cc_32 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 196, 3))
    counters.add(cc_32)
    cc_33 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 201, 3))
    counters.add(cc_33)
    cc_34 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 206, 3))
    counters.add(cc_34)
    cc_35 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 211, 3))
    counters.add(cc_35)
    cc_36 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 216, 3))
    counters.add(cc_36)
    cc_37 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 221, 3))
    counters.add(cc_37)
    cc_38 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 226, 3))
    counters.add(cc_38)
    cc_39 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 231, 3))
    counters.add(cc_39)
    cc_40 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 236, 3))
    counters.add(cc_40)
    cc_41 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 241, 3))
    counters.add(cc_41)
    cc_42 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 246, 3))
    counters.add(cc_42)
    cc_43 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 251, 3))
    counters.add(cc_43)
    cc_44 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 256, 3))
    counters.add(cc_44)
    cc_45 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 261, 3))
    counters.add(cc_45)
    cc_46 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 266, 3))
    counters.add(cc_46)
    cc_47 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 271, 3))
    counters.add(cc_47)
    cc_48 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 276, 3))
    counters.add(cc_48)
    cc_49 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 281, 3))
    counters.add(cc_49)
    cc_50 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 286, 3))
    counters.add(cc_50)
    cc_51 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 291, 3))
    counters.add(cc_51)
    cc_52 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3))
    counters.add(cc_52)
    cc_53 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 302, 3))
    counters.add(cc_53)
    cc_54 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 308, 3))
    counters.add(cc_54)
    cc_55 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('cs_drillingParams.xsd', 313, 3))
    counters.add(cc_55)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'eTimOpBit')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 26, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 31, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStop')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 36, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tubular')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 41, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'hkldRot')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 46, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'overPull')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 51, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'slackOff')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 56, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'hkldUp')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 61, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'hkldDn')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 66, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 71, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotMx')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 76, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tqOnBotMn')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 81, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tqOffBotAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 86, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tqDhAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 91, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wtAboveJar')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 96, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wtBelowJar')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 101, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wtMud')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 106, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'flowratePump')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 111, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'powBit')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 116, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'velNozzleAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 121, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'presDropBit')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 126, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cTimHold')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 131, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cTimSteering')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 136, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cTimDrillRot')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 141, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cTimDrillSlid')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 146, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_23, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cTimCirc')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 151, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_24, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'cTimReam')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 156, 3))
    st_26 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_26)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_25, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'distDrillRot')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 161, 3))
    st_27 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_27)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_26, False))
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'distDrillSlid')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 166, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'distReam')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 171, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'distHold')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 176, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'distSteering')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 181, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rpmAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 186, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rpmMx')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 191, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rpmMn')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 196, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'rpmAvDh')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 201, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ropAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 206, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ropMx')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 211, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'ropMn')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 216, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wobAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 221, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wobMx')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 226, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wobMn')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 231, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'wobAvDh')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 236, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'reasonTrip')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 241, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectiveBha')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 246, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'aziTop')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 251, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'aziBottom')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 256, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'inclStart')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 261, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'inclMx')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 266, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'inclMn')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 271, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'inclStop')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 276, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tempMudDhMx')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 281, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'presPumpAv')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 286, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'flowrateBit')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 291, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mudClass')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 296, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mudSubClass')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 302, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'comments')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 308, 3))
    ...
    symbol = pyxb.binding.content.ElementUse(cs_drillingParams._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extensionNameValue')), pyxb.utils.utility.Location('cs_drillingParams.xsd', 313, 3))
    ...
    return fac.Automaton(states, counters, False, containing_state=None)
cs_drillingParams._Automaton = _BuildAutomaton_9()
...
obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'objectReference'), refObjectString, scope=obj_risk, documentation='A reference to an object that is defined within the context of a wellbore.', location=pyxb.utils.utility.Location('grp_risk.xsd', 28, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'type'), RiskType, scope=obj_risk, documentation='The type of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 33, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'category'), RiskCategory, scope=obj_risk, documentation='The category of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 38, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'subCategory'), RiskSubCategory, scope=obj_risk, documentation='The sub category of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 43, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'extendCategory'), kindString, scope=obj_risk, documentation='Custom string to further categorize the risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 48, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'affectedPersonnel'), RiskAffectedPersonnel, scope=obj_risk, documentation='The personnel afected by the risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 53, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimStart'), timestamp, scope=obj_risk, documentation='Date and time that activities started.', location=pyxb.utils.utility.Location('grp_risk.xsd', 58, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'dTimEnd'), timestamp, scope=obj_risk, documentation='Date and time that activities were completed.', location=pyxb.utils.utility.Location('grp_risk.xsd', 63, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart'), measuredDepthCoord, scope=obj_risk, documentation='Measured Depth at start of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 68, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdHoleEnd'), measuredDepthCoord, scope=obj_risk, documentation='Measured Depth at end of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 73, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleStart'), wellVerticalDepthCoord, scope=obj_risk, documentation='True Vertical Depth at start of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 78, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleEnd'), wellVerticalDepthCoord, scope=obj_risk, documentation='True Vertical Depth at end of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 83, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBitStart'), measuredDepthCoord, scope=obj_risk, documentation='Measured depth of bit at start of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 88, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mdBitEnd'), measuredDepthCoord, scope=obj_risk, documentation='Measured depth of bit at end of activity.', location=pyxb.utils.utility.Location('grp_risk.xsd', 93, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'diaHole'), lengthMeasure, scope=obj_risk, documentation='Hole diameter.  ', location=pyxb.utils.utility.Location('grp_risk.xsd', 98, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'severityLevel'), levelIntegerCode, scope=obj_risk, documentation='Severity Level of the Risk. \n\t\t\t\t\tValues of 1 through 5 with 1 being the lowest.', location=pyxb.utils.utility.Location('grp_risk.xsd', 103, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'probabilityLevel'), levelIntegerCode, scope=obj_risk, documentation='Probability Level of the Risk.\n\t\t\t\t\tValues of 1 through 5 with 1 being the lowest.', location=pyxb.utils.utility.Location('grp_risk.xsd', 109, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'summary'), descriptionString, scope=obj_risk, documentation='summary description of risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 115, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'details'), descriptionString, scope=obj_risk, documentation='Complete description of Risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 120, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'identification'), descriptionString, scope=obj_risk, documentation='Details for identifing the Risk.', location=pyxb.utils.utility.Location('grp_risk.xsd', 125, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'contingency'), descriptionString, scope=obj_risk, documentation='Plan of action if the Risk materializes.', location=pyxb.utils.utility.Location('grp_risk.xsd', 130, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'mitigation'), descriptionString, scope=obj_risk, documentation='Plan of action to ensure the risk does not materialize.', location=pyxb.utils.utility.Location('grp_risk.xsd', 135, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWell'), nameString, scope=obj_risk, documentation='Human recognizable context for the well that contains the wellbore.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 73, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore'), nameString, scope=obj_risk, documentation='Human recognizable context for the wellbore that contains the risk.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 78, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'name'), nameString, scope=obj_risk, documentation='Human recognizable context for the risk.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 83, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'commonData'), cs_commonData, scope=obj_risk, documentation='A container element that contains elements that are common to all data \n\t\t\t\t\tobjects.  ', location=pyxb.utils.utility.Location('obj_risk.xsd', 93, 3)))

obj_risk._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'customData'), cs_customData, scope=obj_risk, documentation='A container element that can contain custom or user defined \n\t\t\t\t\tdata elements.', location=pyxb.utils.utility.Location('obj_risk.xsd', 99, 3)))
...
def _BuildAutomaton_11 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 88, 3))
    counters.add(cc_0)
    cc_1 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 28, 3))
    counters.add(cc_1)
    cc_2 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 43, 3))
    counters.add(cc_2)
    cc_3 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 48, 3))
    counters.add(cc_3)
    cc_4 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 53, 3))
    counters.add(cc_4)
    cc_5 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 58, 3))
    counters.add(cc_5)
    cc_6 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 63, 3))
    counters.add(cc_6)
    cc_7 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 68, 3))
    counters.add(cc_7)
    cc_8 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 73, 3))
    counters.add(cc_8)
    cc_9 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 78, 3))
    counters.add(cc_9)
    cc_10 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 83, 3))
    counters.add(cc_10)
    cc_11 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 88, 3))
    counters.add(cc_11)
    cc_12 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 93, 3))
    counters.add(cc_12)
    cc_13 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 98, 3))
    counters.add(cc_13)
    cc_14 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 103, 3))
    counters.add(cc_14)
    cc_15 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 109, 3))
    counters.add(cc_15)
    cc_16 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 115, 3))
    counters.add(cc_16)
    cc_17 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 120, 3))
    counters.add(cc_17)
    cc_18 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 125, 3))
    counters.add(cc_18)
    cc_19 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 130, 3))
    counters.add(cc_19)
    cc_20 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('grp_risk.xsd', 135, 3))
    counters.add(cc_20)
    cc_21 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 93, 3))
    counters.add(cc_21)
    cc_22 = fac.CounterCondition(min=0, max=1, metadata=pyxb.utils.utility.Location('obj_risk.xsd', 99, 3))
    counters.add(cc_22)
    states = []
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWell')), pyxb.utils.utility.Location('obj_risk.xsd', 73, 3))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'nameWellbore')), pyxb.utils.utility.Location('obj_risk.xsd', 78, 3))
    st_1 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'name')), pyxb.utils.utility.Location('obj_risk.xsd', 83, 3))
    st_2 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'objectReference')), pyxb.utils.utility.Location('grp_risk.xsd', 28, 3))
    st_3 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = None
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'type')), pyxb.utils.utility.Location('grp_risk.xsd', 33, 3))
    st_4 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_4)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'category')), pyxb.utils.utility.Location('grp_risk.xsd', 38, 3))
    st_5 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_5)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'subCategory')), pyxb.utils.utility.Location('grp_risk.xsd', 43, 3))
    st_6 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_6)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'extendCategory')), pyxb.utils.utility.Location('grp_risk.xsd', 48, 3))
    st_7 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_7)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'affectedPersonnel')), pyxb.utils.utility.Location('grp_risk.xsd', 53, 3))
    st_8 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_8)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_5, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimStart')), pyxb.utils.utility.Location('grp_risk.xsd', 58, 3))
    st_9 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_9)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'dTimEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 63, 3))
    st_10 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_10)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdHoleStart')), pyxb.utils.utility.Location('grp_risk.xsd', 68, 3))
    st_11 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_11)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdHoleEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 73, 3))
    st_12 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_12)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_9, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleStart')), pyxb.utils.utility.Location('grp_risk.xsd', 78, 3))
    st_13 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_13)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'tvdHoleEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 83, 3))
    st_14 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_14)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBitStart')), pyxb.utils.utility.Location('grp_risk.xsd', 88, 3))
    st_15 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_15)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mdBitEnd')), pyxb.utils.utility.Location('grp_risk.xsd', 93, 3))
    st_16 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_16)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_13, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'diaHole')), pyxb.utils.utility.Location('grp_risk.xsd', 98, 3))
    st_17 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_17)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_14, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'severityLevel')), pyxb.utils.utility.Location('grp_risk.xsd', 103, 3))
    st_18 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_18)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_15, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'probabilityLevel')), pyxb.utils.utility.Location('grp_risk.xsd', 109, 3))
    st_19 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_19)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_16, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'summary')), pyxb.utils.utility.Location('grp_risk.xsd', 115, 3))
    st_20 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_20)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_17, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'details')), pyxb.utils.utility.Location('grp_risk.xsd', 120, 3))
    st_21 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_21)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_18, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'identification')), pyxb.utils.utility.Location('grp_risk.xsd', 125, 3))
    st_22 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_22)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_19, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'contingency')), pyxb.utils.utility.Location('grp_risk.xsd', 130, 3))
    st_23 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_23)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    final_update.add(fac.UpdateInstruction(cc_20, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'mitigation')), pyxb.utils.utility.Location('grp_risk.xsd', 135, 3))
    st_24 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_24)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_21, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'commonData')), pyxb.utils.utility.Location('obj_risk.xsd', 93, 3))
    st_25 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_25)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_22, False))
    symbol = pyxb.binding.content.ElementUse(obj_risk._UseForTag(pyxb.namespace.ExpandedName(Namespace, 'customData')), pyxb.utils.utility.Location('obj_risk.xsd', 99, 3))
    st_26 = fac.State(symbol, is_initial=False, final_update=final_update, is_unordered_catenation=False)
    states.append(st_26)
    transitions = []
    transitions.append(fac.Transition(st_1, [
    ...
    st_26._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
obj_risk._Automaton = _BuildAutomaton_11()


risks._setSubstitutionGroup(_ImportedBinding__abs.abstractDataObject)
