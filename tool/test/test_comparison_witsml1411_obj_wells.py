...
XML_WELL_EQUAL_NO_DOCUMENT_INFO_SECTION = """<?xml version="1.0" encoding="UTF-8"?>
<!--           Example of Well data         -->
<wells 
    xmlns="http://www.witsml.org/schemas/1series" 
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
...
class Test(unittest.TestCase):
    ...
    def test_witsml_well_removed_document_info_section(self):
        result, report = witsml_obj_compare.witsml1411_compare_obj_wells( XML_WELL , XML_WELL_EQUAL_NO_DOCUMENT_INFO_SECTION ) 
        open("reports/repo_well_removed_document_info_section.html","w").write(report);
        self.assertTrue( result );
