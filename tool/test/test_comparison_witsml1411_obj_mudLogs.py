...
XML_ORIGINAL = """<?xml version="1.0" encoding="UTF-8"?>
                    ...
                    <!--               Example of Mud Log data         -->
                    <mudLogs 
                        xmlns="http://www.witsml.org/schemas/1series" 
                        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
                        xsi:schemaLocation="http://www.witsml.org/schemas/1series  ../xsd_schemas/obj_mudLog.xsd"
                        version="1.4.1.1">
                    <!-- 
                    ...
                    -->
                        <documentInfo>
                            ...
                            <fileCreationInformation>
                                <fileCreationDate>2011-09-15T16:15:31.827Z</fileCreationDate> 
                        ...
                        <mudLog uidWell="W-12" uidWellbore="B-01" uid="h45a">
                            ...
                            <startMd uom="ft">8920.19</startMd>
...
class Test(unittest.TestCase):
    ...
    def testCompareToItself(self):
        XML_INSPECTED_CALCITE_MODIFIED = """<?xml version="1.0" encoding="UTF-8"?>
                    <?xml-stylesheet href="./stylesheets/generic.xsl" type="text/xsl" media="screen"?>
                    <!--               Example of Mud Log data         -->
                    <mudLogs 
                        xmlns="http://www.witsml.org/schemas/1series" 
    ...
    def testCompareChangedOrder(self):
        XML_PARAMETERS_REORDERED = """<?xml version="1.0" encoding="UTF-8"?>
                    <?xml-stylesheet href="./stylesheets/generic.xsl" type="text/xsl" media="screen"?>
                    <!--               Example of Mud Log data         -->
                    <mudLogs 
                        xmlns="http://www.witsml.org/schemas/1series" 
    ...
    def testCompareChangedOrder_chronostratigraphic(self):
        XMLA = """<mudLogs xmlns="http://www.witsml.org/schemas/1series" version="$server_schema_version$">
        ...
        XMLB = """<mudLogs xmlns="http://www.witsml.org/schemas/1series" version="$server_schema_version$">
            <mudLog uidWell="$server_w1_uid$" uidWellbore="$server_w1_wb1_uid$">
                <nameWell>$well_name$</nameWell>
                <nameWellbore>$wellbore_name$</nameWellbore>
                <name>$mudLog_name$</name>
